...
function var_0_0.SwitchBar(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	for iter_20_2, iter_20_3 in ipairs(arg_20_1) do
		...
		elseif iter_20_3 == ACTIVITY_MATRIX_COIN then
			local var_20_1 = arg_20_0:getOrAddBarGo_(iter_20_3, arg_20_0.styleInfo_)

			var_0_0:SetActive(var_20_1, true)
			var_20_1:SetCanAdd(false)
	...
	local var_20_5 = arg_20_0:getMappedBarList_(arg_20_1, arg_20_0.styleInfo_)
	local var_20_6 = arg_20_0:getMappedBarList_(arg_20_0.lastBarList_, arg_20_0.lastStyleInfo_)

	for iter_20_4, iter_20_5 in ipairs(var_20_6) do
		if not table.keyof(var_20_5, iter_20_5) and arg_20_0.barGo_[iter_20_5] then
