return {
	...
	Play320111037 = function(arg_151_0, arg_151_1)
		...
		function arg_151_1.onSingleLineUpdate_(arg_154_0)
			...
			local var_154_4 = arg_151_1.actors_["1056ui_story"].transform
			local var_154_5 = 0

			if var_154_5 < arg_151_1.time_ and arg_151_1.time_ <= var_154_5 + arg_154_0 then
				arg_151_1.var_.moveOldPos1056ui_story = var_154_4.localPosition
			end
			...
			if var_154_5 <= arg_151_1.time_ and arg_151_1.time_ < var_154_5 + var_154_6 then
				...
				local var_154_8 = Vector3.New(0, -1, -5.75)

				var_154_4.localPosition = Vector3.Lerp(arg_151_1.var_.moveOldPos1056ui_story, var_154_8, var_154_7)
			...
			if arg_151_1.time_ >= var_154_5 + var_154_6 and arg_151_1.time_ < var_154_5 + var_154_6 + arg_154_0 then
				var_154_4.localPosition = Vector3.New(0, -1, -5.75)
			...
			local var_154_13 = arg_151_1.actors_["1056ui_story"]
			local var_154_14 = 0

			if var_154_14 < arg_151_1.time_ and arg_151_1.time_ <= var_154_14 + arg_154_0 and arg_151_1.var_.characterEffect1056ui_story == nil then
				arg_151_1.var_.characterEffect1056ui_story = var_154_13:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_151_1.time_ >= var_154_14 + var_154_15 and arg_151_1.time_ < var_154_14 + var_154_15 + arg_154_0 and arg_151_1.var_.characterEffect1056ui_story then
				arg_151_1.var_.characterEffect1056ui_story.fillFlat = false
			end
			...
			if var_154_19 < arg_151_1.time_ and arg_151_1.time_ <= var_154_19 + arg_154_0 then
				...
				local var_154_21 = arg_151_1:FormatText(StoryNameCfg[605].name)
				...
				local var_154_22 = arg_151_1:GetWordFromCfg(320111037)
				...
				if manager.audio:GetVoiceLength("story_v_out_320111", "320111037", "story_v_out_320111.awb") ~= 0 then
					local var_154_27 = manager.audio:GetVoiceLength("story_v_out_320111", "320111037", "story_v_out_320111.awb") / 1000
					...
					if var_154_22.prefab_name ~= "" and arg_151_1.actors_[var_154_22.prefab_name] ~= nil then
						local var_154_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_151_1.actors_[var_154_22.prefab_name].transform, "story_v_out_320111", "320111037", "story_v_out_320111.awb")

						arg_151_1:RecordAudio("320111037", var_154_28)
						arg_151_1:RecordAudio("320111037", var_154_28)
					else
	...
	Play320111040 = function(arg_163_0, arg_163_1)
		...
		function arg_163_1.onSingleLineUpdate_(arg_166_0)
			...
			if var_166_1 < arg_163_1.time_ and arg_163_1.time_ <= var_166_1 + arg_166_0 and arg_163_1.var_.characterEffect1056ui_story == nil then
			...
			if var_166_1 <= arg_163_1.time_ and arg_163_1.time_ < var_166_1 + var_166_2 then
				...
				if arg_163_1.var_.characterEffect1056ui_story then
					arg_163_1.var_.characterEffect1056ui_story.fillFlat = false
				end
			end

			if arg_163_1.time_ >= var_166_1 + var_166_2 and arg_163_1.time_ < var_166_1 + var_166_2 + arg_166_0 and arg_163_1.var_.characterEffect1056ui_story then
				arg_163_1.var_.characterEffect1056ui_story.fillFlat = false
			end
	...
	Play320111042 = function(arg_171_0, arg_171_1)
		...
		function arg_171_1.onSingleLineUpdate_(arg_174_0)
			...
			if var_174_37 < arg_171_1.time_ and arg_171_1.time_ <= var_174_37 + arg_174_0 and arg_171_1.var_.characterEffect1056ui_story == nil then
			...
			if var_174_37 <= arg_171_1.time_ and arg_171_1.time_ < var_174_37 + var_174_38 then
				...
				if arg_171_1.var_.characterEffect1056ui_story then
			...
			if arg_171_1.time_ >= var_174_37 + var_174_38 and arg_171_1.time_ < var_174_37 + var_174_38 + arg_174_0 and arg_171_1.var_.characterEffect1056ui_story then
	...
	Play320111053 = function(arg_217_0, arg_217_1)
		...
		function arg_217_1.onSingleLineUpdate_(arg_220_0)
			...
			if var_220_34 < arg_217_1.time_ and arg_217_1.time_ <= var_220_34 + arg_220_0 and arg_217_1.var_.characterEffect1056ui_story == nil then
			...
			if arg_217_1.time_ >= var_220_34 + var_220_35 and arg_217_1.time_ < var_220_34 + var_220_35 + arg_220_0 and arg_217_1.var_.characterEffect1056ui_story then
