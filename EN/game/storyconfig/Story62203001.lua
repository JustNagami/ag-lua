	...
	Play62203001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_54 < arg_1_1.time_ and arg_1_1.time_ <= var_4_54 + arg_4_0 then
				...
				local var_4_58 = arg_1_1:GetWordFromCfg(62203001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203001", "story_v_chess_62203.awb") ~= 0 then
					local var_4_63 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203001", "story_v_chess_62203.awb") / 1000
					...
					if var_4_58.prefab_name ~= "" and arg_1_1.actors_[var_4_58.prefab_name] ~= nil then
						local var_4_64 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_58.prefab_name].transform, "story_v_chess_62203", "62203001", "story_v_chess_62203.awb")

						arg_1_1:RecordAudio("62203001", var_4_64)
						arg_1_1:RecordAudio("62203001", var_4_64)
					else
	...
	Play62203002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if arg_9_1.actors_[var_12_0] == nil then
				...
				var_12_2.sprite = getSpriteWithoutAtlas("TextureConfig/Character/Portrait/" .. "1111_1")
			...
			local var_12_3 = arg_9_1.actors_["1111_1"]
			local var_12_4 = 0

			if var_12_4 < arg_9_1.time_ and arg_9_1.time_ <= var_12_4 + arg_12_0 and not isNil(var_12_3) then
				local var_12_5 = var_12_3:GetComponent("Image")

				if var_12_5 then
					arg_9_1.var_.highlightMatValue1111_1 = var_12_5
				end
			end

			local var_12_6 = 0.2

			if var_12_4 <= arg_9_1.time_ and arg_9_1.time_ < var_12_4 + var_12_6 and not isNil(var_12_3) then
				local var_12_7 = (arg_9_1.time_ - var_12_4) / var_12_6

				if arg_9_1.var_.highlightMatValue1111_1 then
					local var_12_8 = Mathf.Lerp(1, 0.5, var_12_7)
					local var_12_9 = arg_9_1.var_.highlightMatValue1111_1
					local var_12_10 = var_12_9.color

					var_12_10.r = var_12_8
					var_12_10.g = var_12_8
					var_12_10.b = var_12_8
					var_12_9.color = var_12_10
				end
			end

			if arg_9_1.time_ >= var_12_4 + var_12_6 and arg_9_1.time_ < var_12_4 + var_12_6 + arg_12_0 and not isNil(var_12_3) and arg_9_1.var_.highlightMatValue1111_1 then
				local var_12_11 = 0.5
				local var_12_12 = arg_9_1.var_.highlightMatValue1111_1
				local var_12_13 = var_12_12.color

				var_12_13.r = var_12_11
				var_12_13.g = var_12_11
				var_12_13.b = var_12_11
				var_12_12.color = var_12_13
			end

			local var_12_14 = arg_9_1.actors_["1111ui_story"].transform
			local var_12_15 = 0

			if var_12_15 < arg_9_1.time_ and arg_9_1.time_ <= var_12_15 + arg_12_0 then
				arg_9_1.var_.moveOldPos1111ui_story = var_12_14.localPosition
			end
			...
			if var_12_15 <= arg_9_1.time_ and arg_9_1.time_ < var_12_15 + var_12_16 then
				...
				local var_12_18 = Vector3.New(0, 100, 0)

				var_12_14.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1111ui_story, var_12_18, var_12_17)
			...
			if arg_9_1.time_ >= var_12_15 + var_12_16 and arg_9_1.time_ < var_12_15 + var_12_16 + arg_12_0 then
				var_12_14.localPosition = Vector3.New(0, 100, 0)
			...
			if var_12_23 < arg_9_1.time_ and arg_9_1.time_ <= var_12_23 + arg_12_0 then
				...
				local var_12_25 = arg_9_1:GetWordFromCfg(62203002)
	...
	Play62203003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				...
				local var_16_2 = arg_13_1:GetWordFromCfg(62203003)
	...
	Play62203004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				...
				local var_20_2 = arg_17_1:FormatText(StoryNameCfg[49].name)
				...
				local var_20_3 = arg_17_1:GetWordFromCfg(62203004)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203004", "story_v_chess_62203.awb") ~= 0 then
					local var_20_8 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203004", "story_v_chess_62203.awb") / 1000
					...
					if var_20_3.prefab_name ~= "" and arg_17_1.actors_[var_20_3.prefab_name] ~= nil then
						local var_20_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_3.prefab_name].transform, "story_v_chess_62203", "62203004", "story_v_chess_62203.awb")

						arg_17_1:RecordAudio("62203004", var_20_9)
						arg_17_1:RecordAudio("62203004", var_20_9)
					else
	...
	Play62203005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_1 <= arg_21_1.time_ and arg_21_1.time_ < var_24_1 + var_24_2 then
				...
				local var_24_4 = Vector3.New(0, -0.83, -6)
			...
			if arg_21_1.time_ >= var_24_1 + var_24_2 and arg_21_1.time_ < var_24_1 + var_24_2 + arg_24_0 then
				var_24_0.localPosition = Vector3.New(0, -0.83, -6)
			...
			local var_24_11 = arg_21_1.actors_["1111ui_story"]
			local var_24_12 = 0

			if var_24_12 < arg_21_1.time_ and arg_21_1.time_ <= var_24_12 + arg_24_0 and not isNil(var_24_11) and arg_21_1.var_.characterEffect1111ui_story == nil then
				arg_21_1.var_.characterEffect1111ui_story = var_24_11:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_24_12 <= arg_21_1.time_ and arg_21_1.time_ < var_24_12 + var_24_13 and not isNil(var_24_11) then
				...
				if arg_21_1.var_.characterEffect1111ui_story and not isNil(var_24_11) then
					arg_21_1.var_.characterEffect1111ui_story.fillFlat = false
				end
			end

			if arg_21_1.time_ >= var_24_12 + var_24_13 and arg_21_1.time_ < var_24_12 + var_24_13 + arg_24_0 and not isNil(var_24_11) and arg_21_1.var_.characterEffect1111ui_story then
				arg_21_1.var_.characterEffect1111ui_story.fillFlat = false
			end
			...
			if var_24_15 < arg_21_1.time_ and arg_21_1.time_ <= var_24_15 + arg_24_0 then
				...
				local var_24_18 = arg_21_1:GetWordFromCfg(62203005)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203005", "story_v_chess_62203.awb") ~= 0 then
					local var_24_23 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203005", "story_v_chess_62203.awb") / 1000
					...
					if var_24_18.prefab_name ~= "" and arg_21_1.actors_[var_24_18.prefab_name] ~= nil then
						local var_24_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_18.prefab_name].transform, "story_v_chess_62203", "62203005", "story_v_chess_62203.awb")

						arg_21_1:RecordAudio("62203005", var_24_24)
						arg_21_1:RecordAudio("62203005", var_24_24)
					else
	...
	Play62203006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_2 < arg_25_1.time_ and arg_25_1.time_ <= var_28_2 + arg_28_0 then
				...
				local var_28_5 = arg_25_1:GetWordFromCfg(62203006)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203006", "story_v_chess_62203.awb") ~= 0 then
					local var_28_10 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203006", "story_v_chess_62203.awb") / 1000
					...
					if var_28_5.prefab_name ~= "" and arg_25_1.actors_[var_28_5.prefab_name] ~= nil then
						local var_28_11 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_5.prefab_name].transform, "story_v_chess_62203", "62203006", "story_v_chess_62203.awb")

						arg_25_1:RecordAudio("62203006", var_28_11)
						arg_25_1:RecordAudio("62203006", var_28_11)
					else
	...
	Play62203007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_6 < arg_29_1.time_ and arg_29_1.time_ <= var_32_6 + arg_32_0 then
				...
				local var_32_8 = arg_29_1:FormatText(StoryNameCfg[49].name)
				...
				local var_32_9 = arg_29_1:GetWordFromCfg(62203007)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203007", "story_v_chess_62203.awb") ~= 0 then
					local var_32_14 = manager.audio:GetVoiceLength("story_v_chess_62203", "62203007", "story_v_chess_62203.awb") / 1000
					...
					if var_32_9.prefab_name ~= "" and arg_29_1.actors_[var_32_9.prefab_name] ~= nil then
						local var_32_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_9.prefab_name].transform, "story_v_chess_62203", "62203007", "story_v_chess_62203.awb")

						arg_29_1:RecordAudio("62203007", var_32_15)
						arg_29_1:RecordAudio("62203007", var_32_15)
					else
	...
	Play62203008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_9 < arg_33_1.time_ and arg_33_1.time_ <= var_36_9 + arg_36_0 then
				...
				local var_36_12 = arg_33_1:GetWordFromCfg(62203008)
	...
	Play62203009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_0 + arg_40_0 then
				...
				local var_40_2 = arg_37_1:GetWordFromCfg(62203009)
