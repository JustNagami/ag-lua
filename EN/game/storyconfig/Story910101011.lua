	...
	Play910101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				if var_4_35 then
					arg_1_1.var_.alphaOldValue1070 = var_4_35.alpha
					arg_1_1.var_.characterEffect1070 = var_4_35
				end
			...
			if var_4_34 <= arg_1_1.time_ and arg_1_1.time_ < var_4_34 + var_4_36 then
				...
				local var_4_38 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1070, 1, var_4_37)

				if arg_1_1.var_.characterEffect1070 then
					arg_1_1.var_.characterEffect1070.alpha = var_4_38
				end
			end

			if arg_1_1.time_ >= var_4_34 + var_4_36 and arg_1_1.time_ < var_4_34 + var_4_36 + arg_4_0 and arg_1_1.var_.characterEffect1070 then
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_42 = arg_1_1:FormatText(StoryNameCfg[318].name)
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(910101001)
