	...
	Play910101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_33 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 then
				...
				if var_4_34 then
					arg_1_1.var_.alphaOldValue1070 = var_4_34.alpha
					arg_1_1.var_.characterEffect1070 = var_4_34
				end
			...
			if var_4_33 <= arg_1_1.time_ and arg_1_1.time_ < var_4_33 + var_4_35 then
				...
				local var_4_37 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1070, 1, var_4_36)

				if arg_1_1.var_.characterEffect1070 then
					arg_1_1.var_.characterEffect1070.alpha = var_4_37
				end
			end

			if arg_1_1.time_ >= var_4_33 + var_4_35 and arg_1_1.time_ < var_4_33 + var_4_35 + arg_4_0 and arg_1_1.var_.characterEffect1070 then
			...
			if var_4_38 < arg_1_1.time_ and arg_1_1.time_ <= var_4_38 + arg_4_0 then
				...
				local var_4_41 = arg_1_1:FormatText(StoryNameCfg[318].name)
				...
				local var_4_42 = arg_1_1:GetWordFromCfg(910101001)
