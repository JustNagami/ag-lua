return {
	...
	Play123471004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_5 <= arg_17_1.time_ and arg_17_1.time_ < var_20_5 + var_20_6 then
				...
				local var_20_8 = Vector3.New(0, -1, -6.1)

				var_20_4.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos1050ui_story, var_20_8, var_20_7)
			...
			local var_20_13 = arg_17_1.actors_["1050ui_story"]
			local var_20_14 = 0

			if var_20_14 < arg_17_1.time_ and arg_17_1.time_ <= var_20_14 + arg_20_0 and arg_17_1.var_.characterEffect1050ui_story == nil then
				arg_17_1.var_.characterEffect1050ui_story = var_20_13:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_17_1.time_ >= var_20_14 + var_20_15 and arg_17_1.time_ < var_20_14 + var_20_15 + arg_20_0 and arg_17_1.var_.characterEffect1050ui_story then
				arg_17_1.var_.characterEffect1050ui_story.fillFlat = false
			end
			...
			if var_20_19 < arg_17_1.time_ and arg_17_1.time_ <= var_20_19 + arg_20_0 then
				...
				local var_20_22 = arg_17_1:GetWordFromCfg(123471004)
				...
				if manager.audio:GetVoiceLength("story_v_out_123471", "123471004", "story_v_out_123471.awb") ~= 0 then
					local var_20_27 = manager.audio:GetVoiceLength("story_v_out_123471", "123471004", "story_v_out_123471.awb") / 1000
					...
					if var_20_22.prefab_name ~= "" and arg_17_1.actors_[var_20_22.prefab_name] ~= nil then
						local var_20_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_22.prefab_name].transform, "story_v_out_123471", "123471004", "story_v_out_123471.awb")

						arg_17_1:RecordAudio("123471004", var_20_28)
						arg_17_1:RecordAudio("123471004", var_20_28)
					else
	...
	Play123471005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			local var_24_19 = arg_21_1.actors_["2089ui_story"].transform
			local var_24_20 = 0

			if var_24_20 < arg_21_1.time_ and arg_21_1.time_ <= var_24_20 + arg_24_0 then
				arg_21_1.var_.moveOldPos2089ui_story = var_24_19.localPosition
			end
			...
			if var_24_20 <= arg_21_1.time_ and arg_21_1.time_ < var_24_20 + var_24_21 then
				...
				local var_24_23 = Vector3.New(0, -1.16, -4.85)

				var_24_19.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos2089ui_story, var_24_23, var_24_22)
			...
			if arg_21_1.time_ >= var_24_20 + var_24_21 and arg_21_1.time_ < var_24_20 + var_24_21 + arg_24_0 then
				var_24_19.localPosition = Vector3.New(0, -1.16, -4.85)
			...
			local var_24_29 = arg_21_1.actors_["2089ui_story"]
			local var_24_30 = 0

			if var_24_30 < arg_21_1.time_ and arg_21_1.time_ <= var_24_30 + arg_24_0 and arg_21_1.var_.characterEffect2089ui_story == nil then
				arg_21_1.var_.characterEffect2089ui_story = var_24_29:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_24_30 <= arg_21_1.time_ and arg_21_1.time_ < var_24_30 + var_24_31 then
				...
				if arg_21_1.var_.characterEffect2089ui_story then
					arg_21_1.var_.characterEffect2089ui_story.fillFlat = false
				end
			end

			if arg_21_1.time_ >= var_24_30 + var_24_31 and arg_21_1.time_ < var_24_30 + var_24_31 + arg_24_0 and arg_21_1.var_.characterEffect2089ui_story then
				arg_21_1.var_.characterEffect2089ui_story.fillFlat = false
			end

			local var_24_33 = 0
			local var_24_34 = 0.75
			...
			if var_24_33 < arg_21_1.time_ and arg_21_1.time_ <= var_24_33 + arg_24_0 then
				...
				local var_24_35 = arg_21_1:FormatText(StoryNameCfg[494].name)
				...
				local var_24_36 = arg_21_1:GetWordFromCfg(123471005)
				...
				if manager.audio:GetVoiceLength("story_v_out_123471", "123471005", "story_v_out_123471.awb") ~= 0 then
					local var_24_41 = manager.audio:GetVoiceLength("story_v_out_123471", "123471005", "story_v_out_123471.awb") / 1000
					...
					if var_24_36.prefab_name ~= "" and arg_21_1.actors_[var_24_36.prefab_name] ~= nil then
						local var_24_42 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_36.prefab_name].transform, "story_v_out_123471", "123471005", "story_v_out_123471.awb")

						arg_21_1:RecordAudio("123471005", var_24_42)
						arg_21_1:RecordAudio("123471005", var_24_42)
					else
	...
	Play123471007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_1 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 and arg_29_1.var_.characterEffect2089ui_story == nil then
			...
			if var_32_1 <= arg_29_1.time_ and arg_29_1.time_ < var_32_1 + var_32_2 then
				...
				if arg_29_1.var_.characterEffect2089ui_story then
			...
			if arg_29_1.time_ >= var_32_1 + var_32_2 and arg_29_1.time_ < var_32_1 + var_32_2 + arg_32_0 and arg_29_1.var_.characterEffect2089ui_story then
				local var_32_5 = 0.5
	...
	Play123471008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_11 < arg_33_1.time_ and arg_33_1.time_ <= var_36_11 + arg_36_0 and arg_33_1.var_.characterEffect1050ui_story == nil then
			...
			if arg_33_1.time_ >= var_36_11 + var_36_12 and arg_33_1.time_ < var_36_11 + var_36_12 + arg_36_0 and arg_33_1.var_.characterEffect1050ui_story then
				arg_33_1.var_.characterEffect1050ui_story.fillFlat = false
			end
	...
	Play123471014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_11 < arg_57_1.time_ and arg_57_1.time_ <= var_60_11 + arg_60_0 and arg_57_1.var_.characterEffect1050ui_story == nil then
			...
			if arg_57_1.time_ >= var_60_11 + var_60_12 and arg_57_1.time_ < var_60_11 + var_60_12 + arg_60_0 and arg_57_1.var_.characterEffect1050ui_story then
				local var_60_15 = 0.5
	...
	Play123471015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_11 < arg_61_1.time_ and arg_61_1.time_ <= var_64_11 + arg_64_0 and arg_61_1.var_.characterEffect2089ui_story == nil then
			...
			if var_64_11 <= arg_61_1.time_ and arg_61_1.time_ < var_64_11 + var_64_12 then
				...
				if arg_61_1.var_.characterEffect2089ui_story then
					arg_61_1.var_.characterEffect2089ui_story.fillFlat = false
				end
			end

			if arg_61_1.time_ >= var_64_11 + var_64_12 and arg_61_1.time_ < var_64_11 + var_64_12 + arg_64_0 and arg_61_1.var_.characterEffect2089ui_story then
				arg_61_1.var_.characterEffect2089ui_story.fillFlat = false
			end
	...
	Play123471016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_1 < arg_65_1.time_ and arg_65_1.time_ <= var_68_1 + arg_68_0 and arg_65_1.var_.characterEffect2089ui_story == nil then
			...
			if var_68_1 <= arg_65_1.time_ and arg_65_1.time_ < var_68_1 + var_68_2 then
				...
				if arg_65_1.var_.characterEffect2089ui_story then
			...
			if arg_65_1.time_ >= var_68_1 + var_68_2 and arg_65_1.time_ < var_68_1 + var_68_2 + arg_68_0 and arg_65_1.var_.characterEffect2089ui_story then
				local var_68_5 = 0.5
