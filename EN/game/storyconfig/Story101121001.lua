return {
		...
		function arg_26_1.onSingleLineUpdate_(arg_29_0)
			...
			if var_29_23 < arg_26_1.time_ and arg_26_1.time_ <= var_29_23 + arg_29_0 then
				...
				if not var_29_24 then
					var_29_24 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ripple"))
					var_29_24.name = "shuidi1"
					arg_26_1.var_.effectSA0104shuidi1 = var_29_24
				end

				local var_29_25 = var_29_22:Find("")

				if var_29_25 then
					var_29_24.transform.parent = var_29_25
				else
					var_29_24.transform.parent = var_29_22
				end
			...
			if var_29_26 < arg_26_1.time_ and arg_26_1.time_ <= var_29_26 + arg_29_0 then
				local var_29_28 = "play"
				local var_29_29 = "music"

				arg_26_1:AudioAction(var_29_28, var_29_29, "bgm_activity_1_2_1_summer2_story_general", "bgm_activity_1_2_1_summer2_story_general", "bgm_activity_1_2_1_summer2_story_general.awb")

				local var_29_30 = ""
				local var_29_31 = manager.audio:GetAudioName("bgm_activity_1_2_1_summer2_story_general", "bgm_activity_1_2_1_summer2_story_general")

				if var_29_31 ~= "" then
					if arg_26_1.bgmTxt_.text ~= var_29_31 and arg_26_1.bgmTxt_.text ~= "" then
						if arg_26_1.bgmTxt2_.text ~= "" then
							arg_26_1.bgmTxt_.text = arg_26_1.bgmTxt2_.text
						end

						arg_26_1.bgmTxt2_.text = var_29_31

						arg_26_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_26_1.bgmTxt_.text = var_29_31
					end
			...
			if var_29_32 < arg_26_1.time_ and arg_26_1.time_ <= var_29_32 + arg_29_0 then
				...
				local var_29_34 = LeanTween.value(arg_26_1.dialog_, 0, 1, 0.3)

				var_29_34:setOnUpdate(LuaHelper.FloatAction(function(arg_31_0)
					arg_26_1.dialogCg_.alpha = arg_31_0
				end))
				var_29_34:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_26_1.dialog_)
					var_29_34:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_29_35 = arg_26_1:GetWordFromCfg(112101007)
				local var_29_36 = arg_26_1:FormatText(var_29_35.content)

				arg_26_1.text_.text = var_29_36

				LuaForUtil.ClearLinePrefixSymbol(arg_26_1.text_)

				local var_29_37 = 42
				local var_29_38 = utf8.len(var_29_36)
				local var_29_39 = var_29_37 <= 0 and var_29_33 or var_29_33 * (var_29_38 / var_29_37)

				if var_29_39 > 0 and var_29_33 < var_29_39 then
					arg_26_1.talkMaxDuration = var_29_39
					var_29_32 = var_29_32 + 0.3

					if var_29_39 + var_29_32 > arg_26_1.duration_ then
						arg_26_1.duration_ = var_29_39 + var_29_32
					end
				end
			...
			local var_29_40 = var_29_32 + 0.3
			local var_29_41 = math.max(var_29_33, arg_26_1.talkMaxDuration)

			if var_29_40 <= arg_26_1.time_ and arg_26_1.time_ < var_29_40 + var_29_41 then
				arg_26_1.typewritter.percent = (arg_26_1.time_ - var_29_40) / var_29_41

				arg_26_1.typewritter:SetDirty()
			end

			if arg_26_1.time_ >= var_29_40 + var_29_41 and arg_26_1.time_ < var_29_40 + var_29_41 + arg_29_0 then
	...
	Play112101015 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			local var_66_4 = arg_63_1.actors_["1081ui_story"].transform
			local var_66_5 = 0

			if var_66_5 < arg_63_1.time_ and arg_63_1.time_ <= var_66_5 + arg_66_0 then
				arg_63_1.var_.moveOldPos1081ui_story = var_66_4.localPosition
			end
			...
			if var_66_5 <= arg_63_1.time_ and arg_63_1.time_ < var_66_5 + var_66_6 then
				...
				local var_66_8 = Vector3.New(0, -0.92, -5.8)

				var_66_4.localPosition = Vector3.Lerp(arg_63_1.var_.moveOldPos1081ui_story, var_66_8, var_66_7)
			...
			if arg_63_1.time_ >= var_66_5 + var_66_6 and arg_63_1.time_ < var_66_5 + var_66_6 + arg_66_0 then
				var_66_4.localPosition = Vector3.New(0, -0.92, -5.8)
			...
			local var_66_15 = arg_63_1.actors_["1081ui_story"]
			local var_66_16 = 0

			if var_66_16 < arg_63_1.time_ and arg_63_1.time_ <= var_66_16 + arg_66_0 and arg_63_1.var_.characterEffect1081ui_story == nil then
				arg_63_1.var_.characterEffect1081ui_story = var_66_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_63_1.time_ >= var_66_16 + var_66_17 and arg_63_1.time_ < var_66_16 + var_66_17 + arg_66_0 and arg_63_1.var_.characterEffect1081ui_story then
				arg_63_1.var_.characterEffect1081ui_story.fillFlat = false
			end
			...
			if var_66_19 < arg_63_1.time_ and arg_63_1.time_ <= var_66_19 + arg_66_0 then
				...
				local var_66_21 = arg_63_1:FormatText(StoryNameCfg[202].name)
				...
				local var_66_22 = arg_63_1:GetWordFromCfg(112101015)
				...
				if manager.audio:GetVoiceLength("story_v_out_112101", "112101015", "story_v_out_112101.awb") ~= 0 then
					local var_66_27 = manager.audio:GetVoiceLength("story_v_out_112101", "112101015", "story_v_out_112101.awb") / 1000
					...
					if var_66_22.prefab_name ~= "" and arg_63_1.actors_[var_66_22.prefab_name] ~= nil then
						local var_66_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_63_1.actors_[var_66_22.prefab_name].transform, "story_v_out_112101", "112101015", "story_v_out_112101.awb")

						arg_63_1:RecordAudio("112101015", var_66_28)
						arg_63_1:RecordAudio("112101015", var_66_28)
					else
	...
	Play112101017 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if var_74_0 < arg_71_1.time_ and arg_71_1.time_ <= var_74_0 + arg_74_0 then
				arg_71_1:PlayTimeline("1081ui_story", "StoryTimeline/CharAction/1081/1081action/1081action7_1")
			end
			...
			if var_74_3 < arg_71_1.time_ and arg_71_1.time_ <= var_74_3 + arg_74_0 and arg_71_1.var_.characterEffect1081ui_story == nil then
			...
			if arg_71_1.time_ >= var_74_3 + var_74_4 and arg_71_1.time_ < var_74_3 + var_74_4 + arg_74_0 and arg_71_1.var_.characterEffect1081ui_story then
				arg_71_1.var_.characterEffect1081ui_story.fillFlat = false
			end
