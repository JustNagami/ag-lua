return {
	Play112111001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_41 < arg_1_1.time_ and arg_1_1.time_ <= var_4_41 + arg_4_0 then
				...
				local var_4_44 = arg_1_1:GetWordFromCfg(112111001)
	...
	Play112111002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_5 <= arg_9_1.time_ and arg_9_1.time_ < var_12_5 + var_12_6 then
				...
				local var_12_8 = Vector3.New(-0.7, -0.8, -6.2)

				var_12_4.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1148ui_story, var_12_8, var_12_7)
			...
			if arg_9_1.time_ >= var_12_5 + var_12_6 and arg_9_1.time_ < var_12_5 + var_12_6 + arg_12_0 then
				var_12_4.localPosition = Vector3.New(-0.7, -0.8, -6.2)
			...
			local var_12_15 = arg_9_1.actors_["1148ui_story"]
			local var_12_16 = 0

			if var_12_16 < arg_9_1.time_ and arg_9_1.time_ <= var_12_16 + arg_12_0 and arg_9_1.var_.characterEffect1148ui_story == nil then
				arg_9_1.var_.characterEffect1148ui_story = var_12_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_9_1.time_ >= var_12_16 + var_12_17 and arg_9_1.time_ < var_12_16 + var_12_17 + arg_12_0 and arg_9_1.var_.characterEffect1148ui_story then
				arg_9_1.var_.characterEffect1148ui_story.fillFlat = false
			end
			...
			if var_12_19 < arg_9_1.time_ and arg_9_1.time_ <= var_12_19 + arg_12_0 then
				...
				local var_12_22 = arg_9_1:GetWordFromCfg(112111002)
				...
				if manager.audio:GetVoiceLength("story_v_out_112111", "112111002", "story_v_out_112111.awb") ~= 0 then
					local var_12_27 = manager.audio:GetVoiceLength("story_v_out_112111", "112111002", "story_v_out_112111.awb") / 1000
					...
					if var_12_22.prefab_name ~= "" and arg_9_1.actors_[var_12_22.prefab_name] ~= nil then
						local var_12_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_22.prefab_name].transform, "story_v_out_112111", "112111002", "story_v_out_112111.awb")

						arg_9_1:RecordAudio("112111002", var_12_28)
						arg_9_1:RecordAudio("112111002", var_12_28)
					else
	...
	Play112111003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			local var_16_10 = arg_13_1.actors_["1081ui_story"].transform
			local var_16_11 = 0

			if var_16_11 < arg_13_1.time_ and arg_13_1.time_ <= var_16_11 + arg_16_0 then
				arg_13_1.var_.moveOldPos1081ui_story = var_16_10.localPosition
			end
			...
			if var_16_11 <= arg_13_1.time_ and arg_13_1.time_ < var_16_11 + var_16_12 then
				...
				local var_16_14 = Vector3.New(0.7, -0.92, -5.8)

				var_16_10.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1081ui_story, var_16_14, var_16_13)
			...
			if arg_13_1.time_ >= var_16_11 + var_16_12 and arg_13_1.time_ < var_16_11 + var_16_12 + arg_16_0 then
				var_16_10.localPosition = Vector3.New(0.7, -0.92, -5.8)
			...
			if var_16_21 < arg_13_1.time_ and arg_13_1.time_ <= var_16_21 + arg_16_0 and arg_13_1.var_.characterEffect1081ui_story == nil then
			...
			if arg_13_1.time_ >= var_16_21 + var_16_22 and arg_13_1.time_ < var_16_21 + var_16_22 + arg_16_0 and arg_13_1.var_.characterEffect1081ui_story then
				arg_13_1.var_.characterEffect1081ui_story.fillFlat = false
			end
			...
			if var_16_25 < arg_13_1.time_ and arg_13_1.time_ <= var_16_25 + arg_16_0 then
				...
				local var_16_27 = arg_13_1:FormatText(StoryNameCfg[202].name)
				...
				local var_16_28 = arg_13_1:GetWordFromCfg(112111003)
				...
				if manager.audio:GetVoiceLength("story_v_out_112111", "112111003", "story_v_out_112111.awb") ~= 0 then
					local var_16_33 = manager.audio:GetVoiceLength("story_v_out_112111", "112111003", "story_v_out_112111.awb") / 1000
					...
					if var_16_28.prefab_name ~= "" and arg_13_1.actors_[var_16_28.prefab_name] ~= nil then
						local var_16_34 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_28.prefab_name].transform, "story_v_out_112111", "112111003", "story_v_out_112111.awb")

						arg_13_1:RecordAudio("112111003", var_16_34)
						arg_13_1:RecordAudio("112111003", var_16_34)
					else
	...
	Play112111006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			local var_28_4 = arg_25_1.actors_["1039ui_story"].transform
			local var_28_5 = 0

			if var_28_5 < arg_25_1.time_ and arg_25_1.time_ <= var_28_5 + arg_28_0 then
				arg_25_1.var_.moveOldPos1039ui_story = var_28_4.localPosition
			end
			...
			if var_28_5 <= arg_25_1.time_ and arg_25_1.time_ < var_28_5 + var_28_6 then
				...
				local var_28_8 = Vector3.New(0, -1.01, -5.9)

				var_28_4.localPosition = Vector3.Lerp(arg_25_1.var_.moveOldPos1039ui_story, var_28_8, var_28_7)
			...
			if arg_25_1.time_ >= var_28_5 + var_28_6 and arg_25_1.time_ < var_28_5 + var_28_6 + arg_28_0 then
				var_28_4.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			if var_28_13 < arg_25_1.time_ and arg_25_1.time_ <= var_28_13 + arg_28_0 then
				arg_25_1:PlayTimeline("1039ui_story", "StoryTimeline/CharAction/1039/1039action/1039action5_1")
			end
			...
			local var_28_15 = arg_25_1.actors_["1039ui_story"]
			local var_28_16 = 0

			if var_28_16 < arg_25_1.time_ and arg_25_1.time_ <= var_28_16 + arg_28_0 and arg_25_1.var_.characterEffect1039ui_story == nil then
				arg_25_1.var_.characterEffect1039ui_story = var_28_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_25_1.time_ >= var_28_16 + var_28_17 and arg_25_1.time_ < var_28_16 + var_28_17 + arg_28_0 and arg_25_1.var_.characterEffect1039ui_story then
				arg_25_1.var_.characterEffect1039ui_story.fillFlat = false
			end

			local var_28_19 = 0
			local var_28_20 = 0.175
			...
			if var_28_19 < arg_25_1.time_ and arg_25_1.time_ <= var_28_19 + arg_28_0 then
				...
				local var_28_21 = arg_25_1:FormatText(StoryNameCfg[9].name)
				...
				local var_28_22 = arg_25_1:GetWordFromCfg(112111006)
				...
				if manager.audio:GetVoiceLength("story_v_out_112111", "112111006", "story_v_out_112111.awb") ~= 0 then
					local var_28_27 = manager.audio:GetVoiceLength("story_v_out_112111", "112111006", "story_v_out_112111.awb") / 1000
					...
					if var_28_22.prefab_name ~= "" and arg_25_1.actors_[var_28_22.prefab_name] ~= nil then
						local var_28_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_25_1.actors_[var_28_22.prefab_name].transform, "story_v_out_112111", "112111006", "story_v_out_112111.awb")

						arg_25_1:RecordAudio("112111006", var_28_28)
						arg_25_1:RecordAudio("112111006", var_28_28)
					else
	...
	Play112111009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_12 < arg_37_1.time_ and arg_37_1.time_ <= var_40_12 + arg_40_0 and arg_37_1.var_.characterEffect1081ui_story == nil then
			...
			if arg_37_1.time_ >= var_40_12 + var_40_13 and arg_37_1.time_ < var_40_12 + var_40_13 + arg_40_0 and arg_37_1.var_.characterEffect1081ui_story then
				arg_37_1.var_.characterEffect1081ui_story.fillFlat = false
			end
	...
	Play112111012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_9 < arg_49_1.time_ and arg_49_1.time_ <= var_52_9 + arg_52_0 then
				arg_49_1:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/1148/1148action/1148action4_1")
			end
			...
			if var_52_12 < arg_49_1.time_ and arg_49_1.time_ <= var_52_12 + arg_52_0 and arg_49_1.var_.characterEffect1148ui_story == nil then
			...
			if arg_49_1.time_ >= var_52_12 + var_52_13 and arg_49_1.time_ < var_52_12 + var_52_13 + arg_52_0 and arg_49_1.var_.characterEffect1148ui_story then
				arg_49_1.var_.characterEffect1148ui_story.fillFlat = false
			end
			...
			if var_52_25 < arg_49_1.time_ and arg_49_1.time_ <= var_52_25 + arg_52_0 and arg_49_1.var_.characterEffect1081ui_story == nil then
			...
			if arg_49_1.time_ >= var_52_25 + var_52_26 and arg_49_1.time_ < var_52_25 + var_52_26 + arg_52_0 and arg_49_1.var_.characterEffect1081ui_story then
				local var_52_29 = 0.5
			...
			if var_52_30 < arg_49_1.time_ and arg_49_1.time_ <= var_52_30 + arg_52_0 then
				arg_49_1:PlayTimeline("1081ui_story", "StoryTimeline/CharAction/1081/1081action/1081action5_2")
			end
	...
	Play112111013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_6 < arg_53_1.time_ and arg_53_1.time_ <= var_56_6 + arg_56_0 and arg_53_1.var_.characterEffect1148ui_story == nil then
			...
			if arg_53_1.time_ >= var_56_6 + var_56_7 and arg_53_1.time_ < var_56_6 + var_56_7 + arg_56_0 and arg_53_1.var_.characterEffect1148ui_story then
				local var_56_10 = 0.5
