return {
	Play122423001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_0] == nil then
				local var_4_1 = Asset.Load("Char/" .. "2079ui_story")

				if not isNil(var_4_1) then
					local var_4_2 = Object.Instantiate(Asset.Load("Char/" .. "2079ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_5 = arg_1_1.actors_["2079ui_story"].transform
			local var_4_6 = 0

			if var_4_6 < arg_1_1.time_ and arg_1_1.time_ <= var_4_6 + arg_4_0 then
				arg_1_1.var_.moveOldPos2079ui_story = var_4_5.localPosition
			end
			...
			if var_4_6 <= arg_1_1.time_ and arg_1_1.time_ < var_4_6 + var_4_7 then
				...
				local var_4_9 = Vector3.New(0, -1.28, -5.6)

				var_4_5.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos2079ui_story, var_4_9, var_4_8)
			...
			if arg_1_1.time_ >= var_4_6 + var_4_7 and arg_1_1.time_ < var_4_6 + var_4_7 + arg_4_0 then
				var_4_5.localPosition = Vector3.New(0, -1.28, -5.6)
			...
			if var_4_15 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect2079ui_story == nil then
			...
			if arg_1_1.time_ >= var_4_15 + var_4_16 and arg_1_1.time_ < var_4_15 + var_4_16 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect2079ui_story then
				arg_1_1.var_.characterEffect2079ui_story.fillFlat = false
			end
			...
			if var_4_20 < arg_1_1.time_ and arg_1_1.time_ <= var_4_20 + arg_4_0 then
				...
				local var_4_23 = arg_1_1:FormatText(StoryNameCfg[469].name)
				...
				local var_4_24 = arg_1_1:GetWordFromCfg(122423001)
				...
				if manager.audio:GetVoiceLength("story_v_out_122423", "122423001", "story_v_out_122423.awb") ~= 0 then
					local var_4_29 = manager.audio:GetVoiceLength("story_v_out_122423", "122423001", "story_v_out_122423.awb") / 1000

					if var_4_29 + var_4_20 > arg_1_1.duration_ then
						arg_1_1.duration_ = var_4_29 + var_4_20
					end

					if var_4_24.prefab_name ~= "" and arg_1_1.actors_[var_4_24.prefab_name] ~= nil then
						local var_4_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_24.prefab_name].transform, "story_v_out_122423", "122423001", "story_v_out_122423.awb")

						arg_1_1:RecordAudio("122423001", var_4_30)
						arg_1_1:RecordAudio("122423001", var_4_30)
					else
			...
			local var_4_31 = var_4_20 + 0.3
			local var_4_32 = math.max(var_4_21, arg_1_1.talkMaxDuration)
	...
	Play122423002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 and not isNil(var_10_0) and arg_7_1.var_.characterEffect2079ui_story == nil then
			...
			if var_10_1 <= arg_7_1.time_ and arg_7_1.time_ < var_10_1 + var_10_2 and not isNil(var_10_0) then
				...
				if arg_7_1.var_.characterEffect2079ui_story and not isNil(var_10_0) then
			...
			if arg_7_1.time_ >= var_10_1 + var_10_2 and arg_7_1.time_ < var_10_1 + var_10_2 + arg_10_0 and not isNil(var_10_0) and arg_7_1.var_.characterEffect2079ui_story then
				local var_10_5 = 0.5
	...
	Play122423006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if arg_23_1.actors_[var_26_0] == nil then
				local var_26_1 = Asset.Load("Char/" .. "1075ui_story")

				if not isNil(var_26_1) then
					local var_26_2 = Object.Instantiate(Asset.Load("Char/" .. "1075ui_story"), arg_23_1.stage_.transform)
			...
			local var_26_5 = arg_23_1.actors_["1075ui_story"].transform
			local var_26_6 = 0

			if var_26_6 < arg_23_1.time_ and arg_23_1.time_ <= var_26_6 + arg_26_0 then
				arg_23_1.var_.moveOldPos1075ui_story = var_26_5.localPosition
			end
			...
			if var_26_6 <= arg_23_1.time_ and arg_23_1.time_ < var_26_6 + var_26_7 then
				...
				local var_26_9 = Vector3.New(0, -1.055, -6.16)

				var_26_5.localPosition = Vector3.Lerp(arg_23_1.var_.moveOldPos1075ui_story, var_26_9, var_26_8)
			...
			if arg_23_1.time_ >= var_26_6 + var_26_7 and arg_23_1.time_ < var_26_6 + var_26_7 + arg_26_0 then
				var_26_5.localPosition = Vector3.New(0, -1.055, -6.16)
			...
			local var_26_14 = arg_23_1.actors_["1075ui_story"]
			local var_26_15 = 0

			if var_26_15 < arg_23_1.time_ and arg_23_1.time_ <= var_26_15 + arg_26_0 and not isNil(var_26_14) and arg_23_1.var_.characterEffect1075ui_story == nil then
				arg_23_1.var_.characterEffect1075ui_story = var_26_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_26_15 <= arg_23_1.time_ and arg_23_1.time_ < var_26_15 + var_26_16 and not isNil(var_26_14) then
				...
				if arg_23_1.var_.characterEffect1075ui_story and not isNil(var_26_14) then
					arg_23_1.var_.characterEffect1075ui_story.fillFlat = false
				end
			end

			if arg_23_1.time_ >= var_26_15 + var_26_16 and arg_23_1.time_ < var_26_15 + var_26_16 + arg_26_0 and not isNil(var_26_14) and arg_23_1.var_.characterEffect1075ui_story then
				arg_23_1.var_.characterEffect1075ui_story.fillFlat = false
			end
			...
			if var_26_20 < arg_23_1.time_ and arg_23_1.time_ <= var_26_20 + arg_26_0 then
				...
				local var_26_23 = arg_23_1:GetWordFromCfg(122423006)
				...
				if manager.audio:GetVoiceLength("story_v_out_122423", "122423006", "story_v_out_122423.awb") ~= 0 then
					local var_26_28 = manager.audio:GetVoiceLength("story_v_out_122423", "122423006", "story_v_out_122423.awb") / 1000
					...
					if var_26_23.prefab_name ~= "" and arg_23_1.actors_[var_26_23.prefab_name] ~= nil then
						local var_26_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_23_1.actors_[var_26_23.prefab_name].transform, "story_v_out_122423", "122423006", "story_v_out_122423.awb")

						arg_23_1:RecordAudio("122423006", var_26_29)
						arg_23_1:RecordAudio("122423006", var_26_29)
					else
	...
	Play122423008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_10 < arg_31_1.time_ and arg_31_1.time_ <= var_34_10 + arg_34_0 and not isNil(var_34_9) and arg_31_1.var_.characterEffect1075ui_story == nil then
			...
			if var_34_10 <= arg_31_1.time_ and arg_31_1.time_ < var_34_10 + var_34_11 and not isNil(var_34_9) then
				...
				if arg_31_1.var_.characterEffect1075ui_story and not isNil(var_34_9) then
			...
			if arg_31_1.time_ >= var_34_10 + var_34_11 and arg_31_1.time_ < var_34_10 + var_34_11 + arg_34_0 and not isNil(var_34_9) and arg_31_1.var_.characterEffect1075ui_story then
				local var_34_14 = 0.5
	...
	Play122423009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_10 < arg_35_1.time_ and arg_35_1.time_ <= var_38_10 + arg_38_0 and not isNil(var_38_9) and arg_35_1.var_.characterEffect1075ui_story == nil then
			...
			if var_38_10 <= arg_35_1.time_ and arg_35_1.time_ < var_38_10 + var_38_11 and not isNil(var_38_9) then
				...
				if arg_35_1.var_.characterEffect1075ui_story and not isNil(var_38_9) then
					arg_35_1.var_.characterEffect1075ui_story.fillFlat = false
				end
			end

			if arg_35_1.time_ >= var_38_10 + var_38_11 and arg_35_1.time_ < var_38_10 + var_38_11 + arg_38_0 and not isNil(var_38_9) and arg_35_1.var_.characterEffect1075ui_story then
				arg_35_1.var_.characterEffect1075ui_story.fillFlat = false
			end
	...
	Play122423010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_1 < arg_39_1.time_ and arg_39_1.time_ <= var_42_1 + arg_42_0 and not isNil(var_42_0) and arg_39_1.var_.characterEffect1075ui_story == nil then
			...
			if var_42_1 <= arg_39_1.time_ and arg_39_1.time_ < var_42_1 + var_42_2 and not isNil(var_42_0) then
				...
				if arg_39_1.var_.characterEffect1075ui_story and not isNil(var_42_0) then
			...
			if arg_39_1.time_ >= var_42_1 + var_42_2 and arg_39_1.time_ < var_42_1 + var_42_2 + arg_42_0 and not isNil(var_42_0) and arg_39_1.var_.characterEffect1075ui_story then
				local var_42_5 = 0.5
	...
	Play122423011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_1 < arg_43_1.time_ and arg_43_1.time_ <= var_46_1 + arg_46_0 and not isNil(var_46_0) and arg_43_1.var_.characterEffect1075ui_story == nil then
			...
			if var_46_1 <= arg_43_1.time_ and arg_43_1.time_ < var_46_1 + var_46_2 and not isNil(var_46_0) then
				...
				if arg_43_1.var_.characterEffect1075ui_story and not isNil(var_46_0) then
					arg_43_1.var_.characterEffect1075ui_story.fillFlat = false
				end
			end

			if arg_43_1.time_ >= var_46_1 + var_46_2 and arg_43_1.time_ < var_46_1 + var_46_2 + arg_46_0 and not isNil(var_46_0) and arg_43_1.var_.characterEffect1075ui_story then
				arg_43_1.var_.characterEffect1075ui_story.fillFlat = false
			end
	...
	Play122423015 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if var_62_1 < arg_59_1.time_ and arg_59_1.time_ <= var_62_1 + arg_62_0 and not isNil(var_62_0) and arg_59_1.var_.characterEffect1075ui_story == nil then
			...
			if var_62_1 <= arg_59_1.time_ and arg_59_1.time_ < var_62_1 + var_62_2 and not isNil(var_62_0) then
				...
				if arg_59_1.var_.characterEffect1075ui_story and not isNil(var_62_0) then
			...
			if arg_59_1.time_ >= var_62_1 + var_62_2 and arg_59_1.time_ < var_62_1 + var_62_2 + arg_62_0 and not isNil(var_62_0) and arg_59_1.var_.characterEffect1075ui_story then
				local var_62_5 = 0.5
	...
	Play122423016 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if var_66_19 < arg_63_1.time_ and arg_63_1.time_ <= var_66_19 + arg_66_0 and not isNil(var_66_18) and arg_63_1.var_.characterEffect2079ui_story == nil then
			...
			if var_66_19 <= arg_63_1.time_ and arg_63_1.time_ < var_66_19 + var_66_20 and not isNil(var_66_18) then
				...
				if arg_63_1.var_.characterEffect2079ui_story and not isNil(var_66_18) then
			...
			if arg_63_1.time_ >= var_66_19 + var_66_20 and arg_63_1.time_ < var_66_19 + var_66_20 + arg_66_0 and not isNil(var_66_18) and arg_63_1.var_.characterEffect2079ui_story then
				local var_66_23 = 0.5
