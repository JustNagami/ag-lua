return {
	...
	Play112122002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_4 < arg_9_1.time_ and arg_9_1.time_ <= var_12_4 + arg_12_0 then
				arg_9_1:PlayTimeline("1148ui_story", "StoryTimeline/CharAction/1148/1148action/1148action2_1")
			end
			...
			local var_12_6 = arg_9_1.actors_["1148ui_story"]
			local var_12_7 = 0

			if var_12_7 < arg_9_1.time_ and arg_9_1.time_ <= var_12_7 + arg_12_0 and arg_9_1.var_.characterEffect1148ui_story == nil then
				arg_9_1.var_.characterEffect1148ui_story = var_12_6:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_9_1.time_ >= var_12_7 + var_12_8 and arg_9_1.time_ < var_12_7 + var_12_8 + arg_12_0 and arg_9_1.var_.characterEffect1148ui_story then
				arg_9_1.var_.characterEffect1148ui_story.fillFlat = false
			end

			local var_12_10 = arg_9_1.actors_["1148ui_story"].transform
			local var_12_11 = 0

			if var_12_11 < arg_9_1.time_ and arg_9_1.time_ <= var_12_11 + arg_12_0 then
				arg_9_1.var_.moveOldPos1148ui_story = var_12_10.localPosition
			end
			...
			if var_12_11 <= arg_9_1.time_ and arg_9_1.time_ < var_12_11 + var_12_12 then
				...
				local var_12_14 = Vector3.New(-0.7, -0.8, -6.2)

				var_12_10.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1148ui_story, var_12_14, var_12_13)
			...
			if arg_9_1.time_ >= var_12_11 + var_12_12 and arg_9_1.time_ < var_12_11 + var_12_12 + arg_12_0 then
				var_12_10.localPosition = Vector3.New(-0.7, -0.8, -6.2)
			...
			if var_12_19 < arg_9_1.time_ and arg_9_1.time_ <= var_12_19 + arg_12_0 then
				...
				local var_12_22 = arg_9_1:GetWordFromCfg(112122002)
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122002", "story_v_out_112122.awb") ~= 0 then
					local var_12_27 = manager.audio:GetVoiceLength("story_v_out_112122", "112122002", "story_v_out_112122.awb") / 1000
					...
					if var_12_22.prefab_name ~= "" and arg_9_1.actors_[var_12_22.prefab_name] ~= nil then
						local var_12_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_22.prefab_name].transform, "story_v_out_112122", "112122002", "story_v_out_112122.awb")

						arg_9_1:RecordAudio("112122002", var_12_28)
						arg_9_1:RecordAudio("112122002", var_12_28)
					else
	...
	Play112122003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			local var_16_4 = arg_13_1.actors_["1039ui_story"].transform
			local var_16_5 = 0

			if var_16_5 < arg_13_1.time_ and arg_13_1.time_ <= var_16_5 + arg_16_0 then
				arg_13_1.var_.moveOldPos1039ui_story = var_16_4.localPosition
			end
			...
			if var_16_5 <= arg_13_1.time_ and arg_13_1.time_ < var_16_5 + var_16_6 then
				...
				local var_16_8 = Vector3.New(0.7, -1.01, -5.9)

				var_16_4.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1039ui_story, var_16_8, var_16_7)
			...
			if arg_13_1.time_ >= var_16_5 + var_16_6 and arg_13_1.time_ < var_16_5 + var_16_6 + arg_16_0 then
				var_16_4.localPosition = Vector3.New(0.7, -1.01, -5.9)
			...
			if var_16_13 < arg_13_1.time_ and arg_13_1.time_ <= var_16_13 + arg_16_0 then
				arg_13_1:PlayTimeline("1039ui_story", "StoryTimeline/CharAction/1039/1039action/1039action5_1")
			end
			...
			local var_16_15 = arg_13_1.actors_["1039ui_story"]
			local var_16_16 = 0

			if var_16_16 < arg_13_1.time_ and arg_13_1.time_ <= var_16_16 + arg_16_0 and arg_13_1.var_.characterEffect1039ui_story == nil then
				arg_13_1.var_.characterEffect1039ui_story = var_16_15:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_13_1.time_ >= var_16_16 + var_16_17 and arg_13_1.time_ < var_16_16 + var_16_17 + arg_16_0 and arg_13_1.var_.characterEffect1039ui_story then
				arg_13_1.var_.characterEffect1039ui_story.fillFlat = false
			end

			local var_16_19 = arg_13_1.actors_["1148ui_story"]
			local var_16_20 = 0

			if var_16_20 < arg_13_1.time_ and arg_13_1.time_ <= var_16_20 + arg_16_0 and arg_13_1.var_.characterEffect1148ui_story == nil then
				arg_13_1.var_.characterEffect1148ui_story = var_16_19:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_16_20 <= arg_13_1.time_ and arg_13_1.time_ < var_16_20 + var_16_21 then
				...
				if arg_13_1.var_.characterEffect1148ui_story then
					...
					arg_13_1.var_.characterEffect1148ui_story.fillRatio = var_16_23
				end
			end

			if arg_13_1.time_ >= var_16_20 + var_16_21 and arg_13_1.time_ < var_16_20 + var_16_21 + arg_16_0 and arg_13_1.var_.characterEffect1148ui_story then
				local var_16_24 = 0.5
			...
			if var_16_25 < arg_13_1.time_ and arg_13_1.time_ <= var_16_25 + arg_16_0 then
				...
				local var_16_27 = arg_13_1:FormatText(StoryNameCfg[9].name)
				...
				local var_16_28 = arg_13_1:GetWordFromCfg(112122003)
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122003", "story_v_out_112122.awb") ~= 0 then
					local var_16_33 = manager.audio:GetVoiceLength("story_v_out_112122", "112122003", "story_v_out_112122.awb") / 1000
					...
					if var_16_28.prefab_name ~= "" and arg_13_1.actors_[var_16_28.prefab_name] ~= nil then
						local var_16_34 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_28.prefab_name].transform, "story_v_out_112122", "112122003", "story_v_out_112122.awb")

						arg_13_1:RecordAudio("112122003", var_16_34)
						arg_13_1:RecordAudio("112122003", var_16_34)
					else
	...
	Play112122004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_37 < arg_17_1.time_ and arg_17_1.time_ <= var_20_37 + arg_20_0 then
				...
				local var_20_40 = arg_17_1:GetWordFromCfg(112122004)
				...
				if manager.audio:GetVoiceLength("story_v_out_112122", "112122004", "story_v_out_112122.awb") ~= 0 then
					local var_20_45 = manager.audio:GetVoiceLength("story_v_out_112122", "112122004", "story_v_out_112122.awb") / 1000
					...
					if var_20_40.prefab_name ~= "" and arg_17_1.actors_[var_20_40.prefab_name] ~= nil then
						local var_20_46 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_40.prefab_name].transform, "story_v_out_112122", "112122004", "story_v_out_112122.awb")

						arg_17_1:RecordAudio("112122004", var_20_46)
						arg_17_1:RecordAudio("112122004", var_20_46)
					else
	...
	Play112122009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_1 < arg_37_1.time_ and arg_37_1.time_ <= var_40_1 + arg_40_0 then
				...
				if var_40_2 then
					var_40_2.material = arg_37_1.transpaintGo_:GetComponent("SpriteRenderer").material

					local var_40_3 = var_40_2.material
					local var_40_4 = var_40_3:GetColor("_Color")

					arg_37_1.var_.alphaOldValueH04 = var_40_4.a
					arg_37_1.var_.alphaMatValueH04 = var_40_3
				end
			...
			if var_40_1 <= arg_37_1.time_ and arg_37_1.time_ < var_40_1 + var_40_5 then
				local var_40_6 = (arg_37_1.time_ - var_40_1) / var_40_5
				local var_40_7 = Mathf.Lerp(arg_37_1.var_.alphaOldValueH04, 0, var_40_6)

				if arg_37_1.var_.alphaMatValueH04 then
					local var_40_8 = arg_37_1.var_.alphaMatValueH04
					local var_40_9 = var_40_8:GetColor("_Color")

					var_40_9.a = var_40_7

					var_40_8:SetColor("_Color", var_40_9)
				end
			end

			if arg_37_1.time_ >= var_40_1 + var_40_5 and arg_37_1.time_ < var_40_1 + var_40_5 + arg_40_0 and arg_37_1.var_.alphaMatValueH04 then
				local var_40_10 = arg_37_1.var_.alphaMatValueH04
				local var_40_11 = var_40_10:GetColor("_Color")

				var_40_11.a = 0

				var_40_10:SetColor("_Color", var_40_11)
			end
			...
			if var_40_14 < arg_37_1.time_ and arg_37_1.time_ <= var_40_14 + arg_40_0 then
				...
				arg_37_1:AudioAction(var_40_16, var_40_17, "se_story_activity_1_2_1", "se_story_activity_1_2_1_underwater_loop02", "")
			end
			...
			if var_40_18 < arg_37_1.time_ and arg_37_1.time_ <= var_40_18 + arg_40_0 then
				...
				local var_40_20 = LeanTween.value(arg_37_1.dialog_, 0, 1, 0.3)

				var_40_20:setOnUpdate(LuaHelper.FloatAction(function(arg_41_0)
					arg_37_1.dialogCg_.alpha = arg_41_0
				end))
				var_40_20:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_37_1.dialog_)
					var_40_20:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_40_21 = arg_37_1:GetWordFromCfg(112122009)
			...
			local var_40_26 = var_40_18 + 0.3
			local var_40_27 = math.max(var_40_19, arg_37_1.talkMaxDuration)
