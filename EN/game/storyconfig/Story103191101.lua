return {
	...
	Play319111003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_19 < arg_13_1.time_ and arg_13_1.time_ <= var_16_19 + arg_16_0 then
				...
				local var_16_22 = arg_13_1:GetWordFromCfg(319111003)
				...
				if manager.audio:GetVoiceLength("story_v_out_319111", "319111003", "story_v_out_319111.awb") ~= 0 then
					local var_16_27 = manager.audio:GetVoiceLength("story_v_out_319111", "319111003", "story_v_out_319111.awb") / 1000
					...
					if var_16_22.prefab_name ~= "" and arg_13_1.actors_[var_16_22.prefab_name] ~= nil then
						local var_16_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_22.prefab_name].transform, "story_v_out_319111", "319111003", "story_v_out_319111.awb")

						arg_13_1:RecordAudio("319111003", var_16_28)
						arg_13_1:RecordAudio("319111003", var_16_28)
					else
	...
	Play319111004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_5 <= arg_17_1.time_ and arg_17_1.time_ < var_20_5 + var_20_7 then
				...
				var_20_4.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos10079ui_story, var_20_9, var_20_8)
			...
			if var_20_15 < arg_17_1.time_ and arg_17_1.time_ <= var_20_15 + arg_20_0 and arg_17_1.var_.characterEffect10079ui_story == nil then
			...
			if arg_17_1.time_ >= var_20_15 + var_20_16 and arg_17_1.time_ < var_20_15 + var_20_16 + arg_20_0 and arg_17_1.var_.characterEffect10079ui_story then
				arg_17_1.var_.characterEffect10079ui_story.fillFlat = false
			end
			...
			if var_20_30 < arg_17_1.time_ and arg_17_1.time_ <= var_20_30 + arg_20_0 and arg_17_1.var_.characterEffect4040ui_story == nil then
			...
			if arg_17_1.time_ >= var_20_30 + var_20_31 and arg_17_1.time_ < var_20_30 + var_20_31 + arg_20_0 and arg_17_1.var_.characterEffect4040ui_story then
				local var_20_34 = 0.5
			...
			if var_20_35 < arg_17_1.time_ and arg_17_1.time_ <= var_20_35 + arg_20_0 then
				...
				local var_20_38 = arg_17_1:GetWordFromCfg(319111004)
				...
				if manager.audio:GetVoiceLength("story_v_out_319111", "319111004", "story_v_out_319111.awb") ~= 0 then
					local var_20_43 = manager.audio:GetVoiceLength("story_v_out_319111", "319111004", "story_v_out_319111.awb") / 1000
					...
					if var_20_38.prefab_name ~= "" and arg_17_1.actors_[var_20_38.prefab_name] ~= nil then
						local var_20_44 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_38.prefab_name].transform, "story_v_out_319111", "319111004", "story_v_out_319111.awb")

						arg_17_1:RecordAudio("319111004", var_20_44)
						arg_17_1:RecordAudio("319111004", var_20_44)
					else
	...
	Play319111012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_7 < arg_49_1.time_ and arg_49_1.time_ <= var_52_7 + arg_52_0 and arg_49_1.var_.characterEffect4040ui_story == nil then
			...
			if arg_49_1.time_ >= var_52_7 + var_52_8 and arg_49_1.time_ < var_52_7 + var_52_8 + arg_52_0 and arg_49_1.var_.characterEffect4040ui_story then
				arg_49_1.var_.characterEffect4040ui_story.fillFlat = false
			end
	...
	Play319111013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_12 < arg_53_1.time_ and arg_53_1.time_ <= var_56_12 + arg_56_0 and arg_53_1.var_.characterEffect10079ui_story == nil then
			...
			if arg_53_1.time_ >= var_56_12 + var_56_13 and arg_53_1.time_ < var_56_12 + var_56_13 + arg_56_0 and arg_53_1.var_.characterEffect10079ui_story then
				arg_53_1.var_.characterEffect10079ui_story.fillFlat = false
			end
	...
	Play319111015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_5 < arg_61_1.time_ and arg_61_1.time_ <= var_64_5 + arg_64_0 and arg_61_1.var_.characterEffect4040ui_story == nil then
			...
			if arg_61_1.time_ >= var_64_5 + var_64_6 and arg_61_1.time_ < var_64_5 + var_64_6 + arg_64_0 and arg_61_1.var_.characterEffect4040ui_story then
				local var_64_9 = 0.5
