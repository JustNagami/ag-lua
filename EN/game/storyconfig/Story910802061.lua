		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_4 < arg_7_1.time_ and arg_7_1.time_ <= var_10_4 + arg_10_0 then
				...
				for iter_10_2 = 0, var_10_5 - 1 do
					...
					if var_10_6.name == "split_2" or not string.find(var_10_6.name, "split") then
			...
			if var_10_18 < arg_7_1.time_ and arg_7_1.time_ <= var_10_18 + arg_10_0 then
				...
				local var_10_20 = arg_7_1:FormatText(StoryNameCfg[318].name)
				...
				local var_10_21 = arg_7_1:GetWordFromCfg(910815002)
