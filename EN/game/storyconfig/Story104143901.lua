return {
	Play414391001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_28 = arg_1_1.actors_["104902ui_story"].transform
			local var_4_29 = 1.86666666666667

			if var_4_29 < arg_1_1.time_ and arg_1_1.time_ <= var_4_29 + arg_4_0 then
				arg_1_1.var_.moveOldPos104902ui_story = var_4_28.localPosition
			end
			...
			if var_4_29 <= arg_1_1.time_ and arg_1_1.time_ < var_4_29 + var_4_30 then
				...
				local var_4_32 = Vector3.New(0, -1.2, -6)

				var_4_28.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos104902ui_story, var_4_32, var_4_31)
			...
			if arg_1_1.time_ >= var_4_29 + var_4_30 and arg_1_1.time_ < var_4_29 + var_4_30 + arg_4_0 then
				var_4_28.localPosition = Vector3.New(0, -1.2, -6)
			...
			local var_4_37 = arg_1_1.actors_["104902ui_story"]
			local var_4_38 = 1.86666666666667

			if var_4_38 < arg_1_1.time_ and arg_1_1.time_ <= var_4_38 + arg_4_0 and arg_1_1.var_.characterEffect104902ui_story == nil then
				arg_1_1.var_.characterEffect104902ui_story = var_4_37:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_1_1.time_ >= var_4_38 + var_4_39 and arg_1_1.time_ < var_4_38 + var_4_39 + arg_4_0 and arg_1_1.var_.characterEffect104902ui_story then
				arg_1_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if var_4_43 < arg_1_1.time_ and arg_1_1.time_ <= var_4_43 + arg_4_0 then
				...
				local var_4_46 = arg_1_1:FormatText(StoryNameCfg[562].name)
				...
				local var_4_47 = arg_1_1:GetWordFromCfg(414391001)
	...
	Play414391002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_6 < arg_7_1.time_ and arg_7_1.time_ <= var_10_6 + arg_10_0 then
				...
				local var_10_9 = arg_7_1:GetWordFromCfg(414391002)
	...
	Play414391003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			local var_14_0 = arg_11_1.actors_["104902ui_story"].transform
			local var_14_1 = 0

			if var_14_1 < arg_11_1.time_ and arg_11_1.time_ <= var_14_1 + arg_14_0 then
				arg_11_1.var_.moveOldPos104902ui_story = var_14_0.localPosition
			end
			...
			if var_14_1 <= arg_11_1.time_ and arg_11_1.time_ < var_14_1 + var_14_2 then
				...
				var_14_0.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos104902ui_story, var_14_4, var_14_3)
			...
			if var_14_9 < arg_11_1.time_ and arg_11_1.time_ <= var_14_9 + arg_14_0 then
				...
				local var_14_11 = arg_11_1:GetWordFromCfg(414391003)
	...
	Play414391004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_15 < arg_15_1.time_ and arg_15_1.time_ <= var_18_15 + arg_18_0 then
				...
				local var_18_18 = arg_15_1:GetWordFromCfg(414391004)
	...
	Play414391006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_0 < arg_23_1.time_ and arg_23_1.time_ <= var_26_0 + arg_26_0 then
				...
				local var_26_3 = arg_23_1:GetWordFromCfg(414391006)
	...
	Play414391008 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_0 + arg_30_0 then
				...
				local var_30_3 = arg_27_1:GetWordFromCfg(414391008)
	...
	Play414391009 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_9 < arg_31_1.time_ and arg_31_1.time_ <= var_34_9 + arg_34_0 then
				...
				local var_34_11 = arg_31_1:GetWordFromCfg(414391009)
	...
	Play414391010 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_13 < arg_35_1.time_ and arg_35_1.time_ <= var_38_13 + arg_38_0 then
				...
				local var_38_15 = arg_35_1:FormatText(StoryNameCfg[562].name)
				...
				local var_38_16 = arg_35_1:GetWordFromCfg(414391010)
	...
	Play414391011 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_2 < arg_39_1.time_ and arg_39_1.time_ <= var_42_2 + arg_42_0 then
				...
				local var_42_5 = arg_39_1.bgs_.H07h
			...
			local var_42_19 = 1.86666666666667
			...
			local var_42_23 = 1.86666666666667
			...
			local var_42_24 = 1.86666666666667
			...
			local var_42_30 = 3.53333333333333
			...
			if var_42_30 <= arg_39_1.time_ and arg_39_1.time_ < var_42_30 + var_42_31 then
				...
				local var_42_33 = Vector3.New(0, -1.2, -6)
			...
			if arg_39_1.time_ >= var_42_30 + var_42_31 and arg_39_1.time_ < var_42_30 + var_42_31 + arg_42_0 then
				var_42_29.localPosition = Vector3.New(0, -1.2, -6)
			...
			local var_42_39 = 3.53333333333333

			if var_42_39 < arg_39_1.time_ and arg_39_1.time_ <= var_42_39 + arg_42_0 and arg_39_1.var_.characterEffect104902ui_story == nil then
			...
			if arg_39_1.time_ >= var_42_39 + var_42_40 and arg_39_1.time_ < var_42_39 + var_42_40 + arg_42_0 and arg_39_1.var_.characterEffect104902ui_story then
				arg_39_1.var_.characterEffect104902ui_story.fillFlat = false
			end

			local var_42_42 = 3.53333333333333
			...
			local var_42_43 = arg_39_1.actors_["104902ui_story"].transform
			local var_42_44 = 1.86666666666667

			if var_42_44 < arg_39_1.time_ and arg_39_1.time_ <= var_42_44 + arg_42_0 then
				arg_39_1.var_.moveOldPos104902ui_story = var_42_43.localPosition
			end

			local var_42_45 = 0.001
			...
			if var_42_44 <= arg_39_1.time_ and arg_39_1.time_ < var_42_44 + var_42_45 then
				...
				local var_42_47 = Vector3.New(0, 100, 0)

				var_42_43.localPosition = Vector3.Lerp(arg_39_1.var_.moveOldPos104902ui_story, var_42_47, var_42_46)

				local var_42_48 = manager.ui.mainCamera.transform.position - var_42_43.position

				var_42_43.forward = Vector3.New(var_42_48.x, var_42_48.y, var_42_48.z)

				local var_42_49 = var_42_43.localEulerAngles

				var_42_49.z = 0
				var_42_49.x = 0
				var_42_43.localEulerAngles = var_42_49
			end

			if arg_39_1.time_ >= var_42_44 + var_42_45 and arg_39_1.time_ < var_42_44 + var_42_45 + arg_42_0 then
				var_42_43.localPosition = Vector3.New(0, 100, 0)

				local var_42_50 = manager.ui.mainCamera.transform.position - var_42_43.position

				var_42_43.forward = Vector3.New(var_42_50.x, var_42_50.y, var_42_50.z)

				local var_42_51 = var_42_43.localEulerAngles

				var_42_51.z = 0
				var_42_51.x = 0
				var_42_43.localEulerAngles = var_42_51
			end

			local var_42_52 = 3.56733333518108
			...
			local var_42_53 = 3.73333333333333
			local var_42_54 = 0.525
			...
			if var_42_53 < arg_39_1.time_ and arg_39_1.time_ <= var_42_53 + arg_42_0 then
				...
				local var_42_56 = arg_39_1:FormatText(StoryNameCfg[562].name)
				...
				local var_42_57 = arg_39_1:GetWordFromCfg(414391011)
			...
			local var_42_62 = var_42_53 + 0.3
			local var_42_63 = math.max(var_42_54, arg_39_1.talkMaxDuration)
	...
	Play414391012 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_6 < arg_45_1.time_ and arg_45_1.time_ <= var_48_6 + arg_48_0 then
				...
				local var_48_9 = arg_45_1:GetWordFromCfg(414391012)
	...
	Play414391013 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_6 < arg_49_1.time_ and arg_49_1.time_ <= var_52_6 + arg_52_0 then
				...
				local var_52_9 = arg_49_1:GetWordFromCfg(414391013)
	...
	Play414391014 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_6 < arg_53_1.time_ and arg_53_1.time_ <= var_56_6 + arg_56_0 then
				...
				local var_56_9 = arg_53_1:GetWordFromCfg(414391014)
	...
	Play414391015 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			local var_60_0 = arg_57_1.actors_["104902ui_story"].transform
			local var_60_1 = 0

			if var_60_1 < arg_57_1.time_ and arg_57_1.time_ <= var_60_1 + arg_60_0 then
				arg_57_1.var_.moveOldPos104902ui_story = var_60_0.localPosition
			end
			...
			if var_60_1 <= arg_57_1.time_ and arg_57_1.time_ < var_60_1 + var_60_2 then
				...
				var_60_0.localPosition = Vector3.Lerp(arg_57_1.var_.moveOldPos104902ui_story, var_60_4, var_60_3)
			...
			if var_60_9 < arg_57_1.time_ and arg_57_1.time_ <= var_60_9 + arg_60_0 then
				...
				local var_60_12 = arg_57_1:GetWordFromCfg(414391015)
	...
	Play414391007 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_0 < arg_61_1.time_ and arg_61_1.time_ <= var_64_0 + arg_64_0 then
				...
				local var_64_3 = arg_61_1:GetWordFromCfg(414391007)
