return {
	...
	Play114191033 = function(arg_137_0, arg_137_1)
		...
		function arg_137_1.onSingleLineUpdate_(arg_140_0)
			...
			local var_140_28 = math.max(var_140_21, arg_137_1.talkMaxDuration)

			if var_140_20 <= arg_137_1.time_ and arg_137_1.time_ < var_140_20 + var_140_28 then
				arg_137_1.typewritter.percent = (arg_137_1.time_ - var_140_20) / var_140_28

				arg_137_1.typewritter:SetDirty()
			end

			if arg_137_1.time_ >= var_140_20 + var_140_28 and arg_137_1.time_ < var_140_20 + var_140_28 + arg_140_0 then
	...
	Play114191034 = function(arg_141_0, arg_141_1)
		...
		function arg_141_1.onSingleLineUpdate_(arg_144_0)
			...
			local var_144_34 = math.max(var_144_27, arg_141_1.talkMaxDuration)

			if var_144_26 <= arg_141_1.time_ and arg_141_1.time_ < var_144_26 + var_144_34 then
				arg_141_1.typewritter.percent = (arg_141_1.time_ - var_144_26) / var_144_34

				arg_141_1.typewritter:SetDirty()
			end

			if arg_141_1.time_ >= var_144_26 + var_144_34 and arg_141_1.time_ < var_144_26 + var_144_34 + arg_144_0 then
	...
	Play114191037 = function(arg_153_0, arg_153_1)
		...
		function arg_153_1.onSingleLineUpdate_(arg_156_0)
			...
			local var_156_34 = math.max(var_156_27, arg_153_1.talkMaxDuration)

			if var_156_26 <= arg_153_1.time_ and arg_153_1.time_ < var_156_26 + var_156_34 then
				arg_153_1.typewritter.percent = (arg_153_1.time_ - var_156_26) / var_156_34

				arg_153_1.typewritter:SetDirty()
			end

			if arg_153_1.time_ >= var_156_26 + var_156_34 and arg_153_1.time_ < var_156_26 + var_156_34 + arg_156_0 then
	...
	Play114191040 = function(arg_165_0, arg_165_1)
		...
		function arg_165_1.onSingleLineUpdate_(arg_168_0)
			...
			local var_168_37 = math.max(var_168_30, arg_165_1.talkMaxDuration)

			if var_168_29 <= arg_165_1.time_ and arg_165_1.time_ < var_168_29 + var_168_37 then
				arg_165_1.typewritter.percent = (arg_165_1.time_ - var_168_29) / var_168_37

				arg_165_1.typewritter:SetDirty()
			end

			if arg_165_1.time_ >= var_168_29 + var_168_37 and arg_165_1.time_ < var_168_29 + var_168_37 + arg_168_0 then
	...
	Play114191042 = function(arg_173_0, arg_173_1)
		...
		function arg_173_1.onSingleLineUpdate_(arg_176_0)
			...
			local var_176_37 = math.max(var_176_30, arg_173_1.talkMaxDuration)

			if var_176_29 <= arg_173_1.time_ and arg_173_1.time_ < var_176_29 + var_176_37 then
				arg_173_1.typewritter.percent = (arg_173_1.time_ - var_176_29) / var_176_37

				arg_173_1.typewritter:SetDirty()
			end

			if arg_173_1.time_ >= var_176_29 + var_176_37 and arg_173_1.time_ < var_176_29 + var_176_37 + arg_176_0 then
	...
	Play114191047 = function(arg_193_0, arg_193_1)
		...
		function arg_193_1.onSingleLineUpdate_(arg_196_0)
			...
			local var_196_20 = math.max(var_196_13, arg_193_1.talkMaxDuration)

			if var_196_12 <= arg_193_1.time_ and arg_193_1.time_ < var_196_12 + var_196_20 then
				arg_193_1.typewritter.percent = (arg_193_1.time_ - var_196_12) / var_196_20

				arg_193_1.typewritter:SetDirty()
			end

			if arg_193_1.time_ >= var_196_12 + var_196_20 and arg_193_1.time_ < var_196_12 + var_196_20 + arg_196_0 then
	...
	Play114191048 = function(arg_197_0, arg_197_1)
		...
		function arg_197_1.onSingleLineUpdate_(arg_200_0)
			...
			local var_200_46 = math.max(var_200_39, arg_197_1.talkMaxDuration)

			if var_200_38 <= arg_197_1.time_ and arg_197_1.time_ < var_200_38 + var_200_46 then
				arg_197_1.typewritter.percent = (arg_197_1.time_ - var_200_38) / var_200_46

				arg_197_1.typewritter:SetDirty()
			end

			if arg_197_1.time_ >= var_200_38 + var_200_46 and arg_197_1.time_ < var_200_38 + var_200_46 + arg_200_0 then
	...
	Play114191049 = function(arg_201_0, arg_201_1)
		...
		function arg_201_1.onSingleLineUpdate_(arg_204_0)
			...
			local var_204_29 = math.max(var_204_22, arg_201_1.talkMaxDuration)

			if var_204_21 <= arg_201_1.time_ and arg_201_1.time_ < var_204_21 + var_204_29 then
				arg_201_1.typewritter.percent = (arg_201_1.time_ - var_204_21) / var_204_29

				arg_201_1.typewritter:SetDirty()
			end

			if arg_201_1.time_ >= var_204_21 + var_204_29 and arg_201_1.time_ < var_204_21 + var_204_29 + arg_204_0 then
	...
	Play114191051 = function(arg_209_0, arg_209_1)
		...
		function arg_209_1.onSingleLineUpdate_(arg_212_0)
			...
			local var_212_38 = math.max(var_212_31, arg_209_1.talkMaxDuration)

			if var_212_30 <= arg_209_1.time_ and arg_209_1.time_ < var_212_30 + var_212_38 then
				arg_209_1.typewritter.percent = (arg_209_1.time_ - var_212_30) / var_212_38

				arg_209_1.typewritter:SetDirty()
			end

			if arg_209_1.time_ >= var_212_30 + var_212_38 and arg_209_1.time_ < var_212_30 + var_212_38 + arg_212_0 then
	...
	Play114191055 = function(arg_225_0, arg_225_1)
		...
		function arg_225_1.onSingleLineUpdate_(arg_228_0)
			...
			local var_228_41 = math.max(var_228_34, arg_225_1.talkMaxDuration)

			if var_228_33 <= arg_225_1.time_ and arg_225_1.time_ < var_228_33 + var_228_41 then
				arg_225_1.typewritter.percent = (arg_225_1.time_ - var_228_33) / var_228_41

				arg_225_1.typewritter:SetDirty()
			end

			if arg_225_1.time_ >= var_228_33 + var_228_41 and arg_225_1.time_ < var_228_33 + var_228_41 + arg_228_0 then
	...
	Play114191057 = function(arg_233_0, arg_233_1)
		...
		function arg_233_1.onSingleLineUpdate_(arg_236_0)
			...
			local var_236_29 = math.max(var_236_22, arg_233_1.talkMaxDuration)

			if var_236_21 <= arg_233_1.time_ and arg_233_1.time_ < var_236_21 + var_236_29 then
				arg_233_1.typewritter.percent = (arg_233_1.time_ - var_236_21) / var_236_29

				arg_233_1.typewritter:SetDirty()
			end

			if arg_233_1.time_ >= var_236_21 + var_236_29 and arg_233_1.time_ < var_236_21 + var_236_29 + arg_236_0 then
