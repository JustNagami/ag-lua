	...
	Play320122001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_55 < arg_1_1.time_ and arg_1_1.time_ <= var_4_55 + arg_4_0 then
				...
				local var_4_59 = arg_1_1:GetWordFromCfg(320122001)
				...
				if manager.audio:GetVoiceLength("story_v_out_320122", "320122001", "story_v_out_320122.awb") ~= 0 then
					local var_4_64 = manager.audio:GetVoiceLength("story_v_out_320122", "320122001", "story_v_out_320122.awb") / 1000
					...
					if var_4_59.prefab_name ~= "" and arg_1_1.actors_[var_4_59.prefab_name] ~= nil then
						local var_4_65 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_59.prefab_name].transform, "story_v_out_320122", "320122001", "story_v_out_320122.awb")

						arg_1_1:RecordAudio("320122001", var_4_65)
						arg_1_1:RecordAudio("320122001", var_4_65)
					else
