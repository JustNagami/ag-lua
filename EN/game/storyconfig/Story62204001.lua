	...
	Play62204001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_53 < arg_1_1.time_ and arg_1_1.time_ <= var_4_53 + arg_4_0 then
				...
				local var_4_57 = arg_1_1:GetWordFromCfg(62204001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62204", "62204001", "story_v_chess_62204.awb") ~= 0 then
					local var_4_62 = manager.audio:GetVoiceLength("story_v_chess_62204", "62204001", "story_v_chess_62204.awb") / 1000
					...
					if var_4_57.prefab_name ~= "" and arg_1_1.actors_[var_4_57.prefab_name] ~= nil then
						local var_4_63 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_57.prefab_name].transform, "story_v_chess_62204", "62204001", "story_v_chess_62204.awb")

						arg_1_1:RecordAudio("62204001", var_4_63)
						arg_1_1:RecordAudio("62204001", var_4_63)
					else
	...
	Play62204005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				arg_21_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111actionlink/1111action442")
			end
