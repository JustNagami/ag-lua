return {
	Play122022001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_54 < arg_1_1.time_ and arg_1_1.time_ <= var_4_54 + arg_4_0 then
				...
				local var_4_58 = arg_1_1:GetWordFromCfg(122022001)
				...
				if manager.audio:GetVoiceLength("story_v_out_122022", "122022001", "story_v_out_122022.awb") ~= 0 then
					local var_4_63 = manager.audio:GetVoiceLength("story_v_out_122022", "122022001", "story_v_out_122022.awb") / 1000
					...
					if var_4_58.prefab_name ~= "" and arg_1_1.actors_[var_4_58.prefab_name] ~= nil then
						local var_4_64 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_58.prefab_name].transform, "story_v_out_122022", "122022001", "story_v_out_122022.awb")

						arg_1_1:RecordAudio("122022001", var_4_64)
						arg_1_1:RecordAudio("122022001", var_4_64)
					else
	...
	Play122022003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if arg_13_1.actors_[var_16_15] == nil then
				local var_16_16 = Asset.Load("Char/" .. "1074ui_story")

				if not isNil(var_16_16) then
					local var_16_17 = Object.Instantiate(Asset.Load("Char/" .. "1074ui_story"), arg_13_1.stage_.transform)
			...
			local var_16_20 = arg_13_1.actors_["1074ui_story"].transform
			local var_16_21 = 0

			if var_16_21 < arg_13_1.time_ and arg_13_1.time_ <= var_16_21 + arg_16_0 then
				arg_13_1.var_.moveOldPos1074ui_story = var_16_20.localPosition
			end
			...
			if var_16_21 <= arg_13_1.time_ and arg_13_1.time_ < var_16_21 + var_16_22 then
				...
				local var_16_24 = Vector3.New(0.7, -1.055, -6.12)

				var_16_20.localPosition = Vector3.Lerp(arg_13_1.var_.moveOldPos1074ui_story, var_16_24, var_16_23)
			...
			if arg_13_1.time_ >= var_16_21 + var_16_22 and arg_13_1.time_ < var_16_21 + var_16_22 + arg_16_0 then
				var_16_20.localPosition = Vector3.New(0.7, -1.055, -6.12)
			...
			local var_16_29 = arg_13_1.actors_["1074ui_story"]
			local var_16_30 = 0

			if var_16_30 < arg_13_1.time_ and arg_13_1.time_ <= var_16_30 + arg_16_0 and not isNil(var_16_29) and arg_13_1.var_.characterEffect1074ui_story == nil then
				arg_13_1.var_.characterEffect1074ui_story = var_16_29:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_16_30 <= arg_13_1.time_ and arg_13_1.time_ < var_16_30 + var_16_31 and not isNil(var_16_29) then
				...
				if arg_13_1.var_.characterEffect1074ui_story and not isNil(var_16_29) then
					arg_13_1.var_.characterEffect1074ui_story.fillFlat = false
				end
			end

			if arg_13_1.time_ >= var_16_30 + var_16_31 and arg_13_1.time_ < var_16_30 + var_16_31 + arg_16_0 and not isNil(var_16_29) and arg_13_1.var_.characterEffect1074ui_story then
				arg_13_1.var_.characterEffect1074ui_story.fillFlat = false
			end
			...
			if var_16_35 < arg_13_1.time_ and arg_13_1.time_ <= var_16_35 + arg_16_0 then
				...
				local var_16_37 = arg_13_1:FormatText(StoryNameCfg[410].name)
				...
				local var_16_38 = arg_13_1:GetWordFromCfg(122022003)
				...
				if manager.audio:GetVoiceLength("story_v_out_122022", "122022003", "story_v_out_122022.awb") ~= 0 then
					local var_16_43 = manager.audio:GetVoiceLength("story_v_out_122022", "122022003", "story_v_out_122022.awb") / 1000
					...
					if var_16_38.prefab_name ~= "" and arg_13_1.actors_[var_16_38.prefab_name] ~= nil then
						local var_16_44 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_38.prefab_name].transform, "story_v_out_122022", "122022003", "story_v_out_122022.awb")

						arg_13_1:RecordAudio("122022003", var_16_44)
						arg_13_1:RecordAudio("122022003", var_16_44)
					else
	...
	Play122022007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_7 < arg_29_1.time_ and arg_29_1.time_ <= var_32_7 + arg_32_0 and not isNil(var_32_6) and arg_29_1.var_.characterEffect1072ui_story == nil then
			...
			if var_32_7 <= arg_29_1.time_ and arg_29_1.time_ < var_32_7 + var_32_8 and not isNil(var_32_6) then
				...
				if arg_29_1.var_.characterEffect1072ui_story and not isNil(var_32_6) then
			...
			if arg_29_1.time_ >= var_32_7 + var_32_8 and arg_29_1.time_ < var_32_7 + var_32_8 + arg_32_0 and not isNil(var_32_6) and arg_29_1.var_.characterEffect1072ui_story then
				local var_32_11 = 0.5
	...
	Play122022011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_7 < arg_45_1.time_ and arg_45_1.time_ <= var_48_7 + arg_48_0 and not isNil(var_48_6) and arg_45_1.var_.characterEffect1072ui_story == nil then
			...
			if var_48_7 <= arg_45_1.time_ and arg_45_1.time_ < var_48_7 + var_48_8 and not isNil(var_48_6) then
				...
				if arg_45_1.var_.characterEffect1072ui_story and not isNil(var_48_6) then
			...
			if arg_45_1.time_ >= var_48_7 + var_48_8 and arg_45_1.time_ < var_48_7 + var_48_8 + arg_48_0 and not isNil(var_48_6) and arg_45_1.var_.characterEffect1072ui_story then
				local var_48_11 = 0.5
	...
	Play122022025 = function(arg_101_0, arg_101_1)
		...
		function arg_101_1.onSingleLineUpdate_(arg_104_0)
			...
			if var_104_1 < arg_101_1.time_ and arg_101_1.time_ <= var_104_1 + arg_104_0 and not isNil(var_104_0) and arg_101_1.var_.characterEffect1072ui_story == nil then
			...
			if var_104_1 <= arg_101_1.time_ and arg_101_1.time_ < var_104_1 + var_104_2 and not isNil(var_104_0) then
				...
				if arg_101_1.var_.characterEffect1072ui_story and not isNil(var_104_0) then
					arg_101_1.var_.characterEffect1072ui_story.fillFlat = false
				end
			end

			if arg_101_1.time_ >= var_104_1 + var_104_2 and arg_101_1.time_ < var_104_1 + var_104_2 + arg_104_0 and not isNil(var_104_0) and arg_101_1.var_.characterEffect1072ui_story then
				arg_101_1.var_.characterEffect1072ui_story.fillFlat = false
			end
