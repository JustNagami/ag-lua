return {
	Play114271001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_29 = 0.466666666667667
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				local var_4_37 = arg_1_1:GetWordFromCfg(114271001)
	...
	Play114271002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				local var_12_2 = arg_9_1:GetWordFromCfg(114271002)
	...
	Play114271003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				...
				local var_16_2 = arg_13_1:GetWordFromCfg(114271003)
	...
	Play114271004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			local var_20_3 = arg_17_1.actors_["10015"]
			local var_20_4 = 0

			if var_20_4 < arg_17_1.time_ and arg_17_1.time_ <= var_20_4 + arg_20_0 then
				local var_20_5 = var_20_3:GetComponentInChildren(typeof(CanvasGroup))

				if var_20_5 then
					arg_17_1.var_.alphaOldValue10015 = var_20_5.alpha
					arg_17_1.var_.characterEffect10015 = var_20_5
				end
			...
			if var_20_4 <= arg_17_1.time_ and arg_17_1.time_ < var_20_4 + var_20_6 then
				local var_20_7 = (arg_17_1.time_ - var_20_4) / var_20_6
				local var_20_8 = Mathf.Lerp(arg_17_1.var_.alphaOldValue10015, 1, var_20_7)

				if arg_17_1.var_.characterEffect10015 then
					arg_17_1.var_.characterEffect10015.alpha = var_20_8
				end
			end

			if arg_17_1.time_ >= var_20_4 + var_20_6 and arg_17_1.time_ < var_20_4 + var_20_6 + arg_20_0 and arg_17_1.var_.characterEffect10015 then
				arg_17_1.var_.characterEffect10015.alpha = 1
			end

			local var_20_9 = arg_17_1.actors_["10015"].transform
			local var_20_10 = 0

			if var_20_10 < arg_17_1.time_ and arg_17_1.time_ <= var_20_10 + arg_20_0 then
				arg_17_1.var_.moveOldPos10015 = var_20_9.localPosition
				var_20_9.localScale = Vector3.New(1, 1, 1)

				arg_17_1:CheckSpriteTmpPos("10015", 3)

				local var_20_11 = var_20_9.childCount

				for iter_20_2 = 0, var_20_11 - 1 do
					local var_20_12 = var_20_9:GetChild(iter_20_2)

					if var_20_12.name == "split_5" or not string.find(var_20_12.name, "split") then
			...
			if var_20_10 <= arg_17_1.time_ and arg_17_1.time_ < var_20_10 + var_20_13 then
				local var_20_14 = (arg_17_1.time_ - var_20_10) / var_20_13
				local var_20_15 = Vector3.New(0, -350, -180)

				var_20_9.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos10015, var_20_15, var_20_14)
			end

			if arg_17_1.time_ >= var_20_10 + var_20_13 and arg_17_1.time_ < var_20_10 + var_20_13 + arg_20_0 then
				var_20_9.localPosition = Vector3.New(0, -350, -180)
			end

			local var_20_16 = arg_17_1.actors_["10015"]
			local var_20_17 = 0

			if var_20_17 < arg_17_1.time_ and arg_17_1.time_ <= var_20_17 + arg_20_0 and arg_17_1.var_.actorSpriteComps10015 == nil then
				arg_17_1.var_.actorSpriteComps10015 = var_20_16:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if var_20_17 <= arg_17_1.time_ and arg_17_1.time_ < var_20_17 + var_20_18 then
				...
				if arg_17_1.var_.actorSpriteComps10015 then
					for iter_20_3, iter_20_4 in pairs(arg_17_1.var_.actorSpriteComps10015:ToTable()) do
						if iter_20_4 then
							if arg_17_1.isInRecall_ then
								local var_20_20 = Mathf.Lerp(iter_20_4.color.r, 0.82, var_20_19)
								local var_20_21 = Mathf.Lerp(iter_20_4.color.g, 0.77, var_20_19)
								local var_20_22 = Mathf.Lerp(iter_20_4.color.b, 0.62, var_20_19)

								iter_20_4.color = Color.New(var_20_20, var_20_21, var_20_22)
							else
								local var_20_23 = Mathf.Lerp(iter_20_4.color.r, 1, var_20_19)

								iter_20_4.color = Color.New(var_20_23, var_20_23, var_20_23)
							end
						end
					end
				end
			...
			if arg_17_1.time_ >= var_20_17 + var_20_18 and arg_17_1.time_ < var_20_17 + var_20_18 + arg_20_0 and arg_17_1.var_.actorSpriteComps10015 then
			...
			if var_20_24 < arg_17_1.time_ and arg_17_1.time_ <= var_20_24 + arg_20_0 then
				...
				local var_20_26 = arg_17_1:FormatText(StoryNameCfg[208].name)
				...
				local var_20_27 = arg_17_1:GetWordFromCfg(114271004)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271004", "story_v_out_114271.awb") ~= 0 then
					local var_20_32 = manager.audio:GetVoiceLength("story_v_out_114271", "114271004", "story_v_out_114271.awb") / 1000
					...
					if var_20_27.prefab_name ~= "" and arg_17_1.actors_[var_20_27.prefab_name] ~= nil then
						local var_20_33 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_27.prefab_name].transform, "story_v_out_114271", "114271004", "story_v_out_114271.awb")

						arg_17_1:RecordAudio("114271004", var_20_33)
						arg_17_1:RecordAudio("114271004", var_20_33)
					else
	...
	Play114271005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				...
				local var_24_2 = arg_21_1:FormatText(StoryNameCfg[208].name)
				...
				local var_24_3 = arg_21_1:GetWordFromCfg(114271005)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271005", "story_v_out_114271.awb") ~= 0 then
					local var_24_8 = manager.audio:GetVoiceLength("story_v_out_114271", "114271005", "story_v_out_114271.awb") / 1000
					...
					if var_24_3.prefab_name ~= "" and arg_21_1.actors_[var_24_3.prefab_name] ~= nil then
						local var_24_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_3.prefab_name].transform, "story_v_out_114271", "114271005", "story_v_out_114271.awb")

						arg_21_1:RecordAudio("114271005", var_24_9)
						arg_21_1:RecordAudio("114271005", var_24_9)
					else
	...
	Play114271006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_1 < arg_25_1.time_ and arg_25_1.time_ <= var_28_1 + arg_28_0 then
				...
				if var_28_2 then
					arg_25_1.var_.alphaOldValue10015 = var_28_2.alpha
					arg_25_1.var_.characterEffect10015 = var_28_2
				end
			...
			if var_28_1 <= arg_25_1.time_ and arg_25_1.time_ < var_28_1 + var_28_3 then
				...
				local var_28_5 = Mathf.Lerp(arg_25_1.var_.alphaOldValue10015, 0, var_28_4)

				if arg_25_1.var_.characterEffect10015 then
					arg_25_1.var_.characterEffect10015.alpha = var_28_5
				end
			end

			if arg_25_1.time_ >= var_28_1 + var_28_3 and arg_25_1.time_ < var_28_1 + var_28_3 + arg_28_0 and arg_25_1.var_.characterEffect10015 then
			...
			if var_28_6 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_8 = arg_25_1:GetWordFromCfg(114271006)
	...
	Play114271007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_0 < arg_29_1.time_ and arg_29_1.time_ <= var_32_0 + arg_32_0 then
				...
				local var_32_2 = arg_29_1:GetWordFromCfg(114271007)
	...
	Play114271008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_0 + arg_36_0 then
				...
				local var_36_2 = arg_33_1:GetWordFromCfg(114271008)
	...
	Play114271009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_0 < arg_37_1.time_ and arg_37_1.time_ <= var_40_0 + arg_40_0 then
				...
				local var_40_2 = arg_37_1:GetWordFromCfg(114271009)
	...
	Play114271010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_8 < arg_41_1.time_ and arg_41_1.time_ <= var_44_8 + arg_44_0 and arg_41_1.var_.actorSpriteComps10015 == nil then
			...
			if arg_41_1.time_ >= var_44_8 + var_44_9 and arg_41_1.time_ < var_44_8 + var_44_9 + arg_44_0 and arg_41_1.var_.actorSpriteComps10015 then
			...
			if var_44_21 < arg_41_1.time_ and arg_41_1.time_ <= var_44_21 + arg_44_0 then
				...
				local var_44_24 = arg_41_1:GetWordFromCfg(114271010)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271010", "story_v_out_114271.awb") ~= 0 then
					local var_44_29 = manager.audio:GetVoiceLength("story_v_out_114271", "114271010", "story_v_out_114271.awb") / 1000
					...
					if var_44_24.prefab_name ~= "" and arg_41_1.actors_[var_44_24.prefab_name] ~= nil then
						local var_44_30 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_24.prefab_name].transform, "story_v_out_114271", "114271010", "story_v_out_114271.awb")

						arg_41_1:RecordAudio("114271010", var_44_30)
						arg_41_1:RecordAudio("114271010", var_44_30)
					else
	...
	Play114271011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_6 < arg_45_1.time_ and arg_45_1.time_ <= var_48_6 + arg_48_0 then
				...
				arg_45_1:AudioAction(var_48_8, var_48_9, "se_story_activity_1_4_3", "se_story_activity_1_4_3_raise", "")
			end

			local var_48_10 = manager.ui.mainCamera.transform
			local var_48_11 = 1

			if var_48_11 < arg_45_1.time_ and arg_45_1.time_ <= var_48_11 + arg_48_0 then
				arg_45_1.var_.shakeOldPos = var_48_10.localPosition
			end

			local var_48_12 = 1

			if var_48_11 <= arg_45_1.time_ and arg_45_1.time_ < var_48_11 + var_48_12 then
				local var_48_13 = (arg_45_1.time_ - var_48_11) / 0.066
				local var_48_14, var_48_15 = math.modf(var_48_13)

				var_48_10.localPosition = Vector3.New(var_48_15 * 0.13, var_48_15 * 0.13, var_48_15 * 0.13) + arg_45_1.var_.shakeOldPos
			end

			if arg_45_1.time_ >= var_48_11 + var_48_12 and arg_45_1.time_ < var_48_11 + var_48_12 + arg_48_0 then
				var_48_10.localPosition = arg_45_1.var_.shakeOldPos
			end
			...
			if var_48_18 < arg_45_1.time_ and arg_45_1.time_ <= var_48_18 + arg_48_0 then
				...
				local var_48_20 = arg_45_1:GetWordFromCfg(114271011)
	...
	Play114271012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_2 < arg_49_1.time_ and arg_49_1.time_ <= var_52_2 + arg_52_0 then
				...
				local var_52_5 = arg_49_1.bgs_.F03
			...
			if var_52_22 < arg_49_1.time_ and arg_49_1.time_ <= var_52_22 + arg_52_0 then
				...
				local var_52_25 = arg_49_1:GetWordFromCfg(114271012)
	...
	Play114271013 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if var_58_0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_0 + arg_58_0 then
				...
				local var_58_2 = arg_55_1:GetWordFromCfg(114271013)
	...
	Play114271014 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			...
			if var_62_6 < arg_59_1.time_ and arg_59_1.time_ <= var_62_6 + arg_62_0 then
				...
				local var_62_8 = arg_59_1:FormatText(StoryNameCfg[208].name)
				...
				local var_62_9 = arg_59_1:GetWordFromCfg(114271014)
				...
				if manager.audio:GetVoiceLength("story_v_out_114271", "114271014", "story_v_out_114271.awb") ~= 0 then
					local var_62_14 = manager.audio:GetVoiceLength("story_v_out_114271", "114271014", "story_v_out_114271.awb") / 1000
					...
					if var_62_9.prefab_name ~= "" and arg_59_1.actors_[var_62_9.prefab_name] ~= nil then
						local var_62_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_59_1.actors_[var_62_9.prefab_name].transform, "story_v_out_114271", "114271014", "story_v_out_114271.awb")

						arg_59_1:RecordAudio("114271014", var_62_15)
						arg_59_1:RecordAudio("114271014", var_62_15)
					else
