return {
	Play104012001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_12 = arg_1_1.bgs_.S0401
			local var_4_13 = 0
			...
			if var_4_13 < arg_1_1.time_ and arg_1_1.time_ <= var_4_13 + arg_4_0 then
				...
				if var_4_14 then
					...
					arg_1_1.var_.alphaOldValueS0401 = var_4_16.a
					arg_1_1.var_.alphaMatValueS0401 = var_4_15
				end
			...
			if var_4_13 <= arg_1_1.time_ and arg_1_1.time_ < var_4_13 + var_4_17 then
				...
				local var_4_19 = Mathf.Lerp(arg_1_1.var_.alphaOldValueS0401, 1, var_4_18)
			...
			if arg_1_1.time_ >= var_4_13 + var_4_17 and arg_1_1.time_ < var_4_13 + var_4_17 + arg_4_0 and arg_1_1.var_.alphaMatValueS0401 then
				local var_4_22 = arg_1_1.var_.alphaMatValueS0401
			...
			if var_4_24 < arg_1_1.time_ and arg_1_1.time_ <= var_4_24 + arg_4_0 then
				...
				local var_4_27 = arg_1_1.bgs_.S0401
			...
			if var_4_40 < arg_1_1.time_ and arg_1_1.time_ <= var_4_40 + arg_4_0 then
				...
				local var_4_43 = arg_1_1:FormatText(StoryNameCfg[49].name)
				...
				local var_4_44 = arg_1_1:GetWordFromCfg(104012001)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012001", "story_v_out_104012.awb") ~= 0 then
					local var_4_49 = manager.audio:GetVoiceLength("story_v_out_104012", "104012001", "story_v_out_104012.awb") / 1000
					...
					if var_4_44.prefab_name ~= "" and arg_1_1.actors_[var_4_44.prefab_name] ~= nil then
						local var_4_50 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_44.prefab_name].transform, "story_v_out_104012", "104012001", "story_v_out_104012.awb")

						arg_1_1:RecordAudio("104012001", var_4_50)
						arg_1_1:RecordAudio("104012001", var_4_50)
					else
	...
	Play104012002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if var_11_0 < arg_8_1.time_ and arg_8_1.time_ <= var_11_0 + arg_11_0 then
				...
				local var_11_2 = arg_8_1:GetWordFromCfg(104012002)
	...
	Play104012003 = function(arg_12_0, arg_12_1)
		...
		function arg_12_1.onSingleLineUpdate_(arg_15_0)
			...
			if var_15_0 < arg_12_1.time_ and arg_12_1.time_ <= var_15_0 + arg_15_0 then
				...
				local var_15_2 = arg_12_1:FormatText(StoryNameCfg[45].name)
				...
				local var_15_3 = arg_12_1:GetWordFromCfg(104012003)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012003", "story_v_out_104012.awb") ~= 0 then
					local var_15_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012003", "story_v_out_104012.awb") / 1000
					...
					if var_15_3.prefab_name ~= "" and arg_12_1.actors_[var_15_3.prefab_name] ~= nil then
						local var_15_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_12_1.actors_[var_15_3.prefab_name].transform, "story_v_out_104012", "104012003", "story_v_out_104012.awb")

						arg_12_1:RecordAudio("104012003", var_15_9)
						arg_12_1:RecordAudio("104012003", var_15_9)
					else
	...
	Play104012004 = function(arg_16_0, arg_16_1)
		...
		function arg_16_1.onSingleLineUpdate_(arg_19_0)
			...
			if var_19_0 < arg_16_1.time_ and arg_16_1.time_ <= var_19_0 + arg_19_0 then
				...
				local var_19_3 = arg_16_1:GetWordFromCfg(104012004)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012004", "story_v_out_104012.awb") ~= 0 then
					local var_19_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012004", "story_v_out_104012.awb") / 1000
					...
					if var_19_3.prefab_name ~= "" and arg_16_1.actors_[var_19_3.prefab_name] ~= nil then
						local var_19_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_16_1.actors_[var_19_3.prefab_name].transform, "story_v_out_104012", "104012004", "story_v_out_104012.awb")

						arg_16_1:RecordAudio("104012004", var_19_9)
						arg_16_1:RecordAudio("104012004", var_19_9)
					else
	...
	Play104012005 = function(arg_20_0, arg_20_1)
		...
		function arg_20_1.onSingleLineUpdate_(arg_23_0)
			...
			if var_23_0 < arg_20_1.time_ and arg_20_1.time_ <= var_23_0 + arg_23_0 then
				...
				local var_23_2 = arg_20_1:FormatText(StoryNameCfg[45].name)
				...
				local var_23_3 = arg_20_1:GetWordFromCfg(104012005)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012005", "story_v_out_104012.awb") ~= 0 then
					local var_23_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012005", "story_v_out_104012.awb") / 1000
					...
					if var_23_3.prefab_name ~= "" and arg_20_1.actors_[var_23_3.prefab_name] ~= nil then
						local var_23_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_20_1.actors_[var_23_3.prefab_name].transform, "story_v_out_104012", "104012005", "story_v_out_104012.awb")

						arg_20_1:RecordAudio("104012005", var_23_9)
						arg_20_1:RecordAudio("104012005", var_23_9)
					else
	...
	Play104012006 = function(arg_24_0, arg_24_1)
		...
		function arg_24_1.onSingleLineUpdate_(arg_27_0)
			...
			if var_27_0 < arg_24_1.time_ and arg_24_1.time_ <= var_27_0 + arg_27_0 then
				...
				local var_27_2 = arg_24_1:FormatText(StoryNameCfg[45].name)
				...
				local var_27_3 = arg_24_1:GetWordFromCfg(104012006)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012006", "story_v_out_104012.awb") ~= 0 then
					local var_27_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012006", "story_v_out_104012.awb") / 1000
					...
					if var_27_3.prefab_name ~= "" and arg_24_1.actors_[var_27_3.prefab_name] ~= nil then
						local var_27_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_24_1.actors_[var_27_3.prefab_name].transform, "story_v_out_104012", "104012006", "story_v_out_104012.awb")

						arg_24_1:RecordAudio("104012006", var_27_9)
						arg_24_1:RecordAudio("104012006", var_27_9)
					else
	...
	Play104012007 = function(arg_28_0, arg_28_1)
		...
		function arg_28_1.onSingleLineUpdate_(arg_31_0)
			...
			if var_31_0 < arg_28_1.time_ and arg_28_1.time_ <= var_31_0 + arg_31_0 then
				...
				local var_31_2 = arg_28_1:FormatText(StoryNameCfg[49].name)
				...
				local var_31_3 = arg_28_1:GetWordFromCfg(104012007)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012007", "story_v_out_104012.awb") ~= 0 then
					local var_31_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012007", "story_v_out_104012.awb") / 1000
					...
					if var_31_3.prefab_name ~= "" and arg_28_1.actors_[var_31_3.prefab_name] ~= nil then
						local var_31_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_28_1.actors_[var_31_3.prefab_name].transform, "story_v_out_104012", "104012007", "story_v_out_104012.awb")

						arg_28_1:RecordAudio("104012007", var_31_9)
						arg_28_1:RecordAudio("104012007", var_31_9)
					else
	...
	Play104012008 = function(arg_32_0, arg_32_1)
		...
		function arg_32_1.onSingleLineUpdate_(arg_35_0)
			...
			if var_35_0 < arg_32_1.time_ and arg_32_1.time_ <= var_35_0 + arg_35_0 then
				...
				local var_35_2 = arg_32_1:FormatText(StoryNameCfg[45].name)
				...
				local var_35_3 = arg_32_1:GetWordFromCfg(104012008)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012008", "story_v_out_104012.awb") ~= 0 then
					local var_35_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012008", "story_v_out_104012.awb") / 1000
					...
					if var_35_3.prefab_name ~= "" and arg_32_1.actors_[var_35_3.prefab_name] ~= nil then
						local var_35_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_32_1.actors_[var_35_3.prefab_name].transform, "story_v_out_104012", "104012008", "story_v_out_104012.awb")

						arg_32_1:RecordAudio("104012008", var_35_9)
						arg_32_1:RecordAudio("104012008", var_35_9)
					else
	...
	Play104012009 = function(arg_36_0, arg_36_1)
		...
		function arg_36_1.onSingleLineUpdate_(arg_39_0)
			...
			if var_39_0 < arg_36_1.time_ and arg_36_1.time_ <= var_39_0 + arg_39_0 then
				...
				local var_39_3 = arg_36_1:GetWordFromCfg(104012009)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012009", "story_v_out_104012.awb") ~= 0 then
					local var_39_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012009", "story_v_out_104012.awb") / 1000
					...
					if var_39_3.prefab_name ~= "" and arg_36_1.actors_[var_39_3.prefab_name] ~= nil then
						local var_39_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_36_1.actors_[var_39_3.prefab_name].transform, "story_v_out_104012", "104012009", "story_v_out_104012.awb")

						arg_36_1:RecordAudio("104012009", var_39_9)
						arg_36_1:RecordAudio("104012009", var_39_9)
					else
	...
	Play104012010 = function(arg_40_0, arg_40_1)
		...
		function arg_40_1.onSingleLineUpdate_(arg_43_0)
			...
			if var_43_0 < arg_40_1.time_ and arg_40_1.time_ <= var_43_0 + arg_43_0 then
				...
				local var_43_2 = arg_40_1:FormatText(StoryNameCfg[49].name)
				...
				local var_43_3 = arg_40_1:GetWordFromCfg(104012010)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012010", "story_v_out_104012.awb") ~= 0 then
					local var_43_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012010", "story_v_out_104012.awb") / 1000
					...
					if var_43_3.prefab_name ~= "" and arg_40_1.actors_[var_43_3.prefab_name] ~= nil then
						local var_43_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_40_1.actors_[var_43_3.prefab_name].transform, "story_v_out_104012", "104012010", "story_v_out_104012.awb")

						arg_40_1:RecordAudio("104012010", var_43_9)
						arg_40_1:RecordAudio("104012010", var_43_9)
					else
	...
	Play104012011 = function(arg_44_0, arg_44_1)
		...
		function arg_44_1.onSingleLineUpdate_(arg_47_0)
			...
			if var_47_0 < arg_44_1.time_ and arg_44_1.time_ <= var_47_0 + arg_47_0 then
				...
				local var_47_3 = arg_44_1:GetWordFromCfg(104012011)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012011", "story_v_out_104012.awb") ~= 0 then
					local var_47_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012011", "story_v_out_104012.awb") / 1000
					...
					if var_47_3.prefab_name ~= "" and arg_44_1.actors_[var_47_3.prefab_name] ~= nil then
						local var_47_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_44_1.actors_[var_47_3.prefab_name].transform, "story_v_out_104012", "104012011", "story_v_out_104012.awb")

						arg_44_1:RecordAudio("104012011", var_47_9)
						arg_44_1:RecordAudio("104012011", var_47_9)
					else
	...
	Play104012012 = function(arg_48_0, arg_48_1)
		...
		function arg_48_1.onSingleLineUpdate_(arg_51_0)
			...
			if var_51_0 < arg_48_1.time_ and arg_48_1.time_ <= var_51_0 + arg_51_0 then
				...
				local var_51_2 = arg_48_1:FormatText(StoryNameCfg[45].name)
				...
				local var_51_3 = arg_48_1:GetWordFromCfg(104012012)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012012", "story_v_out_104012.awb") ~= 0 then
					local var_51_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012012", "story_v_out_104012.awb") / 1000
					...
					if var_51_3.prefab_name ~= "" and arg_48_1.actors_[var_51_3.prefab_name] ~= nil then
						local var_51_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_48_1.actors_[var_51_3.prefab_name].transform, "story_v_out_104012", "104012012", "story_v_out_104012.awb")

						arg_48_1:RecordAudio("104012012", var_51_9)
						arg_48_1:RecordAudio("104012012", var_51_9)
					else
	...
	Play104012013 = function(arg_52_0, arg_52_1)
		...
		function arg_52_1.onSingleLineUpdate_(arg_55_0)
			...
			if var_55_0 < arg_52_1.time_ and arg_52_1.time_ <= var_55_0 + arg_55_0 then
				...
				local var_55_2 = arg_52_1:FormatText(StoryNameCfg[45].name)
				...
				local var_55_3 = arg_52_1:GetWordFromCfg(104012013)
				...
				if manager.audio:GetVoiceLength("story_v_out_104012", "104012013", "story_v_out_104012.awb") ~= 0 then
					local var_55_8 = manager.audio:GetVoiceLength("story_v_out_104012", "104012013", "story_v_out_104012.awb") / 1000
					...
					if var_55_3.prefab_name ~= "" and arg_52_1.actors_[var_55_3.prefab_name] ~= nil then
						local var_55_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_52_1.actors_[var_55_3.prefab_name].transform, "story_v_out_104012", "104012013", "story_v_out_104012.awb")

						arg_52_1:RecordAudio("104012013", var_55_9)
						arg_52_1:RecordAudio("104012013", var_55_9)
					else
