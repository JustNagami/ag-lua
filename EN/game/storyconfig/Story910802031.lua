	...
	Play910812001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				...
				local var_4_46 = arg_1_1:FormatText(StoryNameCfg[318].name)
				...
				local var_4_47 = arg_1_1:GetWordFromCfg(910812001)
		...
		function arg_5_1.onSingleLineUpdate_(arg_8_0)
					...
					for iter_8_1, iter_8_2 in pairs(arg_5_1.var_.actorSpriteComps1070:ToTable()) do
						if iter_8_2 then
							if arg_5_1.isInRecall_ then
								local var_8_11 = Mathf.Lerp(iter_8_2.color.r, 0.46, var_8_10)
								local var_8_12 = Mathf.Lerp(iter_8_2.color.g, 0.43, var_8_10)
								local var_8_13 = Mathf.Lerp(iter_8_2.color.b, 0.35, var_8_10)
			...
			if arg_5_1.time_ >= var_8_8 + var_8_9 and arg_5_1.time_ < var_8_8 + var_8_9 + arg_8_0 and arg_5_1.var_.actorSpriteComps1070 then
				for iter_8_3, iter_8_4 in pairs(arg_5_1.var_.actorSpriteComps1070:ToTable()) do
					if iter_8_4 then
						if arg_5_1.isInRecall_ then
							iter_8_4.color = Color.New(0.46, 0.43, 0.35)
						else
