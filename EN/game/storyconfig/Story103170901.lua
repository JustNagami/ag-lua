return {
	...
	Play317091003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_19 < arg_13_1.time_ and arg_13_1.time_ <= var_16_19 + arg_16_0 then
				...
				local var_16_21 = arg_13_1:FormatText(StoryNameCfg[528].name)
				...
				local var_16_22 = arg_13_1:GetWordFromCfg(317091003)
				...
				if manager.audio:GetVoiceLength("story_v_out_317091", "317091003", "story_v_out_317091.awb") ~= 0 then
					local var_16_27 = manager.audio:GetVoiceLength("story_v_out_317091", "317091003", "story_v_out_317091.awb") / 1000
					...
					if var_16_22.prefab_name ~= "" and arg_13_1.actors_[var_16_22.prefab_name] ~= nil then
						local var_16_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_22.prefab_name].transform, "story_v_out_317091", "317091003", "story_v_out_317091.awb")

						arg_13_1:RecordAudio("317091003", var_16_28)
						arg_13_1:RecordAudio("317091003", var_16_28)
					else
	...
	Play317091004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_1 < arg_17_1.time_ and arg_17_1.time_ <= var_20_1 + arg_20_0 and arg_17_1.var_.characterEffect2078ui_story == nil then
			...
			if arg_17_1.time_ >= var_20_1 + var_20_2 and arg_17_1.time_ < var_20_1 + var_20_2 + arg_20_0 and arg_17_1.var_.characterEffect2078ui_story then
				local var_20_5 = 0.5
	...
	Play317091007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_5 <= arg_29_1.time_ and arg_29_1.time_ < var_32_5 + var_32_6 then
				...
				local var_32_8 = Vector3.New(-0.7, -1.15, -6.2)

				var_32_4.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1015ui_story, var_32_8, var_32_7)
			...
			if var_32_14 < arg_29_1.time_ and arg_29_1.time_ <= var_32_14 + arg_32_0 and arg_29_1.var_.characterEffect1015ui_story == nil then
			...
			if arg_29_1.time_ >= var_32_14 + var_32_15 and arg_29_1.time_ < var_32_14 + var_32_15 + arg_32_0 and arg_29_1.var_.characterEffect1015ui_story then
				arg_29_1.var_.characterEffect1015ui_story.fillFlat = false
			end
			...
			local var_32_19 = "1093ui_story"

			if arg_29_1.actors_[var_32_19] == nil then
				local var_32_20 = Object.Instantiate(Asset.Load("Char/" .. var_32_19), arg_29_1.stage_.transform)

				var_32_20.name = var_32_19
				var_32_20.transform.localPosition = Vector3.New(0, 100, 0)
				arg_29_1.actors_[var_32_19] = var_32_20

				local var_32_21 = var_32_20:GetComponentInChildren(typeof(CharacterEffect))

				var_32_21.enabled = true

				local var_32_22 = GameObjectTools.GetOrAddComponent(var_32_20, typeof(DynamicBoneHelper))

				if var_32_22 then
					var_32_22:EnableDynamicBone(false)
				end

				arg_29_1:ShowWeapon(var_32_21.transform, false)

				arg_29_1.var_[var_32_19 .. "Animator"] = var_32_21.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_29_1.var_[var_32_19 .. "Animator"].applyRootMotion = true
				arg_29_1.var_[var_32_19 .. "LipSync"] = var_32_21.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_32_23 = arg_29_1.actors_["1093ui_story"].transform
			local var_32_24 = 0

			if var_32_24 < arg_29_1.time_ and arg_29_1.time_ <= var_32_24 + arg_32_0 then
				arg_29_1.var_.moveOldPos1093ui_story = var_32_23.localPosition
			end

			local var_32_25 = 0.001

			if var_32_24 <= arg_29_1.time_ and arg_29_1.time_ < var_32_24 + var_32_25 then
				local var_32_26 = (arg_29_1.time_ - var_32_24) / var_32_25
				local var_32_27 = Vector3.New(0.7, -1.11, -5.88)

				var_32_23.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos1093ui_story, var_32_27, var_32_26)

				local var_32_28 = manager.ui.mainCamera.transform.position - var_32_23.position

				var_32_23.forward = Vector3.New(var_32_28.x, var_32_28.y, var_32_28.z)

				local var_32_29 = var_32_23.localEulerAngles

				var_32_29.z = 0
				var_32_29.x = 0
				var_32_23.localEulerAngles = var_32_29
			end

			if arg_29_1.time_ >= var_32_24 + var_32_25 and arg_29_1.time_ < var_32_24 + var_32_25 + arg_32_0 then
				var_32_23.localPosition = Vector3.New(0.7, -1.11, -5.88)

				local var_32_30 = manager.ui.mainCamera.transform.position - var_32_23.position

				var_32_23.forward = Vector3.New(var_32_30.x, var_32_30.y, var_32_30.z)

				local var_32_31 = var_32_23.localEulerAngles

				var_32_31.z = 0
				var_32_31.x = 0
				var_32_23.localEulerAngles = var_32_31
			end

			local var_32_32 = arg_29_1.actors_["1093ui_story"]
			local var_32_33 = 0

			if var_32_33 < arg_29_1.time_ and arg_29_1.time_ <= var_32_33 + arg_32_0 and arg_29_1.var_.characterEffect1093ui_story == nil then
				arg_29_1.var_.characterEffect1093ui_story = var_32_32:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_32_34 = 0.200000002980232
			...
			if var_32_33 <= arg_29_1.time_ and arg_29_1.time_ < var_32_33 + var_32_34 then
				...
				if arg_29_1.var_.characterEffect1093ui_story then
					local var_32_36 = Mathf.Lerp(0, 0.5, var_32_35)

					arg_29_1.var_.characterEffect1093ui_story.fillFlat = true
					arg_29_1.var_.characterEffect1093ui_story.fillRatio = var_32_36
				end
			end

			if arg_29_1.time_ >= var_32_33 + var_32_34 and arg_29_1.time_ < var_32_33 + var_32_34 + arg_32_0 and arg_29_1.var_.characterEffect1093ui_story then
				local var_32_37 = 0.5

				arg_29_1.var_.characterEffect1093ui_story.fillFlat = true
				arg_29_1.var_.characterEffect1093ui_story.fillRatio = var_32_37
			end
			...
			if var_32_39 < arg_29_1.time_ and arg_29_1.time_ <= var_32_39 + arg_32_0 then
				...
				local var_32_41 = arg_29_1:FormatText(StoryNameCfg[479].name)
				...
				local var_32_42 = arg_29_1:GetWordFromCfg(317091007)
				...
				local var_32_46 = var_32_44 <= 0 and var_32_40 or var_32_40 * (var_32_45 / var_32_44)

				if var_32_46 > 0 and var_32_40 < var_32_46 then
					arg_29_1.talkMaxDuration = var_32_46

					if var_32_46 + var_32_39 > arg_29_1.duration_ then
						arg_29_1.duration_ = var_32_46 + var_32_39
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_317091", "317091007", "story_v_out_317091.awb") ~= 0 then
					local var_32_47 = manager.audio:GetVoiceLength("story_v_out_317091", "317091007", "story_v_out_317091.awb") / 1000

					if var_32_47 + var_32_39 > arg_29_1.duration_ then
						arg_29_1.duration_ = var_32_47 + var_32_39
					end

					if var_32_42.prefab_name ~= "" and arg_29_1.actors_[var_32_42.prefab_name] ~= nil then
						local var_32_48 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_42.prefab_name].transform, "story_v_out_317091", "317091007", "story_v_out_317091.awb")

						arg_29_1:RecordAudio("317091007", var_32_48)
						arg_29_1:RecordAudio("317091007", var_32_48)
					else
			...
			local var_32_49 = math.max(var_32_40, arg_29_1.talkMaxDuration)

			if var_32_39 <= arg_29_1.time_ and arg_29_1.time_ < var_32_39 + var_32_49 then
				arg_29_1.typewritter.percent = (arg_29_1.time_ - var_32_39) / var_32_49

				arg_29_1.typewritter:SetDirty()
			end

			if arg_29_1.time_ >= var_32_39 + var_32_49 and arg_29_1.time_ < var_32_39 + var_32_49 + arg_32_0 then
	...
	Play317091008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_10 < arg_33_1.time_ and arg_33_1.time_ <= var_36_10 + arg_36_0 and arg_33_1.var_.characterEffect1015ui_story == nil then
			...
			if arg_33_1.time_ >= var_36_10 + var_36_11 and arg_33_1.time_ < var_36_10 + var_36_11 + arg_36_0 and arg_33_1.var_.characterEffect1015ui_story then
				local var_36_14 = 0.5
	...
	Play317091009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_5 < arg_37_1.time_ and arg_37_1.time_ <= var_40_5 + arg_40_0 and arg_37_1.var_.characterEffect1093ui_story == nil then
			...
			if arg_37_1.time_ >= var_40_5 + var_40_6 and arg_37_1.time_ < var_40_5 + var_40_6 + arg_40_0 and arg_37_1.var_.characterEffect1093ui_story then
				local var_40_9 = 0.5
	...
	Play317091010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_25 < arg_41_1.time_ and arg_41_1.time_ <= var_44_25 + arg_44_0 and arg_41_1.var_.characterEffect1093ui_story == nil then
			...
			if arg_41_1.time_ >= var_44_25 + var_44_26 and arg_41_1.time_ < var_44_25 + var_44_26 + arg_44_0 and arg_41_1.var_.characterEffect1093ui_story then
				arg_41_1.var_.characterEffect1093ui_story.fillFlat = false
			end
	...
	Play317091014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_25 < arg_57_1.time_ and arg_57_1.time_ <= var_60_25 + arg_60_0 and arg_57_1.var_.characterEffect1093ui_story == nil then
			...
			if arg_57_1.time_ >= var_60_25 + var_60_26 and arg_57_1.time_ < var_60_25 + var_60_26 + arg_60_0 and arg_57_1.var_.characterEffect1093ui_story then
				arg_57_1.var_.characterEffect1093ui_story.fillFlat = false
			end
	...
	Play317091016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_30 < arg_65_1.time_ and arg_65_1.time_ <= var_68_30 + arg_68_0 and arg_65_1.var_.characterEffect1015ui_story == nil then
			...
			if arg_65_1.time_ >= var_68_30 + var_68_31 and arg_65_1.time_ < var_68_30 + var_68_31 + arg_68_0 and arg_65_1.var_.characterEffect1015ui_story then
				local var_68_34 = 0.5
			...
			if var_68_45 < arg_65_1.time_ and arg_65_1.time_ <= var_68_45 + arg_68_0 and arg_65_1.var_.characterEffect1093ui_story == nil then
			...
			if arg_65_1.time_ >= var_68_45 + var_68_46 and arg_65_1.time_ < var_68_45 + var_68_46 + arg_68_0 and arg_65_1.var_.characterEffect1093ui_story then
				local var_68_49 = 0.5
	...
	Play317091021 = function(arg_85_0, arg_85_1)
		...
		function arg_85_1.onSingleLineUpdate_(arg_88_0)
			...
			if var_88_11 < arg_85_1.time_ and arg_85_1.time_ <= var_88_11 + arg_88_0 and arg_85_1.var_.characterEffect1093ui_story == nil then
			...
			if arg_85_1.time_ >= var_88_11 + var_88_12 and arg_85_1.time_ < var_88_11 + var_88_12 + arg_88_0 and arg_85_1.var_.characterEffect1093ui_story then
				arg_85_1.var_.characterEffect1093ui_story.fillFlat = false
			end
	...
	Play317091024 = function(arg_97_0, arg_97_1)
		...
		function arg_97_1.onSingleLineUpdate_(arg_100_0)
			...
			if var_100_19 < arg_97_1.time_ and arg_97_1.time_ <= var_100_19 + arg_100_0 and arg_97_1.var_.characterEffect1015ui_story == nil then
			...
			if arg_97_1.time_ >= var_100_19 + var_100_20 and arg_97_1.time_ < var_100_19 + var_100_20 + arg_100_0 and arg_97_1.var_.characterEffect1015ui_story then
				arg_97_1.var_.characterEffect1015ui_story.fillFlat = false
			end
