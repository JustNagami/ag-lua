return {
	...
	Play121032002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_20 < arg_9_1.time_ and arg_9_1.time_ <= var_12_20 + arg_12_0 then
				...
				local var_12_23 = arg_9_1:GetWordFromCfg(121032002)
				...
				if manager.audio:GetVoiceLength("story_v_out_121032", "121032002", "story_v_out_121032.awb") ~= 0 then
					local var_12_28 = manager.audio:GetVoiceLength("story_v_out_121032", "121032002", "story_v_out_121032.awb") / 1000
					...
					if var_12_23.prefab_name ~= "" and arg_9_1.actors_[var_12_23.prefab_name] ~= nil then
						local var_12_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_23.prefab_name].transform, "story_v_out_121032", "121032002", "story_v_out_121032.awb")

						arg_9_1:RecordAudio("121032002", var_12_29)
						arg_9_1:RecordAudio("121032002", var_12_29)
					else
	...
	Play121032009 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if arg_41_1.actors_[var_44_0] == nil then
				local var_44_1 = Asset.Load("Char/" .. "1076ui_story")

				if not isNil(var_44_1) then
					local var_44_2 = Object.Instantiate(Asset.Load("Char/" .. "1076ui_story"), arg_41_1.stage_.transform)
			...
			local var_44_5 = arg_41_1.actors_["1076ui_story"].transform
			local var_44_6 = 0

			if var_44_6 < arg_41_1.time_ and arg_41_1.time_ <= var_44_6 + arg_44_0 then
				arg_41_1.var_.moveOldPos1076ui_story = var_44_5.localPosition
			end
			...
			if var_44_6 <= arg_41_1.time_ and arg_41_1.time_ < var_44_6 + var_44_7 then
				...
				local var_44_9 = Vector3.New(-0.7, -1.06, -6.2)

				var_44_5.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1076ui_story, var_44_9, var_44_8)
			...
			if arg_41_1.time_ >= var_44_6 + var_44_7 and arg_41_1.time_ < var_44_6 + var_44_7 + arg_44_0 then
				var_44_5.localPosition = Vector3.New(-0.7, -1.06, -6.2)
			...
			local var_44_20 = arg_41_1.actors_["1029ui_story"].transform
			local var_44_21 = 0

			if var_44_21 < arg_41_1.time_ and arg_41_1.time_ <= var_44_21 + arg_44_0 then
				arg_41_1.var_.moveOldPos1029ui_story = var_44_20.localPosition
			end
			...
			if var_44_21 <= arg_41_1.time_ and arg_41_1.time_ < var_44_21 + var_44_22 then
				...
				local var_44_24 = Vector3.New(0.7, -1.09, -6.2)

				var_44_20.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1029ui_story, var_44_24, var_44_23)
			...
			if arg_41_1.time_ >= var_44_21 + var_44_22 and arg_41_1.time_ < var_44_21 + var_44_22 + arg_44_0 then
				var_44_20.localPosition = Vector3.New(0.7, -1.09, -6.2)
			...
			local var_44_29 = arg_41_1.actors_["1029ui_story"]
			local var_44_30 = 0

			if var_44_30 < arg_41_1.time_ and arg_41_1.time_ <= var_44_30 + arg_44_0 and not isNil(var_44_29) and arg_41_1.var_.characterEffect1029ui_story == nil then
				arg_41_1.var_.characterEffect1029ui_story = var_44_29:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_44_31 = 0.0166666666666667
			...
			if var_44_30 <= arg_41_1.time_ and arg_41_1.time_ < var_44_30 + var_44_31 and not isNil(var_44_29) then
				...
				if arg_41_1.var_.characterEffect1029ui_story and not isNil(var_44_29) then
			...
			if arg_41_1.time_ >= var_44_30 + var_44_31 and arg_41_1.time_ < var_44_30 + var_44_31 + arg_44_0 and not isNil(var_44_29) and arg_41_1.var_.characterEffect1029ui_story then
				local var_44_34 = 0.5

				arg_41_1.var_.characterEffect1029ui_story.fillFlat = true
				arg_41_1.var_.characterEffect1029ui_story.fillRatio = var_44_34
			end
			...
			if var_44_36 < arg_41_1.time_ and arg_41_1.time_ <= var_44_36 + arg_44_0 then
				...
				local var_44_38 = arg_41_1:FormatText(StoryNameCfg[389].name)
				...
				local var_44_39 = arg_41_1:GetWordFromCfg(121032009)
				...
				if manager.audio:GetVoiceLength("story_v_out_121032", "121032009", "story_v_out_121032.awb") ~= 0 then
					local var_44_44 = manager.audio:GetVoiceLength("story_v_out_121032", "121032009", "story_v_out_121032.awb") / 1000
					...
					if var_44_39.prefab_name ~= "" and arg_41_1.actors_[var_44_39.prefab_name] ~= nil then
						local var_44_45 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_39.prefab_name].transform, "story_v_out_121032", "121032009", "story_v_out_121032.awb")

						arg_41_1:RecordAudio("121032009", var_44_45)
						arg_41_1:RecordAudio("121032009", var_44_45)
					else
	...
	Play121032010 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_16 < arg_45_1.time_ and arg_45_1.time_ <= var_48_16 + arg_48_0 and not isNil(var_48_15) and arg_45_1.var_.characterEffect1076ui_story == nil then
			...
			if var_48_16 <= arg_45_1.time_ and arg_45_1.time_ < var_48_16 + var_48_17 and not isNil(var_48_15) then
				...
				if arg_45_1.var_.characterEffect1076ui_story and not isNil(var_48_15) then
			...
			if arg_45_1.time_ >= var_48_16 + var_48_17 and arg_45_1.time_ < var_48_16 + var_48_17 + arg_48_0 and not isNil(var_48_15) and arg_45_1.var_.characterEffect1076ui_story then
				local var_48_20 = 0.5
	...
	Play121032016 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_10 < arg_69_1.time_ and arg_69_1.time_ <= var_72_10 + arg_72_0 and not isNil(var_72_9) and arg_69_1.var_.characterEffect1029ui_story == nil then
			...
			if var_72_10 <= arg_69_1.time_ and arg_69_1.time_ < var_72_10 + var_72_11 and not isNil(var_72_9) then
				...
				if arg_69_1.var_.characterEffect1029ui_story and not isNil(var_72_9) then
			...
			if arg_69_1.time_ >= var_72_10 + var_72_11 and arg_69_1.time_ < var_72_10 + var_72_11 + arg_72_0 and not isNil(var_72_9) and arg_69_1.var_.characterEffect1029ui_story then
				local var_72_14 = 0.5
	...
	Play121032018 = function(arg_77_0, arg_77_1)
		...
		function arg_77_1.onSingleLineUpdate_(arg_80_0)
			...
			if var_80_16 < arg_77_1.time_ and arg_77_1.time_ <= var_80_16 + arg_80_0 and not isNil(var_80_15) and arg_77_1.var_.characterEffect1029ui_story == nil then
			...
			if var_80_16 <= arg_77_1.time_ and arg_77_1.time_ < var_80_16 + var_80_17 and not isNil(var_80_15) then
				...
				if arg_77_1.var_.characterEffect1029ui_story and not isNil(var_80_15) then
			...
			if arg_77_1.time_ >= var_80_16 + var_80_17 and arg_77_1.time_ < var_80_16 + var_80_17 + arg_80_0 and not isNil(var_80_15) and arg_77_1.var_.characterEffect1029ui_story then
				local var_80_20 = 0.5
	...
	Play121032022 = function(arg_93_0, arg_93_1)
		...
		function arg_93_1.onSingleLineUpdate_(arg_96_0)
			...
			if var_96_7 < arg_93_1.time_ and arg_93_1.time_ <= var_96_7 + arg_96_0 and not isNil(var_96_6) and arg_93_1.var_.characterEffect1029ui_story == nil then
			...
			if var_96_7 <= arg_93_1.time_ and arg_93_1.time_ < var_96_7 + var_96_8 and not isNil(var_96_6) then
				...
				if arg_93_1.var_.characterEffect1029ui_story and not isNil(var_96_6) then
			...
			if arg_93_1.time_ >= var_96_7 + var_96_8 and arg_93_1.time_ < var_96_7 + var_96_8 + arg_96_0 and not isNil(var_96_6) and arg_93_1.var_.characterEffect1029ui_story then
				local var_96_11 = 0.5
	...
	Play121032027 = function(arg_113_0, arg_113_1)
		...
		function arg_113_1.onSingleLineUpdate_(arg_116_0)
			...
			if var_116_25 < arg_113_1.time_ and arg_113_1.time_ <= var_116_25 + arg_116_0 and not isNil(var_116_24) and arg_113_1.var_.characterEffect1029ui_story == nil then
			...
			if var_116_25 <= arg_113_1.time_ and arg_113_1.time_ < var_116_25 + var_116_26 and not isNil(var_116_24) then
				...
				if arg_113_1.var_.characterEffect1029ui_story and not isNil(var_116_24) then
			...
			if arg_113_1.time_ >= var_116_25 + var_116_26 and arg_113_1.time_ < var_116_25 + var_116_26 + arg_116_0 and not isNil(var_116_24) and arg_113_1.var_.characterEffect1029ui_story then
