return {
	...
	Play319161011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_54 < arg_45_1.time_ and arg_45_1.time_ <= var_48_54 + arg_48_0 and not isNil(var_48_53) and arg_45_1.var_.characterEffect1084ui_story == nil then
			...
			if var_48_54 <= arg_45_1.time_ and arg_45_1.time_ < var_48_54 + var_48_55 and not isNil(var_48_53) then
				local var_48_56 = (arg_45_1.time_ - var_48_54) / var_48_55

				if arg_45_1.var_.characterEffect1084ui_story and not isNil(var_48_53) then
			...
			if arg_45_1.time_ >= var_48_54 + var_48_55 and arg_45_1.time_ < var_48_54 + var_48_55 + arg_48_0 and not isNil(var_48_53) and arg_45_1.var_.characterEffect1084ui_story then
				local var_48_58 = 0.5
	...
	Play319161013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_41 < arg_53_1.time_ and arg_53_1.time_ <= var_56_41 + arg_56_0 then
				...
				local var_56_43 = var_56_42:GetComponent("Text")
				local var_56_44 = var_56_42:GetComponent("RectTransform")

				var_56_43.alignment = UnityEngine.TextAnchor.LowerCenter
				var_56_44.offsetMin = Vector2.New(0, 0)
				var_56_44.offsetMax = Vector2.New(0, 0)
			end
			...
			local var_56_46 = 2.0666666696469
			local var_56_47 = 0.825
			...
			if var_56_46 < arg_53_1.time_ and arg_53_1.time_ <= var_56_46 + arg_56_0 then
				...
				local var_56_48 = LeanTween.value(arg_53_1.dialog_, 0, 1, 0.3)

				var_56_48:setOnUpdate(LuaHelper.FloatAction(function(arg_57_0)
					arg_53_1.dialogCg_.alpha = arg_57_0
				end))
				var_56_48:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_53_1.dialog_)
					var_56_48:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_56_49 = arg_53_1:FormatText(StoryNameCfg[471].name)

				arg_53_1.leftNameTxt_.text = var_56_49
				...
				local var_56_50 = arg_53_1:GetWordFromCfg(319161013)
				local var_56_51 = arg_53_1:FormatText(var_56_50.content)

				arg_53_1.text_.text = var_56_51

				LuaForUtil.ClearLinePrefixSymbol(arg_53_1.text_)

				local var_56_52 = 33
				local var_56_53 = utf8.len(var_56_51)
				local var_56_54 = var_56_52 <= 0 and var_56_47 or var_56_47 * (var_56_53 / var_56_52)

				if var_56_54 > 0 and var_56_47 < var_56_54 then
					arg_53_1.talkMaxDuration = var_56_54
					var_56_46 = var_56_46 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_319161", "319161013", "story_v_out_319161.awb") ~= 0 then
					local var_56_55 = manager.audio:GetVoiceLength("story_v_out_319161", "319161013", "story_v_out_319161.awb") / 1000

					if var_56_55 + var_56_46 > arg_53_1.duration_ then
						arg_53_1.duration_ = var_56_55 + var_56_46
					end

					if var_56_50.prefab_name ~= "" and arg_53_1.actors_[var_56_50.prefab_name] ~= nil then
						local var_56_56 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_50.prefab_name].transform, "story_v_out_319161", "319161013", "story_v_out_319161.awb")

						arg_53_1:RecordAudio("319161013", var_56_56)
						arg_53_1:RecordAudio("319161013", var_56_56)
					else
			...
			local var_56_57 = var_56_46 + 0.3
			local var_56_58 = math.max(var_56_47, arg_53_1.talkMaxDuration)

			if var_56_57 <= arg_53_1.time_ and arg_53_1.time_ < var_56_57 + var_56_58 then
				arg_53_1.typewritter.percent = (arg_53_1.time_ - var_56_57) / var_56_58

				arg_53_1.typewritter:SetDirty()
			end

			if arg_53_1.time_ >= var_56_57 + var_56_58 and arg_53_1.time_ < var_56_57 + var_56_58 + arg_56_0 then
