...
function var_0_0.GetIsFirstEnter(arg_43_0)
	return getData(string.format("core_verification"), "first_enter")
end

function var_0_0.SetIsFirstEnter(arg_44_0, arg_44_1)
	saveData(string.format("core_verification"), "first_enter", arg_44_1)
end
