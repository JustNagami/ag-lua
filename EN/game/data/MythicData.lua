...
function var_0_0.GetLevelIsOpen(arg_48_0, arg_48_1)
	return table.indexof(var_0_16, arg_48_1)
end

function var_0_0.GetAllFinalReward(arg_49_0)
	for iter_49_0 = 1, var_0_20 do
		if table.indexof(var_0_18, iter_49_0) == false then
			table.insert(var_0_18, iter_49_0)
		end
	end
end
...
function var_0_0.GetRemainTime(arg_50_0)
	...
	for iter_50_0, iter_50_1 in pairs(var_0_26) do
...
function var_0_0.SubLevel(arg_54_0, arg_54_1)
	local var_54_0 = var_0_17 + arg_54_1
	local var_54_1 = true

	if arg_54_1 > 0 then
		if var_54_0 > var_0_22 then
			return
		end
...
function var_0_0.GetIsHaveRewardNotGet(arg_58_0)
	for iter_58_0 = 1, var_0_20 do
		if table.indexof(var_0_18, iter_58_0) == false then
			return true
		end
	end
...
function var_0_0.SortRewards(arg_59_0)
	...
	for iter_59_0, iter_59_1 in ipairs(MythicFinalCfg.all) do
		if iter_59_1 > var_0_20 then
			table.insert(var_59_2, iter_59_1)
		elseif table.indexof(var_0_18, iter_59_1) then
	...
	if arg_65_1.teams_info_list[1] and arg_65_1.teams_info_list[1].stage_type == BattleConst.STAGE_TYPE_NEW.MYTHIC_FINAL then
		for iter_65_0, iter_65_1 in ipairs(arg_65_1.teams_info_list) do
			for iter_65_2, iter_65_3 in ipairs(iter_65_1.teams) do
				var_0_27[iter_65_3.id] = {}
				var_0_27[iter_65_3.id].heroList = {}

				for iter_65_4, iter_65_5 in ipairs(iter_65_3.hero_list) do
					table.insert(var_0_27[iter_65_3.id].heroList, iter_65_5.hero_id)
				end

				if iter_65_3.ai_chip_list[1] then
					var_0_27[iter_65_3.id].chipManagerID = iter_65_3.ai_chip_list[1]
					var_0_27[iter_65_3.id].chipList = {}

					for iter_65_6, iter_65_7 in ipairs(iter_65_3.ai_chip_list) do
						if iter_65_6 > 1 then
							table.insert(var_0_27[iter_65_3.id].chipList, iter_65_7)
						end
					end
				else
					var_0_27[iter_65_3.id].chipManagerID = 0
				end

				var_0_27[iter_65_3.id].uniqueSkillID = iter_65_3.cooperate_unique_skill_id
			end
		end
	end
end
...
function var_0_0.TryToSaveCurTeamData(arg_66_0, arg_66_1)
	...
	if arg_66_1.teams_info_list and arg_66_1.teams_info_list.stage_type == BattleConst.STAGE_TYPE_NEW.MYTHIC_FINAL then
		for iter_66_0, iter_66_1 in ipairs(arg_66_1.teams_info_list.teams) do
			var_0_27[iter_66_1.id] = {}
			var_0_27[iter_66_1.id].heroList = {}

			for iter_66_2, iter_66_3 in ipairs(iter_66_1.hero_list) do
				table.insert(var_0_27[iter_66_1.id].heroList, iter_66_3.hero_id)
			end

			if iter_66_1.ai_chip_list[1] then
				var_0_27[iter_66_1.id].chipManagerID = iter_66_1.ai_chip_list[1]
				var_0_27[iter_66_1.id].chipList = {}

				for iter_66_4, iter_66_5 in ipairs(iter_66_1.ai_chip_list) do
					if iter_66_4 > 1 then
						table.insert(var_0_27[iter_66_1.id].chipList, iter_66_5)
					end
				end
			else
				var_0_27[iter_66_1.id].chipManagerID = 0
			end

			var_0_27[iter_66_1.id].uniqueSkillID = iter_66_1.cooperate_unique_skill_id
		end
	end
end

function var_0_0.GetChipListByTeamID(arg_67_0, arg_67_1)
	return var_0_27[arg_67_1].chipList
end
...
function var_0_0.GetRankTypeConst(arg_69_0)
	return var_0_29
end

function var_0_0.GetCurRankType(arg_70_0)
	return var_0_30
end

function var_0_0.SetCurRankType(arg_71_0, arg_71_1)
	var_0_30 = arg_71_1
end

function var_0_0.GetCurTime(arg_72_0)
	local var_72_0 = MythicFinalCfg[var_0_17].time

	if arg_72_0:GetIsBattleIng() then
		for iter_72_0, iter_72_1 in pairs(var_0_26) do
			if iter_72_1.clear_state == 1 then
				var_72_0 = var_72_0 - iter_72_1.use_time
			end
		end
	end
...
function var_0_0.GetBattlingTime(arg_73_0)
...
function var_0_0.GetBattleRemainTime(arg_74_0, arg_74_1)
	local var_74_0 = MythicFinalCfg[var_0_17].time

	for iter_74_0 = 1, arg_74_1 - 1 do
		var_74_0 = var_74_0 - var_0_26[iter_74_0].use_time
	end
