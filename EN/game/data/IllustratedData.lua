...
function var_0_0.GetRandomTips(arg_35_0)
	...
	if var_35_3 <= var_35_0 then
		...
		return GetI18NText(var_35_6.title), GetI18NText(var_35_6.tips), var_35_6.loading_picture, true
	elseif var_35_3 <= var_35_0 + var_35_1 then
		...
		return GetI18NText(var_35_9.title), GetI18NText(var_35_9.tips), var_35_12, true
	else
		...
		return GetI18NText(var_35_15.name), GetI18NText(var_35_15.desc), var_35_15.picture, false
	end
end
