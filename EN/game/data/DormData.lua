...
function var_0_1.AddFurTotalNum(arg_28_0, arg_28_1, arg_28_2, arg_28_3)
	if var_0_3 then
		...
		if var_28_0.num == 0 then
			DormRedPointTools:SetIlluNewTagRed(arg_28_1, "furNew", RedPointConst.DORM_ILLU_FUR, true)
		end
	...
	if BackHomeFurniture[arg_28_1].is_give == DormConst.BACKHOME_FUR_GIVE_TYPE.SPECIFY then
		local var_28_1 = BackHomeFurniture[arg_28_1].hero_id
		local var_28_2 = DormRoomTools:GetDormIDViaArchive(var_28_1)

		if var_28_2 then
			local var_28_3 = DormitoryData:GetDormLevel(var_28_2)

			DormRoomTools:RefreshDormExp(var_28_2, arg_28_1, arg_28_2)

			local var_28_4 = DormitoryData:GetDormLevel(var_28_2)

			if var_28_3 ~= var_28_4 then
				DormRoomTools:GetDormLevelAward(var_28_1, var_28_3, var_28_4)
				manager.notify:Invoke(DORM_PRIVATE_LEVEL_UP, var_28_2, var_28_1)
			end
		end
	end
end
