...
function var_0_0.InitHeroPose(arg_18_0, arg_18_1, arg_18_2)
	...
	arg_18_0:FilterInvalidHeroPos()
end

function var_0_0.FilterInvalidHeroPos(arg_19_0)
	if SDKTools.GetIsKorea() then
		if arg_19_0.heroPoseList_[1099] then
			for iter_19_0, iter_19_1 in ipairs(arg_19_0.heroPoseList_[1099]) do
				if iter_19_1.id == 109903 then
					table.remove(arg_19_0.heroPoseList_[1099], iter_19_0)
		...
		if arg_19_0.heroPoseList_[1070] then
			for iter_19_2, iter_19_3 in ipairs(arg_19_0.heroPoseList_[1070]) do
				if iter_19_3.id == 107003 then
					table.remove(arg_19_0.heroPoseList_[1070], iter_19_2)
...
function var_0_0.GetHeroPoseList(arg_20_0, arg_20_1)
	return arg_20_0.heroPoseList_[arg_20_1]
end
