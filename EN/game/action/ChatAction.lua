...
manager.net:Bind(19039, function(arg_31_0)
	...
	for iter_31_0, iter_31_1 in ipairs(arg_31_0.friend_msg_list) do
		if iter_31_1.type == ChatConst.CHAT_CONTENT_TYPE.STICKER then
			local var_31_3 = tonumber(iter_31_1.content)

			if not ChatStickerCfg[var_31_3] then
				iter_31_1.content = "1"
			end
		end
		...
		local var_31_4 = iter_31_1.chat_base_info.content

		if iter_31_1.chat_base_info.type == ChatConst.CHAT_CONTENT_TYPE.STICKER then
			var_31_4 = string.format("[%s]", GetI18NText(ChatStickerCfg[tonumber(iter_31_1.chat_base_info.content)].name))
		end

		local var_31_5 = var_31_1 == iter_31_1.chat_base_info.id and iter_31_1.receive_uid or iter_31_1.chat_base_info.id

		if not table.keyof(var_31_2, var_31_5) then
			table.insert(var_31_2, var_31_5)
		end

		FriendsAction:RefreshChat(var_31_5, var_31_4, iter_31_1.chat_base_info.timestamp)
		FriendsAction:RefreshUnread(var_31_5, ChatFriendData:GetUnreadMsgCnt(var_31_5))
		manager.notify:Invoke(CHAT_FRIEND_NEW_MESSAGE, var_31_5)
