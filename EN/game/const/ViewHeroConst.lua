return {
	CLASS = {
		{
			[HeroConst.HERO_DATA_TYPE.DEFAULT] = "HeroPropertyPage",
			[HeroConst.HERO_DATA_TYPE.POLYHEDRON] = "PolyhedronHeroPropertyPage"
		},
		{
	...
	PREFAB = {
		{
			[HeroConst.HERO_DATA_TYPE.DEFAULT] = "Widget/System/Hero_arrt/HeroArrtUI"
		},
		{
		...
		{
			[HeroConst.HERO_DATA_TYPE.DEFAULT] = "Widget/System/Hero_god/HeroGodUI"
		},
		{
