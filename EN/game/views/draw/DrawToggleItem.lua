...
function var_0_0.SetData(arg_6_0, arg_6_1, arg_6_2)
	...
	if DrawData:IsOnePrefabPool(arg_6_1) then
		arg_6_0.bgImg_.sprite = getSpriteWithoutAtlas("I18NImage/TextureConfig/Treasure/" .. 140035)
	else
...
function var_0_0.RefreshBgImg(arg_8_0, arg_8_1)
	...
	arg_8_0.bgImg_.sprite = getSpriteWithoutAtlas("I18NImage/TextureConfig/Treasure/" .. var_8_0)
end
