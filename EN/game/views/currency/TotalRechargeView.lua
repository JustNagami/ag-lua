...
function var_0_0.RefreshUI(arg_9_0)
	local var_9_0 = CurrencyData:GetCurrencyMap()[CurrencyConst.CURRENCY_TYPE_RECHARGE_DIAMOND_FREE].num
	local var_9_1 = CurrencyData:GetRechargeDiamond()

	arg_9_0.freeText_.text = var_9_0
	arg_9_0.paidText_.text = var_9_1 - var_9_0
	arg_9_0.totalText_.text = var_9_1
end
