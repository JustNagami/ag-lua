...
function var_0_0.OnEnter(arg_12_0)
	...
	manager.notify:RegistListener(EQUIP_STRENGTH_SUCCESS, arg_12_0.equipStrengthHandler_)
end
...
function var_0_0.Hide(arg_38_0)
	...
	manager.notify:RemoveListener(EQUIP_STRENGTH_SUCCESS, arg_38_0.equipStrengthHandler_)
end
