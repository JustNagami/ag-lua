...
function var_0_0.OnEquipChange(arg_11_0, arg_11_1)
	...
	local var_11_0 = EquipCfg[arg_11_0.equip.prefab_id]

	if arg_11_0.equip:GetLevel() >= var_11_0.max_level[var_11_0.break_times_max + 1] then
		arg_11_0.handler_:RefreshSideBar(arg_11_0.equipId)
