	...
	if TaskTools:IsCompletedAllNoobAdvanceTask(arg_10_0.taskType_) then
		...
		if arg_10_0.nextType_ then
			if var_10_5 <= var_10_4 then
				...
				print("<-------type(self.nextType_):", type(arg_10_0.nextType_))
				print("<-------self.nextType_:", arg_10_0.nextType_)
		...
		if var_10_1 then
			...
			print("<-------type(curTaskTypeTitle):", type(var_10_6))
			print("<-------curTaskTypeTitle:", var_10_6)
