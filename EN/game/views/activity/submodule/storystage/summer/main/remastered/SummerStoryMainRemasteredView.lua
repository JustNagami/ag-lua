...
function var_0_0.AddListeners(arg_7_0)
	arg_7_0:AddBtnListener(arg_7_0.sideStoryBtn_, nil, function()
		if not arg_7_0.unLockSideStoryState_ then
			...
			ShowTips(string.format(GetTips("UNLOCK_CONDITION_ACTIVITY_TIPS"), GetI18NText(ChapterCfg[var_8_0[2][1]].subhead), GetI18NText(BattleActivityStoryStageCfg[var_8_0[2][2]].name)))
	...
	arg_7_0:AddBtnListener(arg_7_0.shipLogBtn_, nil, function()
		if not arg_7_0.unLockChipLogState_ then
			...
			ShowTips(string.format(GetTips("UNLOCK_CONDITION_ACTIVITY_TIPS"), GetI18NText(ChapterCfg[var_9_0[2][1]].subhead), GetI18NText(BattleActivityStoryStageCfg[var_9_0[2][2]].name)))
