...
function var_0_0.RefreshWaveInfoPanel(arg_18_0)
	...
	if var_18_0.combo_skill_id > 0 then
		...
		arg_18_0.comboSkillLevelText_.text = string.format(GetTips("DORM_LEVEL_TIPS"), var_18_2.maxLevel)
	...
	arg_18_0.waveIndexText_.text = GetTips("ACTIVITY_REFORGE_REPAIR_PHASE") .. table.indexof(arg_18_0.levelCfg_.wave_list, arg_18_0.curWaveID_)
end
