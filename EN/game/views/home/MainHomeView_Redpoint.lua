...
function var_0_0.BindRedPointUI(arg_11_0)
	...
	manager.redPoint:bindUIandKey(arg_11_0.btn_draw.transform, RedPointConst.DRAW_HOME)
...
function var_0_0.UnBindRedPointUI(arg_12_0)
	...
	manager.redPoint:unbindUIandKey(arg_12_0.btn_draw.transform, RedPointConst.DRAW_HOME)
