...
function var_0_0.OnEnter(arg_8_0)
	...
	arg_8_0.descText_.text = GetTips("ACTIVITY_RACE_TRIAL_DESC")
...
function var_0_0.IndexItem(arg_10_0, arg_10_1, arg_10_2)
	arg_10_2:SetData(arg_10_0.rewards[arg_10_1])
end
...
function var_0_0.OnExit(arg_12_0)
	manager.redPoint:unbindUIandKey(arg_12_0.m_entrustBtn.transform, string.format("%s_%s", RedPointConst.ACTIVITY_RACE_TRIAL, arg_12_0.activityID_))
