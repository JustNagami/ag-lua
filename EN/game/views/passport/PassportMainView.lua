...
function var_0_0.AddUIListener(arg_7_0)
	...
	if arg_7_0.fundsettlementmethodBtn_ and arg_7_0.commercialBtn_ then
		arg_7_0:AddBtnListener(arg_7_0.fundsettlementmethodBtn_, nil, function()
			local var_18_0 = "Payment_Services_Act_Url"
			local var_18_1 = OperationAction.GetOperationUrl(var_18_0)
			local var_18_2 = EncodeURL(var_18_1)

			print("url : ", var_18_2)

			local var_18_3 = OperationConst.URL_OPEN_WAY.NORMAL

			OperationAction.OpenUrl(var_18_2, var_18_3, nil)
		end)
		arg_7_0:AddBtnListener(arg_7_0.commercialBtn_, nil, function()
			local var_19_0 = "Specified_Commercial_Transactions_Url"
			local var_19_1 = OperationAction.GetOperationUrl(var_19_0)
			local var_19_2 = EncodeURL(var_19_1)

			print("url : ", var_19_2)

			local var_19_3 = OperationConst.URL_OPEN_WAY.NORMAL

			OperationAction.OpenUrl(var_19_2, var_19_3, nil)
		end)
	end
end
...
function var_0_0.UpdateView(arg_22_0)
	...
	local var_22_5 = PassportData:HasDiscount()

	SetActive(arg_22_0.discountHighlight_, var_22_5)
end
