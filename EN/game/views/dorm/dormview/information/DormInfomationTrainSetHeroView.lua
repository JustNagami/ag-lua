...
function var_0_0.OnDormHeroItemClick(arg_25_0, arg_25_1)
	...
	local var_25_2 = DormData:GetHeroTemplateInfo(arg_25_1)

	if var_25_2 then
		local var_25_3 = var_25_2:GetHeroState()

		if var_25_3 == DormEnum.DormHeroState.InCanteenJob or var_25_3 == DormEnum.DormHeroState.InCanteenEntrust then
