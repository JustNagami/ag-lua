	...
	if arg_12_1 then
		...
		if var_12_0 then
			...
			if not arg_12_0.showState then
				...
				if arg_12_0.state == var_0_1.DormHeroState.InCanteenJob then
					arg_12_0.postextText_.text = GetTips("DORM_HERO_AT_CANTEEN")
				elseif arg_12_0.state == var_0_1.DormHeroState.InCanteenEntrust then
					arg_12_0.postextText_.text = GetTips("DORM_HERO_AT_TASK")
				elseif arg_12_0.state == var_0_1.DormHeroState.InPublicDorm then
					arg_12_0.postextText_.text = GetTips("DORM_HERO_AT_LOBBY")
				elseif arg_12_0.state == var_0_1.DormHeroState.InPrivateDorm then
					arg_12_0.postextText_.text = GetTips("DORM_HERO_AT_DORM")
				elseif arg_12_0.state == var_0_1.DormHeroState.OutDorm then
					arg_12_0.postextText_.text = GetTips("DORM_HERO_AT_DORM")
				elseif arg_12_0.state == var_0_1.DormHeroState.InIdolTraineeCamp then
