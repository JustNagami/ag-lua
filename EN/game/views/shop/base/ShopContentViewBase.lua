local var_0_0 = require("game.tools.ShopTools")
local var_0_1 = class("ShopContentViewBase", ReduxView)
...
function var_0_1.ScrollByPosition(arg_5_0, arg_5_1, arg_5_2)
	return
end

function var_0_1.ResetFilter(arg_6_0)
	return
end

function var_0_1.SetShopId(arg_7_0, arg_7_1)
	arg_7_0.shopId_ = arg_7_1
end

function var_0_1.SetShopHideHome(arg_8_0, arg_8_1)
	arg_8_0.hideHomeBtn_ = arg_8_1
end

function var_0_1.UpdateBarByShopId(arg_9_0)
	...
	for iter_9_1 = 1, #var_9_2 do
		manager.windowBar:SetBarCanAdd(var_9_2[iter_9_1], ShopConst.ADD_CURRENCY[var_9_2[iter_9_1]] == true and ShopTools.IsLimitRecharge())
	end
end

function var_0_1.OnShopClick(arg_10_0, arg_10_1)
...
function var_0_1.GetShopGoodList(arg_11_0)
	return ShopTools.FilterShopDataList(arg_11_0.shopId_)
end

function var_0_1.GetLuaList(arg_12_0)
...
function var_0_1.RefreshShopGoodInfo(arg_14_0, arg_14_1)
...
function var_0_1.RefreshList(arg_15_0, arg_15_1)
...
function var_0_1.GetScrolledPosition(arg_19_0)
