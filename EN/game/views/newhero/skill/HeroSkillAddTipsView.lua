...
function var_0_0.SetDataAndShow(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_1 = arg_16_0.typeArgsList[arg_16_1]

	if var_16_1 then
		arg_16_0.titleText_.text = var_16_1.titleName
	end

	local var_16_2 = #arg_16_2 > 0 and var_0_1.noEmpty or var_0_1.empty
