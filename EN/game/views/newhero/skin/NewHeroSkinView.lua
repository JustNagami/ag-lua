...
function var_0_0.SetCurDlcID(arg_28_0)
	...
	local var_28_2 = SkinSceneActionCfg[arg_28_0.skinID_]

	if var_28_2 and var_28_2.special_scene_id then
		arg_28_0.dlcItemID_ = var_28_2.special_scene_id
	end
end
...
function var_0_0.SetVideoTrack(arg_63_0, arg_63_1, arg_63_2)
	local var_63_0 = manager.video:GetVedioTrackIndex(arg_63_2)

	arg_63_1:SetAudioTrack(var_63_0)
	arg_63_1:SetSubtitleChannel(var_63_0)
end
...
function var_0_0.AddUIListener(arg_76_0)
	...
	arg_76_0:AddBtnListener(arg_76_0.goBtn_, nil, function()
		...
		elseif arg_76_0.showDlcState_ == 1 then
...
function var_0_0.OnTryToUseItemOther(arg_101_0)
	...
	manager.redPoint:setTip(RedPointConst.HERO_SKIN_ROUTE_ID .. arg_101_0.skinID_, 0, RedPointStyle.SHOW_NEW_TAG)
end
