...
var_0_0.typeToFunction = {
	...
	purchase_complete = function(arg_20_0)
		var_0_1 = {
			user_id = PlayerData:GetPlayerInfo().userID,
			time = manager.time:GetServerTime(),
			payment = arg_20_0.payment,
			order_id = arg_20_0.order_id,
			currency = arg_20_0.currency
		}

		SDKTools.SetParamsAttribute("purchase_complete", var_0_1)
	end,
