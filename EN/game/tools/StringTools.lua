...
function WordVerifyBySDK(arg_3_0, arg_3_1, arg_3_2)
	...
	if not SDKTools.GetIsTw() then
		...
		if var_3_0 == "" then
			local var_3_5 = var_3_3 and ChatConst.VERIFY_STATUS.PASS or ChatConst.VERIFY_STATUS.LOCAL_NO_PASS

			SendJudgeResult(arg_3_2, arg_3_0, var_3_5, "")
			arg_3_1(var_3_3, var_3_5)

			return
		end

		local var_3_6 = var_0_0.encode({
		...
		SendMessageToSDKWithCallBack(var_3_6, "CheckTextResult", function(arg_4_0)
