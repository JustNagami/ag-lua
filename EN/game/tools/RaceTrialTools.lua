return {
	...
	GetFirstRewardPopItem = function(arg_7_0)
		if ActivityTools.GetActivityTheme(arg_7_0) == ActivityConst.THEME.ACTIVITY_3_5 then
	...
	GetScoreRewardPopItem = function(arg_8_0)
		if ActivityTools.GetActivityTheme(arg_8_0) == ActivityConst.THEME.ACTIVITY_3_5 then
	...
	GetDisplayScorePatternTips = function(arg_9_0)
		if ActivityTools.GetActivityTheme(arg_9_0) == ActivityConst.THEME.ACTIVITY_3_5 then
