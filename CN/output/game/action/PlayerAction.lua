...
function var_0_0.UnlockPortrait(arg_70_0, arg_70_1)
	PlayerData:UnlockPortrait(arg_70_0, arg_70_1)
end
...
function var_0_0.InitChatBubbleRedPoint()
	...
	for iter_96_0, iter_96_1 in ipairs(PlayerData:GetUnlockChatBubbleIDList()) do
		if iter_96_1 ~= var_96_0 then
			RedPointData:GetIsRedPointOpen(RedPointConst.CHAT_BUBBLE_RANGE + iter_96_1)
		else
