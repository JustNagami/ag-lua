return {
	...
	Play1108106094 = function(arg_395_0, arg_395_1)
		...
		function arg_395_1.onSingleLineUpdate_(arg_398_0)
			...
			local var_398_18 = math.max(var_398_11, arg_395_1.talkMaxDuration)

			if var_398_10 <= arg_395_1.time_ and arg_395_1.time_ < var_398_10 + var_398_18 then
				arg_395_1.typewritter.percent = (arg_395_1.time_ - var_398_10) / var_398_18

				arg_395_1.typewritter:SetDirty()
			end

			if arg_395_1.time_ >= var_398_10 + var_398_18 and arg_395_1.time_ < var_398_10 + var_398_18 + arg_398_0 then
	...
	Play1108106192 = function(arg_803_0, arg_803_1)
		...
		function arg_803_1.onSingleLineUpdate_(arg_806_0)
			...
			local var_806_62 = var_806_53 + 0.3
			local var_806_63 = math.max(var_806_54, arg_803_1.talkMaxDuration)

			if var_806_62 <= arg_803_1.time_ and arg_803_1.time_ < var_806_62 + var_806_63 then
				arg_803_1.typewritter.percent = (arg_803_1.time_ - var_806_62) / var_806_63

				arg_803_1.typewritter:SetDirty()
			end

			if arg_803_1.time_ >= var_806_62 + var_806_63 and arg_803_1.time_ < var_806_62 + var_806_63 + arg_806_0 then
	...
	Play1108106224 = function(arg_934_0, arg_934_1)
		...
		function arg_934_1.onSingleLineUpdate_(arg_937_0)
			...
			local var_937_18 = math.max(var_937_11, arg_934_1.talkMaxDuration)

			if var_937_10 <= arg_934_1.time_ and arg_934_1.time_ < var_937_10 + var_937_18 then
				arg_934_1.typewritter.percent = (arg_934_1.time_ - var_937_10) / var_937_18

				arg_934_1.typewritter:SetDirty()
			end

			if arg_934_1.time_ >= var_937_10 + var_937_18 and arg_934_1.time_ < var_937_10 + var_937_18 + arg_937_0 then
	...
	Play1108106218 = function(arg_966_0, arg_966_1)
		...
		function arg_966_1.onSingleLineUpdate_(arg_969_0)
			...
			local var_969_24 = math.max(var_969_17, arg_966_1.talkMaxDuration)

			if var_969_16 <= arg_966_1.time_ and arg_966_1.time_ < var_969_16 + var_969_24 then
				arg_966_1.typewritter.percent = (arg_966_1.time_ - var_969_16) / var_969_24

				arg_966_1.typewritter:SetDirty()
			end

			if arg_966_1.time_ >= var_969_16 + var_969_24 and arg_966_1.time_ < var_969_16 + var_969_24 + arg_969_0 then
	...
	Play1108106009 = function(arg_970_0, arg_970_1)
		...
		function arg_970_1.onSingleLineUpdate_(arg_973_0)
			...
			local var_973_18 = math.max(var_973_11, arg_970_1.talkMaxDuration)

			if var_973_10 <= arg_970_1.time_ and arg_970_1.time_ < var_973_10 + var_973_18 then
				arg_970_1.typewritter.percent = (arg_970_1.time_ - var_973_10) / var_973_18

				arg_970_1.typewritter:SetDirty()
			end

			if arg_970_1.time_ >= var_973_10 + var_973_18 and arg_970_1.time_ < var_973_10 + var_973_18 + arg_973_0 then
