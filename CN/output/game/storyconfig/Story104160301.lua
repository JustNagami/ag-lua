			...
			if var_16_5 <= arg_13_1.time_ and arg_13_1.time_ < var_16_5 + var_16_6 and not isNil(var_16_4) then
				...
				if arg_13_1.var_.actorSpriteComps10054 then
					for iter_16_2, iter_16_3 in pairs(arg_13_1.var_.actorSpriteComps10054:ToTable()) do
						if iter_16_3 then
							if arg_13_1.isInRecall_ then
								local var_16_8 = Mathf.Lerp(iter_16_3.color.r, 0.82, var_16_7)
								local var_16_9 = Mathf.Lerp(iter_16_3.color.g, 0.77, var_16_7)
								local var_16_10 = Mathf.Lerp(iter_16_3.color.b, 0.62, var_16_7)
