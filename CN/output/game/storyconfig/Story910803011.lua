return {
	Play910819001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_45 < arg_1_1.time_ and arg_1_1.time_ <= var_4_45 + arg_4_0 then
				...
				local var_4_49 = arg_1_1:GetWordFromCfg(910819001)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
					...
					for iter_10_0, iter_10_1 in pairs(arg_7_1.var_.actorSpriteComps1111:ToTable()) do
						if iter_10_1 then
							if arg_7_1.isInRecall_ then
								local var_10_4 = Mathf.Lerp(iter_10_1.color.r, 0.46, var_10_3)
								local var_10_5 = Mathf.Lerp(iter_10_1.color.g, 0.43, var_10_3)
								local var_10_6 = Mathf.Lerp(iter_10_1.color.b, 0.35, var_10_3)
			...
			if arg_7_1.time_ >= var_10_1 + var_10_2 and arg_7_1.time_ < var_10_1 + var_10_2 + arg_10_0 and not isNil(var_10_0) and arg_7_1.var_.actorSpriteComps1111 then
				for iter_10_2, iter_10_3 in pairs(arg_7_1.var_.actorSpriteComps1111:ToTable()) do
					if iter_10_3 then
						if arg_7_1.isInRecall_ then
							iter_10_3.color = Color.New(0.46, 0.43, 0.35)
						else
			...
			if var_10_8 < arg_7_1.time_ and arg_7_1.time_ <= var_10_8 + arg_10_0 then
				...
				local var_10_10 = arg_7_1:GetWordFromCfg(910819002)
	...
	Play910819005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 then
				...
				local var_22_18 = arg_19_1:GetWordFromCfg(910819005)
	...
	Play910819006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_8 < arg_23_1.time_ and arg_23_1.time_ <= var_26_8 + arg_26_0 then
				...
				local var_26_11 = arg_23_1:GetWordFromCfg(910819006)
	...
	Play910819007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_15 < arg_27_1.time_ and arg_27_1.time_ <= var_30_15 + arg_30_0 then
				...
				local var_30_18 = arg_27_1:GetWordFromCfg(910819007)
	...
	Play910819008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_8 < arg_31_1.time_ and arg_31_1.time_ <= var_34_8 + arg_34_0 then
				...
				local var_34_10 = arg_31_1:FormatText(StoryNameCfg[623].name)
				...
				local var_34_11 = arg_31_1:GetWordFromCfg(910819008)
	...
	Play910819010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_15 < arg_39_1.time_ and arg_39_1.time_ <= var_42_15 + arg_42_0 then
				...
				local var_42_18 = arg_39_1:GetWordFromCfg(910819010)
	...
	Play910819011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_8 < arg_43_1.time_ and arg_43_1.time_ <= var_46_8 + arg_46_0 then
				...
				local var_46_10 = arg_43_1:FormatText(StoryNameCfg[623].name)
				...
				local var_46_11 = arg_43_1:GetWordFromCfg(910819011)
	...
	Play910819012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_15 < arg_47_1.time_ and arg_47_1.time_ <= var_50_15 + arg_50_0 then
				...
				local var_50_18 = arg_47_1:GetWordFromCfg(910819012)
	...
	Play910819013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if var_54_8 < arg_51_1.time_ and arg_51_1.time_ <= var_54_8 + arg_54_0 then
				...
				local var_54_11 = arg_51_1:GetWordFromCfg(910819013)
	...
	Play910819017 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if var_70_15 < arg_67_1.time_ and arg_67_1.time_ <= var_70_15 + arg_70_0 then
				...
				local var_70_17 = arg_67_1:FormatText(StoryNameCfg[67].name)
				...
				local var_70_18 = arg_67_1:GetWordFromCfg(910819017)
	...
	Play910819018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			...
			if var_74_1 < arg_71_1.time_ and arg_71_1.time_ <= var_74_1 + arg_74_0 and not isNil(var_74_0) and arg_71_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_71_1.time_ >= var_74_1 + var_74_2 and arg_71_1.time_ < var_74_1 + var_74_2 + arg_74_0 and not isNil(var_74_0) and arg_71_1.var_.actorSpriteComps1111 then
			...
			if var_74_8 < arg_71_1.time_ and arg_71_1.time_ <= var_74_8 + arg_74_0 then
				...
				local var_74_10 = arg_71_1:GetWordFromCfg(910819018)
	...
	Play910819019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			...
			if var_78_8 < arg_75_1.time_ and arg_75_1.time_ <= var_78_8 + arg_78_0 and not isNil(var_78_7) and arg_75_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_75_1.time_ >= var_78_8 + var_78_9 and arg_75_1.time_ < var_78_8 + var_78_9 + arg_78_0 and not isNil(var_78_7) and arg_75_1.var_.actorSpriteComps1111 then
			...
			if var_78_15 < arg_75_1.time_ and arg_75_1.time_ <= var_78_15 + arg_78_0 then
				...
				local var_78_17 = arg_75_1:FormatText(StoryNameCfg[67].name)
				...
				local var_78_18 = arg_75_1:GetWordFromCfg(910819019)
	...
	Play910819020 = function(arg_79_0, arg_79_1)
		...
		function arg_79_1.onSingleLineUpdate_(arg_82_0)
			...
			if var_82_1 < arg_79_1.time_ and arg_79_1.time_ <= var_82_1 + arg_82_0 and not isNil(var_82_0) and arg_79_1.var_.actorSpriteComps1111 == nil then
			...
			if arg_79_1.time_ >= var_82_1 + var_82_2 and arg_79_1.time_ < var_82_1 + var_82_2 + arg_82_0 and not isNil(var_82_0) and arg_79_1.var_.actorSpriteComps1111 then
			...
			if var_82_8 < arg_79_1.time_ and arg_79_1.time_ <= var_82_8 + arg_82_0 then
				...
				local var_82_11 = arg_79_1:GetWordFromCfg(910819020)
	...
	Play910819021 = function(arg_83_0, arg_83_1)
		...
		function arg_83_1.onSingleLineUpdate_(arg_86_0)
			...
			if var_86_19 < arg_83_1.time_ and arg_83_1.time_ <= var_86_19 + arg_86_0 then
				...
				local var_86_22 = arg_83_1:GetWordFromCfg(910819021)
