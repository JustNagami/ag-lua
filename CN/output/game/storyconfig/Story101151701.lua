return {
	...
	Play115171005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if arg_21_1.actors_[var_24_0] == nil then
				local var_24_1 = Asset.Load("Char/" .. "1016ui_story")
			...
			if var_24_6 <= arg_21_1.time_ and arg_21_1.time_ < var_24_6 + var_24_7 then
				...
				local var_24_9 = Vector3.New(0, -0.95, -6.2)

				var_24_5.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos1016ui_story, var_24_9, var_24_8)
			...
			if arg_21_1.time_ >= var_24_6 + var_24_7 and arg_21_1.time_ < var_24_6 + var_24_7 + arg_24_0 then
				var_24_5.localPosition = Vector3.New(0, -0.95, -6.2)
			...
			local var_24_16 = arg_21_1.actors_["1016ui_story"]
			local var_24_17 = 0

			if var_24_17 < arg_21_1.time_ and arg_21_1.time_ <= var_24_17 + arg_24_0 and not isNil(var_24_16) and arg_21_1.var_.characterEffect1016ui_story == nil then
				arg_21_1.var_.characterEffect1016ui_story = var_24_16:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_24_17 <= arg_21_1.time_ and arg_21_1.time_ < var_24_17 + var_24_18 and not isNil(var_24_16) then
				...
				if arg_21_1.var_.characterEffect1016ui_story and not isNil(var_24_16) then
					arg_21_1.var_.characterEffect1016ui_story.fillFlat = false
				end
			end

			if arg_21_1.time_ >= var_24_17 + var_24_18 and arg_21_1.time_ < var_24_17 + var_24_18 + arg_24_0 and not isNil(var_24_16) and arg_21_1.var_.characterEffect1016ui_story then
				arg_21_1.var_.characterEffect1016ui_story.fillFlat = false
			end

			local var_24_20 = 0
			local var_24_21 = 0.325
			...
			if var_24_20 < arg_21_1.time_ and arg_21_1.time_ <= var_24_20 + arg_24_0 then
				...
				local var_24_22 = arg_21_1:FormatText(StoryNameCfg[260].name)
				...
				local var_24_23 = arg_21_1:GetWordFromCfg(115171005)
				...
				if manager.audio:GetVoiceLength("story_v_out_115171", "115171005", "story_v_out_115171.awb") ~= 0 then
					local var_24_28 = manager.audio:GetVoiceLength("story_v_out_115171", "115171005", "story_v_out_115171.awb") / 1000
					...
					if var_24_23.prefab_name ~= "" and arg_21_1.actors_[var_24_23.prefab_name] ~= nil then
						local var_24_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_23.prefab_name].transform, "story_v_out_115171", "115171005", "story_v_out_115171.awb")

						arg_21_1:RecordAudio("115171005", var_24_29)
						arg_21_1:RecordAudio("115171005", var_24_29)
					else
	...
	Play115171007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_1 < arg_29_1.time_ and arg_29_1.time_ <= var_32_1 + arg_32_0 and not isNil(var_32_0) and arg_29_1.var_.characterEffect1016ui_story == nil then
			...
			if arg_29_1.time_ >= var_32_1 + var_32_2 and arg_29_1.time_ < var_32_1 + var_32_2 + arg_32_0 and not isNil(var_32_0) and arg_29_1.var_.characterEffect1016ui_story then
				arg_29_1.var_.characterEffect1016ui_story.fillFlat = false
			end
	...
	Play115171015 = function(arg_61_0, arg_61_1)
		...
		function arg_61_1.onSingleLineUpdate_(arg_64_0)
			...
			if var_64_12 < arg_61_1.time_ and arg_61_1.time_ <= var_64_12 + arg_64_0 and not isNil(var_64_11) and arg_61_1.var_.characterEffect1016ui_story == nil then
			...
			if var_64_12 <= arg_61_1.time_ and arg_61_1.time_ < var_64_12 + var_64_13 and not isNil(var_64_11) then
				...
				if arg_61_1.var_.characterEffect1016ui_story and not isNil(var_64_11) then
					arg_61_1.var_.characterEffect1016ui_story.fillFlat = false
				end
			end

			if arg_61_1.time_ >= var_64_12 + var_64_13 and arg_61_1.time_ < var_64_12 + var_64_13 + arg_64_0 and not isNil(var_64_11) and arg_61_1.var_.characterEffect1016ui_story then
				arg_61_1.var_.characterEffect1016ui_story.fillFlat = false
			end
	...
	Play115171017 = function(arg_69_0, arg_69_1)
		...
		function arg_69_1.onSingleLineUpdate_(arg_72_0)
			...
			if var_72_12 < arg_69_1.time_ and arg_69_1.time_ <= var_72_12 + arg_72_0 and not isNil(var_72_11) and arg_69_1.var_.characterEffect1016ui_story == nil then
			...
			if var_72_12 <= arg_69_1.time_ and arg_69_1.time_ < var_72_12 + var_72_13 and not isNil(var_72_11) then
				...
				if arg_69_1.var_.characterEffect1016ui_story and not isNil(var_72_11) then
					arg_69_1.var_.characterEffect1016ui_story.fillFlat = false
				end
			end

			if arg_69_1.time_ >= var_72_12 + var_72_13 and arg_69_1.time_ < var_72_12 + var_72_13 + arg_72_0 and not isNil(var_72_11) and arg_69_1.var_.characterEffect1016ui_story then
				arg_69_1.var_.characterEffect1016ui_story.fillFlat = false
			end
