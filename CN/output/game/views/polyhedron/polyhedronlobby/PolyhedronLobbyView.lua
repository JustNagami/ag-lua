...
function var_0_0.BindRedPoint(arg_29_0)
	manager.redPoint:bindUIandKey(arg_29_0.m_taskBtn.transform, RedPointConst.POLYHEDRON_RESIDENT_TASK)
...
function var_0_0.UnbindRedPoint(arg_30_0)
	manager.redPoint:unbindUIandKey(arg_30_0.m_taskBtn.transform, RedPointConst.POLYHEDRON_RESIDENT_TASK)
