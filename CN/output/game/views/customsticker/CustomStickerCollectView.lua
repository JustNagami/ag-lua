...
function var_0_0.OnEnter(arg_18_0)
	...
	manager.redPoint:bindUIandKey(arg_18_0.main2Btn_.transform, RedPointConst.CUSTOM_STICKER_ROOT)
...
function var_0_0.OnExit(arg_31_0)
	...
	manager.redPoint:unbindUIandKey(arg_31_0.main2Btn_.transform, RedPointConst.CUSTOM_STICKER_ROOT)
