...
function var_0_0.StartMovie(arg_57_0)
	...
	for iter_57_0, iter_57_1 in ipairs(SkinSceneActionCfg.all) do
		...
		if var_57_8.special_scene_id == var_57_5.param[1] then
			...
			arg_57_0.mainMovieRaw_.material = nil
			arg_57_0.bgMovieRaw_.material = nil
...
function var_0_0.OnTryToUseItemOther(arg_101_0)
	arg_101_0:SetButtonActive(2)
	manager.redPoint:setTip(RedPointConst.HERO_SKIN_ROUTE_ID .. skinID, 0, RedPointStyle.SHOW_NEW_TAG)
end
