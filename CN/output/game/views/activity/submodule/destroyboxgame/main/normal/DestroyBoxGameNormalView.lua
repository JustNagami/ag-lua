...
function var_0_0.RefreshScore(arg_12_0)
	...
	if DestroyBoxGameData:GetStageData(var_12_0) then
		-- block empty
	end

	local var_12_1 = table.keyof(DestroyBoxGameData:GetDifficultList(arg_12_0.mainActivityID_)[arg_12_0.selectDifficult_], var_12_0)

	arg_12_0.numText_.text = string.format("%02d", var_12_1)

	if DestroyBoxGameData:IsFinishPreStage(var_12_0) then
		-- block empty
	else
		local var_12_2 = DestroyBoxGameCfg[var_12_0].unlock_condition
		local var_12_3 = DestroyBoxGameCfg[var_12_2[1]].difficult

		if var_12_3 == 1 then
			var_12_3 = GetTips("HARDLEVEL_EASY")
		elseif var_12_3 == 2 then
			local var_12_4 = GetTips("HARDLEVEL_HARD")
		end
	end
end
