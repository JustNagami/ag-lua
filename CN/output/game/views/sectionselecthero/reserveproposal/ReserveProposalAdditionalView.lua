...
function var_0_1.InitController(arg_2_0)
	...
	arg_2_0.comboActiveController_ = arg_2_0.controllerExCollection_:GetController("comboActive")
	arg_2_0.mimirActiveController_ = arg_2_0.controllerExCollection_:GetController("mimirActive")
...
function var_0_1.RefreshSwitchList(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4)
	arg_10_0.contIDList_ = arg_10_1
	arg_10_0.curSelectContID_ = arg_10_2
	arg_10_0.tempContID_ = arg_10_3
	...
	arg_10_0.progressText_.text = string.format(GetTips("RESERVE_PROPOSAL_NUM"), arg_10_4, GameSetting.default_formation_num_max.value[1])
end
...
function var_0_1.IndexItem(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_1 = var_13_0 == arg_13_0.tempContID_

	arg_13_2:SetProxy(arg_13_0.sectionProxy_)
	arg_13_2:SetData(var_13_0, var_13_1)
