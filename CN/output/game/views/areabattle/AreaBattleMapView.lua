...
function var_0_1.UIName(arg_1_0)
	return "Widget/Version/ShashwatUI_3_7/ShashwatUI_3_7_SeizuresUI/NormalfightingMapUI"
end
...
function var_0_1.AddUIListener(arg_6_0)
	...
	arg_6_0:AddBtnListener(arg_6_0.hardBtn_, nil, function()
		...
		if arg_6_0.hardController:GetSelectedState() == "true" then
			ShowTips("ACTIVITY_AREA_BATTLE_HARD_AREA_UNLOCK")
...
function var_0_1.UpdateData(arg_16_0)
	...
	if arg_16_0.difficultList[arg_16_0.activityID] ~= nil then
		...
		arg_16_0.difficult = var_0_0.EASY
	end
...
function var_0_1.UpdateView(arg_17_0)
	...
	arg_17_0.hardSelectController:SetSelectedState(arg_17_0.difficult == var_0_0.HARD and "true" or "false")
	arg_17_0.difficultController:SetSelectedState(tostring(arg_17_0.difficult))
	arg_17_0.hardController:SetSelectedState(tostring(arg_17_0.data.allChallengeValue == 0))
