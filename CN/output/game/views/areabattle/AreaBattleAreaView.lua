...
function var_0_0.UIName(arg_1_0)
	return "Widget/Version/ShashwatUI_3_7/ShashwatUI_3_7_SeizuresUI/NormalfightingAreaUI"
end
...
function var_0_0.UpdateView(arg_6_0)
	for iter_6_0 = 1, 4 do
		...
		var_6_0:SetData(iter_6_0, ActivityAreaBattleCfg.all[iter_6_0], arg_6_0.data[ActivityAreaBattleCfg.all[iter_6_0]], arg_6_0.activityID)
	end
