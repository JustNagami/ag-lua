...
function var_0_0.MoveContentScreenPosXDelta(arg_17_0, arg_17_1)
	local var_17_0 = arg_17_1 * manager.ui.canvasRate / (arg_17_0.contentTrans_.rect.width - arg_17_0.viewPortTrans_.rect.width)

	arg_17_0.scrollRect_.enabled = false

	arg_17_0:DoMoveXTween(var_17_0)
end
