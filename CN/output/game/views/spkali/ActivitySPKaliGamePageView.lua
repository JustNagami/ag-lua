...
function var_0_0.AddListeners(arg_7_0)
	arg_7_0:AddBtnListener(arg_7_0.btn_ringsideBtn_, nil, function()
		local var_8_0 = SpKaliTool.GetGameIDByMainActivityID(arg_7_0.activityID_, ActivityTemplateConst.ACTIVITY_KALIFIGHT)
		local var_8_1 = SPKaliChallengeData:GetNowAffixEffect(var_8_0)

		JumpTools.OpenPageByJump("/SpKaliChallenge", {
			activityID_ = var_8_0
		})

		if not SpKaliTool.IsHaveRolled(var_8_0) then
			-- block empty
		end
	end)
	arg_7_0:AddBtnListener(arg_7_0.btn_sniperBtn_, nil, function()
		local var_9_0 = SpKaliTool.GetGameIDByMainActivityID(arg_7_0.activityID_, ActivityTemplateConst.ACTIVITY_KALISHOOT)
