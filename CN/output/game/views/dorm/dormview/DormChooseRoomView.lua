...
function var_0_0.ClickChangeFloor(arg_33_0, arg_33_1)
	if arg_33_0.roomItemView.edit then
		return
	end

	if arg_33_0.floor == arg_33_1 then
		return
	end

	arg_33_0.floor = arg_33_1
	arg_33_0.toggleGroup[arg_33_0.floor].isOn = true

	arg_33_0:RefreshRoomItem()
	DormTools:PlayDormAudioEffect(DormConst.DORM_AUDIO_EFFECT.ChangeFloor)
	arg_33_0.roomItemView:PlayFloorAnimation()
end

function var_0_0.RefreshCanteenState(arg_34_0)
	if CanteenEntrustData.AnyEntrustFinished() then
		arg_34_0.canteenTaskStateController:SetSelectedState("true")
	else
		arg_34_0.canteenTaskStateController:SetSelectedState("false")
	end

	if CanteenTools:CheckSignFoodNumCanOpen() then
		arg_34_0.canteenFoodEnoughController:SetSelectedState("false")
	else
		arg_34_0.canteenFoodEnoughController:SetSelectedState("true")
	end

	arg_34_0:RefreshCanteenJobItem()
end

function var_0_0.RefreshRoomItem(arg_35_0)
	if arg_35_0.floor then
		arg_35_0.roomItemView:RefreshUI(arg_35_0.floor)
	end
end

function var_0_0.RefreshCanteenJobItem(arg_36_0)
	arg_36_0.workHeroList = {}

	local var_36_0 = CanteenHeroTools:GetCanteenJobList()

	if var_36_0 then
		for iter_36_0, iter_36_1 in ipairs(var_36_0) do
			table.insert(arg_36_0.workHeroList, iter_36_1.heroID or -1)
		end
	end

	arg_36_0.canteenHeroStateScroll:StartScroll(#arg_36_0.workHeroList)
end
...
function var_0_0.indexHeroItem(arg_37_0, arg_37_1, arg_37_2)
	...
	arg_37_2:RefreshUI(arg_37_0.workHeroList[arg_37_1])
end

function var_0_0.indexDanceHeroItem(arg_38_0, arg_38_1, arg_38_2)
	arg_38_2:SetItemFunction({
		showFatigue = true,
		showJobState = true
	})
	arg_38_2:RefreshUI(arg_38_0.danceHeroList[arg_38_1])
end

function var_0_0.RefreshDanceState(arg_39_0)
	arg_39_0.danceHeroList = {}

	local var_39_0 = DormHeroTools:GetHeroListInDance()
	local var_39_1 = GameSetting.dorm_idol_room_max_place.value[1]

	for iter_39_0 = 1, var_39_1 do
		arg_39_0.danceHeroList[iter_39_0] = 0
	end

	for iter_39_1, iter_39_2 in ipairs(var_39_0) do
		if iter_39_2.dancePos then
			arg_39_0.danceHeroList[iter_39_2.dancePos] = iter_39_2.hero_id
		end
	end

	arg_39_0.danceHeroStateScroll:StartScroll(#arg_39_0.danceHeroList)

	if IdolTraineeTools:CheckDanceTaskComplete() then
		arg_39_0.danceTaskController:SetSelectedState("true")
	else
		arg_39_0.danceTaskController:SetSelectedState("false")
	end
end

function var_0_0.RenderMarque(arg_40_0)
	return
end

function var_0_0.Dispose(arg_41_0)
	if arg_41_0.canteenHeroStateScroll then
		arg_41_0.canteenHeroStateScroll:Dispose()
	end

	if arg_41_0.danceHeroStateScroll then
		arg_41_0.danceHeroStateScroll:Dispose()
	end

	if arg_41_0.roomItemView then
		arg_41_0.roomItemView:Dispose()
	end

	arg_41_0.marqueComp:Dispose()
	DormitoryData:SetFloor(arg_41_0.floor)
