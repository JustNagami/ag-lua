...
function var_0_0.RefreshCameraState(arg_2_0)
	...
	if arg_2_0.scaleLevel_ == var_0_1.NEAR then
		local var_2_1 = Dorm.DormEntityManager.GetTransform(arg_2_0.furEntityID_).position
		local var_2_2 = Vector3(var_2_0.position[1], var_2_0.position[2], var_2_0.position[3])
		local var_2_3 = Vector3.Lerp(var_2_2, var_2_1, 0.25)

		manager.ui:SetMainCameraPos(var_2_3)
	else
		local var_2_4 = Vector3(var_2_0.position[1], var_2_0.position[2], var_2_0.position[3])

		manager.ui:SetMainCameraPos(var_2_4)
	end
end
