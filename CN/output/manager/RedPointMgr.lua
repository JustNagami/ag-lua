...
function var_0_0.Init(arg_2_0)
	...
	for iter_2_153, iter_2_154 in pairs(HeroCfg.get_id_list_by_private[0]) do
		if BackHomeHeroCfg[iter_2_154] then
			local var_2_161 = RedPointConst.DORM_ILLU_HERO .. iter_2_154

			table.insert(var_2_158, var_2_161)
		end
	end
	...
	for iter_2_155, iter_2_156 in ipairs(BackHomeFurnitureThemeCfg.all) do
		local var_2_162 = RedPointConst.DORM_ILLU_FUR_THEME .. iter_2_156

		table.insert(var_2_159, var_2_162)
	end

	for iter_2_157, iter_2_158 in ipairs(BackHomeFurnitureThemeCfg.all) do
		local var_2_163 = {}
		local var_2_164 = DormIlluTools.GetFurList(iter_2_158)

		for iter_2_159, iter_2_160 in ipairs(var_2_164) do
			local var_2_165 = RedPointConst.DORM_ILLU_FUR .. iter_2_160

			table.insert(var_2_163, var_2_165)
		end

		arg_2_0:addGroup(RedPointConst.DORM_ILLU_FUR_THEME .. iter_2_158, var_2_163)
	end
	...
	for iter_2_161, iter_2_162 in ipairs(IdolDanceDIYActionCfg.all) do
		local var_2_166 = RedPointConst.DORM_ILLU_DANCE .. iter_2_162

		table.insert(var_2_160, var_2_166)
	end
	...
	local var_2_167 = MailSpecialLetterCfg.get_id_list_by_letter_belongs
	local var_2_168 = {}

	for iter_2_163, iter_2_164 in pairs(var_2_167) do
		table.insert(var_2_168, RedPointConst.LETTER_SENDER_ID .. iter_2_163)

		local var_2_169 = {}

		for iter_2_165, iter_2_166 in pairs(iter_2_164) do
			table.insert(var_2_169, RedPointConst.LETTER_ID .. iter_2_166)
		end

		arg_2_0:addGroup(RedPointConst.LETTER_SENDER_ID .. iter_2_163, var_2_169)
	end

	arg_2_0:addGroup(RedPointConst.LETTER_UNREAD, var_2_168)
	...
	for iter_2_167 = 1, #ExploreMeowCfg.all do
		local var_2_171 = ExploreMeowCfg.all[iter_2_167]

		var_2_170[iter_2_167] = RedPointConst.EXPLORE_UNLOCK_ADMIN_CAT .. var_2_171
	end

	local var_2_172 = {}

	for iter_2_168 = 1, #ExploreAreaCfg.all do
		local var_2_173 = ExploreAreaCfg.all[iter_2_168]

		var_2_172[iter_2_168] = RedPointConst.EXPLORE_FINISH .. var_2_173
	end

	arg_2_0:addGroup(RedPointConst.EXPLORE_UNLOCK_ADMIN_CAT, var_2_170)
	arg_2_0:addGroup(RedPointConst.EXPLORE_FINISH, var_2_172)
	...
	for iter_2_169, iter_2_170 in ipairs(RechargeRecommendCfg.all) do
		table.insert(var_2_174, RedPointConst.RECHARGE_RECOMMEND .. iter_2_170)
	end

	arg_2_0:addGroup(RedPointConst.RECHARGE_RECOMMEND, var_2_174)
	...
	for iter_2_173, iter_2_174 in ipairs(ActivityCfg.get_id_list_by_activity_template[ActivityTemplateConst.ACTIVITY_SKIN_DRAW]) do
		table.insert(var_2_175, RedPointConst.ACTIVITY_DRAW .. "_" .. iter_2_174)
	end

	arg_2_0:addGroup(RedPointConst.ACTIVITY_DRAW, var_2_175)

	local var_2_176 = ActivityCfg.get_id_list_by_activity_template[ActivityTemplateConst.ACTIVITY_ATTRIBUTE_ARENA] or {}

	for iter_2_175, iter_2_176 in ipairs(var_2_176) do
	...
	local var_2_177 = SPHeroChallengeData.activityCfg[ActivityConst.ACTIVITY_HERO_CHALLENGE_3_1].heroChipActivityID
	local var_2_178 = SPHeroChallengeData.activityCfg[ActivityConst.ACTIVITY_HERO_CHALLENGE_3_1].taskActivityID

	arg_2_0:addGroup(RedPointConst.SP_HERO_CHALLENGE_3_1, {
		RedPointConst.SP_HERO_CHALLENGE_3_1_ENTRUST,
		string.format("%s_%s", RedPointConst.ACTIVITY_TASK, var_2_177),
		string.format("%s_%s", RedPointConst.ACTIVITY_TASK, var_2_178)
	})
	...
	for iter_2_177, iter_2_178 in ipairs(ActivityCfg.get_id_list_by_activity_template[ActivityTemplateConst.ACTIVITY_SWIMSUIT_BATTLE_HERO_STAGE]) do
		table.insert(var_2_179, string.format("%s_%s", RedPointConst.ACTIVITY_SWIMSUIT_BATTLE_HERO, iter_2_178))
	end

	table.insert(var_2_179, RedPointConst.ACTIVITY_SWIMSUIT_BATTLE_REWARD)
	arg_2_0:addGroup(string.format("%s%s", ActivityTools.GetRedPointKey(282951), 282951), var_2_179)
	...
	for iter_2_179, iter_2_180 in ipairs(ActivitySwimSkinSectionCfg.all) do
		local var_2_184 = ActivitySwimSkinSectionCfg[iter_2_180]
		local var_2_185 = {}

		var_2_183[3] = iter_2_180

		local var_2_186 = table.concat(var_2_183)

		if var_2_184.mode == CaptureGameConst.CaptureGameMode.Single then
			for iter_2_181, iter_2_182 in ipairs(var_2_184.sub_section_list) do
				var_2_182[3] = iter_2_182

				table.insert(var_2_185, table.concat(var_2_182))
			end

			table.insert(var_2_180, var_2_186)
		elseif var_2_184.mode == CaptureGameConst.CaptureGameMode.Multiple then
			for iter_2_183, iter_2_184 in ipairs(var_2_184.sub_section_list) do
				var_2_182[3] = iter_2_184

				table.insert(var_2_185, table.concat(var_2_182))
			end

			table.insert(var_2_181, var_2_186)
		end

		arg_2_0:addGroup(var_2_186, var_2_185)
	end

	arg_2_0:addGroup(RedPointConst.CAPTURE_GAME_UNLOCK_SINGLE_ROOT, var_2_180)
	arg_2_0:addGroup(RedPointConst.CAPTURE_GAME_UNLOCK_MULTI_ROOT, var_2_181)
	...
	for iter_2_185, iter_2_186 in ipairs(ActivityTangramGameChapterCfg.all) do
		local var_2_188 = string.format("%s_%s", RedPointConst.ACTIVITY_3_5_TANGRAM_GAME_CHAPTER, iter_2_186)

		table.insert(var_2_187, var_2_188)
		arg_2_0:addGroup(var_2_188, {
	...
	arg_2_0:addGroup(RedPointConst.ACTIVITY_3_5_TANGRAM_GAME_CHAPTER, var_2_187)
end
