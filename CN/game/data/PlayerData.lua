...
function var_0_0.ClearStickerCollectPageRedPoint(arg_63_0, arg_63_1)
	...
	if arg_63_1 == 0 then
		for iter_63_0, iter_63_1 in ipairs(StickerSuitCfg.all) do
			table.insertto(var_63_0, StickerSuitCfg[iter_63_1].content)
		end
	...
	for iter_63_2, iter_63_3 in ipairs(var_63_0) do
		if not getData("PlayerCustomStickerTriggered", "StickerItem_" .. iter_63_3) and manager.redPoint:getTipValue(RedPointConst.CUSTOM_STICKER_ITEM .. "_" .. iter_63_3) == 1 then
			saveData("PlayerCustomStickerTriggered", "StickerItem_" .. iter_63_3, 1)
			manager.redPoint:setTip(RedPointConst.CUSTOM_STICKER_ITEM .. "_" .. iter_63_3, 0)
		end
	end
end
