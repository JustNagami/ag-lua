...
function var_0_0.RefreshInfo(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = SettingData:GetCurrentLanguage()

	if var_12_1 == "jp" or var_12_1 == "en" or var_12_1 == "de" or var_12_1 == "fr" then
		arg_12_0.infoTxt_.text = GetI18NText(var_12_0.detail_note)
	else
