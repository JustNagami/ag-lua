...
function var_0_1.InitProxy(arg_2_0)
	...
	arg_2_0.sectionMultiPosController_ = arg_2_0.sectionController_:GetController("sectionMultiPos")
end
...
function var_0_1.SetMultiPos(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	arg_21_0.sectionMultiPosController_:SetSelectedState(arg_21_1 and "on" or "off")

	if arg_21_1 then
		arg_21_0.sectionMultiPosText_.text = arg_21_3
	end
end
