...
function var_0_0.RefreshList(arg_7_0)
	arg_7_0.list_ = ActivitySkinDrawData:GetActivityList() or {}
...
function var_0_0.OnSkinDrawUpdate(arg_9_0, arg_9_1)
	if ActivityTemplateConst.ACTIVITY_SKIN_DRAW ~= ActivityTools.GetActivityType(arg_9_1) or isNil(arg_9_0.gameObject_) or arg_9_0.isRefreshed_ then
		return
	end

	arg_9_0.isRefreshed_ = true
