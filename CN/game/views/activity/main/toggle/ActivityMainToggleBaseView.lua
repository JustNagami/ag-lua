...
function var_0_0.OnEnter(arg_4_0)
	...
	for iter_4_2, iter_4_3 in ipairs(ActivityToggleCfg.get_id_list_by_activity_theme[arg_4_0:GetActivityTheme()] or {}) do
		...
		local var_4_1 = ActivityData:GetActivityData(var_4_0.activity_id)
		local var_4_2 = var_4_1.template == ActivityTemplateConst.ACTIVITY_ADVANCE_OPEN and var_4_1.subActivityIdList[1] or var_4_0.activity_id

		arg_4_0.toggleItemList_[var_4_0.activity_id] = arg_4_0.toggleItemList_[var_4_0.activity_id] or ActivityMainToggleItem.New(arg_4_0.itemGo_, arg_4_0.itemParentGo_, iter_4_3, var_4_0.activity_id, var_4_2)
	...
	if arg_4_0.params_.isBack then
		var_4_3 = ActivityVersionData:GetSelectActivityID(arg_4_0:GetActivityID())
	elseif arg_4_0.params_.subActivityID then
		var_4_3 = arg_4_0.params_.subActivityID
	else
		var_4_3 = arg_4_0:GetOpenActivityID()
	end
	...
	arg_4_0:ScrollToggle(var_4_3)
	arg_4_0:ToggleOnClick(var_4_3, true)
