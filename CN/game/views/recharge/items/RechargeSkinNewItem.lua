...
function var_0_1.UpdateTimerView(arg_7_0)
	...
	if arg_7_0.dlcID ~= 0 then
		local var_7_3 = ShopTools.GetDiscount(arg_7_0.dlcID)
		local var_7_4, var_7_5, var_7_6 = ShopTools.IsOnDiscountArea(arg_7_0.dlcID)

		arg_7_0.giftController_:SetSelectedState(var_7_4 and var_7_6 and var_7_3 == 0 and "true" or "false")
	end
