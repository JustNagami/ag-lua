...
function var_0_0.InitTabList(arg_10_0)
	...
	for iter_10_0, iter_10_1 in ipairs(arg_10_0.subActivityIDList_) do
		if not arg_10_0.tabList_[iter_10_0] then
			...
			arg_10_0.tabList_[iter_10_0] = LimitTimeTaskTools.GetLimitTimeTabView(arg_10_0.mainActivityID_).New(var_10_1)
		end
	...
	if var_12_0 then
		...
		for iter_12_0, iter_12_1 in ipairs(var_12_0) do
			if not arg_12_0.pointItemList_[iter_12_0] then
				...
				arg_12_0.pointItemList_[iter_12_0] = LimitTimeTaskTools.GetLimitTimeTaskScheduleItemView(arg_12_0.mainActivityID_).New(var_12_2)
			end
...
function var_0_0.RefreshActivityPoint(arg_20_0)
	...
	local var_20_3 = var_20_2 and #var_20_2 or 0
	...
	for iter_20_0 = 1, var_20_3 do
		...
		if iter_20_0 == 1 then
			...
			var_20_4:RefreshSlider(var_20_8, var_20_9, TaskData2:GetTaskComplete(var_20_5))
		else
			...
			var_20_4:RefreshSlider(var_20_12, var_20_13, TaskData2:GetTaskComplete(var_20_5))
		end
	end

	arg_20_0.progressText_.text = string.format(var_0_1, tostring(var_20_0), tostring(var_20_1))

	if arg_20_0.progressShadowText_ then
		arg_20_0.progressShadowText_.text = string.format(var_0_1, tostring(var_20_0), tostring(var_20_1))
	end

	arg_20_0.taskScheduleText_.text = LimitTimeTaskCfg[arg_20_0.mainActivityID_] and LimitTimeTaskCfg[arg_20_0.mainActivityID_].name or "缺少配置"
end
