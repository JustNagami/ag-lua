...
function SetSDKUploadImageLimit(arg_27_0, arg_27_1)
	local var_27_0 = string.format("{\"messageType\":\"SetImageMaxCount\",\"maxCount\":\"%d\",\"savePath\":\"%s\"}", arg_27_0, arg_27_1)

	GameToSDK.SetImageMaxCount(var_27_0)
end

function SDKUploadImage(arg_28_0, arg_28_1)
	local var_28_0 = string.format("{\"messageType\":\"UploadImage\",\"imagePath\":\"%s\",\"moduleStr\":\"%s\"}", arg_28_1, arg_28_0)

	GameToSDK.UploadImage(var_28_0)
end

function SDKDownloadImage(arg_29_0, arg_29_1)
	local var_29_0 = string.format("{\"messageType\":\"DownloadImage\",\"path\":\"%s\",\"url\":\"%s\"}", arg_29_1, arg_29_0)

	GameToSDK.DownloadImage(var_29_0)
end

function SDKDonwloadUrlToLocalPath(arg_30_0)
	local var_30_0 = (arg_30_0 or ""):match("[^/]+$")

	if not var_30_0 or var_30_0 == "" then
		return ""
	end

	local var_30_1, var_30_2 = var_30_0:gsub("%.[^.]*$", "")
