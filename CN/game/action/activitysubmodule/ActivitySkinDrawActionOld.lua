...
function var_0_0.OnFinishStory(arg_7_0, arg_7_1)
	if isSuccess(arg_7_0.result) then
		...
		local var_7_1 = ActivityLimitedSkinStoryCfg.get_id_list_by_activity_id[var_7_0][1]
		local var_7_2 = ActivityLimitedSkinStoryCfg[var_7_1].main_activity_id

		ActivitySkinDrawDataOld:FinishStory(var_7_2)
	else
...
function var_0_0.RefreshRed(arg_8_0)
	local var_8_0 = ActivitySkinDrawToolsOld.GetSceneID(arg_8_0)
