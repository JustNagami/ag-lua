		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_12 < arg_1_1.time_ and arg_1_1.time_ <= var_4_12 + arg_4_0 then
				...
				if var_4_13 then
					...
					arg_1_1.var_.alphaOldValueST06a = var_4_15.a
					arg_1_1.var_.alphaMatValueST06a = var_4_14
				end
			...
			if var_4_12 <= arg_1_1.time_ and arg_1_1.time_ < var_4_12 + var_4_16 then
				...
				local var_4_18 = Mathf.Lerp(arg_1_1.var_.alphaOldValueST06a, 1, var_4_17)

				if arg_1_1.var_.alphaMatValueST06a then
					local var_4_19 = arg_1_1.var_.alphaMatValueST06a
			...
			if arg_1_1.time_ >= var_4_12 + var_4_16 and arg_1_1.time_ < var_4_12 + var_4_16 + arg_4_0 and arg_1_1.var_.alphaMatValueST06a then
				local var_4_21 = arg_1_1.var_.alphaMatValueST06a
			...
			if var_4_23 < arg_1_1.time_ and arg_1_1.time_ <= var_4_23 + arg_4_0 then
				...
				local var_4_26 = arg_1_1.bgs_.ST06a
			...
			local var_4_37 = arg_1_1.actors_["3004_tpose"].transform
			local var_4_38 = 1.79999995231628

			if var_4_38 < arg_1_1.time_ and arg_1_1.time_ <= var_4_38 + arg_4_0 then
				arg_1_1.var_.moveOldPos3004_tpose = var_4_37.localPosition
			end
			...
			if var_4_38 <= arg_1_1.time_ and arg_1_1.time_ < var_4_38 + var_4_39 then
				...
				local var_4_41 = Vector3.New(-0.7, -2.22, -3.1)

				var_4_37.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos3004_tpose, var_4_41, var_4_40)
			...
			if arg_1_1.time_ >= var_4_38 + var_4_39 and arg_1_1.time_ < var_4_38 + var_4_39 + arg_4_0 then
				var_4_37.localPosition = Vector3.New(-0.7, -2.22, -3.1)
			...
			if var_4_55 < arg_1_1.time_ and arg_1_1.time_ <= var_4_55 + arg_4_0 then
				...
				local var_4_59 = arg_1_1:GetWordFromCfg(106051001)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051001", "story_v_out_106051.awb") ~= 0 then
					local var_4_64 = manager.audio:GetVoiceLength("story_v_out_106051", "106051001", "story_v_out_106051.awb") / 1000
					...
					if var_4_59.prefab_name ~= "" and arg_1_1.actors_[var_4_59.prefab_name] ~= nil then
						local var_4_65 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_59.prefab_name].transform, "story_v_out_106051", "106051001", "story_v_out_106051.awb")

						arg_1_1:RecordAudio("106051001", var_4_65)
						arg_1_1:RecordAudio("106051001", var_4_65)
					else
	...
	Play106051002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if var_11_25 < arg_8_1.time_ and arg_8_1.time_ <= var_11_25 + arg_11_0 then
				...
				local var_11_28 = arg_8_1:GetWordFromCfg(106051002)
				...
				if manager.audio:GetVoiceLength("story_v_out_106051", "106051002", "story_v_out_106051.awb") ~= 0 then
					local var_11_33 = manager.audio:GetVoiceLength("story_v_out_106051", "106051002", "story_v_out_106051.awb") / 1000
					...
					if var_11_28.prefab_name ~= "" and arg_8_1.actors_[var_11_28.prefab_name] ~= nil then
						local var_11_34 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_28.prefab_name].transform, "story_v_out_106051", "106051002", "story_v_out_106051.awb")

						arg_8_1:RecordAudio("106051002", var_11_34)
						arg_8_1:RecordAudio("106051002", var_11_34)
					else
