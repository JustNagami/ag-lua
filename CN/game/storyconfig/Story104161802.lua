		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_3 < arg_9_1.time_ and arg_9_1.time_ <= var_12_3 + arg_12_0 then
				...
				if not var_12_4 then
					var_12_4 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"))
					var_12_4.name = "788"
				...
				if var_12_5 then
					var_12_4.transform.parent = var_12_5
				else
					var_12_4.transform.parent = var_12_2
				end
				...
				local var_12_7 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_12_6.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_12_8 = var_12_4.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_12_9 = 15
				local var_12_10 = 2 * var_12_9 * Mathf.Tan(var_12_6.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_12_6.aspect
				local var_12_11 = 1
				local var_12_12 = 1.7777777777777777

				if var_12_12 < var_12_6.aspect then
					var_12_11 = var_12_10 / (2 * var_12_9 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_12_12)
				end

				for iter_12_0, iter_12_1 in ipairs(var_12_8) do
					local var_12_13 = iter_12_1.transform.localScale

					iter_12_1.transform.localScale = Vector3.New(var_12_13.x / var_12_7 * var_12_11, var_12_13.y / var_12_7, var_12_13.z)
				end
			end

			local var_12_14 = manager.ui.mainCamera.transform
			local var_12_15 = 1.40833333333267

			if var_12_15 < arg_9_1.time_ and arg_9_1.time_ <= var_12_15 + arg_12_0 then
				local var_12_16 = arg_9_1.var_.effect788

				if var_12_16 then
					Object.Destroy(var_12_16)

					arg_9_1.var_.effect788 = nil
				end
			end

			local var_12_17 = 0.05
			local var_12_18 = 1

			if var_12_17 < arg_9_1.time_ and arg_9_1.time_ <= var_12_17 + arg_12_0 then
				local var_12_19 = "play"
				local var_12_20 = "effect"

				arg_9_1:AudioAction(var_12_19, var_12_20, "se_story_side_1026", "se_story_1026_electric", "")
			end
			...
			if var_12_21 < arg_9_1.time_ and arg_9_1.time_ <= var_12_21 + arg_12_0 then
				local var_12_23 = "play"
				local var_12_24 = "effect"

				arg_9_1:AudioAction(var_12_23, var_12_24, "se_story_120_00", "se_story_120_00_sizzle", "")
			end
			...
			local var_12_25 = 0.866666666666667
			...
			if var_12_25 < arg_9_1.time_ and arg_9_1.time_ <= var_12_25 + arg_12_0 then
				...
				local var_12_28 = arg_9_1:GetWordFromCfg(416182002)
