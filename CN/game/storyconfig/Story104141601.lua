return {
	Play414161001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				local var_4_38 = arg_1_1:GetWordFromCfg(414161001)
	...
	Play414161002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_20 < arg_9_1.time_ and arg_9_1.time_ <= var_12_20 + arg_12_0 then
				...
				local var_12_23 = arg_9_1:GetWordFromCfg(414161002)
	...
	Play414161003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_9 = arg_13_1:GetWordFromCfg(414161003)
	...
	Play414161004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			local var_20_2 = 0.333333333333333
			...
			local var_20_6 = arg_17_1.actors_["104902ui_story"].transform
			local var_20_7 = 0

			if var_20_7 < arg_17_1.time_ and arg_17_1.time_ <= var_20_7 + arg_20_0 then
				arg_17_1.var_.moveOldPos104902ui_story = var_20_6.localPosition
			end
			...
			if var_20_7 <= arg_17_1.time_ and arg_17_1.time_ < var_20_7 + var_20_8 then
				...
				var_20_6.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos104902ui_story, var_20_10, var_20_9)
			...
			local var_20_15 = 0.333333333333333
			...
			if var_20_15 < arg_17_1.time_ and arg_17_1.time_ <= var_20_15 + arg_20_0 then
				...
				local var_20_17 = LeanTween.value(arg_17_1.dialog_, 0, 1, 0.3)

				var_20_17:setOnUpdate(LuaHelper.FloatAction(function(arg_21_0)
					arg_17_1.dialogCg_.alpha = arg_21_0
				end))
				var_20_17:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_17_1.dialog_)
					var_20_17:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_20_18 = arg_17_1:FormatText(StoryNameCfg[945].name)
				...
				local var_20_19 = arg_17_1:GetWordFromCfg(414161004)
				...
				local var_20_23 = var_20_21 <= 0 and var_20_16 or var_20_16 * (var_20_22 / var_20_21)

				if var_20_23 > 0 and var_20_16 < var_20_23 then
					arg_17_1.talkMaxDuration = var_20_23
					var_20_15 = var_20_15 + 0.3
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_10 <= arg_23_1.time_ and arg_23_1.time_ < var_26_10 + var_26_11 and not isNil(var_26_9) then
				...
				if arg_23_1.var_.characterEffect104902ui_story and not isNil(var_26_9) then
					...
					arg_23_1.var_.characterEffect104902ui_story.fillRatio = var_26_13
				end
			end
			...
			if arg_23_1.time_ >= var_26_10 + var_26_11 and arg_23_1.time_ < var_26_10 + var_26_11 + arg_26_0 and not isNil(var_26_9) and arg_23_1.var_.characterEffect104902ui_story then
				...
				arg_23_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_23_1.var_.characterEffect104902ui_story.fillRatio = var_26_14
			end

			local var_26_15 = 0
			local var_26_16 = 1.45
			...
			if var_26_15 < arg_23_1.time_ and arg_23_1.time_ <= var_26_15 + arg_26_0 then
				...
				local var_26_17 = arg_23_1:GetWordFromCfg(414161005)
	...
	Play414161006 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_0 < arg_27_1.time_ and arg_27_1.time_ <= var_30_0 + arg_30_0 then
				...
				local var_30_2 = arg_27_1:GetWordFromCfg(414161006)
	...
	Play414161007 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_15 < arg_31_1.time_ and arg_31_1.time_ <= var_34_15 + arg_34_0 then
				...
				local var_34_18 = arg_31_1:GetWordFromCfg(414161007)
	...
	Play414161008 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.playNext_(arg_37_0)
			...
			arg_35_1:RecordChoiceLog(414161008, 414161009, 414161009)
		end
	...
	Play414161009 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_0 < arg_39_1.time_ and arg_39_1.time_ <= var_42_0 + arg_42_0 then
				...
				local var_42_3 = arg_39_1:GetWordFromCfg(414161009)
	...
	Play414161010 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_15 < arg_43_1.time_ and arg_43_1.time_ <= var_46_15 + arg_46_0 then
				...
				local var_46_18 = arg_43_1:GetWordFromCfg(414161010)
	...
	Play414161011 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_6 < arg_47_1.time_ and arg_47_1.time_ <= var_50_6 + arg_50_0 then
				...
				local var_50_9 = arg_47_1:GetWordFromCfg(414161011)
	...
	Play414161012 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if var_54_0 < arg_51_1.time_ and arg_51_1.time_ <= var_54_0 + arg_54_0 then
				...
				local var_54_3 = arg_51_1:GetWordFromCfg(414161012)
	...
	Play414161013 = function(arg_55_0, arg_55_1)
		...
		function arg_55_1.onSingleLineUpdate_(arg_58_0)
			...
			if var_58_0 < arg_55_1.time_ and arg_55_1.time_ <= var_58_0 + arg_58_0 then
				...
				arg_55_1:AudioAction(var_58_2, var_58_3, "se_story_133", "se_story_133_gaga2", "")
			end
			...
			if var_58_4 < arg_55_1.time_ and arg_55_1.time_ <= var_58_4 + arg_58_0 then
				...
				local var_58_6 = arg_55_1:FormatText(StoryNameCfg[945].name)
				...
				local var_58_7 = arg_55_1:GetWordFromCfg(414161013)
	...
	Play414161014 = function(arg_59_0, arg_59_1)
		...
		function arg_59_1.onSingleLineUpdate_(arg_62_0)
			local var_62_0 = arg_59_1.actors_["104902ui_story"].transform
			local var_62_1 = 0

			if var_62_1 < arg_59_1.time_ and arg_59_1.time_ <= var_62_1 + arg_62_0 then
				arg_59_1.var_.moveOldPos104902ui_story = var_62_0.localPosition
			end
			...
			if var_62_1 <= arg_59_1.time_ and arg_59_1.time_ < var_62_1 + var_62_2 then
				...
				var_62_0.localPosition = Vector3.Lerp(arg_59_1.var_.moveOldPos104902ui_story, var_62_4, var_62_3)
			...
			local var_62_9 = arg_59_1.actors_["104902ui_story"]
			local var_62_10 = 0

			if var_62_10 < arg_59_1.time_ and arg_59_1.time_ <= var_62_10 + arg_62_0 and not isNil(var_62_9) and arg_59_1.var_.characterEffect104902ui_story == nil then
				arg_59_1.var_.characterEffect104902ui_story = var_62_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_62_10 <= arg_59_1.time_ and arg_59_1.time_ < var_62_10 + var_62_11 and not isNil(var_62_9) then
				...
				if arg_59_1.var_.characterEffect104902ui_story and not isNil(var_62_9) then
					arg_59_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_59_1.time_ >= var_62_10 + var_62_11 and arg_59_1.time_ < var_62_10 + var_62_11 + arg_62_0 and not isNil(var_62_9) and arg_59_1.var_.characterEffect104902ui_story then
				arg_59_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if var_62_15 < arg_59_1.time_ and arg_59_1.time_ <= var_62_15 + arg_62_0 then
				...
				local var_62_18 = arg_59_1:GetWordFromCfg(414161014)
	...
	Play414161015 = function(arg_63_0, arg_63_1)
		...
		function arg_63_1.playNext_(arg_65_0)
			...
			arg_63_1:RecordChoiceLog(414161015, 414161016, 414161017)
		end
		...
		function arg_63_1.onSingleLineUpdate_(arg_66_0)
			...
			if var_66_1 <= arg_63_1.time_ and arg_63_1.time_ < var_66_1 + var_66_2 and not isNil(var_66_0) then
				...
				if arg_63_1.var_.characterEffect104902ui_story and not isNil(var_66_0) then
					...
					arg_63_1.var_.characterEffect104902ui_story.fillRatio = var_66_4
				end
			end
			...
			if arg_63_1.time_ >= var_66_1 + var_66_2 and arg_63_1.time_ < var_66_1 + var_66_2 + arg_66_0 and not isNil(var_66_0) and arg_63_1.var_.characterEffect104902ui_story then
				...
				arg_63_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_63_1.var_.characterEffect104902ui_story.fillRatio = var_66_5
			end
		end
	end,
	Play414161016 = function(arg_67_0, arg_67_1)
		...
		function arg_67_1.onSingleLineUpdate_(arg_70_0)
			...
			if var_70_0 < arg_67_1.time_ and arg_67_1.time_ <= var_70_0 + arg_70_0 then
				...
				local var_70_3 = arg_67_1:GetWordFromCfg(414161016)
	...
	Play414161018 = function(arg_71_0, arg_71_1)
		...
		function arg_71_1.onSingleLineUpdate_(arg_74_0)
			local var_74_0 = arg_71_1.actors_["104902ui_story"].transform
			local var_74_1 = 0

			if var_74_1 < arg_71_1.time_ and arg_71_1.time_ <= var_74_1 + arg_74_0 then
				arg_71_1.var_.moveOldPos104902ui_story = var_74_0.localPosition
			end
			...
			if var_74_1 <= arg_71_1.time_ and arg_71_1.time_ < var_74_1 + var_74_2 then
				...
				var_74_0.localPosition = Vector3.Lerp(arg_71_1.var_.moveOldPos104902ui_story, var_74_4, var_74_3)
			...
			local var_74_9 = arg_71_1.actors_["104902ui_story"]
			local var_74_10 = 0

			if var_74_10 < arg_71_1.time_ and arg_71_1.time_ <= var_74_10 + arg_74_0 and not isNil(var_74_9) and arg_71_1.var_.characterEffect104902ui_story == nil then
				arg_71_1.var_.characterEffect104902ui_story = var_74_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_74_10 <= arg_71_1.time_ and arg_71_1.time_ < var_74_10 + var_74_11 and not isNil(var_74_9) then
				...
				if arg_71_1.var_.characterEffect104902ui_story and not isNil(var_74_9) then
					arg_71_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_71_1.time_ >= var_74_10 + var_74_11 and arg_71_1.time_ < var_74_10 + var_74_11 + arg_74_0 and not isNil(var_74_9) and arg_71_1.var_.characterEffect104902ui_story then
				arg_71_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if var_74_15 < arg_71_1.time_ and arg_71_1.time_ <= var_74_15 + arg_74_0 then
				...
				local var_74_17 = arg_71_1:FormatText(StoryNameCfg[562].name)
				...
				local var_74_18 = arg_71_1:GetWordFromCfg(414161018)
	...
	Play414161019 = function(arg_75_0, arg_75_1)
		...
		function arg_75_1.onSingleLineUpdate_(arg_78_0)
			local var_78_0 = arg_75_1.actors_["104902ui_story"]
			local var_78_1 = 0

			if var_78_1 < arg_75_1.time_ and arg_75_1.time_ <= var_78_1 + arg_78_0 and not isNil(var_78_0) and arg_75_1.var_.characterEffect104902ui_story == nil then
				arg_75_1.var_.characterEffect104902ui_story = var_78_0:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_78_1 <= arg_75_1.time_ and arg_75_1.time_ < var_78_1 + var_78_2 and not isNil(var_78_0) then
				...
				if arg_75_1.var_.characterEffect104902ui_story and not isNil(var_78_0) then
					local var_78_4 = Mathf.Lerp(0, 0.5, var_78_3)

					arg_75_1.var_.characterEffect104902ui_story.fillFlat = true
					arg_75_1.var_.characterEffect104902ui_story.fillRatio = var_78_4
				end
			end

			if arg_75_1.time_ >= var_78_1 + var_78_2 and arg_75_1.time_ < var_78_1 + var_78_2 + arg_78_0 and not isNil(var_78_0) and arg_75_1.var_.characterEffect104902ui_story then
				local var_78_5 = 0.5

				arg_75_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_75_1.var_.characterEffect104902ui_story.fillRatio = var_78_5
			end
			...
			if var_78_6 < arg_75_1.time_ and arg_75_1.time_ <= var_78_6 + arg_78_0 then
				...
				local var_78_9 = arg_75_1:GetWordFromCfg(414161019)
	...
	Play414161017 = function(arg_79_0, arg_79_1)
		...
		function arg_79_1.onSingleLineUpdate_(arg_82_0)
			...
			if var_82_0 < arg_79_1.time_ and arg_79_1.time_ <= var_82_0 + arg_82_0 then
				...
				local var_82_3 = arg_79_1:GetWordFromCfg(414161017)
