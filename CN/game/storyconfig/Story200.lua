return {
	Play100 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_48 = "10120"

			if arg_1_1.actors_[var_4_48] == nil then
				local var_4_49 = Asset.Load("Widget/System/Story/StoryExpression/" .. "10120")

				if not isNil(var_4_49) then
					local var_4_50 = Object.Instantiate(var_4_49, arg_1_1.canvasGo_.transform)

					var_4_50.transform:SetSiblingIndex(1)

					var_4_50.name = var_4_48
					var_4_50.transform.localPosition = Vector3.New(0, 100000, 0)
					arg_1_1.actors_[var_4_48] = var_4_50

					local var_4_51 = var_4_50:GetComponentsInChildren(typeof(Image), true):ToTable()

					if arg_1_1.isInRecall_ then
						for iter_4_2, iter_4_3 in ipairs(var_4_51) do
			...
			local var_4_52 = arg_1_1.actors_["10120"].transform
			local var_4_53 = 0

			if var_4_53 < arg_1_1.time_ and arg_1_1.time_ <= var_4_53 + arg_4_0 then
				arg_1_1.var_.moveOldPos10120 = var_4_52.localPosition
				var_4_52.localScale = Vector3.New(1, 1, 1)

				local var_4_54 = var_4_52.childCount

				for iter_4_4 = 0, var_4_54 - 1 do
					local var_4_55 = var_4_52:GetChild(iter_4_4)

					if var_4_55.name == "" or not string.find(var_4_55.name, "split") then
						var_4_55.gameObject:SetActive(true)
					else
						var_4_55.gameObject:SetActive(false)
					end
				end
			end
			...
			if var_4_53 <= arg_1_1.time_ and arg_1_1.time_ < var_4_53 + var_4_56 then
				local var_4_57 = (arg_1_1.time_ - var_4_53) / var_4_56
				local var_4_58 = Vector3.New(0, -260, -274.72)

				var_4_52.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos10120, var_4_58, var_4_57)
			end

			if arg_1_1.time_ >= var_4_53 + var_4_56 and arg_1_1.time_ < var_4_53 + var_4_56 + arg_4_0 then
				var_4_52.localPosition = Vector3.New(0, -260, -274.72)
			end

			local var_4_59 = "10022"

			if arg_1_1.actors_[var_4_59] == nil then
				local var_4_60 = Asset.Load("Widget/System/Story/StoryExpression/" .. "10022")

				if not isNil(var_4_60) then
					local var_4_61 = Object.Instantiate(var_4_60, arg_1_1.canvasGo_.transform)

					var_4_61.transform:SetSiblingIndex(1)

					var_4_61.name = var_4_59
					var_4_61.transform.localPosition = Vector3.New(0, 100000, 0)
					arg_1_1.actors_[var_4_59] = var_4_61

					local var_4_62 = var_4_61:GetComponentsInChildren(typeof(Image), true):ToTable()

					if arg_1_1.isInRecall_ then
						for iter_4_5, iter_4_6 in ipairs(var_4_62) do
			...
			local var_4_63 = arg_1_1.actors_["10022"].transform
			local var_4_64 = 0

			if var_4_64 < arg_1_1.time_ and arg_1_1.time_ <= var_4_64 + arg_4_0 then
				arg_1_1.var_.moveOldPos10022 = var_4_63.localPosition
				var_4_63.localScale = Vector3.New(1, 1, 1)

				arg_1_1:CheckSpriteTmpPos("10022", 5)

				local var_4_65 = var_4_63.childCount

				for iter_4_7 = 0, var_4_65 - 1 do
					local var_4_66 = var_4_63:GetChild(iter_4_7)

					if var_4_66.name == "" or not string.find(var_4_66.name, "split") then
						var_4_66.gameObject:SetActive(true)
					else
						var_4_66.gameObject:SetActive(false)
					end
				end
			end

			local var_4_67 = 0.001

			if var_4_64 <= arg_1_1.time_ and arg_1_1.time_ < var_4_64 + var_4_67 then
				local var_4_68 = (arg_1_1.time_ - var_4_64) / var_4_67
				local var_4_69 = Vector3.New(660, -350, -180)

				var_4_63.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos10022, var_4_69, var_4_68)
			end

			if arg_1_1.time_ >= var_4_64 + var_4_67 and arg_1_1.time_ < var_4_64 + var_4_67 + arg_4_0 then
				var_4_63.localPosition = Vector3.New(660, -350, -180)
			end
