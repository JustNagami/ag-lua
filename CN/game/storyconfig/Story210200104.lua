return {
	...
	Play1102004037 = function(arg_149_0, arg_149_1)
		...
		function arg_149_1.playNext_(arg_151_0)
			...
			arg_149_1:RecordChoiceLog(1102004037, 1102004038, 1102004038)
		end
		...
		function arg_283_1.onSingleLineUpdate_(arg_286_0)
			...
			if var_286_15 < arg_283_1.time_ and arg_283_1.time_ <= var_286_15 + arg_286_0 then
				...
				if not var_286_16 then
					var_286_16 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_in_keep"))
					var_286_16.name = "fantianxinlian3"
					arg_283_1.var_.effectfantianxinlian3 = var_286_16
				end

				local var_286_17 = var_286_14:Find("")

				if var_286_17 then
					var_286_16.transform.parent = var_286_17
				else
					var_286_16.transform.parent = var_286_14
				end

				var_286_16.transform.localPosition = Vector3.New(0, 0, 0)
				var_286_16.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_286_18 = manager.ui.mainCameraCom_
				local var_286_19 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_286_18.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_286_20 = var_286_16.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_286_21 = 15
				local var_286_22 = 2 * var_286_21 * Mathf.Tan(var_286_18.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_286_18.aspect
				local var_286_23 = 1
				local var_286_24 = 1.7777777777777777

				if var_286_24 < var_286_18.aspect then
					var_286_23 = var_286_22 / (2 * var_286_21 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_286_24)
				end

				for iter_286_2, iter_286_3 in ipairs(var_286_20) do
					local var_286_25 = iter_286_3.transform.localScale

					iter_286_3.transform.localScale = Vector3.New(var_286_25.x / var_286_19 * var_286_23, var_286_25.y / var_286_19, var_286_25.z)
				end
			end

			local var_286_26 = manager.ui.mainCamera.transform
			local var_286_27 = 1.5

			if var_286_27 < arg_283_1.time_ and arg_283_1.time_ <= var_286_27 + arg_286_0 then
				local var_286_28 = arg_283_1.var_.effectfantianxinlian3

				if var_286_28 then
					Object.Destroy(var_286_28)

					arg_283_1.var_.effectfantianxinlian3 = nil
				end
			end

			local var_286_29 = manager.ui.mainCamera.transform
			local var_286_30 = 1.7

			if var_286_30 < arg_283_1.time_ and arg_283_1.time_ <= var_286_30 + arg_286_0 then
				local var_286_31 = arg_283_1.var_.effectfantianxinlian4

				if not var_286_31 then
					var_286_31 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Zxuanguang_out"))
					var_286_31.name = "fantianxinlian4"
					arg_283_1.var_.effectfantianxinlian4 = var_286_31
				end

				local var_286_32 = var_286_29:Find("")

				if var_286_32 then
					var_286_31.transform.parent = var_286_32
				else
					var_286_31.transform.parent = var_286_29
				end

				var_286_31.transform.localPosition = Vector3.New(0, 0, 0)
				var_286_31.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_286_33 = manager.ui.mainCameraCom_
				local var_286_34 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_286_33.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_286_35 = var_286_31.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_286_36 = 15
				local var_286_37 = 2 * var_286_36 * Mathf.Tan(var_286_33.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_286_33.aspect
				local var_286_38 = 1
				local var_286_39 = 1.7777777777777777

				if var_286_39 < var_286_33.aspect then
					var_286_38 = var_286_37 / (2 * var_286_36 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_286_39)
				end

				for iter_286_4, iter_286_5 in ipairs(var_286_35) do
					local var_286_40 = iter_286_5.transform.localScale

					iter_286_5.transform.localScale = Vector3.New(var_286_40.x / var_286_34 * var_286_38, var_286_40.y / var_286_34, var_286_40.z)
				end
			end

			local var_286_41 = arg_283_1.bgs_.R2001.transform
			local var_286_42 = 1.46666666666667

			if var_286_42 < arg_283_1.time_ and arg_283_1.time_ <= var_286_42 + arg_286_0 then
				arg_283_1.var_.moveOldPosR2001 = var_286_41.localPosition
			end

			local var_286_43 = 0.001

			if var_286_42 <= arg_283_1.time_ and arg_283_1.time_ < var_286_42 + var_286_43 then
				local var_286_44 = (arg_283_1.time_ - var_286_42) / var_286_43
				local var_286_45 = Vector3.New(0, 1, 9.5)

				var_286_41.localPosition = Vector3.Lerp(arg_283_1.var_.moveOldPosR2001, var_286_45, var_286_44)
			end

			if arg_283_1.time_ >= var_286_42 + var_286_43 and arg_283_1.time_ < var_286_42 + var_286_43 + arg_286_0 then
				var_286_41.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_286_46 = arg_283_1.bgs_.R2001.transform
			local var_286_47 = 1.5

			if var_286_47 < arg_283_1.time_ and arg_283_1.time_ <= var_286_47 + arg_286_0 then
				arg_283_1.var_.moveOldPosR2001 = var_286_46.localPosition
			end

			local var_286_48 = 4

			if var_286_47 <= arg_283_1.time_ and arg_283_1.time_ < var_286_47 + var_286_48 then
				local var_286_49 = (arg_283_1.time_ - var_286_47) / var_286_48
				local var_286_50 = Vector3.New(0, 1, 10)

				var_286_46.localPosition = Vector3.Lerp(arg_283_1.var_.moveOldPosR2001, var_286_50, var_286_49)
			end

			if arg_283_1.time_ >= var_286_47 + var_286_48 and arg_283_1.time_ < var_286_47 + var_286_48 + arg_286_0 then
				var_286_46.localPosition = Vector3.New(0, 1, 10)
			end

			local var_286_51 = 3.2

			if var_286_51 < arg_283_1.time_ and arg_283_1.time_ <= var_286_51 + arg_286_0 then
				arg_283_1.allBtn_.enabled = false
			end

			local var_286_52 = 2.4
			...
			local var_286_53 = 2.5
			local var_286_54 = 0.825
			...
			if var_286_53 < arg_283_1.time_ and arg_283_1.time_ <= var_286_53 + arg_286_0 then
				...
				local var_286_55 = LeanTween.value(arg_283_1.dialog_, 0, 1, 0.3)

				var_286_55:setOnUpdate(LuaHelper.FloatAction(function(arg_287_0)
					arg_283_1.dialogCg_.alpha = arg_287_0
				end))
				var_286_55:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_283_1.dialog_)
					var_286_55:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_286_56 = arg_283_1:GetWordFromCfg(1102004069)
				local var_286_57 = arg_283_1:FormatText(var_286_56.content)

				arg_283_1.text_.text = var_286_57

				LuaForUtil.ClearLinePrefixSymbol(arg_283_1.text_)

				local var_286_58 = 33
				local var_286_59 = utf8.len(var_286_57)
				local var_286_60 = var_286_58 <= 0 and var_286_54 or var_286_54 * (var_286_59 / var_286_58)

				if var_286_60 > 0 and var_286_54 < var_286_60 then
					arg_283_1.talkMaxDuration = var_286_60
					var_286_53 = var_286_53 + 0.3

					if var_286_60 + var_286_53 > arg_283_1.duration_ then
						arg_283_1.duration_ = var_286_60 + var_286_53
					end
				end
			...
			local var_286_61 = var_286_53 + 0.3
			local var_286_62 = math.max(var_286_54, arg_283_1.talkMaxDuration)

			if var_286_61 <= arg_283_1.time_ and arg_283_1.time_ < var_286_61 + var_286_62 then
				arg_283_1.typewritter.percent = (arg_283_1.time_ - var_286_61) / var_286_62

				arg_283_1.typewritter:SetDirty()
			end

			if arg_283_1.time_ >= var_286_61 + var_286_62 and arg_283_1.time_ < var_286_61 + var_286_62 + arg_286_0 then
	...
	Play1102004084 = function(arg_347_0, arg_347_1)
		...
		function arg_347_1.playNext_(arg_349_0)
			...
			arg_347_1:RecordChoiceLog(1102004084, 1102004085)
		end
	...
	assets = {
		...
		"Assets/UIResources/UI_AB/TextureConfig/Background/R2001",
		"Assets/UIResources/UI_AB/TextureConfig/Background/R2001a",
