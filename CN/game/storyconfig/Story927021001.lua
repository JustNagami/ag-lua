return {
	Play927021001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_22 = 1.93333333333333
			...
			local var_4_29 = arg_1_1.actors_["1211ui_story"]
			local var_4_30 = 1.93333333333333

			if var_4_30 < arg_1_1.time_ and arg_1_1.time_ <= var_4_30 + arg_4_0 and not isNil(var_4_29) and arg_1_1.var_.characterEffect1211ui_story == nil then
				arg_1_1.var_.characterEffect1211ui_story = var_4_29:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_4_30 <= arg_1_1.time_ and arg_1_1.time_ < var_4_30 + var_4_31 and not isNil(var_4_29) then
				...
				if arg_1_1.var_.characterEffect1211ui_story and not isNil(var_4_29) then
					local var_4_33 = Mathf.Lerp(0, 0.5, var_4_32)

					arg_1_1.var_.characterEffect1211ui_story.fillFlat = true
					arg_1_1.var_.characterEffect1211ui_story.fillRatio = var_4_33
				end
			end

			if arg_1_1.time_ >= var_4_30 + var_4_31 and arg_1_1.time_ < var_4_30 + var_4_31 + arg_4_0 and not isNil(var_4_29) and arg_1_1.var_.characterEffect1211ui_story then
				local var_4_34 = 0.5

				arg_1_1.var_.characterEffect1211ui_story.fillFlat = true
				arg_1_1.var_.characterEffect1211ui_story.fillRatio = var_4_34
			end

			local var_4_35 = arg_1_1.actors_["1211ui_story"].transform
			local var_4_36 = 1.93333333333333

			if var_4_36 < arg_1_1.time_ and arg_1_1.time_ <= var_4_36 + arg_4_0 then
				arg_1_1.var_.moveOldPos1211ui_story = var_4_35.localPosition
			end
			...
			if var_4_36 <= arg_1_1.time_ and arg_1_1.time_ < var_4_36 + var_4_37 then
				...
				local var_4_39 = Vector3.New(0, -0.67, -6.07)

				var_4_35.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1211ui_story, var_4_39, var_4_38)

				local var_4_40 = manager.ui.mainCamera.transform.position - var_4_35.position

				var_4_35.forward = Vector3.New(var_4_40.x, var_4_40.y, var_4_40.z)

				local var_4_41 = var_4_35.localEulerAngles

				var_4_41.z = 0
				var_4_41.x = 0
				var_4_35.localEulerAngles = var_4_41
			end

			if arg_1_1.time_ >= var_4_36 + var_4_37 and arg_1_1.time_ < var_4_36 + var_4_37 + arg_4_0 then
				var_4_35.localPosition = Vector3.New(0, -0.67, -6.07)

				local var_4_42 = manager.ui.mainCamera.transform.position - var_4_35.position

				var_4_35.forward = Vector3.New(var_4_42.x, var_4_42.y, var_4_42.z)

				local var_4_43 = var_4_35.localEulerAngles

				var_4_43.z = 0
				var_4_43.x = 0
				var_4_35.localEulerAngles = var_4_43
			end

			local var_4_44 = 1.93333333333333

			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				arg_1_1:PlayTimeline("1211ui_story", "StoryTimeline/CharAction/story1211/story1211action/1211action1_1")
			end

			local var_4_45 = 1.93333333333333
			...
			if var_4_46 < arg_1_1.time_ and arg_1_1.time_ <= var_4_46 + arg_4_0 then
				...
				local var_4_50 = arg_1_1:GetWordFromCfg(927021001)
	...
	Play927021002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_0 < arg_7_1.time_ and arg_7_1.time_ <= var_10_0 + arg_10_0 then
				...
				local var_10_3 = arg_7_1:GetWordFromCfg(927021002)
	...
	Play927021003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_0 < arg_11_1.time_ and arg_11_1.time_ <= var_14_0 + arg_14_0 then
				...
				local var_14_3 = arg_11_1:GetWordFromCfg(927021003)
	...
	Play927021004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			local var_18_9 = arg_15_1.actors_["1211ui_story"]
			local var_18_10 = 0

			if var_18_10 < arg_15_1.time_ and arg_15_1.time_ <= var_18_10 + arg_18_0 and not isNil(var_18_9) and arg_15_1.var_.characterEffect1211ui_story == nil then
				arg_15_1.var_.characterEffect1211ui_story = var_18_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_18_10 <= arg_15_1.time_ and arg_15_1.time_ < var_18_10 + var_18_11 and not isNil(var_18_9) then
				...
				if arg_15_1.var_.characterEffect1211ui_story and not isNil(var_18_9) then
					arg_15_1.var_.characterEffect1211ui_story.fillFlat = false
				end
			end

			if arg_15_1.time_ >= var_18_10 + var_18_11 and arg_15_1.time_ < var_18_10 + var_18_11 + arg_18_0 and not isNil(var_18_9) and arg_15_1.var_.characterEffect1211ui_story then
				arg_15_1.var_.characterEffect1211ui_story.fillFlat = false
			end
			...
			if var_18_15 < arg_15_1.time_ and arg_15_1.time_ <= var_18_15 + arg_18_0 then
				...
				local var_18_18 = arg_15_1:GetWordFromCfg(927021004)
	...
	Play927021005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_9 < arg_19_1.time_ and arg_19_1.time_ <= var_22_9 + arg_22_0 then
				...
				local var_22_12 = arg_19_1:GetWordFromCfg(927021005)
	...
	Play927021006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			local var_26_0 = arg_23_1.actors_["1211ui_story"].transform
			local var_26_1 = 0

			if var_26_1 < arg_23_1.time_ and arg_23_1.time_ <= var_26_1 + arg_26_0 then
				arg_23_1.var_.moveOldPos1211ui_story = var_26_0.localPosition
			end
			...
			if var_26_1 <= arg_23_1.time_ and arg_23_1.time_ < var_26_1 + var_26_2 then
				...
				local var_26_4 = Vector3.New(0, -0.67, -6.07)

				var_26_0.localPosition = Vector3.Lerp(arg_23_1.var_.moveOldPos1211ui_story, var_26_4, var_26_3)
			...
			if arg_23_1.time_ >= var_26_1 + var_26_2 and arg_23_1.time_ < var_26_1 + var_26_2 + arg_26_0 then
				var_26_0.localPosition = Vector3.New(0, -0.67, -6.07)
			...
			if var_26_10 < arg_23_1.time_ and arg_23_1.time_ <= var_26_10 + arg_26_0 then
				...
				local var_26_13 = arg_23_1:GetWordFromCfg(927021006)
	...
	Play927021007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_10 < arg_27_1.time_ and arg_27_1.time_ <= var_30_10 + arg_30_0 then
				...
				local var_30_12 = arg_27_1:FormatText(StoryNameCfg[37].name)
				...
				local var_30_13 = arg_27_1:GetWordFromCfg(927021007)
