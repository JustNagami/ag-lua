return {
	Play62107001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_16] == nil then
				local var_4_17 = Asset.Load("Char/" .. "1111ui_story")

				if not isNil(var_4_17) then
					local var_4_18 = Object.Instantiate(Asset.Load("Char/" .. "1111ui_story"), arg_1_1.stage_.transform)
			...
			local var_4_21 = arg_1_1.actors_["1111ui_story"].transform
			local var_4_22 = 1.8

			if var_4_22 < arg_1_1.time_ and arg_1_1.time_ <= var_4_22 + arg_4_0 then
				arg_1_1.var_.moveOldPos1111ui_story = var_4_21.localPosition
			end
			...
			if var_4_22 <= arg_1_1.time_ and arg_1_1.time_ < var_4_22 + var_4_23 then
				...
				local var_4_25 = Vector3.New(0, -0.87, -5.7)

				var_4_21.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1111ui_story, var_4_25, var_4_24)
			...
			if arg_1_1.time_ >= var_4_22 + var_4_23 and arg_1_1.time_ < var_4_22 + var_4_23 + arg_4_0 then
				var_4_21.localPosition = Vector3.New(0, -0.87, -5.7)
			...
			if var_4_54 < arg_1_1.time_ and arg_1_1.time_ <= var_4_54 + arg_4_0 then
				...
				local var_4_58 = arg_1_1:GetWordFromCfg(62107001)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62107", "62107001", "story_v_chess_62107.awb") ~= 0 then
					local var_4_63 = manager.audio:GetVoiceLength("story_v_chess_62107", "62107001", "story_v_chess_62107.awb") / 1000
					...
					if var_4_58.prefab_name ~= "" and arg_1_1.actors_[var_4_58.prefab_name] ~= nil then
						local var_4_64 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_58.prefab_name].transform, "story_v_chess_62107", "62107001", "story_v_chess_62107.awb")

						arg_1_1:RecordAudio("62107001", var_4_64)
						arg_1_1:RecordAudio("62107001", var_4_64)
					else
	...
	Play62107002 = function(arg_9_0, arg_9_1)
		arg_9_1.time_ = 0
		arg_9_1.frameCnt_ = 0
		arg_9_1.state_ = "playing"
		arg_9_1.curTalkId_ = 62107002
		arg_9_1.duration_ = 5
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_6 < arg_9_1.time_ and arg_9_1.time_ <= var_12_6 + arg_12_0 then
				...
				local var_12_9 = arg_9_1:GetWordFromCfg(62107002)
	...
	Play62107003 = function(arg_13_0, arg_13_1)
		arg_13_1.time_ = 0
		arg_13_1.frameCnt_ = 0
		arg_13_1.state_ = "playing"
		arg_13_1.curTalkId_ = 62107003
		arg_13_1.duration_ = 5.17
		...
		function arg_13_1.playNext_(arg_15_0)
			if arg_15_0 == 1 then
				arg_13_0:Play62107004(arg_13_1)
			end
		end
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_0 < arg_13_1.time_ and arg_13_1.time_ <= var_16_0 + arg_16_0 then
				arg_13_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111actionlink/1111action454")
			end
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_9 = arg_13_1:GetWordFromCfg(62107003)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62107", "62107003", "story_v_chess_62107.awb") ~= 0 then
					local var_16_14 = manager.audio:GetVoiceLength("story_v_chess_62107", "62107003", "story_v_chess_62107.awb") / 1000
					...
					if var_16_9.prefab_name ~= "" and arg_13_1.actors_[var_16_9.prefab_name] ~= nil then
						local var_16_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_9.prefab_name].transform, "story_v_chess_62107", "62107003", "story_v_chess_62107.awb")

						arg_13_1:RecordAudio("62107003", var_16_15)
						arg_13_1:RecordAudio("62107003", var_16_15)
					else
						arg_13_1:AudioAction("play", "voice", "story_v_chess_62107", "62107003", "story_v_chess_62107.awb")
					end

					arg_13_1:RecordHistoryTalkVoice("story_v_chess_62107", "62107003", "story_v_chess_62107.awb")
				end
	...
	Play62107004 = function(arg_17_0, arg_17_1)
		arg_17_1.time_ = 0
		arg_17_1.frameCnt_ = 0
		arg_17_1.state_ = "playing"
		arg_17_1.curTalkId_ = 62107004
		...
		function arg_17_1.playNext_(arg_19_0)
			if arg_19_0 == 1 then
				arg_17_0:Play62107005(arg_17_1)
			end
		end
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_6 < arg_17_1.time_ and arg_17_1.time_ <= var_20_6 + arg_20_0 then
				...
				local var_20_9 = arg_17_1:GetWordFromCfg(62107004)
	...
	Play62107005 = function(arg_21_0, arg_21_1)
		arg_21_1.time_ = 0
		arg_21_1.frameCnt_ = 0
		arg_21_1.state_ = "playing"
		arg_21_1.curTalkId_ = 62107005
		...
		function arg_21_1.playNext_(arg_23_0)
			if arg_23_0 == 1 then
				arg_21_0:Play62107006(arg_21_1)
			end
		end
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				arg_21_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action4_2")
			end
			...
			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:GetWordFromCfg(62107005)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62107", "62107005", "story_v_chess_62107.awb") ~= 0 then
					local var_24_14 = manager.audio:GetVoiceLength("story_v_chess_62107", "62107005", "story_v_chess_62107.awb") / 1000
					...
					if var_24_9.prefab_name ~= "" and arg_21_1.actors_[var_24_9.prefab_name] ~= nil then
						local var_24_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_9.prefab_name].transform, "story_v_chess_62107", "62107005", "story_v_chess_62107.awb")

						arg_21_1:RecordAudio("62107005", var_24_15)
						arg_21_1:RecordAudio("62107005", var_24_15)
					else
						arg_21_1:AudioAction("play", "voice", "story_v_chess_62107", "62107005", "story_v_chess_62107.awb")
					end

					arg_21_1:RecordHistoryTalkVoice("story_v_chess_62107", "62107005", "story_v_chess_62107.awb")
				end
	...
	Play62107006 = function(arg_25_0, arg_25_1)
		arg_25_1.time_ = 0
		arg_25_1.frameCnt_ = 0
		arg_25_1.state_ = "playing"
		arg_25_1.curTalkId_ = 62107006
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_6 < arg_25_1.time_ and arg_25_1.time_ <= var_28_6 + arg_28_0 then
				...
				local var_28_9 = arg_25_1:GetWordFromCfg(62107006)
