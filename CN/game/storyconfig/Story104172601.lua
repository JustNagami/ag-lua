return {
	...
	Play417261040 = function(arg_164_0, arg_164_1)
		...
		function arg_164_1.onSingleLineUpdate_(arg_167_0)
			...
			if var_167_59 < arg_164_1.time_ and arg_164_1.time_ <= var_167_59 + arg_167_0 then
				...
				arg_164_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image").enabled = true
	...
	Play417261059 = function(arg_242_0, arg_242_1)
		...
		function arg_242_1.onSingleLineUpdate_(arg_245_0)
			...
			if var_245_43 < arg_242_1.time_ and arg_242_1.time_ <= var_245_43 + arg_245_0 then
				...
				arg_242_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image").enabled = true
	...
	Play417261060 = function(arg_247_0, arg_247_1)
		...
		function arg_247_1.onSingleLineUpdate_(arg_250_0)
			...
			if var_250_0 < arg_247_1.time_ and arg_247_1.time_ <= var_250_0 + arg_250_0 then
				...
				arg_247_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image").enabled = true
	...
	Play417261086 = function(arg_354_0, arg_354_1)
		...
		function arg_354_1.onSingleLineUpdate_(arg_357_0)
			...
			if var_357_29 < arg_354_1.time_ and arg_354_1.time_ <= var_357_29 + arg_357_0 then
				...
				arg_354_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image").enabled = true
	...
	Play417261087 = function(arg_358_0, arg_358_1)
		...
		function arg_358_1.onSingleLineUpdate_(arg_361_0)
			...
			if var_361_0 < arg_358_1.time_ and arg_358_1.time_ <= var_361_0 + arg_361_0 then
				...
				arg_358_1.fswbg_.transform:Find("textbox/bg"):GetComponent("Image").enabled = true
	...
	Play417261088 = function(arg_362_0, arg_362_1)
		...
		function arg_362_1.onSingleLineUpdate_(arg_365_0)
			...
			local var_365_50 = 1.33333333333333
			local var_365_51 = 1

			if var_365_50 < arg_362_1.time_ and arg_362_1.time_ <= var_365_50 + arg_365_0 then
				local var_365_52 = "play"
				local var_365_53 = "effect"

				arg_362_1:AudioAction(var_365_52, var_365_53, "se_story_1311", "se_story_1311_thunder03", "")
			end

			local var_365_54 = manager.ui.mainCamera.transform
			local var_365_55 = 1.33333333333333

			if var_365_55 < arg_362_1.time_ and arg_362_1.time_ <= var_365_55 + arg_365_0 then
				local var_365_56 = arg_362_1.var_.effect10892

				if not var_365_56 then
					var_365_56 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_Lightning_in"))
					var_365_56.name = "10892"
					arg_362_1.var_.effect10892 = var_365_56
				end

				local var_365_57 = var_365_54:Find("")

				if var_365_57 then
					var_365_56.transform.parent = var_365_57
				else
					var_365_56.transform.parent = var_365_54
				end

				var_365_56.transform.localPosition = Vector3.New(0, 0, 0)
				var_365_56.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_365_58 = manager.ui.mainCameraCom_
				local var_365_59 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_365_58.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_365_60 = var_365_56.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_365_61 = 15
				local var_365_62 = 2 * var_365_61 * Mathf.Tan(var_365_58.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_365_58.aspect
				local var_365_63 = 1
				local var_365_64 = 1.7777777777777777

				if var_365_64 < var_365_58.aspect then
					var_365_63 = var_365_62 / (2 * var_365_61 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_365_64)
				end

				for iter_365_2, iter_365_3 in ipairs(var_365_60) do
					local var_365_65 = iter_365_3.transform.localScale

					iter_365_3.transform.localScale = Vector3.New(var_365_65.x / var_365_59 * var_365_63, var_365_65.y / var_365_59, var_365_65.z)
				end
			end

			local var_365_66 = manager.ui.mainCamera.transform
			local var_365_67 = 2.225

			if var_365_67 < arg_362_1.time_ and arg_362_1.time_ <= var_365_67 + arg_365_0 then
				local var_365_68 = arg_362_1.var_.effect10892

				if var_365_68 then
					Object.Destroy(var_365_68)
	...
	Play417261089 = function(arg_366_0, arg_366_1)
		...
		function arg_366_1.onSingleLineUpdate_(arg_369_0)
			...
			if var_369_28 < arg_366_1.time_ and arg_366_1.time_ <= var_369_28 + arg_369_0 then
				local var_369_30 = "play"
				local var_369_31 = "effect"

				arg_366_1:AudioAction(var_369_30, var_369_31, "se_story_1212", "se_story_1210_thunderrain_loop", "")
			end
		end
	end,
	assets = {
