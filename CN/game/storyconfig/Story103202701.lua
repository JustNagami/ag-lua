	...
	Play320271087 = function(arg_359_0, arg_359_1)
		...
		function arg_359_1.onSingleLineUpdate_(arg_362_0)
			...
			if var_362_14 < arg_359_1.time_ and arg_359_1.time_ <= var_362_14 + arg_362_0 then
				arg_359_1:PlayTimeline("10101ui_story", "StoryTimeline/CharAction/public_expression/expr_kuaileC_biyan")
			end
		...
		function arg_385_1.onSingleLineUpdate_(arg_388_0)
			...
			if var_388_1 < arg_385_1.time_ and arg_385_1.time_ <= var_388_1 + arg_388_0 then
				...
				if not var_388_2 then
					var_388_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in_1"))
					var_388_2.name = "123"
					arg_385_1.var_.effect123 = var_388_2
				end

				local var_388_3 = var_388_0:Find("")

				if var_388_3 then
					var_388_2.transform.parent = var_388_3
				else
					var_388_2.transform.parent = var_388_0
				end
			...
			local var_388_5 = 1.53333333333333

			if var_388_5 < arg_385_1.time_ and arg_385_1.time_ <= var_388_5 + arg_388_0 then
				local var_388_6 = arg_385_1.var_.effect124

				if not var_388_6 then
					var_388_6 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in_1"))
					var_388_6.name = "124"
					arg_385_1.var_.effect124 = var_388_6
				end

				local var_388_7 = var_388_4:Find("")

				if var_388_7 then
					var_388_6.transform.parent = var_388_7
				else
					var_388_6.transform.parent = var_388_4
				end

				var_388_6.transform.localPosition = Vector3.New(0.04, -0.02, 0)
				var_388_6.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_388_8 = manager.ui.mainCamera.transform
			local var_388_9 = 2.63333333333333

			if var_388_9 < arg_385_1.time_ and arg_385_1.time_ <= var_388_9 + arg_388_0 then
				local var_388_10 = arg_385_1.var_.effect125

				if not var_388_10 then
					var_388_10 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_blood_in_1"))
					var_388_10.name = "125"
					arg_385_1.var_.effect125 = var_388_10
				end

				local var_388_11 = var_388_8:Find("")

				if var_388_11 then
					var_388_10.transform.parent = var_388_11
				else
					var_388_10.transform.parent = var_388_8
				end

				var_388_10.transform.localPosition = Vector3.New(0.06, -0.08, 0)
				var_388_10.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end

			local var_388_12 = manager.ui.mainCamera.transform
			local var_388_13 = 0

			if var_388_13 < arg_385_1.time_ and arg_385_1.time_ <= var_388_13 + arg_388_0 then
				local var_388_14 = arg_385_1.var_.effect777

				if not var_388_14 then
					var_388_14 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_burning"))
					var_388_14.name = "777"
					arg_385_1.var_.effect777 = var_388_14
				end

				local var_388_15 = var_388_12:Find("")

				if var_388_15 then
					var_388_14.transform.parent = var_388_15
				else
					var_388_14.transform.parent = var_388_12
				end

				var_388_14.transform.localPosition = Vector3.New(0, 0, 0)
				var_388_14.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			local var_388_17 = 0.666666666666667
			...
			if var_388_16 <= arg_385_1.time_ and arg_385_1.time_ < var_388_16 + var_388_17 then
				...
				local var_388_19 = Color.New(0.3301887, 0.06385724, 0.06385724)
			...
			if arg_385_1.time_ >= var_388_16 + var_388_17 and arg_385_1.time_ < var_388_16 + var_388_17 + arg_388_0 then
				local var_388_20 = Color.New(0.3301887, 0.06385724, 0.06385724)
				local var_388_21 = 0
			...
			local var_388_24 = 0.333333333333333
			local var_388_25 = 1

			if var_388_24 < arg_385_1.time_ and arg_385_1.time_ <= var_388_24 + arg_388_0 then
				local var_388_26 = "play"
				local var_388_27 = "effect"

				arg_385_1:AudioAction(var_388_26, var_388_27, "se_story_15", "se_story_15_gun02", "")
			end
			...
			local var_388_28 = 1.13333333333333
			local var_388_29 = 1.8
			...
			if var_388_28 < arg_385_1.time_ and arg_385_1.time_ <= var_388_28 + arg_388_0 then
				...
				local var_388_30 = LeanTween.value(arg_385_1.dialog_, 0, 1, 0.3)

				var_388_30:setOnUpdate(LuaHelper.FloatAction(function(arg_389_0)
					arg_385_1.dialogCg_.alpha = arg_389_0
				end))
				var_388_30:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_385_1.dialog_)
					var_388_30:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_388_31 = arg_385_1:GetWordFromCfg(320271093)
			...
			local var_388_36 = var_388_28 + 0.3
			local var_388_37 = math.max(var_388_29, arg_385_1.talkMaxDuration)
		...
		function arg_415_1.onSingleLineUpdate_(arg_418_0)
			...
			if var_418_24 < arg_415_1.time_ and arg_415_1.time_ <= var_418_24 + arg_418_0 then
				...
				if not var_418_25 then
					var_418_25 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_dust"))
					var_418_25.name = "999"
					arg_415_1.var_.effect999 = var_418_25
				end

				local var_418_26 = var_418_23:Find("")

				if var_418_26 then
					var_418_25.transform.parent = var_418_26
				else
					var_418_25.transform.parent = var_418_23
				end
			...
			local var_418_27 = manager.ui.mainCamera.transform
			local var_418_28 = 3.2

			if var_418_28 < arg_415_1.time_ and arg_415_1.time_ <= var_418_28 + arg_418_0 then
				local var_418_29 = arg_415_1.var_.effect999

				if var_418_29 then
					Object.Destroy(var_418_29)

					arg_415_1.var_.effect999 = nil
				end
			end

			local var_418_30 = 1.03333333333333
			local var_418_31 = 1
			...
			if var_418_30 < arg_415_1.time_ and arg_415_1.time_ <= var_418_30 + arg_418_0 then
				...
				arg_415_1:AudioAction(var_418_32, var_418_33, "se_story_16", "se_story_16_fight04_loop", "")
			end
			...
			local var_418_34 = 2.5
			local var_418_35 = 1.775
			...
			if var_418_34 < arg_415_1.time_ and arg_415_1.time_ <= var_418_34 + arg_418_0 then
				...
				local var_418_36 = LeanTween.value(arg_415_1.dialog_, 0, 1, 0.3)

				var_418_36:setOnUpdate(LuaHelper.FloatAction(function(arg_419_0)
					arg_415_1.dialogCg_.alpha = arg_419_0
				end))
				var_418_36:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_415_1.dialog_)
					var_418_36:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_418_37 = arg_415_1:GetWordFromCfg(320271100)
				...
				local var_418_41 = var_418_39 <= 0 and var_418_35 or var_418_35 * (var_418_40 / var_418_39)

				if var_418_41 > 0 and var_418_35 < var_418_41 then
					arg_415_1.talkMaxDuration = var_418_41
					var_418_34 = var_418_34 + 0.3

					if var_418_41 + var_418_34 > arg_415_1.duration_ then
						arg_415_1.duration_ = var_418_41 + var_418_34
					end
				end
			...
			local var_418_42 = var_418_34 + 0.3
			local var_418_43 = math.max(var_418_35, arg_415_1.talkMaxDuration)
