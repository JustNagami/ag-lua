	...
	Play62105001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				local var_4_38 = arg_1_1:GetWordFromCfg(62105001)
	...
	Play62105002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_20 < arg_9_1.time_ and arg_9_1.time_ <= var_12_20 + arg_12_0 then
				...
				local var_12_23 = arg_9_1:GetWordFromCfg(62105002)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62105", "62105002", "story_v_chess_62105.awb") ~= 0 then
					local var_12_28 = manager.audio:GetVoiceLength("story_v_chess_62105", "62105002", "story_v_chess_62105.awb") / 1000
					...
					if var_12_23.prefab_name ~= "" and arg_9_1.actors_[var_12_23.prefab_name] ~= nil then
						local var_12_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_23.prefab_name].transform, "story_v_chess_62105", "62105002", "story_v_chess_62105.awb")

						arg_9_1:RecordAudio("62105002", var_12_29)
						arg_9_1:RecordAudio("62105002", var_12_29)
					else
	...
	Play62105003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_6 < arg_13_1.time_ and arg_13_1.time_ <= var_16_6 + arg_16_0 then
				...
				local var_16_9 = arg_13_1:GetWordFromCfg(62105003)
	...
	Play62105004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_5 < arg_17_1.time_ and arg_17_1.time_ <= var_20_5 + arg_20_0 then
				...
				local var_20_8 = arg_17_1:GetWordFromCfg(62105004)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62105", "62105004", "story_v_chess_62105.awb") ~= 0 then
					local var_20_13 = manager.audio:GetVoiceLength("story_v_chess_62105", "62105004", "story_v_chess_62105.awb") / 1000
					...
					if var_20_8.prefab_name ~= "" and arg_17_1.actors_[var_20_8.prefab_name] ~= nil then
						local var_20_14 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_8.prefab_name].transform, "story_v_chess_62105", "62105004", "story_v_chess_62105.awb")

						arg_17_1:RecordAudio("62105004", var_20_14)
						arg_17_1:RecordAudio("62105004", var_20_14)
					else
	...
	Play62105005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_0 < arg_21_1.time_ and arg_21_1.time_ <= var_24_0 + arg_24_0 then
				arg_21_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111actionlink/1111action454")
			end
			...
			if var_24_6 < arg_21_1.time_ and arg_21_1.time_ <= var_24_6 + arg_24_0 then
				...
				local var_24_9 = arg_21_1:GetWordFromCfg(62105005)
				...
				if manager.audio:GetVoiceLength("story_v_chess_62105", "62105005", "story_v_chess_62105.awb") ~= 0 then
					local var_24_14 = manager.audio:GetVoiceLength("story_v_chess_62105", "62105005", "story_v_chess_62105.awb") / 1000
					...
					if var_24_9.prefab_name ~= "" and arg_21_1.actors_[var_24_9.prefab_name] ~= nil then
						local var_24_15 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_9.prefab_name].transform, "story_v_chess_62105", "62105005", "story_v_chess_62105.awb")

						arg_21_1:RecordAudio("62105005", var_24_15)
						arg_21_1:RecordAudio("62105005", var_24_15)
					else
