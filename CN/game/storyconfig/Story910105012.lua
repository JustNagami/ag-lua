return {
	...
	Play910112099 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if arg_9_1.actors_[var_12_0] == nil then
				local var_12_1 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1070")
			...
			local var_12_4 = arg_9_1.actors_["1070"]
			local var_12_5 = 0
			...
			if var_12_5 < arg_9_1.time_ and arg_9_1.time_ <= var_12_5 + arg_12_0 then
				...
				if var_12_6 then
					arg_9_1.var_.alphaOldValue1070 = var_12_6.alpha
					arg_9_1.var_.characterEffect1070 = var_12_6
				end
			...
			if var_12_5 <= arg_9_1.time_ and arg_9_1.time_ < var_12_5 + var_12_7 then
				...
				local var_12_9 = Mathf.Lerp(arg_9_1.var_.alphaOldValue1070, 1, var_12_8)

				if arg_9_1.var_.characterEffect1070 then
					arg_9_1.var_.characterEffect1070.alpha = var_12_9
				end
			end

			if arg_9_1.time_ >= var_12_5 + var_12_7 and arg_9_1.time_ < var_12_5 + var_12_7 + arg_12_0 and arg_9_1.var_.characterEffect1070 then
				arg_9_1.var_.characterEffect1070.alpha = 1
			end

			local var_12_10 = arg_9_1.actors_["1070"].transform
			local var_12_11 = 0

			if var_12_11 < arg_9_1.time_ and arg_9_1.time_ <= var_12_11 + arg_12_0 then
				arg_9_1.var_.moveOldPos1070 = var_12_10.localPosition
				...
				for iter_12_2 = 0, var_12_12 - 1 do
					...
					if var_12_13.name == "split_2" or not string.find(var_12_13.name, "split") then
			...
			if var_12_11 <= arg_9_1.time_ and arg_9_1.time_ < var_12_11 + var_12_14 then
				...
				local var_12_16 = Vector3.New(0, -350, -180)

				var_12_10.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1070, var_12_16, var_12_15)
			end

			if arg_9_1.time_ >= var_12_11 + var_12_14 and arg_9_1.time_ < var_12_11 + var_12_14 + arg_12_0 then
				var_12_10.localPosition = Vector3.New(0, -350, -180)
			end

			local var_12_17 = arg_9_1.actors_["1070"]
			local var_12_18 = 0

			if var_12_18 < arg_9_1.time_ and arg_9_1.time_ <= var_12_18 + arg_12_0 and not isNil(var_12_17) and arg_9_1.var_.actorSpriteComps1070 == nil then
				arg_9_1.var_.actorSpriteComps1070 = var_12_17:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_9_1.time_ >= var_12_18 + var_12_19 and arg_9_1.time_ < var_12_18 + var_12_19 + arg_12_0 and not isNil(var_12_17) and arg_9_1.var_.actorSpriteComps1070 then
			...
			if var_12_25 < arg_9_1.time_ and arg_9_1.time_ <= var_12_25 + arg_12_0 then
				...
				local var_12_27 = arg_9_1:FormatText(StoryNameCfg[318].name)
				...
				local var_12_28 = arg_9_1:GetWordFromCfg(910112099)
	...
	Play910112100 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_1 < arg_13_1.time_ and arg_13_1.time_ <= var_16_1 + arg_16_0 and not isNil(var_16_0) and arg_13_1.var_.actorSpriteComps1070 == nil then
			...
			if arg_13_1.time_ >= var_16_1 + var_16_2 and arg_13_1.time_ < var_16_1 + var_16_2 + arg_16_0 and not isNil(var_16_0) and arg_13_1.var_.actorSpriteComps1070 then
			...
			if var_16_8 < arg_13_1.time_ and arg_13_1.time_ <= var_16_8 + arg_16_0 then
				...
				local var_16_11 = arg_13_1:GetWordFromCfg(910112100)
	...
	Play910112101 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_15 < arg_17_1.time_ and arg_17_1.time_ <= var_20_15 + arg_20_0 then
				...
				local var_20_18 = arg_17_1:GetWordFromCfg(910112101)
	...
	Play910112103 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_15 < arg_25_1.time_ and arg_25_1.time_ <= var_28_15 + arg_28_0 then
				...
				local var_28_17 = arg_25_1:GetWordFromCfg(910112103)
