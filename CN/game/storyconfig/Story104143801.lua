return {
	Play414381001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_28 = 1.76666666666733
			...
			local var_4_37 = 1.76666666666733
			...
			local var_4_40 = 1.76666666666733
			...
			if var_4_42 < arg_1_1.time_ and arg_1_1.time_ <= var_4_42 + arg_4_0 then
				...
				local var_4_45 = arg_1_1:FormatText(StoryNameCfg[562].name)
				...
				local var_4_46 = arg_1_1:GetWordFromCfg(414381001)
	...
	Play414381002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_1 < arg_7_1.time_ and arg_7_1.time_ <= var_10_1 + arg_10_0 and not isNil(var_10_0) and arg_7_1.var_.characterEffect104902ui_story == nil then
			...
			if var_10_1 <= arg_7_1.time_ and arg_7_1.time_ < var_10_1 + var_10_2 and not isNil(var_10_0) then
				...
				if arg_7_1.var_.characterEffect104902ui_story and not isNil(var_10_0) then
			...
			if arg_7_1.time_ >= var_10_1 + var_10_2 and arg_7_1.time_ < var_10_1 + var_10_2 + arg_10_0 and not isNil(var_10_0) and arg_7_1.var_.characterEffect104902ui_story then
				local var_10_5 = 0.5
	...
	Play414381004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_11 < arg_15_1.time_ and arg_15_1.time_ <= var_18_11 + arg_18_0 and not isNil(var_18_10) and arg_15_1.var_.characterEffect104902ui_story == nil then
			...
			if var_18_11 <= arg_15_1.time_ and arg_15_1.time_ < var_18_11 + var_18_12 and not isNil(var_18_10) then
				local var_18_13 = (arg_15_1.time_ - var_18_11) / var_18_12

				if arg_15_1.var_.characterEffect104902ui_story and not isNil(var_18_10) then
					arg_15_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_15_1.time_ >= var_18_11 + var_18_12 and arg_15_1.time_ < var_18_11 + var_18_12 + arg_18_0 and not isNil(var_18_10) and arg_15_1.var_.characterEffect104902ui_story then
				arg_15_1.var_.characterEffect104902ui_story.fillFlat = false
			end
	...
	Play414381007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_10 < arg_27_1.time_ and arg_27_1.time_ <= var_30_10 + arg_30_0 and not isNil(var_30_9) and arg_27_1.var_.characterEffect104902ui_story == nil then
			...
			if var_30_10 <= arg_27_1.time_ and arg_27_1.time_ < var_30_10 + var_30_11 and not isNil(var_30_9) then
				...
				if arg_27_1.var_.characterEffect104902ui_story and not isNil(var_30_9) then
					arg_27_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_27_1.time_ >= var_30_10 + var_30_11 and arg_27_1.time_ < var_30_10 + var_30_11 + arg_30_0 and not isNil(var_30_9) and arg_27_1.var_.characterEffect104902ui_story then
				arg_27_1.var_.characterEffect104902ui_story.fillFlat = false
			end
	...
	Play414381008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.playNext_(arg_33_0)
			...
			arg_31_1:RecordChoiceLog(414381008, 414381009, 414381009)
		end
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_1 < arg_31_1.time_ and arg_31_1.time_ <= var_34_1 + arg_34_0 and not isNil(var_34_0) and arg_31_1.var_.characterEffect104902ui_story == nil then
			...
			if var_34_1 <= arg_31_1.time_ and arg_31_1.time_ < var_34_1 + var_34_2 and not isNil(var_34_0) then
				...
				if arg_31_1.var_.characterEffect104902ui_story and not isNil(var_34_0) then
			...
			if arg_31_1.time_ >= var_34_1 + var_34_2 and arg_31_1.time_ < var_34_1 + var_34_2 + arg_34_0 and not isNil(var_34_0) and arg_31_1.var_.characterEffect104902ui_story then
				local var_34_5 = 0.5
	...
	Play414381009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if arg_35_1.actors_[var_38_13] == nil then
				local var_38_14 = Asset.Load("Char/" .. "104902ui_story")

				if not isNil(var_38_14) then
					local var_38_15 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_35_1.stage_.transform)
			...
			local var_38_19 = "104902ui_story"

			if arg_35_1.actors_[var_38_19] == nil then
				local var_38_20 = Asset.Load("Char/" .. "104902ui_story")

				if not isNil(var_38_20) then
					local var_38_21 = Object.Instantiate(Asset.Load("Char/" .. "104902ui_story"), arg_35_1.stage_.transform)
			...
			if var_38_25 < arg_35_1.time_ and arg_35_1.time_ <= var_38_25 + arg_38_0 then
				...
				local var_38_27 = arg_35_1:FormatText(StoryNameCfg[562].name)
				...
				local var_38_28 = arg_35_1:GetWordFromCfg(414381009)
	...
	Play414381010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_1 < arg_39_1.time_ and arg_39_1.time_ <= var_42_1 + arg_42_0 and not isNil(var_42_0) and arg_39_1.var_.characterEffect104902ui_story == nil then
			...
			if var_42_1 <= arg_39_1.time_ and arg_39_1.time_ < var_42_1 + var_42_2 and not isNil(var_42_0) then
				...
				if arg_39_1.var_.characterEffect104902ui_story and not isNil(var_42_0) then
			...
			if arg_39_1.time_ >= var_42_1 + var_42_2 and arg_39_1.time_ < var_42_1 + var_42_2 + arg_42_0 and not isNil(var_42_0) and arg_39_1.var_.characterEffect104902ui_story then
				local var_42_5 = 0.5
	...
	Play414381011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_10 < arg_43_1.time_ and arg_43_1.time_ <= var_46_10 + arg_46_0 and not isNil(var_46_9) and arg_43_1.var_.characterEffect104902ui_story == nil then
			...
			if var_46_10 <= arg_43_1.time_ and arg_43_1.time_ < var_46_10 + var_46_11 and not isNil(var_46_9) then
				...
				if arg_43_1.var_.characterEffect104902ui_story and not isNil(var_46_9) then
					arg_43_1.var_.characterEffect104902ui_story.fillFlat = false
				end
			end

			if arg_43_1.time_ >= var_46_10 + var_46_11 and arg_43_1.time_ < var_46_10 + var_46_11 + arg_46_0 and not isNil(var_46_9) and arg_43_1.var_.characterEffect104902ui_story then
				arg_43_1.var_.characterEffect104902ui_story.fillFlat = false
			end
	...
	Play414381012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_1 < arg_47_1.time_ and arg_47_1.time_ <= var_50_1 + arg_50_0 and not isNil(var_50_0) and arg_47_1.var_.characterEffect104902ui_story == nil then
			...
			if var_50_1 <= arg_47_1.time_ and arg_47_1.time_ < var_50_1 + var_50_2 and not isNil(var_50_0) then
				...
				if arg_47_1.var_.characterEffect104902ui_story and not isNil(var_50_0) then
			...
			if arg_47_1.time_ >= var_50_1 + var_50_2 and arg_47_1.time_ < var_50_1 + var_50_2 + arg_50_0 and not isNil(var_50_0) and arg_47_1.var_.characterEffect104902ui_story then
				local var_50_5 = 0.5
