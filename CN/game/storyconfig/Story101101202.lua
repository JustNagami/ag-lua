return {
	Play110122001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_42 = 0.738461699336767
			local var_4_43 = 1
			...
			if var_4_42 < arg_1_1.time_ and arg_1_1.time_ <= var_4_42 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_44, var_4_45, "bgm_story_v0_battleground", "bgm_story_v0_battleground", "bgm_story_v0_battleground.awb")

				local var_4_46 = ""
				local var_4_47 = manager.audio:GetAudioName("bgm_story_v0_battleground", "bgm_story_v0_battleground")
			...
			if var_4_48 < arg_1_1.time_ and arg_1_1.time_ <= var_4_48 + arg_4_0 then
				...
				local var_4_52 = arg_1_1:GetWordFromCfg(110122001)
	...
	Play110122002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_14 < arg_9_1.time_ and arg_9_1.time_ <= var_12_14 + arg_12_0 then
				arg_9_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action2_1")
			end
	...
	Play110122004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				arg_17_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111actionlink/1111action424")
			end
	...
	Play110122007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_13 < arg_29_1.time_ and arg_29_1.time_ <= var_32_13 + arg_32_0 then
				arg_29_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action7_2")
			end
	...
	Play110122011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_9 < arg_45_1.time_ and arg_45_1.time_ <= var_48_9 + arg_48_0 then
				arg_45_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111action/1111action4_1")
			end
	...
	Play110122016 = function(arg_65_0, arg_65_1)
		...
		function arg_65_1.onSingleLineUpdate_(arg_68_0)
			...
			if var_68_17 < arg_65_1.time_ and arg_65_1.time_ <= var_68_17 + arg_68_0 then
				arg_65_1:PlayTimeline("1111ui_story", "StoryTimeline/CharAction/1111/1111actionlink/1111action442")
			end
		...
		function arg_91_1.onSingleLineUpdate_(arg_94_0)
			...
			if var_94_1 < arg_91_1.time_ and arg_91_1.time_ <= var_94_1 + arg_94_0 then
				...
				if var_94_2 then
					...
					arg_91_1.var_.alphaOldValueB12a = var_94_4.a
					arg_91_1.var_.alphaMatValueB12a = var_94_3
				end
			...
			if var_94_1 <= arg_91_1.time_ and arg_91_1.time_ < var_94_1 + var_94_5 then
				...
				local var_94_7 = Mathf.Lerp(arg_91_1.var_.alphaOldValueB12a, 0, var_94_6)

				if arg_91_1.var_.alphaMatValueB12a then
					local var_94_8 = arg_91_1.var_.alphaMatValueB12a
			...
			if arg_91_1.time_ >= var_94_1 + var_94_5 and arg_91_1.time_ < var_94_1 + var_94_5 + arg_94_0 and arg_91_1.var_.alphaMatValueB12a then
				local var_94_10 = arg_91_1.var_.alphaMatValueB12a
			...
			local var_94_12 = arg_91_1.bgs_.B12a
			local var_94_13 = 1
			...
			if var_94_13 < arg_91_1.time_ and arg_91_1.time_ <= var_94_13 + arg_94_0 then
				...
				if var_94_14 then
					...
					arg_91_1.var_.alphaOldValueB12a = var_94_16.a
					arg_91_1.var_.alphaMatValueB12a = var_94_15
				end
			...
			if var_94_13 <= arg_91_1.time_ and arg_91_1.time_ < var_94_13 + var_94_17 then
				...
				local var_94_19 = Mathf.Lerp(arg_91_1.var_.alphaOldValueB12a, 1, var_94_18)

				if arg_91_1.var_.alphaMatValueB12a then
					local var_94_20 = arg_91_1.var_.alphaMatValueB12a
			...
			if arg_91_1.time_ >= var_94_13 + var_94_17 and arg_91_1.time_ < var_94_13 + var_94_17 + arg_94_0 and arg_91_1.var_.alphaMatValueB12a then
				local var_94_22 = arg_91_1.var_.alphaMatValueB12a
			...
			if var_94_24 < arg_91_1.time_ and arg_91_1.time_ <= var_94_24 + arg_94_0 then
				...
				local var_94_26 = arg_91_1:GetWordFromCfg(110122022)
		...
		function arg_115_1.onSingleLineUpdate_(arg_118_0)
			...
			if var_118_1 < arg_115_1.time_ and arg_115_1.time_ <= var_118_1 + arg_118_0 then
				...
				if var_118_2 then
					...
					arg_115_1.var_.alphaOldValueB12a = var_118_4.a
					arg_115_1.var_.alphaMatValueB12a = var_118_3
				end
			...
			if var_118_1 <= arg_115_1.time_ and arg_115_1.time_ < var_118_1 + var_118_5 then
				...
				local var_118_7 = Mathf.Lerp(arg_115_1.var_.alphaOldValueB12a, 0, var_118_6)

				if arg_115_1.var_.alphaMatValueB12a then
					local var_118_8 = arg_115_1.var_.alphaMatValueB12a
			...
			if arg_115_1.time_ >= var_118_1 + var_118_5 and arg_115_1.time_ < var_118_1 + var_118_5 + arg_118_0 and arg_115_1.var_.alphaMatValueB12a then
				local var_118_10 = arg_115_1.var_.alphaMatValueB12a
			...
			local var_118_12 = arg_115_1.bgs_.B12a
			local var_118_13 = 1.5

			if var_118_13 < arg_115_1.time_ and arg_115_1.time_ <= var_118_13 + arg_118_0 then
				local var_118_14 = var_118_12:GetComponent("SpriteRenderer")

				if var_118_14 then
					var_118_14.material = arg_115_1.transpaintGo_:GetComponent("SpriteRenderer").material

					local var_118_15 = var_118_14.material
					local var_118_16 = var_118_15:GetColor("_Color")

					arg_115_1.var_.alphaOldValueB12a = var_118_16.a
					arg_115_1.var_.alphaMatValueB12a = var_118_15
				end
			...
			if var_118_13 <= arg_115_1.time_ and arg_115_1.time_ < var_118_13 + var_118_17 then
				local var_118_18 = (arg_115_1.time_ - var_118_13) / var_118_17
				local var_118_19 = Mathf.Lerp(arg_115_1.var_.alphaOldValueB12a, 1, var_118_18)

				if arg_115_1.var_.alphaMatValueB12a then
					local var_118_20 = arg_115_1.var_.alphaMatValueB12a
					local var_118_21 = var_118_20:GetColor("_Color")

					var_118_21.a = var_118_19

					var_118_20:SetColor("_Color", var_118_21)
				end
			end

			if arg_115_1.time_ >= var_118_13 + var_118_17 and arg_115_1.time_ < var_118_13 + var_118_17 + arg_118_0 and arg_115_1.var_.alphaMatValueB12a then
				local var_118_22 = arg_115_1.var_.alphaMatValueB12a
			...
			if var_118_24 < arg_115_1.time_ and arg_115_1.time_ <= var_118_24 + arg_118_0 then
				...
				local var_118_26 = arg_115_1:GetWordFromCfg(110122028)
	...
	Play110122029 = function(arg_119_0, arg_119_1)
		...
		function arg_119_1.onSingleLineUpdate_(arg_122_0)
			...
			if var_122_1 < arg_119_1.time_ and arg_119_1.time_ <= var_122_1 + arg_122_0 then
				...
				if var_122_2 then
					var_122_2.material = arg_119_1.transpaintGo_:GetComponent("SpriteRenderer").material

					local var_122_3 = var_122_2.material
					local var_122_4 = var_122_3:GetColor("_Color")

					arg_119_1.var_.alphaOldValueB12a = var_122_4.a
					arg_119_1.var_.alphaMatValueB12a = var_122_3
				end
			...
			if var_122_1 <= arg_119_1.time_ and arg_119_1.time_ < var_122_1 + var_122_5 then
				local var_122_6 = (arg_119_1.time_ - var_122_1) / var_122_5
				local var_122_7 = Mathf.Lerp(arg_119_1.var_.alphaOldValueB12a, 0, var_122_6)

				if arg_119_1.var_.alphaMatValueB12a then
					local var_122_8 = arg_119_1.var_.alphaMatValueB12a
					local var_122_9 = var_122_8:GetColor("_Color")

					var_122_9.a = var_122_7

					var_122_8:SetColor("_Color", var_122_9)
				end
			end

			if arg_119_1.time_ >= var_122_1 + var_122_5 and arg_119_1.time_ < var_122_1 + var_122_5 + arg_122_0 and arg_119_1.var_.alphaMatValueB12a then
				local var_122_10 = arg_119_1.var_.alphaMatValueB12a
				local var_122_11 = var_122_10:GetColor("_Color")

				var_122_11.a = 0

				var_122_10:SetColor("_Color", var_122_11)
			end

			local var_122_12 = 0
			local var_122_13 = 1.1
			...
			if var_122_12 < arg_119_1.time_ and arg_119_1.time_ <= var_122_12 + arg_122_0 then
				...
				local var_122_14 = arg_119_1:GetWordFromCfg(110122029)
