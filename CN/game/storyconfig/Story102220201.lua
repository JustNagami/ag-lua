	...
	Play222021001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_32 < arg_1_1.time_ and arg_1_1.time_ <= var_4_32 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_34, var_4_35, "bgm_activity_2_1_story_city", "bgm_activity_2_1_story_city", "bgm_activity_2_1_story_city.awb")

				local var_4_36 = ""
				local var_4_37 = manager.audio:GetAudioName("bgm_activity_2_1_story_city", "bgm_activity_2_1_story_city")
			...
			if var_4_38 < arg_1_1.time_ and arg_1_1.time_ <= var_4_38 + arg_4_0 then
				...
				local var_4_41 = arg_1_1:GetWordFromCfg(222021001)
	...
	Play222021002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_0 < arg_9_1.time_ and arg_9_1.time_ <= var_12_0 + arg_12_0 then
				...
				local var_12_2 = arg_9_1:GetWordFromCfg(222021002)
	...
	Play222021003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_20 < arg_13_1.time_ and arg_13_1.time_ <= var_16_20 + arg_16_0 then
				...
				local var_16_23 = arg_13_1:GetWordFromCfg(222021003)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021003", "story_v_out_222021.awb") ~= 0 then
					local var_16_28 = manager.audio:GetVoiceLength("story_v_out_222021", "222021003", "story_v_out_222021.awb") / 1000
					...
					if var_16_23.prefab_name ~= "" and arg_13_1.actors_[var_16_23.prefab_name] ~= nil then
						local var_16_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_23.prefab_name].transform, "story_v_out_222021", "222021003", "story_v_out_222021.awb")

						arg_13_1:RecordAudio("222021003", var_16_29)
						arg_13_1:RecordAudio("222021003", var_16_29)
					else
	...
	Play222021004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_0 < arg_17_1.time_ and arg_17_1.time_ <= var_20_0 + arg_20_0 then
				...
				local var_20_3 = arg_17_1:GetWordFromCfg(222021004)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021004", "story_v_out_222021.awb") ~= 0 then
					local var_20_8 = manager.audio:GetVoiceLength("story_v_out_222021", "222021004", "story_v_out_222021.awb") / 1000
					...
					if var_20_3.prefab_name ~= "" and arg_17_1.actors_[var_20_3.prefab_name] ~= nil then
						local var_20_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_3.prefab_name].transform, "story_v_out_222021", "222021004", "story_v_out_222021.awb")

						arg_17_1:RecordAudio("222021004", var_20_9)
						arg_17_1:RecordAudio("222021004", var_20_9)
					else
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_10 <= arg_21_1.time_ and arg_21_1.time_ < var_24_10 + var_24_11 and not isNil(var_24_9) then
				...
				if arg_21_1.var_.characterEffect1074ui_story and not isNil(var_24_9) then
					...
					arg_21_1.var_.characterEffect1074ui_story.fillRatio = var_24_13
				end
			end
			...
			if arg_21_1.time_ >= var_24_10 + var_24_11 and arg_21_1.time_ < var_24_10 + var_24_11 + arg_24_0 and not isNil(var_24_9) and arg_21_1.var_.characterEffect1074ui_story then
				...
				arg_21_1.var_.characterEffect1074ui_story.fillFlat = true
				arg_21_1.var_.characterEffect1074ui_story.fillRatio = var_24_14
			end
			...
			if var_24_15 < arg_21_1.time_ and arg_21_1.time_ <= var_24_15 + arg_24_0 then
				...
				local var_24_17 = arg_21_1:GetWordFromCfg(222021005)
	...
	Play222021006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_0 < arg_25_1.time_ and arg_25_1.time_ <= var_28_0 + arg_28_0 then
				...
				local var_28_2 = arg_25_1:GetWordFromCfg(222021006)
	...
	Play222021007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_15 < arg_29_1.time_ and arg_29_1.time_ <= var_32_15 + arg_32_0 then
				...
				local var_32_18 = arg_29_1:GetWordFromCfg(222021007)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021007", "story_v_out_222021.awb") ~= 0 then
					local var_32_23 = manager.audio:GetVoiceLength("story_v_out_222021", "222021007", "story_v_out_222021.awb") / 1000
					...
					if var_32_18.prefab_name ~= "" and arg_29_1.actors_[var_32_18.prefab_name] ~= nil then
						local var_32_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_18.prefab_name].transform, "story_v_out_222021", "222021007", "story_v_out_222021.awb")

						arg_29_1:RecordAudio("222021007", var_32_24)
						arg_29_1:RecordAudio("222021007", var_32_24)
					else
	...
	Play222021008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_0 < arg_33_1.time_ and arg_33_1.time_ <= var_36_0 + arg_36_0 then
				...
				local var_36_3 = arg_33_1:GetWordFromCfg(222021008)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021008", "story_v_out_222021.awb") ~= 0 then
					local var_36_8 = manager.audio:GetVoiceLength("story_v_out_222021", "222021008", "story_v_out_222021.awb") / 1000
					...
					if var_36_3.prefab_name ~= "" and arg_33_1.actors_[var_36_3.prefab_name] ~= nil then
						local var_36_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_3.prefab_name].transform, "story_v_out_222021", "222021008", "story_v_out_222021.awb")

						arg_33_1:RecordAudio("222021008", var_36_9)
						arg_33_1:RecordAudio("222021008", var_36_9)
					else
	...
	Play222021009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_15 < arg_37_1.time_ and arg_37_1.time_ <= var_40_15 + arg_40_0 then
				...
				local var_40_17 = arg_37_1:GetWordFromCfg(222021009)
	...
	Play222021010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_1 <= arg_41_1.time_ and arg_41_1.time_ < var_44_1 + var_44_2 then
				...
				local var_44_4 = Vector3.New(0, -1.055, -6.12)
			...
			if arg_41_1.time_ >= var_44_1 + var_44_2 and arg_41_1.time_ < var_44_1 + var_44_2 + arg_44_0 then
				var_44_0.localPosition = Vector3.New(0, -1.055, -6.12)
			...
			if var_44_15 < arg_41_1.time_ and arg_41_1.time_ <= var_44_15 + arg_44_0 then
				...
				local var_44_17 = arg_41_1:FormatText(StoryNameCfg[410].name)
				...
				local var_44_18 = arg_41_1:GetWordFromCfg(222021010)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021010", "story_v_out_222021.awb") ~= 0 then
					local var_44_23 = manager.audio:GetVoiceLength("story_v_out_222021", "222021010", "story_v_out_222021.awb") / 1000
					...
					if var_44_18.prefab_name ~= "" and arg_41_1.actors_[var_44_18.prefab_name] ~= nil then
						local var_44_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_18.prefab_name].transform, "story_v_out_222021", "222021010", "story_v_out_222021.awb")

						arg_41_1:RecordAudio("222021010", var_44_24)
						arg_41_1:RecordAudio("222021010", var_44_24)
					else
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_10 <= arg_45_1.time_ and arg_45_1.time_ < var_48_10 + var_48_11 and not isNil(var_48_9) then
				...
				if arg_45_1.var_.characterEffect1074ui_story and not isNil(var_48_9) then
					...
					arg_45_1.var_.characterEffect1074ui_story.fillRatio = var_48_13
				end
			end
			...
			if arg_45_1.time_ >= var_48_10 + var_48_11 and arg_45_1.time_ < var_48_10 + var_48_11 + arg_48_0 and not isNil(var_48_9) and arg_45_1.var_.characterEffect1074ui_story then
				...
				arg_45_1.var_.characterEffect1074ui_story.fillFlat = true
				arg_45_1.var_.characterEffect1074ui_story.fillRatio = var_48_14
			end
			...
			if var_48_15 < arg_45_1.time_ and arg_45_1.time_ <= var_48_15 + arg_48_0 then
				...
				local var_48_17 = arg_45_1:FormatText(StoryNameCfg[29].name)
				...
				local var_48_18 = arg_45_1:GetWordFromCfg(222021011)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021011", "story_v_out_222021.awb") ~= 0 then
					local var_48_23 = manager.audio:GetVoiceLength("story_v_out_222021", "222021011", "story_v_out_222021.awb") / 1000
					...
					if var_48_18.prefab_name ~= "" and arg_45_1.actors_[var_48_18.prefab_name] ~= nil then
						local var_48_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_18.prefab_name].transform, "story_v_out_222021", "222021011", "story_v_out_222021.awb")

						arg_45_1:RecordAudio("222021011", var_48_24)
						arg_45_1:RecordAudio("222021011", var_48_24)
					else
	...
	Play222021012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_15 < arg_49_1.time_ and arg_49_1.time_ <= var_52_15 + arg_52_0 then
				...
				local var_52_18 = arg_49_1:GetWordFromCfg(222021012)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021012", "story_v_out_222021.awb") ~= 0 then
					local var_52_23 = manager.audio:GetVoiceLength("story_v_out_222021", "222021012", "story_v_out_222021.awb") / 1000
					...
					if var_52_18.prefab_name ~= "" and arg_49_1.actors_[var_52_18.prefab_name] ~= nil then
						local var_52_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_49_1.actors_[var_52_18.prefab_name].transform, "story_v_out_222021", "222021012", "story_v_out_222021.awb")

						arg_49_1:RecordAudio("222021012", var_52_24)
						arg_49_1:RecordAudio("222021012", var_52_24)
					else
	...
	Play222021013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_0 < arg_53_1.time_ and arg_53_1.time_ <= var_56_0 + arg_56_0 then
				...
				local var_56_3 = arg_53_1:GetWordFromCfg(222021013)
				...
				if manager.audio:GetVoiceLength("story_v_out_222021", "222021013", "story_v_out_222021.awb") ~= 0 then
					local var_56_8 = manager.audio:GetVoiceLength("story_v_out_222021", "222021013", "story_v_out_222021.awb") / 1000
					...
					if var_56_3.prefab_name ~= "" and arg_53_1.actors_[var_56_3.prefab_name] ~= nil then
						local var_56_9 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_3.prefab_name].transform, "story_v_out_222021", "222021013", "story_v_out_222021.awb")

						arg_53_1:RecordAudio("222021013", var_56_9)
						arg_53_1:RecordAudio("222021013", var_56_9)
					else
