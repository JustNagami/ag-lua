		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				if not var_4_40 then
					var_4_40 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_dust"))
					var_4_40.name = "001"
			...
			if var_4_48 < arg_1_1.time_ and arg_1_1.time_ <= var_4_48 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_50, var_4_51, "bgm_activity_4_0_story_quake_daily", "bgm_activity_4_0_story_quake_daily", "bgm_activity_4_0_story_quake_daily.awb")

				local var_4_52 = ""
				local var_4_53 = manager.audio:GetAudioName("bgm_activity_4_0_story_quake_daily", "bgm_activity_4_0_story_quake_daily")
			...
			if var_4_54 < arg_1_1.time_ and arg_1_1.time_ <= var_4_54 + arg_4_0 then
				...
				local var_4_57 = arg_1_1:GetWordFromCfg(321261001)
		...
		function arg_237_1.onSingleLineUpdate_(arg_240_0)
			...
			if var_240_1 < arg_237_1.time_ and arg_237_1.time_ <= var_240_1 + arg_240_0 then
				...
				if not var_240_2 then
					var_240_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_suduxian01_in_keep"))
					var_240_2.name = "zhimingguangxian1"
					arg_237_1.var_.effectzhimingguangxian1 = var_240_2
				end

				local var_240_3 = var_240_0:Find("")

				if var_240_3 then
					var_240_2.transform.parent = var_240_3
				else
					var_240_2.transform.parent = var_240_0
				end
			...
			if var_240_5 < arg_237_1.time_ and arg_237_1.time_ <= var_240_5 + arg_240_0 then
				local var_240_6 = arg_237_1.var_.effectzhimingguangxian1

				if var_240_6 then
					Object.Destroy(var_240_6)
			...
			if var_240_7 <= arg_237_1.time_ and arg_237_1.time_ < var_240_7 + var_240_8 then
				...
				var_240_10.a = Mathf.Lerp(0, 1, var_240_9)
			...
			if var_240_12 <= arg_237_1.time_ and arg_237_1.time_ < var_240_12 + var_240_13 then
				...
				local var_240_15 = Color.New(1, 1, 1)

				var_240_15.a = Mathf.Lerp(1, 0, var_240_14)
			...
			if arg_237_1.time_ >= var_240_12 + var_240_13 and arg_237_1.time_ < var_240_12 + var_240_13 + arg_240_0 then
				...
				var_240_16.a = var_240_17
				arg_237_1.mask_.color = var_240_16
			end

			local var_240_18 = manager.ui.mainCamera.transform
			local var_240_19 = 0.6

			if var_240_19 < arg_237_1.time_ and arg_237_1.time_ <= var_240_19 + arg_240_0 then
				local var_240_20 = arg_237_1.var_.effectkongjianniuqu1

				if not var_240_20 then
					var_240_20 = Object.Instantiate(Asset.Load("Effect/Scene/fx_ripple"))
					var_240_20.name = "kongjianniuqu1"
					arg_237_1.var_.effectkongjianniuqu1 = var_240_20
				end

				local var_240_21 = var_240_18:Find("")

				if var_240_21 then
					var_240_20.transform.parent = var_240_21
				else
					var_240_20.transform.parent = var_240_18
				end

				var_240_20.transform.localPosition = Vector3.New(0, 0, 0)
				var_240_20.transform.localRotation = Quaternion.Euler(0, 0, 0)
			end
			...
			local var_240_22 = 1.36666666666667
			local var_240_23 = 1.575
			...
			if var_240_22 < arg_237_1.time_ and arg_237_1.time_ <= var_240_22 + arg_240_0 then
				...
				local var_240_24 = LeanTween.value(arg_237_1.dialog_, 0, 1, 0.3)

				var_240_24:setOnUpdate(LuaHelper.FloatAction(function(arg_241_0)
					arg_237_1.dialogCg_.alpha = arg_241_0
				end))
				var_240_24:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_237_1.dialog_)
					var_240_24:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_240_25 = arg_237_1:GetWordFromCfg(321261058)
			...
			local var_240_30 = var_240_22 + 0.3
			local var_240_31 = math.max(var_240_23, arg_237_1.talkMaxDuration)

			if var_240_30 <= arg_237_1.time_ and arg_237_1.time_ < var_240_30 + var_240_31 then
				arg_237_1.typewritter.percent = (arg_237_1.time_ - var_240_30) / var_240_31
		...
		function arg_247_1.onSingleLineUpdate_(arg_250_0)
			...
			if var_250_1 < arg_247_1.time_ and arg_247_1.time_ <= var_250_1 + arg_250_0 then
				...
				if not var_250_2 then
					var_250_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redlight_keep"))
					var_250_2.name = "hainengjingbao1"
					arg_247_1.var_.effecthainengjingbao1 = var_250_2
				end

				local var_250_3 = var_250_0:Find("")

				if var_250_3 then
					var_250_2.transform.parent = var_250_3
				else
					var_250_2.transform.parent = var_250_0
				end

				var_250_2.transform.localPosition = Vector3.New(0, 0, 0)
				var_250_2.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_250_4 = manager.ui.mainCameraCom_
				local var_250_5 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_250_4.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_250_6 = var_250_2.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_250_7 = 15
				local var_250_8 = 2 * var_250_7 * Mathf.Tan(var_250_4.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_250_4.aspect
				local var_250_9 = 1
				local var_250_10 = 1.7777777777777777

				if var_250_10 < var_250_4.aspect then
					var_250_9 = var_250_8 / (2 * var_250_7 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_250_10)
				end

				for iter_250_0, iter_250_1 in ipairs(var_250_6) do
					local var_250_11 = iter_250_1.transform.localScale

					iter_250_1.transform.localScale = Vector3.New(var_250_11.x / var_250_5 * var_250_9, var_250_11.y / var_250_5, var_250_11.z)
				end
			end
			...
			if var_250_12 < arg_247_1.time_ and arg_247_1.time_ <= var_250_12 + arg_250_0 then
				...
				arg_247_1:AudioAction(var_250_14, var_250_15, "se_story_129", "se_story_129_alarm", "")
			end
			...
			if var_250_16 < arg_247_1.time_ and arg_247_1.time_ <= var_250_16 + arg_250_0 then
				...
				local var_250_18 = arg_247_1:FormatText(StoryNameCfg[1176].name)
				...
				local var_250_19 = arg_247_1:GetWordFromCfg(321261060)
				...
				if manager.audio:GetVoiceLength("story_v_out_321261", "321261060", "story_v_out_321261.awb") ~= 0 then
					local var_250_24 = manager.audio:GetVoiceLength("story_v_out_321261", "321261060", "story_v_out_321261.awb") / 1000
					...
					if var_250_19.prefab_name ~= "" and arg_247_1.actors_[var_250_19.prefab_name] ~= nil then
						local var_250_25 = LuaForUtil.PlayVoiceWithCriLipsync(arg_247_1.actors_[var_250_19.prefab_name].transform, "story_v_out_321261", "321261060", "story_v_out_321261.awb")

						arg_247_1:RecordAudio("321261060", var_250_25)
						arg_247_1:RecordAudio("321261060", var_250_25)
					else
		...
		function arg_255_1.onSingleLineUpdate_(arg_258_0)
			...
			if var_258_1 < arg_255_1.time_ and arg_255_1.time_ <= var_258_1 + arg_258_0 then
				...
				if not var_258_2 then
					var_258_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_redlight_out"))
					var_258_2.name = "hainengjingbao2"
					arg_255_1.var_.effecthainengjingbao2 = var_258_2
				end

				local var_258_3 = var_258_0:Find("")

				if var_258_3 then
					var_258_2.transform.parent = var_258_3
				else
					var_258_2.transform.parent = var_258_0
				end
			...
			if var_258_5 < arg_255_1.time_ and arg_255_1.time_ <= var_258_5 + arg_258_0 then
				local var_258_6 = arg_255_1.var_.effecthainengjingbao2

				if var_258_6 then
					Object.Destroy(var_258_6)

					arg_255_1.var_.effecthainengjingbao2 = nil
				end
			end

			local var_258_7 = manager.ui.mainCamera.transform
			local var_258_8 = 0

			if var_258_8 < arg_255_1.time_ and arg_255_1.time_ <= var_258_8 + arg_258_0 then
				local var_258_9 = arg_255_1.var_.effecthainengjingbao1

				if var_258_9 then
					Object.Destroy(var_258_9)
			...
			if var_258_10 < arg_255_1.time_ and arg_255_1.time_ <= var_258_10 + arg_258_0 then
				...
				local var_258_12 = arg_255_1:FormatText(StoryNameCfg[612].name)
				...
				local var_258_13 = arg_255_1:GetWordFromCfg(321261062)
				...
				if manager.audio:GetVoiceLength("story_v_out_321261", "321261062", "story_v_out_321261.awb") ~= 0 then
					local var_258_18 = manager.audio:GetVoiceLength("story_v_out_321261", "321261062", "story_v_out_321261.awb") / 1000
					...
					if var_258_13.prefab_name ~= "" and arg_255_1.actors_[var_258_13.prefab_name] ~= nil then
						local var_258_19 = LuaForUtil.PlayVoiceWithCriLipsync(arg_255_1.actors_[var_258_13.prefab_name].transform, "story_v_out_321261", "321261062", "story_v_out_321261.awb")

						arg_255_1:RecordAudio("321261062", var_258_19)
						arg_255_1:RecordAudio("321261062", var_258_19)
					else
