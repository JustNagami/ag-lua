	...
	Play910108001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if arg_1_1.actors_[var_4_22] == nil then
				local var_4_23 = Asset.Load("Widget/System/Story/StoryExpression/" .. "1066")
			...
			local var_4_26 = arg_1_1.actors_["1066"].transform
			local var_4_27 = 0.5

			if var_4_27 < arg_1_1.time_ and arg_1_1.time_ <= var_4_27 + arg_4_0 then
				arg_1_1.var_.moveOldPos1066 = var_4_26.localPosition
			...
			if var_4_27 <= arg_1_1.time_ and arg_1_1.time_ < var_4_27 + var_4_30 then
				...
				var_4_26.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1066, var_4_32, var_4_31)
			end
			...
			local var_4_33 = arg_1_1.actors_["1066"]
			local var_4_34 = 0.5
			...
			if var_4_34 < arg_1_1.time_ and arg_1_1.time_ <= var_4_34 + arg_4_0 then
				...
				if var_4_35 then
					arg_1_1.var_.alphaOldValue1066 = var_4_35.alpha
					arg_1_1.var_.characterEffect1066 = var_4_35
				end
			...
			if var_4_34 <= arg_1_1.time_ and arg_1_1.time_ < var_4_34 + var_4_36 then
				...
				local var_4_38 = Mathf.Lerp(arg_1_1.var_.alphaOldValue1066, 1, var_4_37)

				if arg_1_1.var_.characterEffect1066 then
					arg_1_1.var_.characterEffect1066.alpha = var_4_38
				end
			end

			if arg_1_1.time_ >= var_4_34 + var_4_36 and arg_1_1.time_ < var_4_34 + var_4_36 + arg_4_0 and arg_1_1.var_.characterEffect1066 then
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 then
				...
				local var_4_42 = arg_1_1:FormatText(StoryNameCfg[32].name)
				...
				local var_4_43 = arg_1_1:GetWordFromCfg(910108001)
