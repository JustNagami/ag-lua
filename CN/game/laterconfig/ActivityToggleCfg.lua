return {
	...
	[33001] = {
		...
		name = "夏 日 竞 技",
		sub_title_type = 0,
		desc = "「海洋之星游乐园」时隔多年再次开启，明媚的海滨日光，躁动的海上音乐节，神秘的竞技项目。充满活力的夏日，开始了！",
		activity_id = 280001,
		activity_theme = 28,
		icon = "280001",
		order = 0,
	...
	[30801] = {
		...
		name = "雾 魇 迷 途",
		sub_title_type = 2,
		desc = "虚与实的界线已然模糊，由残梦滋生的魇魔徘徊在荒芜之中，收割生命的火光。在冰冷的死亡面前，英雄将重燃勇气的光辉，以希望铸成唯一的坦途。",
		activity_id = 301201,
		activity_theme = 30,
		icon = "141201",
		order = 0,
	...
	[30806] = {
		...
		name = "金乌历险记",
		sub_title_type = 0,
		desc = "「新泰镇？乌以前还没来玩过……不对！师父是让我来修习天通术的，总之先四处看看吧！」",
		activity_id = 303601,
		activity_theme = 30,
		icon = "303511",
		order = 0,
		class_name = WaterPipeHomeView
	},
	[30807] = {
		id = 30807,
		name = "涅 白 造 像",
		sub_title_type = 0,
		desc = "城镇被雾气笼罩而陷入寂静，诸多相仿的身影在涅白的雾霭中游逛。那些不曾见过的、无法理解的延展出更多的疑惑，但当那些造像消失时，雾好像淡了一些……",
		activity_id = 303481,
		activity_theme = 30,
		icon = "303481",
		order = 0,
		class_name = PinballMainView
	},
	[30808] = {
		id = 30808,
		name = "暗动的浮漂",
		sub_title_type = 0,
		desc = "阴云遮蔽天空，天色逐渐暗去，即将降临的暴雨终会打破池塘的宁静。",
		activity_id = 303602,
		activity_theme = 30,
		icon = "172141",
		order = 0,
		class_name = PuzzleNewTaskView_Resident
	},
	[30809] = {
		id = 30809,
		name = "砰！惊喜礼物",
		sub_title_type = 0,
		desc = "“欢迎，欢迎~这是为新朋友们准备的幕间表演，这是送给新朋友们的惊喜礼物~”",
		activity_id = 302361,
		activity_theme = 30,
		icon = "202361",
		order = 0,
	...
	[31001] = {
		...
		name = "雨 声",
		sub_title_type = 2,
		desc = "人们坐在各自的位置上，望向各自的窗外，看到听到大雨打在各自窗前，遮住彷徨的声音，掩去呐喊的声音——直到雨停，再没人见过雨声中的隐秘。",
		activity_id = 311201,
		activity_theme = 31,
		icon = "141201",
		order = 0,
	...
	[40001] = {
		...
		icon = "321201",
		order = 100,
		class_name = SkuldActivityMainView
	},
	[40002] = {
		id = 40002,
		name = "刺桐港埠漫行纪",
		sub_title_type = 0,
		desc = "游子归乡巡船启，百货齐聚尽琳琅。刺桐海隅风云起，且看麟钰见真章。",
		activity_id = 323641,
		activity_theme = 32,
		icon = "323641",
		order = 98,
		class_name = QWQuanZhouActivityMainUI
	},
	[40003] = {
		id = 40003,
		name = "庆 典 贺 礼",
		...
		icon = "293401",
		order = 97,
		class_name = SevenDaySkinPage_4_0
	},
	[40004] = {
		id = 40004,
		name = "神 域 模 拟",
	...
	[40006] = {
		...
		name = "河 岸 访 谈",
		sub_title_type = 0,
		desc = "一场在特殊场合的访谈，本社特约记者达克纳为您带来关于持有「未知力量」，不愿透露姓名的A女士的内心深度剖析。",
		activity_id = 323601,
		activity_theme = 32,
		icon = "172141",
		order = 92,
