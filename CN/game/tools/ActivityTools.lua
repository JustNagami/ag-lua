			...
			if var_37_0 then
				...
				if var_37_1 == ActivityTemplateConst.MAIN_ACTIVITY then
					...
					for iter_37_2, iter_37_3 in ipairs(var_37_3) do
						local var_37_5 = ActivityToggleCfg[iter_37_3]

						if ActivityCfg[var_37_5.activity_id] then
							if ActivityCfg[var_37_5.activity_id].activity_template == ActivityTemplateConst.ACTIVITY_ADVANCE_OPEN then
								var_37_4[ActivityCfg[var_37_5.activity_id].sub_activity_list[1]] = true
							else
								var_37_4[var_37_5.activity_id] = true
							end
						end
					end
					...
					local var_37_6 = var_37_0.sub_activity_list or {}

					for iter_37_4, iter_37_5 in ipairs(var_37_6) do
...
function var_0_0.GetActivityLocalData(arg_41_0, arg_41_1)
	return getData("activity_local_data_" .. arg_41_0, arg_41_1)
end

function var_0_0.SetActivityLocalData(arg_42_0, arg_42_1, arg_42_2)
	saveData("activity_local_data_" .. arg_42_0, arg_42_1, arg_42_2)
end

function var_0_0.GetActivityTitleName(arg_43_0)
	local var_43_0 = nullable(ActivityCfg, arg_43_0, "remark")

	if var_43_0 then
		return GetI18NText(var_43_0)
	end
