local var_0_0 = {
	GetTaskUIName = function(arg_1_0)
		...
		if var_1_0 >= ActivityConst.THEME.ACTIVITY_3_8 then
	...
	GetPlayViewUIName = function(arg_2_0)
		...
		if var_2_0 >= ActivityConst.THEME.ACTIVITY_3_8 then
	...
	GetRewardViewUIName = function(arg_3_0)
		...
		if var_3_0 >= ActivityConst.THEME.ACTIVITY_3_8 then
	...
	GetPreviewUIName = function(arg_4_0)
		...
		if var_4_0 >= ActivityConst.THEME.ACTIVITY_3_8 then
	...
	GetCheckPreviewUIName = function(arg_5_0)
		...
		if var_5_0 >= ActivityConst.THEME.ACTIVITY_3_8 then
