...
function var_0_0.SetData(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if ConditionCfg[arg_5_1].type == 5001 then
		...
		local var_5_1 = GetI18NText(StoryCfg[var_5_0.plot_id[#var_5_0.plot_id]].name)

		arg_5_0.desText_.text = string.format(GetI18NText(ConditionCfg[arg_5_1].desc), var_5_1)
	end
