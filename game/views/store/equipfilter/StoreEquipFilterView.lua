...
function var_0_0.InitSuitDataList(arg_18_0)
	...
	local var_18_0 = HideInfoData:GetEquipSuitHideList()

	for iter_18_0, iter_18_1 in ipairs(EquipSuitCfg.all) do
		if not var_18_0[iter_18_1] then
			local var_18_1 = EquipTools.GetSuitEquipNum(iter_18_1, nil, arg_18_0.params_.equipPosition)
			local var_18_2 = {
			...
			table.insert(arg_18_0.suitList_, var_18_2)
		end
	end
end
