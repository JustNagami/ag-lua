	...
	for iter_18_5, iter_18_6 in ipairs(arg_18_0.poolToggles_) do
		...
		elseif var_18_7.pool_show_type == 8 or var_18_7.pool_show_type == 3 and var_18_7.pool_selected_type == 2 then
			...
			if var_18_11 ~= 0 then
				...
				var_18_9.text = GetI18NText(HeroCfg[var_18_12].name) or ""
			end
		elseif var_18_7.pool_show_type == 1 then
			...
			if var_18_13 ~= 0 then
				var_18_9.text = GetI18NText(HeroCfg[var_18_13].name) or ""
			end
		end
