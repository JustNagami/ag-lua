...
function var_0_0.InitUI(arg_2_0)
	...
	arg_2_0.firstController_ = ControllerUtil.GetController(arg_2_0.transform_, "first")
...
function var_0_0.Refresh(arg_6_0, arg_6_1)
	...
	if DrawData:GetIsFirstSSR() and arg_6_0.poolId ~= 31019 then
		local var_6_0 = DrawData:GetPoolDrawTimes(arg_6_0.poolId)
		local var_6_1 = GameSetting.draw_ssr_lucky_num_first_time.value[1]

		arg_6_0.drawTime_.text = string.format("%d/%d", var_6_0, var_6_1)

		arg_6_0.firstController_:SetSelectedIndex(1)
	else
		arg_6_0.firstController_:SetSelectedIndex(0)
	end
	...
	local var_6_2 = DrawPoolCfg[arg_6_0.poolId]
	local var_6_3 = table.indexof(var_6_2.optional_lists_poolId, arg_6_1)

	arg_6_0.heroId = DrawData:ConvertUpId(arg_6_0.poolId, arg_6_0.upID, 0)

	local var_6_4 = HeroCfg[arg_6_0.heroId]

	if arg_6_0.m_changeCount then
		local var_6_5 = DrawPoolCfg[arg_6_0.poolId].pool_change

		if var_6_5 == 0 then
			arg_6_0.m_changeCount.text = ""
		else
			local var_6_6 = var_6_5 - DrawData:GetPoolUpTimes(arg_6_0.poolId)

			arg_6_0.m_changeCount.text = string.format(GetTips("DRAW_REMAIN_UP_TIMES"), tostring(var_6_6))
		end
	end
