...
function var_0_0.AddListeners(arg_5_0)
	arg_5_0:AddBtnListener(arg_5_0.button_, nil, function()
		...
		if arg_5_0:IsLock() then
			...
			ShowTips(string.format(GetTips("UNLOCK_CONDITION_ACTIVITY_TIPS"), GetI18NText(ActivityStoryChapterCfg[var_6_4[2][1]].name), GetI18NText(BattleActivityStoryStageCfg[var_6_4[2][2]].name)))
