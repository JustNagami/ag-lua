...
function var_0_0.UpdateAvatarView(arg_16_0)
	...
	if var_16_0 then
		local var_16_1 = arg_16_0.heroViewDataProxy_:GetHeroUsingSkinInfo(var_16_0).id

		manager.heroRaiseTrack:SetModelState(var_16_1)
	end
end
...
function var_0_0.CameraEnter(arg_17_0)
	...
	local var_17_0 = HeroTools.HeroUsingSkinInfo(arg_17_0.params_.heroInfo.id).id

	manager.heroRaiseTrack:SetModelState(var_17_0)
end
