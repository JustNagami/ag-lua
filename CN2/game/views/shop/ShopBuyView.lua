	...
	arg_6_0:AddBtnListener(arg_6_0.okBtn_, nil, function()
		...
		elseif var_14_3.type == ItemConst.ITEM_TYPE.SCENE and HomeSceneSettingCfg[var_14_3.param[1]].limit_display == 0 then
			...
			if var_14_8 then
				...
				ShowMessageBox({
					title = GetTips("PROMPT"),
					content = GetTipsF("BUY_SCENE_NOT_HAVE_HERO_SKIN_CONFIRM", var_14_11.name, ItemTools.getItemName(var_14_3.id)),
					OkCallback = function()
						ShopAction.BuyItem({
							{
								goodID = var_14_0.id,
...
function var_0_0.RefreshUI(arg_26_0)
	...
	local var_26_2 = not manager.windowBar:GetWhereTag() == "qworld"

	if var_26_1.type == ItemConst.ITEM_TYPE.DORM_FURNITURE and var_26_2 then
	...
	local var_26_3, var_26_4, var_26_5 = ShopTools.IsOnDiscountArea(arg_26_0.goodID)

	if var_26_3 and var_26_5 then
	...
	if var_26_3 and var_26_5 and arg_26_0.shopCfg.tag == ShopConst.TAGS.NEW then
