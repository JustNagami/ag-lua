...
function var_0_0.OnTop(arg_15_0)
	...
	if arg_15_0.groupInfo[arg_15_0.currentItemIndex_] then
		local var_15_0 = arg_15_0.groupInfo[arg_15_0.currentItemIndex_].id

		if var_15_0 == ShopConst.SHOP_ID.CONTRACT_BENEFITS and arg_15_0.pages_[var_15_0] then
			arg_15_0.pages_[var_15_0]:Show()
		end
	end
end
...
function var_0_0.SpecialShop(arg_23_0, arg_23_1)
	if ShopConst.PC_LOCK_SHOP[arg_23_1] == true and ShopTools.IsPC() then
		return false
	end
