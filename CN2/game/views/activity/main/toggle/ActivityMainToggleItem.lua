...
function var_0_0.OnSelect(arg_8_0, arg_8_1)
	...
	if arg_8_1 then
		if arg_8_0.redPointActivityID_ and arg_8_0.redPointActivityID_ ~= arg_8_0.activityID_ then
			ActivityRedPoint:CancelSubActivityNewTag(arg_8_0.redPointActivityID_)

			local var_8_0 = ActivityTools.GetRedPointKey(arg_8_0.redPointActivityID_) .. arg_8_0.redPointActivityID_

			manager.redPoint:setTip(var_8_0, 0, RedPointStyle.SHOW_NEW_TAG)
		else
			local var_8_1 = ActivityTools.GetRedPointKey(arg_8_0.activityID_) .. arg_8_0.activityID_

			ActivityRedPoint:CancelSubActivityNewTag(arg_8_0.activityID_)
			manager.redPoint:setTip(var_8_1, 0, RedPointStyle.SHOW_NEW_TAG)
		end
	end
