...
function var_0_1.OnEnter(arg_18_0)
	...
	if not getData("SandPlayZumaGame", "showHelp") then
		local var_18_0 = GameSetting.activity_zuma_describe and GameSetting.activity_zuma_describe.value or {}
...
function var_0_1.Dispose(arg_19_0)
	...
	if arg_19_0.talentInfo then
		arg_19_0.talentInfo:Dispose()

		arg_19_0.talentInfo = nil
	end
end
