	...
	arg_11_0:AddBtnListener(arg_11_0.noGetBtn_, nil, function()
		if arg_11_0.curPage_ == 1 then
			...
			if not var_22_1 or not HeroTools.GetHeroIsUnlock(var_22_1) then
				ShowTips(GetTipsF("HOME_SCENE_UNAVAILABLE", HeroTools.GetHeroFullName(var_22_1)))
			elseif not var_22_0 or not HeroTools.GetHasOwnedSkin(var_22_0) then
				ShowTips(GetTipsF("HOME_SCENE_UNAVAILABLE", SkinCfg[var_22_0].name))
			end
		end
	end)
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_0.setting_) do
		if arg_11_0.settingBtn_[iter_11_0] then
			arg_11_0:AddBtnListener(arg_11_0.settingBtn_[iter_11_0], nil, function()
				...
				if iter_11_0 == HomeSceneSettingConst.SETTING.SCENE_BGM then
					arg_11_0:CheckPlayBgm()
				end
			end)
		end
	end
...
function var_0_0.OnEnter(arg_27_0)
	...
	local var_27_0 = HomeSceneSettingData:GetCurScene()
	local var_27_1 = HomeSceneSettingCfg[var_27_0]

	if not var_27_0 or HomeSceneSettingData:GetUsedState(var_27_0) == SceneConst.HOME_SCENE_TYPE.LOCK then
...
function var_0_0.RefreshType(arg_39_0)
	...
	if arg_39_0.curPage_ == 1 then
		...
		if var_39_0 == 0 then
			...
			arg_39_0.tip_.text = arg_39_0.cfg_.unlock_description
			arg_39_0.banText_.text = arg_39_0.cfg_.unlock_description
		...
		if var_39_3 == 0 then
			...
			if not var_39_6 or not HeroTools.GetHeroIsUnlock(var_39_6) then
				arg_39_0.banText_.text = GetTipsF("HOME_SCENE_UNAVAILABLE", HeroTools.GetHeroFullName(var_39_6))
			elseif not var_39_5 or not HeroTools.GetHasOwnedSkin(var_39_5) then
				arg_39_0.banText_.text = GetTipsF("HOME_SCENE_UNAVAILABLE", SkinCfg[var_39_5].name)
			end
...
function var_0_0.OnExit(arg_53_0)
	arg_53_0:CheckPlayBgm()
	arg_53_0:UnbindRedpoint()
	arg_53_0:StopTimer()

	for iter_53_0, iter_53_1 in ipairs(arg_53_0.sceneScrollHelper_:GetItemList()) do
		iter_53_1:OnExit()
	end

	for iter_53_2, iter_53_3 in ipairs(arg_53_0.dlcScrollHelper_:GetItemList()) do
		iter_53_3:OnExit()
	end
...
function var_0_0.UseScene(arg_54_0, arg_54_1)
	if HomeSceneSettingData:IsRandomScene() then
		ShowMessageBox({
			...
			OkCallback = function()
				...
				HomeSceneSettingAction.SetHomeScene(arg_54_1)
			end
		})
	else
		local var_54_0 = HomeSceneSettingCfg[arg_54_1]

		if var_54_0 and var_54_0.limit_display == 1 and PlayerData:IsRandomHero() and PlayerData:IsRandomHeroUseDlcScene() then
			HomeSceneSettingData:SetIsUseDlcScene(false)
		end

		if HomeSceneSettingData:GetCurScene() == arg_54_1 then
			arg_54_0:RefreshUI()
		end
	...
	if PosterGirlTools.SceneHasTimeEffect(arg_54_1) then
		HomeSceneSettingData:SetIsTimeScene(false)
	end
end

function var_0_0.BindRedpoint(arg_57_0)
	manager.redPoint:bindUIandKey(arg_57_0.sceneBtn_.transform, RedPointConst.SCENE_NORMAL)
	manager.redPoint:bindUIandKey(arg_57_0.dlcBtn_.transform, RedPointConst.SCENE_DLC)
end

function var_0_0.UnbindRedpoint(arg_58_0)
	manager.redPoint:unbindUIandKey(arg_58_0.sceneBtn_.transform)
	manager.redPoint:unbindUIandKey(arg_58_0.dlcBtn_.transform)
end

function var_0_0.Dispose(arg_59_0)
	arg_59_0:RemoveAllListeners()

	if arg_59_0.sceneScrollHelper_ then
		arg_59_0.sceneScrollHelper_:Dispose()

		arg_59_0.sceneScrollHelper_ = nil
	end

	if arg_59_0.dlcScrollHelper_ then
		arg_59_0.dlcScrollHelper_:Dispose()

		arg_59_0.dlcScrollHelper_ = nil
	end
