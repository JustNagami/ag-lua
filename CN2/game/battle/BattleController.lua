...
function var_0_0.SetOutSourcingData(arg_28_0, arg_28_1)
	local var_28_0
	local var_28_1

	if arg_28_1 and arg_28_1 ~= 0 then
		var_28_0, var_28_1 = GetVirtualData(arg_28_1)
	end

	local var_28_2 = GetHeroFinalAttr(var_28_0, var_28_0.servantInfo, var_28_1, arg_28_1)
	...
	for iter_28_0, iter_28_1 in pairs(var_28_2) do
		local var_28_9 = PublicAttrCfg[iter_28_0]

		if var_28_9 then
			table.insert(var_28_7, var_28_9.id)
			table.insert(var_28_8, iter_28_1)
		end
	end

	local var_28_10, var_28_11 = BattleTools.FixBattleAttributeListAndWeaponModule(var_28_7, var_28_8, var_28_0.using_skin, var_28_0.weapon_module_level)
