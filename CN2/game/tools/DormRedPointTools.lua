...
function var_0_0.SetIlluHeroNewTagRed(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	if JumpTools.IsSystemLocked(ViewConst.SYSTEM_ID.DORM) then
		return
	end

	local var_30_0 = getData("dormIllu", arg_30_1) or 0
	...
	if var_30_0 then
		...
		if not arg_30_3 then
			...
			manager.redPoint:setTip(arg_30_2, 0, RedPointStyle.NORMAL)
		else
			var_30_1 = true
			var_30_0 = 1

			manager.redPoint:setTip(arg_30_2, 1, RedPointStyle.NORMAL)
		end

		if var_30_1 then
			saveData("dormIllu", arg_30_1, var_30_0)
		end
	end

	arg_30_0:RefreshDormIlluNew()
end

function var_0_0.SetIlluNewTagRed(arg_31_0, arg_31_1, arg_31_2, arg_31_3, arg_31_4)
	if JumpTools.IsSystemLocked(ViewConst.SYSTEM_ID.DORM) then
		return
	end

	local var_31_0 = getData("dormIllu", arg_31_1) or {}

	if var_31_0 then
		local var_31_1 = 0

		for iter_31_0, iter_31_1 in ipairs(var_31_0) do
			if iter_31_1 == arg_31_4 then
				var_31_1 = iter_31_0
		...
		if var_31_1 > 0 then
			if not arg_31_3 then
				...
				table.remove(var_31_0, var_31_1)
				manager.redPoint:setTip(arg_31_2 .. arg_31_4, 0, RedPointStyle.NORMAL)
			end
		elseif arg_31_3 then
			var_31_2 = true

			table.insert(var_31_0, arg_31_4)
			manager.redPoint:setTip(arg_31_2 .. arg_31_4, 1, RedPointStyle.NORMAL)
		end
...
function var_0_0.SetDanceRed(arg_32_0)
	local var_32_0 = {}

	for iter_32_0, iter_32_1 in ipairs(IdolDanceDIYActionCfg.all) do
		if IdolTraineeData:DanceDIYActionAvailable(iter_32_1) then
			table.insert(var_32_0, iter_32_1)
		end
	end

	saveData("dormIllu", "danceNew", var_32_0)
	arg_32_0:RefreshDormIlluNew()
end

function var_0_0.RefreshDormIlluNew(arg_33_0)
	if JumpTools.IsSystemLocked(ViewConst.SYSTEM_ID.DORM) then
		return
	end

	local var_33_0 = getData("dormIllu", "heroNew") or 0

	if var_33_0 and var_33_0 == 1 then
	...
	for iter_33_0, iter_33_1 in ipairs(BackHomeFurnitureThemeCfg.all) do
		local var_33_1 = RedPointConst.DORM_ILLU_FUR_THEME .. iter_33_1

		manager.redPoint:setTip(var_33_1, 0, RedPointStyle.NORMAL)
	end

	local var_33_2 = getData("dormIllu", "furNew") or {}

	for iter_33_2, iter_33_3 in pairs(var_33_2) do
		local var_33_3 = RedPointConst.DORM_ILLU_FUR_THEME .. iter_33_3

		manager.redPoint:setTip(var_33_3, 1, RedPointStyle.NORMAL)
	end

	arg_33_0:RefreshIlluDanceNew()
end

function var_0_0.RefreshIlluDanceNew(arg_34_0)
	if JumpTools.IsSystemLocked(ViewConst.SYSTEM_ID.DORM) then
		return
	end

	local var_34_0 = getData("dormIllu", "danceNew")

	if var_34_0 == nil then
		local var_34_1 = {}
		local var_34_2 = IdolDanceDIYActionCfg.all

		for iter_34_0, iter_34_1 in ipairs(var_34_2) do
			if IdolTraineeData:DanceDIYActionAvailable(iter_34_1) then
				table.insert(var_34_1, iter_34_1)
			end
		end

		saveData("dormIllu", "danceNew", var_34_1)

		var_34_0 = getData("dormIllu", "danceNew")
	end

	local var_34_3 = false

	for iter_34_2, iter_34_3 in pairs(IdolDanceDIYActionCfg.all) do
		if IdolTraineeData:DanceDIYActionAvailable(iter_34_3) then
			local var_34_4 = false

			for iter_34_4, iter_34_5 in pairs(var_34_0) do
				if iter_34_5 == iter_34_3 then
					var_34_4 = true
