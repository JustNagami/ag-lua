...
function var_0_0.GetPrice(arg_33_0)
	...
	local var_33_6 = SettingData:GetCurrentLanguage()

	if var_33_6 == "fr" or var_33_6 == "de" then
		var_33_0 = string.gsub(tostring(var_33_0), "%.", ",")
	end

	if var_33_2 and var_33_4 then
		return var_33_0, var_33_1, var_33_5
	else
		...
		if var_0_0.IsRMB(arg_40_0) then
			...
			if var_40_2 and var_40_2.discount ~= 0 then
				...
				if var_40_0.cheap_cost == 0 then
					return var_40_5 and math.max(var_40_4, 1) or var_40_4
				elseif var_40_2.is_limit_buy_discount == 0 and var_40_0.limit_num > 0 then
					return var_40_0.cheap_cost
				else
					return math.min(var_40_5 and math.max(var_40_4, 1) or var_40_4, var_40_0.cheap_cost)
				end
			end
...
function var_0_0.CheckShopIsUnLock(arg_44_0)
	if arg_44_0 then
		...
		if var_44_0 and var_44_0 > 0 and (ShopListCfg[arg_44_0].display_group == 18 or ShopListCfg[arg_44_0].display_group == 24) then
	...
	if var_50_1.sub_type == ItemConst.ITEM_SUB_TYPE.SHOP_PACKS then
		for iter_50_0, iter_50_1 in ipairs(var_50_1.param) do
			if iter_50_1[1] then
				...
				if ItemTools.getItemNum(iter_50_1[1]) == 1 and var_50_2.type == ItemConst.ITEM_TYPE.HERO_SKIN and ShopTools.HaveSkin(iter_50_1[1]) then
					return true
				end
			end
		end
