return {
	...
	Play318241003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_20 < arg_13_1.time_ and arg_13_1.time_ <= var_16_20 + arg_16_0 then
				...
				local var_16_23 = arg_13_1:GetWordFromCfg(318241003)
				...
				if manager.audio:GetVoiceLength("story_v_out_318241", "318241003", "story_v_out_318241.awb") ~= 0 then
					local var_16_28 = manager.audio:GetVoiceLength("story_v_out_318241", "318241003", "story_v_out_318241.awb") / 1000
					...
					if var_16_23.prefab_name ~= "" and arg_13_1.actors_[var_16_23.prefab_name] ~= nil then
						local var_16_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_23.prefab_name].transform, "story_v_out_318241", "318241003", "story_v_out_318241.awb")

						arg_13_1:RecordAudio("318241003", var_16_29)
						arg_13_1:RecordAudio("318241003", var_16_29)
					else
	...
	Play318241005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_35 < arg_21_1.time_ and arg_21_1.time_ <= var_24_35 + arg_24_0 then
				...
				local var_24_38 = arg_21_1:GetWordFromCfg(318241005)
				...
				if manager.audio:GetVoiceLength("story_v_out_318241", "318241005", "story_v_out_318241.awb") ~= 0 then
					local var_24_43 = manager.audio:GetVoiceLength("story_v_out_318241", "318241005", "story_v_out_318241.awb") / 1000
					...
					if var_24_38.prefab_name ~= "" and arg_21_1.actors_[var_24_38.prefab_name] ~= nil then
						local var_24_44 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_38.prefab_name].transform, "story_v_out_318241", "318241005", "story_v_out_318241.awb")

						arg_21_1:RecordAudio("318241005", var_24_44)
						arg_21_1:RecordAudio("318241005", var_24_44)
					else
	...
	Play318241008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if arg_33_1.actors_[var_36_0] == nil then
				local var_36_1 = Asset.Load("Char/" .. "1049ui_story")

				if not isNil(var_36_1) then
					local var_36_2 = Object.Instantiate(Asset.Load("Char/" .. "1049ui_story"), arg_33_1.stage_.transform)
			...
			local var_36_5 = arg_33_1.actors_["1049ui_story"].transform
			local var_36_6 = 0

			if var_36_6 < arg_33_1.time_ and arg_33_1.time_ <= var_36_6 + arg_36_0 then
				arg_33_1.var_.moveOldPos1049ui_story = var_36_5.localPosition
			end
			...
			if var_36_6 <= arg_33_1.time_ and arg_33_1.time_ < var_36_6 + var_36_7 then
				...
				local var_36_9 = Vector3.New(0.7, -1.2, -6)

				var_36_5.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos1049ui_story, var_36_9, var_36_8)
			...
			if arg_33_1.time_ >= var_36_6 + var_36_7 and arg_33_1.time_ < var_36_6 + var_36_7 + arg_36_0 then
				var_36_5.localPosition = Vector3.New(0.7, -1.2, -6)
			...
			local var_36_14 = arg_33_1.actors_["1049ui_story"]
			local var_36_15 = 0

			if var_36_15 < arg_33_1.time_ and arg_33_1.time_ <= var_36_15 + arg_36_0 and not isNil(var_36_14) and arg_33_1.var_.characterEffect1049ui_story == nil then
				arg_33_1.var_.characterEffect1049ui_story = var_36_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_36_15 <= arg_33_1.time_ and arg_33_1.time_ < var_36_15 + var_36_16 and not isNil(var_36_14) then
				...
				if arg_33_1.var_.characterEffect1049ui_story and not isNil(var_36_14) then
					arg_33_1.var_.characterEffect1049ui_story.fillFlat = false
				end
			end

			if arg_33_1.time_ >= var_36_15 + var_36_16 and arg_33_1.time_ < var_36_15 + var_36_16 + arg_36_0 and not isNil(var_36_14) and arg_33_1.var_.characterEffect1049ui_story then
				arg_33_1.var_.characterEffect1049ui_story.fillFlat = false
			end
			...
			if var_36_21 <= arg_33_1.time_ and arg_33_1.time_ < var_36_21 + var_36_22 then
				...
				local var_36_24 = Vector3.New(-0.7, -1.15, -6.2)

				var_36_20.localPosition = Vector3.Lerp(arg_33_1.var_.moveOldPos1015ui_story, var_36_24, var_36_23)
			...
			local var_36_29 = arg_33_1.actors_["1015ui_story"]
			local var_36_30 = 0

			if var_36_30 < arg_33_1.time_ and arg_33_1.time_ <= var_36_30 + arg_36_0 and not isNil(var_36_29) and arg_33_1.var_.characterEffect1015ui_story == nil then
				arg_33_1.var_.characterEffect1015ui_story = var_36_29:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_36_30 <= arg_33_1.time_ and arg_33_1.time_ < var_36_30 + var_36_31 and not isNil(var_36_29) then
				...
				if arg_33_1.var_.characterEffect1015ui_story and not isNil(var_36_29) then
			...
			if arg_33_1.time_ >= var_36_30 + var_36_31 and arg_33_1.time_ < var_36_30 + var_36_31 + arg_36_0 and not isNil(var_36_29) and arg_33_1.var_.characterEffect1015ui_story then
				local var_36_34 = 0.5

				arg_33_1.var_.characterEffect1015ui_story.fillFlat = true
				arg_33_1.var_.characterEffect1015ui_story.fillRatio = var_36_34
			end

			local var_36_35 = 0
			local var_36_36 = 0.35
			...
			if var_36_35 < arg_33_1.time_ and arg_33_1.time_ <= var_36_35 + arg_36_0 then
				...
				local var_36_37 = arg_33_1:FormatText(StoryNameCfg[562].name)
				...
				local var_36_38 = arg_33_1:GetWordFromCfg(318241008)
				...
				if manager.audio:GetVoiceLength("story_v_out_318241", "318241008", "story_v_out_318241.awb") ~= 0 then
					local var_36_43 = manager.audio:GetVoiceLength("story_v_out_318241", "318241008", "story_v_out_318241.awb") / 1000
					...
					if var_36_38.prefab_name ~= "" and arg_33_1.actors_[var_36_38.prefab_name] ~= nil then
						local var_36_44 = LuaForUtil.PlayVoiceWithCriLipsync(arg_33_1.actors_[var_36_38.prefab_name].transform, "story_v_out_318241", "318241008", "story_v_out_318241.awb")

						arg_33_1:RecordAudio("318241008", var_36_44)
						arg_33_1:RecordAudio("318241008", var_36_44)
					else
	...
	Play318241009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			...
			if var_40_7 < arg_37_1.time_ and arg_37_1.time_ <= var_40_7 + arg_40_0 and not isNil(var_40_6) and arg_37_1.var_.characterEffect1049ui_story == nil then
			...
			if arg_37_1.time_ >= var_40_7 + var_40_8 and arg_37_1.time_ < var_40_7 + var_40_8 + arg_40_0 and not isNil(var_40_6) and arg_37_1.var_.characterEffect1049ui_story then
				local var_40_11 = 0.5
