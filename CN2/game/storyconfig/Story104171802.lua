return {
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_1 < arg_45_1.time_ and arg_45_1.time_ <= var_48_1 + arg_48_0 then
				...
				if not var_48_2 then
					var_48_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_suduxian01_in_keep"))
					var_48_2.name = "20111"
					arg_45_1.var_.effect20111 = var_48_2
				end

				local var_48_3 = var_48_0:Find("")

				if var_48_3 then
					var_48_2.transform.parent = var_48_3
				else
					var_48_2.transform.parent = var_48_0
				end

				var_48_2.transform.localPosition = Vector3.New(0, 0, -4)
				var_48_2.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_48_4 = manager.ui.mainCameraCom_
				local var_48_5 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_48_4.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_48_6 = var_48_2.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_48_7 = 15
				local var_48_8 = 2 * var_48_7 * Mathf.Tan(var_48_4.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_48_4.aspect
				local var_48_9 = 1
				local var_48_10 = 1.7777777777777777

				if var_48_10 < var_48_4.aspect then
					var_48_9 = var_48_8 / (2 * var_48_7 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_48_10)
				end

				for iter_48_0, iter_48_1 in ipairs(var_48_6) do
					local var_48_11 = iter_48_1.transform.localScale

					iter_48_1.transform.localScale = Vector3.New(var_48_11.x / var_48_5 * var_48_9, var_48_11.y / var_48_5, var_48_11.z)
				end
			end

			local var_48_12 = manager.ui.mainCamera.transform
			local var_48_13 = 1.86666666666667

			if var_48_13 < arg_45_1.time_ and arg_45_1.time_ <= var_48_13 + arg_48_0 then
				local var_48_14 = arg_45_1.var_.effect20111
			...
			local var_48_15 = arg_45_1.bgs_.I17i.transform
			local var_48_16 = 0.1

			if var_48_16 < arg_45_1.time_ and arg_45_1.time_ <= var_48_16 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_15.localPosition
			end
			...
			if var_48_16 <= arg_45_1.time_ and arg_45_1.time_ < var_48_16 + var_48_17 then
				...
				local var_48_19 = Vector3.New(0, 1, 10)

				var_48_15.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, var_48_19, var_48_18)
			end

			if arg_45_1.time_ >= var_48_16 + var_48_17 and arg_45_1.time_ < var_48_16 + var_48_17 + arg_48_0 then
				var_48_15.localPosition = Vector3.New(0, 1, 10)
			end

			local var_48_20 = arg_45_1.bgs_.I17i.transform
			local var_48_21 = 0.2

			if var_48_21 < arg_45_1.time_ and arg_45_1.time_ <= var_48_21 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_20.localPosition
			end
			...
			if var_48_21 <= arg_45_1.time_ and arg_45_1.time_ < var_48_21 + var_48_22 then
				...
				local var_48_24 = Vector3.New(0, 1, 3)

				var_48_20.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, var_48_24, var_48_23)
			end

			if arg_45_1.time_ >= var_48_21 + var_48_22 and arg_45_1.time_ < var_48_21 + var_48_22 + arg_48_0 then
				var_48_20.localPosition = Vector3.New(0, 1, 3)
			end

			local var_48_25 = arg_45_1.bgs_.I17i.transform
			local var_48_26 = 1

			if var_48_26 < arg_45_1.time_ and arg_45_1.time_ <= var_48_26 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_25.localPosition
			end
			...
			if var_48_26 <= arg_45_1.time_ and arg_45_1.time_ < var_48_26 + var_48_27 then
				...
				local var_48_29 = Vector3.New(0, 1, 10)

				var_48_25.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, var_48_29, var_48_28)
			end

			if arg_45_1.time_ >= var_48_26 + var_48_27 and arg_45_1.time_ < var_48_26 + var_48_27 + arg_48_0 then
				var_48_25.localPosition = Vector3.New(0, 1, 10)
			end

			local var_48_30 = arg_45_1.bgs_.I17i.transform
			local var_48_31 = 1.1

			if var_48_31 < arg_45_1.time_ and arg_45_1.time_ <= var_48_31 + arg_48_0 then
				arg_45_1.var_.moveOldPosI17i = var_48_30.localPosition
			end
			...
			if var_48_31 <= arg_45_1.time_ and arg_45_1.time_ < var_48_31 + var_48_32 then
				...
				local var_48_34 = Vector3.New(0, 1, 9.5)

				var_48_30.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPosI17i, var_48_34, var_48_33)
			end

			if arg_45_1.time_ >= var_48_31 + var_48_32 and arg_45_1.time_ < var_48_31 + var_48_32 + arg_48_0 then
				var_48_30.localPosition = Vector3.New(0, 1, 9.5)
			end

			local var_48_35 = manager.ui.mainCamera.transform
			local var_48_36 = 0.9

			if var_48_36 < arg_45_1.time_ and arg_45_1.time_ <= var_48_36 + arg_48_0 then
				arg_45_1.var_.shakeOldPos = var_48_35.localPosition
			end

			local var_48_37 = 0.466666666666667

			if var_48_36 <= arg_45_1.time_ and arg_45_1.time_ < var_48_36 + var_48_37 then
				local var_48_38 = (arg_45_1.time_ - var_48_36) / 0.099
				local var_48_39, var_48_40 = math.modf(var_48_38)

				var_48_35.localPosition = Vector3.New(var_48_40 * 0.13, var_48_40 * 0.13, var_48_40 * 0.13) + arg_45_1.var_.shakeOldPos
			end

			if arg_45_1.time_ >= var_48_36 + var_48_37 and arg_45_1.time_ < var_48_36 + var_48_37 + arg_48_0 then
				var_48_35.localPosition = arg_45_1.var_.shakeOldPos
			end
			...
			if var_48_41 < arg_45_1.time_ and arg_45_1.time_ <= var_48_41 + arg_48_0 then
				local var_48_43 = "play"
				local var_48_44 = "effect"

				arg_45_1:AudioAction(var_48_43, var_48_44, "se_story_1311", "se_story_1311_gun04", "")
			end
			...
			if var_48_45 < arg_45_1.time_ and arg_45_1.time_ <= var_48_45 + arg_48_0 then
				...
				local var_48_47 = arg_45_1:GetWordFromCfg(417182011)
				...
				local var_48_51 = var_48_49 <= 0 and var_48_46 or var_48_46 * (var_48_50 / var_48_49)

				if var_48_51 > 0 and var_48_46 < var_48_51 then
					arg_45_1.talkMaxDuration = var_48_51

					if var_48_51 + var_48_45 > arg_45_1.duration_ then
						arg_45_1.duration_ = var_48_51 + var_48_45
					end
				end
			...
			local var_48_52 = math.max(var_48_46, arg_45_1.talkMaxDuration)

			if var_48_45 <= arg_45_1.time_ and arg_45_1.time_ < var_48_45 + var_48_52 then
				arg_45_1.typewritter.percent = (arg_45_1.time_ - var_48_45) / var_48_52

				arg_45_1.typewritter:SetDirty()
			end

			if arg_45_1.time_ >= var_48_45 + var_48_52 and arg_45_1.time_ < var_48_45 + var_48_52 + arg_48_0 then
		...
		function arg_179_1.onSingleLineUpdate_(arg_182_0)
			...
			if var_182_1 < arg_179_1.time_ and arg_179_1.time_ <= var_182_1 + arg_182_0 then
				...
				if not var_182_2 then
					var_182_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"))
					var_182_2.name = "2043"
					arg_179_1.var_.effect2043 = var_182_2
				end

				local var_182_3 = var_182_0:Find("")

				if var_182_3 then
					var_182_2.transform.parent = var_182_3
				else
					var_182_2.transform.parent = var_182_0
				end
			...
			local var_182_4 = manager.ui.mainCamera.transform
			local var_182_5 = 0.0666666666666667

			if var_182_5 < arg_179_1.time_ and arg_179_1.time_ <= var_182_5 + arg_182_0 then
				arg_179_1.var_.shakeOldPos = var_182_4.localPosition
			end

			local var_182_6 = 0.433333333333333

			if var_182_5 <= arg_179_1.time_ and arg_179_1.time_ < var_182_5 + var_182_6 then
				local var_182_7 = (arg_179_1.time_ - var_182_5) / 0.099
				local var_182_8, var_182_9 = math.modf(var_182_7)

				var_182_4.localPosition = Vector3.New(var_182_9 * 0.13, var_182_9 * 0.13, var_182_9 * 0.13) + arg_179_1.var_.shakeOldPos
			end

			if arg_179_1.time_ >= var_182_5 + var_182_6 and arg_179_1.time_ < var_182_5 + var_182_6 + arg_182_0 then
				var_182_4.localPosition = arg_179_1.var_.shakeOldPos
			end
			...
			if var_182_10 < arg_179_1.time_ and arg_179_1.time_ <= var_182_10 + arg_182_0 then
				...
				local var_182_13 = "effect"

				arg_179_1:AudioAction(var_182_12, var_182_13, "se_story_1311", "se_story_1311_gun02", "")
			end
			...
			if var_182_14 < arg_179_1.time_ and arg_179_1.time_ <= var_182_14 + arg_182_0 then
				...
				local var_182_16 = LeanTween.value(arg_179_1.dialog_, 0, 1, 0.3)

				var_182_16:setOnUpdate(LuaHelper.FloatAction(function(arg_183_0)
					arg_179_1.dialogCg_.alpha = arg_183_0
				end))
				var_182_16:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_179_1.dialog_)
					var_182_16:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_182_17 = arg_179_1:GetWordFromCfg(417182043)
			...
			local var_182_22 = var_182_14 + 0.3
			local var_182_23 = math.max(var_182_15, arg_179_1.talkMaxDuration)
		...
		function arg_193_1.onSingleLineUpdate_(arg_196_0)
			...
			if var_196_1 < arg_193_1.time_ and arg_193_1.time_ <= var_196_1 + arg_196_0 then
				...
				if not var_196_2 then
					var_196_2 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_hit"))
					var_196_2.name = "417182046"
					arg_193_1.var_.effect417182046 = var_196_2
				end

				local var_196_3 = var_196_0:Find("")

				if var_196_3 then
					var_196_2.transform.parent = var_196_3
				else
					var_196_2.transform.parent = var_196_0
				end
			...
			local var_196_4 = manager.ui.mainCamera.transform
			local var_196_5 = 0.0333333333333333

			if var_196_5 < arg_193_1.time_ and arg_193_1.time_ <= var_196_5 + arg_196_0 then
				arg_193_1.var_.shakeOldPos = var_196_4.localPosition
			end

			local var_196_6 = 0.383275299333036

			if var_196_5 <= arg_193_1.time_ and arg_193_1.time_ < var_196_5 + var_196_6 then
				local var_196_7 = (arg_193_1.time_ - var_196_5) / 0.066
				local var_196_8, var_196_9 = math.modf(var_196_7)

				var_196_4.localPosition = Vector3.New(var_196_9 * 0.13, var_196_9 * 0.13, var_196_9 * 0.13) + arg_193_1.var_.shakeOldPos
			end

			if arg_193_1.time_ >= var_196_5 + var_196_6 and arg_193_1.time_ < var_196_5 + var_196_6 + arg_196_0 then
				var_196_4.localPosition = arg_193_1.var_.shakeOldPos
			end

			local var_196_10 = 0.05
			local var_196_11 = 1

			if var_196_10 < arg_193_1.time_ and arg_193_1.time_ <= var_196_10 + arg_196_0 then
				local var_196_12 = "play"
				local var_196_13 = "effect"

				arg_193_1:AudioAction(var_196_12, var_196_13, "se_story_1311", "se_story_1311_gun03", "")
			end
			...
			local var_196_14 = 0.718898800201714
			local var_196_15 = 1.075
			...
			if var_196_14 < arg_193_1.time_ and arg_193_1.time_ <= var_196_14 + arg_196_0 then
				...
				local var_196_17 = arg_193_1:GetWordFromCfg(417182046)
			...
			local var_196_22 = var_196_14 + 0.3
			local var_196_23 = math.max(var_196_15, arg_193_1.talkMaxDuration)
	...
	assets = {
		...
		"Assets/UIResources/UI_AB/TextureConfig/Background/SS1706a"
	},
	voices = {
