	...
	Play107052001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_42 < arg_1_1.time_ and arg_1_1.time_ <= var_4_42 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_44, var_4_45, "se_story_7", "se_story_7_lift", "")
			end
			...
			if var_4_46 < arg_1_1.time_ and arg_1_1.time_ <= var_4_46 + arg_4_0 then
				...
				arg_1_1:AudioAction(var_4_48, var_4_49, "se_story_7", "se_story_7_lastcharge_loop", "")
			end
			...
			if var_4_50 < arg_1_1.time_ and arg_1_1.time_ <= var_4_50 + arg_4_0 then
				...
				local var_4_53 = arg_1_1:FormatText(StoryNameCfg[84].name)
				...
				local var_4_54 = arg_1_1:GetWordFromCfg(107052001)
				...
				if manager.audio:GetVoiceLength("story_v_out_107052", "107052001", "story_v_out_107052.awb") ~= 0 then
					local var_4_59 = manager.audio:GetVoiceLength("story_v_out_107052", "107052001", "story_v_out_107052.awb") / 1000
					...
					if var_4_54.prefab_name ~= "" and arg_1_1.actors_[var_4_54.prefab_name] ~= nil then
						local var_4_60 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_54.prefab_name].transform, "story_v_out_107052", "107052001", "story_v_out_107052.awb")

						arg_1_1:RecordAudio("107052001", var_4_60)
						arg_1_1:RecordAudio("107052001", var_4_60)
					else
	...
	Play107052004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_18 < arg_17_1.time_ and arg_17_1.time_ <= var_20_18 + arg_20_0 then
				arg_17_1:PlayTimeline("1050ui_story", "StoryTimeline/CharAction/1050/1050action/1050action7_1")
			end
	...
	Play107052006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_27 < arg_25_1.time_ and arg_25_1.time_ <= var_28_27 + arg_28_0 then
				arg_25_1:PlayTimeline("1099ui_story", "StoryTimeline/CharAction/1099/1099action/1099action5_1")
			end
	...
	Play107052007 = function(arg_29_0, arg_29_1)
		...
		function arg_29_1.onSingleLineUpdate_(arg_32_0)
			...
			if var_32_25 <= arg_29_1.time_ and arg_29_1.time_ < var_32_25 + var_32_26 then
				...
				local var_32_28 = Vector3.New(0, -2.35, -2.9)

				var_32_24.localPosition = Vector3.Lerp(arg_29_1.var_.moveOldPos3014_tpose, var_32_28, var_32_27)

				local var_32_29 = manager.ui.mainCamera.transform.position - var_32_24.position

				var_32_24.forward = Vector3.New(var_32_29.x, var_32_29.y, var_32_29.z)

				local var_32_30 = var_32_24.localEulerAngles

				var_32_30.z = 0
				var_32_30.x = 0
				var_32_24.localEulerAngles = var_32_30
			end
			...
			if arg_29_1.time_ >= var_32_25 + var_32_26 and arg_29_1.time_ < var_32_25 + var_32_26 + arg_32_0 then
				...
				local var_32_31 = manager.ui.mainCamera.transform.position - var_32_24.position

				var_32_24.forward = Vector3.New(var_32_31.x, var_32_31.y, var_32_31.z)

				local var_32_32 = var_32_24.localEulerAngles

				var_32_32.z = 0
				var_32_32.x = 0
				var_32_24.localEulerAngles = var_32_32
			end
			...
			if var_32_34 < arg_29_1.time_ and arg_29_1.time_ <= var_32_34 + arg_32_0 then
				...
				local var_32_36 = arg_29_1:FormatText(StoryNameCfg[96].name)
				...
				local var_32_37 = arg_29_1:GetWordFromCfg(107052007)
				...
				if manager.audio:GetVoiceLength("story_v_out_107052", "107052007", "story_v_out_107052.awb") ~= 0 then
					local var_32_42 = manager.audio:GetVoiceLength("story_v_out_107052", "107052007", "story_v_out_107052.awb") / 1000
					...
					if var_32_37.prefab_name ~= "" and arg_29_1.actors_[var_32_37.prefab_name] ~= nil then
						local var_32_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_29_1.actors_[var_32_37.prefab_name].transform, "story_v_out_107052", "107052007", "story_v_out_107052.awb")

						arg_29_1:RecordAudio("107052007", var_32_43)
						arg_29_1:RecordAudio("107052007", var_32_43)
					else
	...
	Play107052010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_11 <= arg_41_1.time_ and arg_41_1.time_ < var_44_11 + var_44_12 then
				...
				local var_44_14 = Vector3.New(0, 100, 0)

				var_44_10.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos3014_tpose, var_44_14, var_44_13)

				local var_44_15 = manager.ui.mainCamera.transform.position - var_44_10.position

				var_44_10.forward = Vector3.New(var_44_15.x, var_44_15.y, var_44_15.z)

				local var_44_16 = var_44_10.localEulerAngles

				var_44_16.z = 0
				var_44_16.x = 0
				var_44_10.localEulerAngles = var_44_16
			end
			...
			if arg_41_1.time_ >= var_44_11 + var_44_12 and arg_41_1.time_ < var_44_11 + var_44_12 + arg_44_0 then
				...
				local var_44_17 = manager.ui.mainCamera.transform.position - var_44_10.position

				var_44_10.forward = Vector3.New(var_44_17.x, var_44_17.y, var_44_17.z)

				local var_44_18 = var_44_10.localEulerAngles

				var_44_18.z = 0
				var_44_18.x = 0
				var_44_10.localEulerAngles = var_44_18
			end

			local var_44_19 = arg_41_1.actors_["1099ui_story"].transform
			local var_44_20 = 0

			if var_44_20 < arg_41_1.time_ and arg_41_1.time_ <= var_44_20 + arg_44_0 then
				arg_41_1.var_.moveOldPos1099ui_story = var_44_19.localPosition
			end
			...
			if var_44_20 <= arg_41_1.time_ and arg_41_1.time_ < var_44_20 + var_44_21 then
				...
				local var_44_23 = Vector3.New(0, -1.08, -5.9)

				var_44_19.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1099ui_story, var_44_23, var_44_22)
			...
			if arg_41_1.time_ >= var_44_20 + var_44_21 and arg_41_1.time_ < var_44_20 + var_44_21 + arg_44_0 then
				var_44_19.localPosition = Vector3.New(0, -1.08, -5.9)
			...
			if var_44_28 < arg_41_1.time_ and arg_41_1.time_ <= var_44_28 + arg_44_0 then
				arg_41_1:PlayTimeline("1099ui_story", "StoryTimeline/CharAction/1099/1099action/1099action5_1")
			end
			...
			if var_44_30 < arg_41_1.time_ and arg_41_1.time_ <= var_44_30 + arg_44_0 then
				...
				local var_44_32 = arg_41_1:FormatText(StoryNameCfg[84].name)
				...
				local var_44_33 = arg_41_1:GetWordFromCfg(107052010)
				...
				if manager.audio:GetVoiceLength("story_v_out_107052", "107052010", "story_v_out_107052.awb") ~= 0 then
					local var_44_38 = manager.audio:GetVoiceLength("story_v_out_107052", "107052010", "story_v_out_107052.awb") / 1000
					...
					if var_44_33.prefab_name ~= "" and arg_41_1.actors_[var_44_33.prefab_name] ~= nil then
						local var_44_39 = LuaForUtil.PlayVoiceWithCriLipsync(arg_41_1.actors_[var_44_33.prefab_name].transform, "story_v_out_107052", "107052010", "story_v_out_107052.awb")

						arg_41_1:RecordAudio("107052010", var_44_39)
						arg_41_1:RecordAudio("107052010", var_44_39)
					else
	...
	Play107052011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_41 < arg_45_1.time_ and arg_45_1.time_ <= var_48_41 + arg_48_0 then
				...
				if var_48_42 then
					var_48_42.material = arg_45_1.transpaintGo_:GetComponent("SpriteRenderer").material

					local var_48_43 = var_48_42.material
					local var_48_44 = var_48_43:GetColor("_Color")

					arg_45_1.var_.alphaOldValueC04a = var_48_44.a
					arg_45_1.var_.alphaMatValueC04a = var_48_43
				end
			...
			if var_48_41 <= arg_45_1.time_ and arg_45_1.time_ < var_48_41 + var_48_45 then
				local var_48_46 = (arg_45_1.time_ - var_48_41) / var_48_45
				local var_48_47 = Mathf.Lerp(arg_45_1.var_.alphaOldValueC04a, 0, var_48_46)

				if arg_45_1.var_.alphaMatValueC04a then
					local var_48_48 = arg_45_1.var_.alphaMatValueC04a
					local var_48_49 = var_48_48:GetColor("_Color")

					var_48_49.a = var_48_47

					var_48_48:SetColor("_Color", var_48_49)
				end
			end

			if arg_45_1.time_ >= var_48_41 + var_48_45 and arg_45_1.time_ < var_48_41 + var_48_45 + arg_48_0 and arg_45_1.var_.alphaMatValueC04a then
				local var_48_50 = arg_45_1.var_.alphaMatValueC04a
				local var_48_51 = var_48_50:GetColor("_Color")

				var_48_51.a = 0

				var_48_50:SetColor("_Color", var_48_51)
			end

			local var_48_52 = arg_45_1.bgs_.S0702
			local var_48_53 = 1.5

			if var_48_53 < arg_45_1.time_ and arg_45_1.time_ <= var_48_53 + arg_48_0 then
				local var_48_54 = var_48_52:GetComponent("SpriteRenderer")

				if var_48_54 then
					var_48_54.material = arg_45_1.transpaintGo_:GetComponent("SpriteRenderer").material

					local var_48_55 = var_48_54.material
					local var_48_56 = var_48_55:GetColor("_Color")

					arg_45_1.var_.alphaOldValueS0702 = var_48_56.a
					arg_45_1.var_.alphaMatValueS0702 = var_48_55
				end
			...
			if var_48_53 <= arg_45_1.time_ and arg_45_1.time_ < var_48_53 + var_48_57 then
				local var_48_58 = (arg_45_1.time_ - var_48_53) / var_48_57
				local var_48_59 = Mathf.Lerp(arg_45_1.var_.alphaOldValueS0702, 1, var_48_58)

				if arg_45_1.var_.alphaMatValueS0702 then
					local var_48_60 = arg_45_1.var_.alphaMatValueS0702
					local var_48_61 = var_48_60:GetColor("_Color")

					var_48_61.a = var_48_59

					var_48_60:SetColor("_Color", var_48_61)
				end
			end

			if arg_45_1.time_ >= var_48_53 + var_48_57 and arg_45_1.time_ < var_48_53 + var_48_57 + arg_48_0 and arg_45_1.var_.alphaMatValueS0702 then
				local var_48_62 = arg_45_1.var_.alphaMatValueS0702
				local var_48_63 = var_48_62:GetColor("_Color")

				var_48_63.a = 1

				var_48_62:SetColor("_Color", var_48_63)
			end

			local var_48_64 = 0

			if var_48_64 < arg_45_1.time_ and arg_45_1.time_ <= var_48_64 + arg_48_0 then
			...
			if var_48_66 < arg_45_1.time_ and arg_45_1.time_ <= var_48_66 + arg_48_0 then
				...
				local var_48_68 = LeanTween.value(arg_45_1.dialog_, 0, 1, 0.3)

				var_48_68:setOnUpdate(LuaHelper.FloatAction(function(arg_49_0)
					arg_45_1.dialogCg_.alpha = arg_49_0
				end))
				var_48_68:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_45_1.dialog_)
					var_48_68:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_48_69 = arg_45_1:FormatText(StoryNameCfg[96].name)

				arg_45_1.leftNameTxt_.text = var_48_69
				...
				local var_48_70 = arg_45_1:GetWordFromCfg(107052011)
				local var_48_71 = arg_45_1:FormatText(var_48_70.content)

				arg_45_1.text_.text = var_48_71

				LuaForUtil.ClearLinePrefixSymbol(arg_45_1.text_)

				local var_48_72 = 27
				local var_48_73 = utf8.len(var_48_71)
				local var_48_74 = var_48_72 <= 0 and var_48_67 or var_48_67 * (var_48_73 / var_48_72)

				if var_48_74 > 0 and var_48_67 < var_48_74 then
					arg_45_1.talkMaxDuration = var_48_74
					var_48_66 = var_48_66 + 0.3

					if var_48_74 + var_48_66 > arg_45_1.duration_ then
						arg_45_1.duration_ = var_48_74 + var_48_66
					end
				end
				...
				if manager.audio:GetVoiceLength("story_v_out_107052", "107052011", "story_v_out_107052.awb") ~= 0 then
					local var_48_75 = manager.audio:GetVoiceLength("story_v_out_107052", "107052011", "story_v_out_107052.awb") / 1000

					if var_48_75 + var_48_66 > arg_45_1.duration_ then
						arg_45_1.duration_ = var_48_75 + var_48_66
					end

					if var_48_70.prefab_name ~= "" and arg_45_1.actors_[var_48_70.prefab_name] ~= nil then
						local var_48_76 = LuaForUtil.PlayVoiceWithCriLipsync(arg_45_1.actors_[var_48_70.prefab_name].transform, "story_v_out_107052", "107052011", "story_v_out_107052.awb")

						arg_45_1:RecordAudio("107052011", var_48_76)
						arg_45_1:RecordAudio("107052011", var_48_76)
					else
			...
			local var_48_77 = var_48_66 + 0.3
			local var_48_78 = math.max(var_48_67, arg_45_1.talkMaxDuration)

			if var_48_77 <= arg_45_1.time_ and arg_45_1.time_ < var_48_77 + var_48_78 then
				arg_45_1.typewritter.percent = (arg_45_1.time_ - var_48_77) / var_48_78

				arg_45_1.typewritter:SetDirty()
			end

			if arg_45_1.time_ >= var_48_77 + var_48_78 and arg_45_1.time_ < var_48_77 + var_48_78 + arg_48_0 then
