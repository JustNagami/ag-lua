	...
	Play417191067 = function(arg_278_0, arg_278_1)
		...
		function arg_278_1.onSingleLineUpdate_(arg_281_0)
			...
			if var_281_57 < arg_278_1.time_ and arg_278_1.time_ <= var_281_57 + arg_281_0 then
				...
				local var_281_59 = arg_278_1:GetWordFromCfg(102)
				local var_281_60 = arg_278_1:FormatText(var_281_59.content)

				arg_278_1.text_.text = var_281_60

				LuaForUtil.ClearLinePrefixSymbol(arg_278_1.text_)

				local var_281_61 = 0
				local var_281_62 = utf8.len(var_281_60)
				local var_281_63 = var_281_61 <= 0 and var_281_58 or var_281_58 * (var_281_62 / var_281_61)

				if var_281_63 > 0 and var_281_58 < var_281_63 then
					arg_278_1.talkMaxDuration = var_281_63

					if var_281_63 + var_281_57 > arg_278_1.duration_ then
						arg_278_1.duration_ = var_281_63 + var_281_57
					end
				end
			...
			local var_281_64 = math.max(var_281_58, arg_278_1.talkMaxDuration)

			if var_281_57 <= arg_278_1.time_ and arg_278_1.time_ < var_281_57 + var_281_64 then
				arg_278_1.typewritter.percent = (arg_278_1.time_ - var_281_57) / var_281_64

				arg_278_1.typewritter:SetDirty()
			end

			if arg_278_1.time_ >= var_281_57 + var_281_64 and arg_278_1.time_ < var_281_57 + var_281_64 + arg_281_0 then
