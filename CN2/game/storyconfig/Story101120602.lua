return {
	...
	Play112062002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if arg_7_1.actors_[var_10_0] == nil then
				local var_10_1 = Asset.Load("Char/" .. "1081ui_story")

				if not isNil(var_10_1) then
					local var_10_2 = Object.Instantiate(Asset.Load("Char/" .. "1081ui_story"), arg_7_1.stage_.transform)
			...
			local var_10_5 = arg_7_1.actors_["1081ui_story"].transform
			local var_10_6 = 0

			if var_10_6 < arg_7_1.time_ and arg_7_1.time_ <= var_10_6 + arg_10_0 then
				arg_7_1.var_.moveOldPos1081ui_story = var_10_5.localPosition
			end
			...
			if var_10_6 <= arg_7_1.time_ and arg_7_1.time_ < var_10_6 + var_10_7 then
				...
				var_10_5.localPosition = Vector3.Lerp(arg_7_1.var_.moveOldPos1081ui_story, var_10_9, var_10_8)
			...
			if arg_7_1.time_ >= var_10_6 + var_10_7 and arg_7_1.time_ < var_10_6 + var_10_7 + arg_10_0 then
				var_10_5.localPosition = Vector3.New(0, -0.92, -5.8)
			...
			local var_10_16 = arg_7_1.actors_["1081ui_story"]
			local var_10_17 = 0

			if var_10_17 < arg_7_1.time_ and arg_7_1.time_ <= var_10_17 + arg_10_0 and not isNil(var_10_16) and arg_7_1.var_.characterEffect1081ui_story == nil then
				arg_7_1.var_.characterEffect1081ui_story = var_10_16:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_10_17 <= arg_7_1.time_ and arg_7_1.time_ < var_10_17 + var_10_18 and not isNil(var_10_16) then
				...
				if arg_7_1.var_.characterEffect1081ui_story and not isNil(var_10_16) then
					arg_7_1.var_.characterEffect1081ui_story.fillFlat = false
				end
			end

			if arg_7_1.time_ >= var_10_17 + var_10_18 and arg_7_1.time_ < var_10_17 + var_10_18 + arg_10_0 and not isNil(var_10_16) and arg_7_1.var_.characterEffect1081ui_story then
				arg_7_1.var_.characterEffect1081ui_story.fillFlat = false
			end
			...
			if var_10_20 < arg_7_1.time_ and arg_7_1.time_ <= var_10_20 + arg_10_0 then
				...
				local var_10_23 = arg_7_1:GetWordFromCfg(112062002)
				...
				if manager.audio:GetVoiceLength("story_v_out_112062", "112062002", "story_v_out_112062.awb") ~= 0 then
					local var_10_28 = manager.audio:GetVoiceLength("story_v_out_112062", "112062002", "story_v_out_112062.awb") / 1000
					...
					if var_10_23.prefab_name ~= "" and arg_7_1.actors_[var_10_23.prefab_name] ~= nil then
						local var_10_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_7_1.actors_[var_10_23.prefab_name].transform, "story_v_out_112062", "112062002", "story_v_out_112062.awb")

						arg_7_1:RecordAudio("112062002", var_10_29)
						arg_7_1:RecordAudio("112062002", var_10_29)
					else
	...
	Play112062004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if arg_15_1.actors_[var_18_0] == nil then
				local var_18_1 = Asset.Load("Char/" .. "1039ui_story")

				if not isNil(var_18_1) then
					local var_18_2 = Object.Instantiate(Asset.Load("Char/" .. "1039ui_story"), arg_15_1.stage_.transform)
			...
			local var_18_5 = arg_15_1.actors_["1039ui_story"].transform
			local var_18_6 = 0

			if var_18_6 < arg_15_1.time_ and arg_15_1.time_ <= var_18_6 + arg_18_0 then
				arg_15_1.var_.moveOldPos1039ui_story = var_18_5.localPosition
			end
			...
			if var_18_6 <= arg_15_1.time_ and arg_15_1.time_ < var_18_6 + var_18_7 then
				...
				local var_18_9 = Vector3.New(0, -1.01, -5.9)

				var_18_5.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos1039ui_story, var_18_9, var_18_8)
			...
			if arg_15_1.time_ >= var_18_6 + var_18_7 and arg_15_1.time_ < var_18_6 + var_18_7 + arg_18_0 then
				var_18_5.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			local var_18_16 = arg_15_1.actors_["1039ui_story"]
			local var_18_17 = 0

			if var_18_17 < arg_15_1.time_ and arg_15_1.time_ <= var_18_17 + arg_18_0 and not isNil(var_18_16) and arg_15_1.var_.characterEffect1039ui_story == nil then
				arg_15_1.var_.characterEffect1039ui_story = var_18_16:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_18_18 = 0.2

			if var_18_17 <= arg_15_1.time_ and arg_15_1.time_ < var_18_17 + var_18_18 and not isNil(var_18_16) then
				local var_18_19 = (arg_15_1.time_ - var_18_17) / var_18_18

				if arg_15_1.var_.characterEffect1039ui_story and not isNil(var_18_16) then
					arg_15_1.var_.characterEffect1039ui_story.fillFlat = false
				end
			end

			if arg_15_1.time_ >= var_18_17 + var_18_18 and arg_15_1.time_ < var_18_17 + var_18_18 + arg_18_0 and not isNil(var_18_16) and arg_15_1.var_.characterEffect1039ui_story then
				arg_15_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if var_18_20 < arg_15_1.time_ and arg_15_1.time_ <= var_18_20 + arg_18_0 then
				...
				local var_18_22 = arg_15_1:FormatText(StoryNameCfg[9].name)
				...
				local var_18_23 = arg_15_1:GetWordFromCfg(112062004)
				...
				if manager.audio:GetVoiceLength("story_v_out_112062", "112062004", "story_v_out_112062.awb") ~= 0 then
					local var_18_28 = manager.audio:GetVoiceLength("story_v_out_112062", "112062004", "story_v_out_112062.awb") / 1000
					...
					if var_18_23.prefab_name ~= "" and arg_15_1.actors_[var_18_23.prefab_name] ~= nil then
						local var_18_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_15_1.actors_[var_18_23.prefab_name].transform, "story_v_out_112062", "112062004", "story_v_out_112062.awb")

						arg_15_1:RecordAudio("112062004", var_18_29)
						arg_15_1:RecordAudio("112062004", var_18_29)
					else
	...
	Play112062008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_12 < arg_31_1.time_ and arg_31_1.time_ <= var_34_12 + arg_34_0 and not isNil(var_34_11) and arg_31_1.var_.characterEffect1081ui_story == nil then
			...
			if var_34_12 <= arg_31_1.time_ and arg_31_1.time_ < var_34_12 + var_34_13 and not isNil(var_34_11) then
				...
				if arg_31_1.var_.characterEffect1081ui_story and not isNil(var_34_11) then
					arg_31_1.var_.characterEffect1081ui_story.fillFlat = false
				end
			end

			if arg_31_1.time_ >= var_34_12 + var_34_13 and arg_31_1.time_ < var_34_12 + var_34_13 + arg_34_0 and not isNil(var_34_11) and arg_31_1.var_.characterEffect1081ui_story then
				arg_31_1.var_.characterEffect1081ui_story.fillFlat = false
			end
	...
	Play112062010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_2 < arg_39_1.time_ and arg_39_1.time_ <= var_42_2 + arg_42_0 and not isNil(var_42_1) and arg_39_1.var_.characterEffect1081ui_story == nil then
			...
			if arg_39_1.time_ >= var_42_2 + var_42_3 and arg_39_1.time_ < var_42_2 + var_42_3 + arg_42_0 and not isNil(var_42_1) and arg_39_1.var_.characterEffect1081ui_story then
				arg_39_1.var_.characterEffect1081ui_story.fillFlat = false
			end
