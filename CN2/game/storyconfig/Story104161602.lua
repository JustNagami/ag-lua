return {
		...
		function arg_73_1.onSingleLineUpdate_(arg_76_0)
			...
			if var_76_45 < arg_73_1.time_ and arg_73_1.time_ <= var_76_45 + arg_76_0 then
				...
				if not var_76_46 then
					var_76_46 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_error"))
					var_76_46.name = "113"
					arg_73_1.var_.effect113113 = var_76_46
				end

				local var_76_47 = var_76_44:Find("")

				if var_76_47 then
					var_76_46.transform.parent = var_76_47
				else
					var_76_46.transform.parent = var_76_44
				end

				var_76_46.transform.localPosition = Vector3.New(0, 0, 0)
				var_76_46.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_76_48 = manager.ui.mainCameraCom_
				local var_76_49 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_76_48.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_76_50 = var_76_46.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_76_51 = 15
				local var_76_52 = 2 * var_76_51 * Mathf.Tan(var_76_48.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_76_48.aspect
				local var_76_53 = 1
				local var_76_54 = 1.7777777777777777

				if var_76_54 < var_76_48.aspect then
					var_76_53 = var_76_52 / (2 * var_76_51 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_76_54)
				end

				for iter_76_7, iter_76_8 in ipairs(var_76_50) do
					local var_76_55 = iter_76_8.transform.localScale

					iter_76_8.transform.localScale = Vector3.New(var_76_55.x / var_76_49 * var_76_53, var_76_55.y / var_76_49, var_76_55.z)
				end
			end

			local var_76_56 = manager.ui.mainCamera.transform
			local var_76_57 = 1.98333333333333

			if var_76_57 < arg_73_1.time_ and arg_73_1.time_ <= var_76_57 + arg_76_0 then
				local var_76_58 = arg_73_1.var_.effect113113

				if var_76_58 then
					Object.Destroy(var_76_58)

					arg_73_1.var_.effect113113 = nil
				end
			end

			local var_76_59 = arg_73_1.bgs_.SS1607.transform
			local var_76_60 = 1.05

			if var_76_60 < arg_73_1.time_ and arg_73_1.time_ <= var_76_60 + arg_76_0 then
				arg_73_1.var_.moveOldPosSS1607 = var_76_59.localPosition
			end

			local var_76_61 = 0.001

			if var_76_60 <= arg_73_1.time_ and arg_73_1.time_ < var_76_60 + var_76_61 then
				local var_76_62 = (arg_73_1.time_ - var_76_60) / var_76_61
				local var_76_63 = Vector3.New(0, 1, 8.4)

				var_76_59.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPosSS1607, var_76_63, var_76_62)
			end

			if arg_73_1.time_ >= var_76_60 + var_76_61 and arg_73_1.time_ < var_76_60 + var_76_61 + arg_76_0 then
				var_76_59.localPosition = Vector3.New(0, 1, 8.4)
			end

			local var_76_64 = arg_73_1.bgs_.SS1607.transform
			local var_76_65 = 1.06666666666667

			if var_76_65 < arg_73_1.time_ and arg_73_1.time_ <= var_76_65 + arg_76_0 then
				arg_73_1.var_.moveOldPosSS1607 = var_76_64.localPosition
			end

			local var_76_66 = 2.8

			if var_76_65 <= arg_73_1.time_ and arg_73_1.time_ < var_76_65 + var_76_66 then
				local var_76_67 = (arg_73_1.time_ - var_76_65) / var_76_66
				local var_76_68 = Vector3.New(0, 1, 6.8)

				var_76_64.localPosition = Vector3.Lerp(arg_73_1.var_.moveOldPosSS1607, var_76_68, var_76_67)
			end

			if arg_73_1.time_ >= var_76_65 + var_76_66 and arg_73_1.time_ < var_76_65 + var_76_66 + arg_76_0 then
				var_76_64.localPosition = Vector3.New(0, 1, 6.8)
			end

			local var_76_69 = manager.ui.mainCamera.transform
			local var_76_70 = 1.06666666666667

			if var_76_70 < arg_73_1.time_ and arg_73_1.time_ <= var_76_70 + arg_76_0 then
				local var_76_71 = arg_73_1.var_.effect112

				if not var_76_71 then
					var_76_71 = Object.Instantiate(Asset.Load("Effect/Scene/fx_uistory_mist_in"))
					var_76_71.name = "112"
					arg_73_1.var_.effect112 = var_76_71
				end

				local var_76_72 = var_76_69:Find("")

				if var_76_72 then
					var_76_71.transform.parent = var_76_72
				else
					var_76_71.transform.parent = var_76_69
				end

				var_76_71.transform.localPosition = Vector3.New(0, 0, 0)
				var_76_71.transform.localRotation = Quaternion.Euler(0, 0, 0)

				local var_76_73 = manager.ui.mainCameraCom_
				local var_76_74 = Mathf.Tan(12.5 * Mathf.Deg2Rad) / Mathf.Tan(var_76_73.fieldOfView * 0.5 * Mathf.Deg2Rad)
				local var_76_75 = var_76_71.transform:GetComponentsInChildren(typeof(Transform), true):ToTable()
				local var_76_76 = 15
				local var_76_77 = 2 * var_76_76 * Mathf.Tan(var_76_73.fieldOfView * 0.5 * Mathf.Deg2Rad) * var_76_73.aspect
				local var_76_78 = 1
				local var_76_79 = 1.7777777777777777

				if var_76_79 < var_76_73.aspect then
					var_76_78 = var_76_77 / (2 * var_76_76 * Mathf.Tan(15 * Mathf.Deg2Rad) * var_76_79)
				end

				for iter_76_9, iter_76_10 in ipairs(var_76_75) do
					local var_76_80 = iter_76_10.transform.localScale

					iter_76_10.transform.localScale = Vector3.New(var_76_80.x / var_76_74 * var_76_78, var_76_80.y / var_76_74, var_76_80.z)
				end
			end
			...
			if var_76_81 < arg_73_1.time_ and arg_73_1.time_ <= var_76_81 + arg_76_0 then
				local var_76_83 = "play"
				local var_76_84 = "music"

				arg_73_1:AudioAction(var_76_83, var_76_84, "ui_battle", "ui_battle_stopbgm", "")

				local var_76_85 = ""
				local var_76_86 = manager.audio:GetAudioName("ui_battle", "ui_battle_stopbgm")

				if var_76_86 ~= "" then
					if arg_73_1.bgmTxt_.text ~= var_76_86 and arg_73_1.bgmTxt_.text ~= "" then
						if arg_73_1.bgmTxt2_.text ~= "" then
							arg_73_1.bgmTxt_.text = arg_73_1.bgmTxt2_.text
						end

						arg_73_1.bgmTxt2_.text = var_76_86

						arg_73_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_73_1.bgmTxt_.text = var_76_86
					end
			...
			local var_76_87 = 1.05
			local var_76_88 = 1

			if var_76_87 < arg_73_1.time_ and arg_73_1.time_ <= var_76_87 + arg_76_0 then
				local var_76_89 = "play"
				local var_76_90 = "music"

				arg_73_1:AudioAction(var_76_89, var_76_90, "bgm_activity_3_8_story_tide_battle", "bgm_activity_3_8_story_tide_battle", "bgm_activity_3_8_story_tide_battle.awb")

				local var_76_91 = ""
				local var_76_92 = manager.audio:GetAudioName("bgm_activity_3_8_story_tide_battle", "bgm_activity_3_8_story_tide_battle")

				if var_76_92 ~= "" then
					if arg_73_1.bgmTxt_.text ~= var_76_92 and arg_73_1.bgmTxt_.text ~= "" then
						if arg_73_1.bgmTxt2_.text ~= "" then
							arg_73_1.bgmTxt_.text = arg_73_1.bgmTxt2_.text
						end

						arg_73_1.bgmTxt2_.text = var_76_92

						arg_73_1.musicChangeAnimator_:Play("music_change", 0, 0)
					else
						arg_73_1.bgmTxt_.text = var_76_92
					end
			...
			local var_76_93 = 1.06666666666667
			local var_76_94 = 1

			if var_76_93 < arg_73_1.time_ and arg_73_1.time_ <= var_76_93 + arg_76_0 then
				local var_76_95 = "play"
				local var_76_96 = "effect"

				arg_73_1:AudioAction(var_76_95, var_76_96, "se_story_6", "se_story_6_black_fog02", "")
			end
			...
			local var_76_97 = 3.6
			local var_76_98 = 0.633333333333333

			if var_76_97 < arg_73_1.time_ and arg_73_1.time_ <= var_76_97 + arg_76_0 then
				arg_73_1.talkMaxDuration = 0

				arg_73_1.dialog_:SetActive(true)

				local var_76_99 = LeanTween.value(arg_73_1.dialog_, 0, 1, 0.3)

				var_76_99:setOnUpdate(LuaHelper.FloatAction(function(arg_79_0)
					arg_73_1.dialogCg_.alpha = arg_79_0
				end))
				var_76_99:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_73_1.dialog_)
					var_76_99:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_76_100 = arg_73_1:GetWordFromCfg(416162018)
				local var_76_101 = arg_73_1:FormatText(var_76_100.content)

				arg_73_1.text_.text = var_76_101

				LuaForUtil.ClearLinePrefixSymbol(arg_73_1.text_)

				local var_76_102 = 55
				local var_76_103 = utf8.len(var_76_101)
				local var_76_104 = var_76_102 <= 0 and var_76_98 or var_76_98 * (var_76_103 / var_76_102)

				if var_76_104 > 0 and var_76_98 < var_76_104 then
					arg_73_1.talkMaxDuration = var_76_104
					var_76_97 = var_76_97 + 0.3

					if var_76_104 + var_76_97 > arg_73_1.duration_ then
						arg_73_1.duration_ = var_76_104 + var_76_97
					end
				end
			...
			local var_76_105 = var_76_97 + 0.3
			local var_76_106 = math.max(var_76_98, arg_73_1.talkMaxDuration)

			if var_76_105 <= arg_73_1.time_ and arg_73_1.time_ < var_76_105 + var_76_106 then
				arg_73_1.typewritter.percent = (arg_73_1.time_ - var_76_105) / var_76_106

				arg_73_1.typewritter:SetDirty()
			end

			if arg_73_1.time_ >= var_76_105 + var_76_106 and arg_73_1.time_ < var_76_105 + var_76_106 + arg_76_0 then
	...
	assets = {
		...
		"Assets/UIResources/UI_AB/TextureConfig/Background/SS1607",
