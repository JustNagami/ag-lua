return {
	Play108053001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_5 = arg_1_1.actors_["1050ui_story"].transform
			local var_4_6 = 0

			if var_4_6 < arg_1_1.time_ and arg_1_1.time_ <= var_4_6 + arg_4_0 then
				arg_1_1.var_.moveOldPos1050ui_story = var_4_5.localPosition
			end
			...
			if var_4_6 <= arg_1_1.time_ and arg_1_1.time_ < var_4_6 + var_4_7 then
				...
				local var_4_9 = Vector3.New(-0.7, -1, -6.1)

				var_4_5.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1050ui_story, var_4_9, var_4_8)
			...
			if arg_1_1.time_ >= var_4_6 + var_4_7 and arg_1_1.time_ < var_4_6 + var_4_7 + arg_4_0 then
				var_4_5.localPosition = Vector3.New(-0.7, -1, -6.1)
			...
			if var_4_15 < arg_1_1.time_ and arg_1_1.time_ <= var_4_15 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect1050ui_story == nil then
			...
			if arg_1_1.time_ >= var_4_15 + var_4_16 and arg_1_1.time_ < var_4_15 + var_4_16 + arg_4_0 and not isNil(var_4_14) and arg_1_1.var_.characterEffect1050ui_story then
				arg_1_1.var_.characterEffect1050ui_story.fillFlat = false
			end
			...
			if var_4_20 < arg_1_1.time_ and arg_1_1.time_ <= var_4_20 + arg_4_0 then
				...
				local var_4_22 = arg_1_1:FormatText(StoryNameCfg[74].name)
				...
				local var_4_23 = arg_1_1:GetWordFromCfg(108053001)
				...
				if manager.audio:GetVoiceLength("story_v_out_108053", "108053001", "story_v_out_108053.awb") ~= 0 then
					local var_4_28 = manager.audio:GetVoiceLength("story_v_out_108053", "108053001", "story_v_out_108053.awb") / 1000
					...
					if var_4_23.prefab_name ~= "" and arg_1_1.actors_[var_4_23.prefab_name] ~= nil then
						local var_4_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_23.prefab_name].transform, "story_v_out_108053", "108053001", "story_v_out_108053.awb")

						arg_1_1:RecordAudio("108053001", var_4_29)
						arg_1_1:RecordAudio("108053001", var_4_29)
					else
	...
	Play108053003 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			local var_12_19 = arg_9_1.actors_["1050ui_story"]
			local var_12_20 = 0

			if var_12_20 < arg_9_1.time_ and arg_9_1.time_ <= var_12_20 + arg_12_0 and not isNil(var_12_19) and arg_9_1.var_.characterEffect1050ui_story == nil then
				arg_9_1.var_.characterEffect1050ui_story = var_12_19:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_12_20 <= arg_9_1.time_ and arg_9_1.time_ < var_12_20 + var_12_21 and not isNil(var_12_19) then
				...
				if arg_9_1.var_.characterEffect1050ui_story and not isNil(var_12_19) then
			...
			if arg_9_1.time_ >= var_12_20 + var_12_21 and arg_9_1.time_ < var_12_20 + var_12_21 + arg_12_0 and not isNil(var_12_19) and arg_9_1.var_.characterEffect1050ui_story then
				local var_12_24 = 0.5

				arg_9_1.var_.characterEffect1050ui_story.fillFlat = true
				arg_9_1.var_.characterEffect1050ui_story.fillRatio = var_12_24
			end
			...
			if var_12_26 < arg_9_1.time_ and arg_9_1.time_ <= var_12_26 + arg_12_0 then
				...
				local var_12_29 = arg_9_1:GetWordFromCfg(108053003)
				...
				if manager.audio:GetVoiceLength("story_v_out_108053", "108053003", "story_v_out_108053.awb") ~= 0 then
					local var_12_34 = manager.audio:GetVoiceLength("story_v_out_108053", "108053003", "story_v_out_108053.awb") / 1000
					...
					if var_12_29.prefab_name ~= "" and arg_9_1.actors_[var_12_29.prefab_name] ~= nil then
						local var_12_35 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_29.prefab_name].transform, "story_v_out_108053", "108053003", "story_v_out_108053.awb")

						arg_9_1:RecordAudio("108053003", var_12_35)
						arg_9_1:RecordAudio("108053003", var_12_35)
					else
	...
	Play108053007 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_5 < arg_25_1.time_ and arg_25_1.time_ <= var_28_5 + arg_28_0 and not isNil(var_28_4) and arg_25_1.var_.characterEffect1050ui_story == nil then
			...
			if arg_25_1.time_ >= var_28_5 + var_28_6 and arg_25_1.time_ < var_28_5 + var_28_6 + arg_28_0 and not isNil(var_28_4) and arg_25_1.var_.characterEffect1050ui_story then
				local var_28_9 = 0.5
