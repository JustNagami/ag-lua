...
function var_0_0.RefreshDesc(arg_10_0)
	...
	if HeroTools.GetHeroIsUnlock(var_10_0.hero) then
		local var_10_3 = CultivateHeroData:GetHeroTaskInfoList(arg_10_0.activityID_)[arg_10_0.taskID_]

		if var_10_3 and var_10_3.progress then
			var_10_2 = var_10_1 > var_10_3.progress and var_10_3.progress or var_10_1
		elseif var_10_3.isReceived then
			var_10_2 = var_10_1
		end
	end

	arg_10_0.progressText_.text = string.format("%d/%d", var_10_2, var_10_1)
