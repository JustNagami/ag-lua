...
function var_0_0.UpdateShopList(arg_28_0, arg_28_1)
	arg_28_0.curShopId_ = arg_28_1

	local var_28_0 = ShopListCfg[arg_28_1]

	arg_28_0.shopDataList = ShopTools.FilterShopDataList(arg_28_0.curShopId_, var_28_0.chain_last_visible == 1)
	arg_28_0.shopDataList = ShopTools.CommonSort(arg_28_0.shopDataList)

	if arg_28_0.needKeepPos1 then
		arg_28_0.pos = arg_28_0.list:GetScrolledPosition()
	else
		arg_28_0.pos = nil
	end

	arg_28_0.list:StartScrollWithoutAnimator(#arg_28_0.shopDataList, arg_28_0.pos)

	arg_28_0.needKeepPos1 = nil

	arg_28_0:UpdateBarByShopId(arg_28_0.curShopId_)
	arg_28_0:UpdateTimer()
end

function var_0_0.UpdateTimer(arg_29_0)
	local var_29_0 = ShopListCfg[arg_29_0.curShopId_]

	arg_29_0.remainTimeTxt_.text = string.format(GetTips("LEFT_TIME"), manager.time:GetLostTimeStrWith2Unit(ActivityData:GetActivityData(var_29_0.activity_id).stopTime))

	for iter_29_0, iter_29_1 in pairs(arg_29_0.list:GetItemList()) do
		iter_29_1:UpdateTimerView()
	end
end

function var_0_0.SetTimer(arg_30_0)
	SetActive(arg_30_0.timebgGo_, not ShopConst.NEED_HIDE_TIME[arg_30_0.curShopId_])
	arg_30_0:StopTimer()
	arg_30_0:UpdateTimer()

	arg_30_0.refreshTimer_ = Timer.New(function()
		arg_30_0:UpdateTimer()
	end, 1, -1, 1)

	arg_30_0.refreshTimer_:Start()
end

function var_0_0.OnExit(arg_32_0)
	for iter_32_0, iter_32_1 in pairs(arg_32_0.list:GetItemList()) do
		iter_32_1:OnExit()
	end

	arg_32_0.enterTimer = nil

	manager.windowBar:HideBar()

	arg_32_0.params_.hideHomeBtn = nil
...
function var_0_0.StopTimer(arg_33_0)
	if arg_33_0.refreshTimer_ then
		arg_33_0.refreshTimer_:Stop()

		arg_33_0.refreshTimer_ = nil
	end
end
...
function var_0_0.Dispose(arg_34_0)
	...
	for iter_34_0, iter_34_1 in ipairs(arg_34_0.titleTogList) do
		iter_34_1:Dispose()
	end

	arg_34_0:RemoveAllListeners()

	arg_34_0.curShopId_ = nil
