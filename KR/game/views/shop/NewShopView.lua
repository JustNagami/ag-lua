...
function var_0_0.GetShowList(arg_43_0, arg_43_1)
	...
	local var_43_2 = arg_43_0.item1UIList_._padding.left
	local var_43_3 = arg_43_0.item1UIList_._padding.right
	local var_43_4 = arg_43_0.item1Trs_.rect.width - var_43_2 - var_43_3
	local var_43_5 = arg_43_0.shopItemTrs_.rect.width

	arg_43_0.lineCount = math.floor(var_43_4 / var_43_5)

	local var_43_6 = arg_43_0.item1UIList_._spacing.x

	while true do
		if var_43_4 < arg_43_0.lineCount * var_43_5 + var_43_6 * (arg_43_0.lineCount - 1) then
			arg_43_0.lineCount = arg_43_0.lineCount - 1
		else
			break
		end
	end
