...
function var_0_0.AddUIListener(arg_5_0)
	arg_5_0:AddBtnListener(nil, arg_5_0.friendBtn_, function()
		...
		arg_5_0.friendController_:SetSelectedIndex(var_6_0 and 1 or 0)
		arg_5_0:RefreshUI()
	end)
	arg_5_0:AddBtnListener(nil, arg_5_0.guildBtn_, function()
		...
		arg_5_0.guildController_:SetSelectedIndex(var_7_0 and 1 or 0)
		arg_5_0:RefreshUI()
	end)
	arg_5_0:AddBtnListener(nil, arg_5_0.nearBtn_, function()
		...
		arg_5_0.nearController_:SetSelectedIndex(var_8_0 and 1 or 0)
		arg_5_0:RefreshUI()
	end)
