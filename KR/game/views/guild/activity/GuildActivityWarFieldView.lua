...
function var_0_0.UpdateBar(arg_28_0)
	...
	manager.windowBar:SetGameHelpKey({
		...
		params = {
			pages = {
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_01",
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_02",
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_03",
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_04",
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_05",
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_06",
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_07",
				"I18NImg/TextureConfig/GuildActivitiesUI/note/activity_club_courses_08"
			}
		}
	})
...
function var_0_0.RefreshBossSprite(arg_52_0)
	...
	if var_52_2.hpSprite_ then
		var_52_2.hpSprite_.sprite = getSpriteWithoutAtlas("I18NImg/GuildActivitiesUI/" .. var_52_1.hpSprite)
	end

	if var_52_2.fightingSprite_ then
		var_52_2.fightingSprite_.sprite = getSpriteWithoutAtlas("I18NImg/GuildActivitiesUI/" .. var_52_1.fightingSprite)
	end

	if var_52_2.defeatSprite_ then
		var_52_2.defeatSprite_.sprite = getSpriteWithoutAtlas("I18NImg/GuildActivitiesUI/" .. var_52_1.defeatSprite)
	end

	if var_52_2.nextLevelSprite_ then
		var_52_2.nextLevelSprite_.sprite = getSpriteWithoutAtlas("I18NImg/GuildActivitiesUI/" .. var_52_1.nextLevel)
	end
end
