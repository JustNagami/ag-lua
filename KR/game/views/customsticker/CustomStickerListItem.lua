...
function var_0_0.SetData(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4, arg_6_5, arg_6_6, arg_6_7, arg_6_8, arg_6_9)
	...
	arg_6_0:RebuildLabelLayout()
end

function var_0_0.RebuildLabelLayout(arg_7_0)
	if arg_7_0.labelTrans_ then
		TimeTools.StartAfterSeconds(0.1, function()
			UnityEngine.UI.LayoutRebuilder.ForceRebuildLayoutImmediate(arg_7_0.labelTrans_)
		end, {})
	end
end

function var_0_0.Select(arg_9_0, arg_9_1)
	arg_9_0.selectController_:SetSelectedState(arg_9_1 and "state1" or "state0")
end

function var_0_0.SetUse(arg_10_0, arg_10_1, arg_10_2)
	arg_10_0.useController_:SetSelectedState(arg_10_1 and "state1" or "state0")

	if arg_10_0.pageController_ then
		if arg_10_2 and arg_10_2 ~= 0 then
			arg_10_0.pageController_:SetSelectedState("state1")

			arg_10_0.pageText_.text = arg_10_2
		else
			arg_10_0.pageController_:SetSelectedState("state0")
		end
	end
end
...
function var_0_0.Dispose(arg_11_0)
	...
	if arg_11_0.Tag_ then
		manager.redPoint:unbindUIandKey(arg_11_0.transform_, RedPointConst.CUSTOM_STICKER_ITEM .. "_" .. arg_11_0.ID_)
	end
end
