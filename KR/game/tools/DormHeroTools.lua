...
function var_0_0.GetBackHomeHeadSprite(arg_16_0)
	local var_16_0
...
function var_0_0.CheckFeedTime(arg_27_0, arg_27_1)
	if not DormNpcTools:CheckIDIsNpc(arg_27_1) then
		local var_27_0 = DormData:GetHeroTemplateInfo(arg_27_1)

		if not var_27_0 then
			return false
		end

		if var_27_0.feed_times >= GameSetting.dorm_feed_max.value[1] then
			return false
		else
			return true
		end
