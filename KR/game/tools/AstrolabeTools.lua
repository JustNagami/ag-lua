...
function var_0_0.InitAstrolableNameTextAnchorCfg()
	var_0_0.astrolableNameTextAnchorDic = {}

	local var_17_0 = GameSetting.aether_code_adaptation.value

	for iter_17_0, iter_17_1 in ipairs(var_17_0) do
		local var_17_1 = iter_17_1[1]
		local var_17_2 = iter_17_1[2][1]
		local var_17_3 = iter_17_1[2][2]
		local var_17_4 = iter_17_1[2][3]

		var_0_0.astrolableNameTextAnchorDic[var_17_1] = var_0_0.astrolableNameTextAnchorDic[var_17_1] or {}
		var_0_0.astrolableNameTextAnchorDic[var_17_1][var_17_2] = var_0_0.astrolableNameTextAnchorDic[var_17_1][var_17_2] or {}
		var_0_0.astrolableNameTextAnchorDic[var_17_1][var_17_2][var_17_3] = var_17_4
	end
end

function var_0_0.GetAstrolableNameTextAnchor(arg_18_0, arg_18_1, arg_18_2)
	arg_18_0 = string.split(arg_18_0, "(Clone)")[1]

	if not var_0_0.astrolableNameTextAnchorDic then
		var_0_0.InitAstrolableNameTextAnchorCfg()
	end

	if var_0_0.astrolableNameTextAnchorDic[arg_18_0] and var_0_0.astrolableNameTextAnchorDic[arg_18_0][arg_18_1] and var_0_0.astrolableNameTextAnchorDic[arg_18_0][arg_18_1][arg_18_2] then
		return var_0_0.astrolableNameTextAnchorDic[arg_18_0][arg_18_1][arg_18_2]
	end
