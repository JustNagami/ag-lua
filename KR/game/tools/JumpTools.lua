...
function var_0_0.GoToSystem(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	if ShopTools.IsLimitRecharge() and arg_23_1 and arg_23_1.shopId and ShopConst.PC_LOCK_SHOP[arg_23_1.shopID] then
		ShowTips("PC_SHOP_TIPS1")

		return
	end

	if ShopTools.IsLimitRecharge() and arg_23_1 and arg_23_1.childShopIndex and ShopConst.PC_LOCK_RECHARGE[arg_23_1.childShopIndex .. "_" .. arg_23_1.page] then
		ShowTips("PC_SHOP_TIPS1")
