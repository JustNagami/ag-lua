	...
	elseif arg_13_0.currentState == var_0_2.change_no_prop or arg_13_0.currentState == var_0_2.change_have_prop then
		if arg_13_0.giveUpPropCallback then
			ChessBoardTools.ChessBoardMessageBox({
				...
				content = string.format(GetTips("CHESSBOARD_GIVEUP_CHANCE"), GetI18NText(ChessBoardPropCfg[arg_13_0.selectPropID].name)),
				OkCallback = function()
...
function var_0_0.RefreshItemInfo(arg_22_0)
	...
	if var_22_1 then
		...
		arg_22_0.nameText_.text = GetI18NText(var_22_1.name)
		arg_22_0.descText_.text = GetI18NText(var_22_1.use_description)
		arg_22_0.tipsText_.text = GetI18NText(var_22_1.prop_description)
	end
end
