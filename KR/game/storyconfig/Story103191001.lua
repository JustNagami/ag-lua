	...
	Play319101001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_53 < arg_1_1.time_ and arg_1_1.time_ <= var_4_53 + arg_4_0 then
				...
				local var_4_57 = arg_1_1:GetWordFromCfg(319101001)
				...
				if manager.audio:GetVoiceLength("story_v_out_319101", "319101001", "story_v_out_319101.awb") ~= 0 then
					local var_4_62 = manager.audio:GetVoiceLength("story_v_out_319101", "319101001", "story_v_out_319101.awb") / 1000
					...
					if var_4_57.prefab_name ~= "" and arg_1_1.actors_[var_4_57.prefab_name] ~= nil then
						local var_4_63 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_57.prefab_name].transform, "story_v_out_319101", "319101001", "story_v_out_319101.awb")

						arg_1_1:RecordAudio("319101001", var_4_63)
						arg_1_1:RecordAudio("319101001", var_4_63)
					else
	...
	Play319101003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_34 < arg_13_1.time_ and arg_13_1.time_ <= var_16_34 + arg_16_0 then
				...
				local var_16_37 = arg_13_1:GetWordFromCfg(319101003)
				...
				if manager.audio:GetVoiceLength("story_v_out_319101", "319101003", "story_v_out_319101.awb") ~= 0 then
					local var_16_42 = manager.audio:GetVoiceLength("story_v_out_319101", "319101003", "story_v_out_319101.awb") / 1000
					...
					if var_16_37.prefab_name ~= "" and arg_13_1.actors_[var_16_37.prefab_name] ~= nil then
						local var_16_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_37.prefab_name].transform, "story_v_out_319101", "319101003", "story_v_out_319101.awb")

						arg_13_1:RecordAudio("319101003", var_16_43)
						arg_13_1:RecordAudio("319101003", var_16_43)
					else
