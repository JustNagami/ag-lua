return {
	...
	Play112071002 = function(arg_8_0, arg_8_1)
		...
		function arg_8_1.onSingleLineUpdate_(arg_11_0)
			...
			if var_11_19 < arg_8_1.time_ and arg_8_1.time_ <= var_11_19 + arg_11_0 then
				...
				local var_11_22 = arg_8_1:GetWordFromCfg(112071002)
				...
				if manager.audio:GetVoiceLength("story_v_out_112071", "112071002", "story_v_out_112071.awb") ~= 0 then
					local var_11_27 = manager.audio:GetVoiceLength("story_v_out_112071", "112071002", "story_v_out_112071.awb") / 1000
					...
					if var_11_22.prefab_name ~= "" and arg_8_1.actors_[var_11_22.prefab_name] ~= nil then
						local var_11_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_8_1.actors_[var_11_22.prefab_name].transform, "story_v_out_112071", "112071002", "story_v_out_112071.awb")

						arg_8_1:RecordAudio("112071002", var_11_28)
						arg_8_1:RecordAudio("112071002", var_11_28)
					else
	...
	Play112071007 = function(arg_30_0, arg_30_1)
		...
		function arg_30_1.onSingleLineUpdate_(arg_33_0)
			...
			if var_33_12 < arg_30_1.time_ and arg_30_1.time_ <= var_33_12 + arg_33_0 and arg_30_1.var_.characterEffect1027ui_story == nil then
			...
			if var_33_12 <= arg_30_1.time_ and arg_30_1.time_ < var_33_12 + var_33_13 then
				...
				if arg_30_1.var_.characterEffect1027ui_story then
					arg_30_1.var_.characterEffect1027ui_story.fillFlat = false
				end
			end

			if arg_30_1.time_ >= var_33_12 + var_33_13 and arg_30_1.time_ < var_33_12 + var_33_13 + arg_33_0 and arg_30_1.var_.characterEffect1027ui_story then
				arg_30_1.var_.characterEffect1027ui_story.fillFlat = false
			end
