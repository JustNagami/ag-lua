	...
	Play410121001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			if var_4_52 < arg_1_1.time_ and arg_1_1.time_ <= var_4_52 + arg_4_0 then
				...
				local var_4_56 = arg_1_1:GetWordFromCfg(410121001)
				...
				if manager.audio:GetVoiceLength("story_v_out_410121", "410121001", "story_v_out_410121.awb") ~= 0 then
					local var_4_61 = manager.audio:GetVoiceLength("story_v_out_410121", "410121001", "story_v_out_410121.awb") / 1000
					...
					if var_4_56.prefab_name ~= "" and arg_1_1.actors_[var_4_56.prefab_name] ~= nil then
						local var_4_62 = LuaForUtil.PlayVoiceWithCriLipsync(arg_1_1.actors_[var_4_56.prefab_name].transform, "story_v_out_410121", "410121001", "story_v_out_410121.awb")

						arg_1_1:RecordAudio("410121001", var_4_62)
						arg_1_1:RecordAudio("410121001", var_4_62)
					else
