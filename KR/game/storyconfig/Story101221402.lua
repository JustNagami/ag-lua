return {
	...
	Play122142046 = function(arg_199_0, arg_199_1)
		...
		function arg_199_1.onSingleLineUpdate_(arg_202_0)
			...
			local var_202_4 = arg_199_1.actors_["1184ui_story"].transform
			local var_202_5 = 0

			if var_202_5 < arg_199_1.time_ and arg_199_1.time_ <= var_202_5 + arg_202_0 then
				arg_199_1.var_.moveOldPos1184ui_story = var_202_4.localPosition

				local var_202_6 = "1184ui_story"

				arg_199_1:ShowWeapon(arg_199_1.var_[var_202_6 .. "Animator"].transform, true)
			end

			local var_202_7 = 0.001

			if var_202_5 <= arg_199_1.time_ and arg_199_1.time_ < var_202_5 + var_202_7 then
				local var_202_8 = (arg_199_1.time_ - var_202_5) / var_202_7
				local var_202_9 = Vector3.New(-0.7, -0.97, -6)

				var_202_4.localPosition = Vector3.Lerp(arg_199_1.var_.moveOldPos1184ui_story, var_202_9, var_202_8)

				local var_202_10 = manager.ui.mainCamera.transform.position - var_202_4.position

				var_202_4.forward = Vector3.New(var_202_10.x, var_202_10.y, var_202_10.z)

				local var_202_11 = var_202_4.localEulerAngles

				var_202_11.z = 0
				var_202_11.x = 0
				var_202_4.localEulerAngles = var_202_11
			end

			if arg_199_1.time_ >= var_202_5 + var_202_7 and arg_199_1.time_ < var_202_5 + var_202_7 + arg_202_0 then
				var_202_4.localPosition = Vector3.New(-0.7, -0.97, -6)

				local var_202_12 = manager.ui.mainCamera.transform.position - var_202_4.position

				var_202_4.forward = Vector3.New(var_202_12.x, var_202_12.y, var_202_12.z)

				local var_202_13 = var_202_4.localEulerAngles

				var_202_13.z = 0
				var_202_13.x = 0
				var_202_4.localEulerAngles = var_202_13
			end

			local var_202_14 = arg_199_1.actors_["1184ui_story"]
			local var_202_15 = 0

			if var_202_15 < arg_199_1.time_ and arg_199_1.time_ <= var_202_15 + arg_202_0 and arg_199_1.var_.characterEffect1184ui_story == nil then
				arg_199_1.var_.characterEffect1184ui_story = var_202_14:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_199_1.time_ >= var_202_15 + var_202_16 and arg_199_1.time_ < var_202_15 + var_202_16 + arg_202_0 and arg_199_1.var_.characterEffect1184ui_story then
				arg_199_1.var_.characterEffect1184ui_story.fillFlat = false
			end
			...
			if var_202_20 < arg_199_1.time_ and arg_199_1.time_ <= var_202_20 + arg_202_0 then
				...
				local var_202_22 = arg_199_1:FormatText(StoryNameCfg[6].name)
				...
				local var_202_23 = arg_199_1:GetWordFromCfg(122142046)
				...
				if manager.audio:GetVoiceLength("story_v_out_122142", "122142046", "story_v_out_122142.awb") ~= 0 then
					local var_202_28 = manager.audio:GetVoiceLength("story_v_out_122142", "122142046", "story_v_out_122142.awb") / 1000
					...
					if var_202_23.prefab_name ~= "" and arg_199_1.actors_[var_202_23.prefab_name] ~= nil then
						local var_202_29 = LuaForUtil.PlayVoiceWithCriLipsync(arg_199_1.actors_[var_202_23.prefab_name].transform, "story_v_out_122142", "122142046", "story_v_out_122142.awb")

						arg_199_1:RecordAudio("122142046", var_202_29)
						arg_199_1:RecordAudio("122142046", var_202_29)
					else
	...
	Play122142048 = function(arg_207_0, arg_207_1)
		...
		function arg_207_1.onSingleLineUpdate_(arg_210_0)
			...
			if var_210_7 <= arg_207_1.time_ and arg_207_1.time_ < var_210_7 + var_210_8 then
				...
				local var_210_10 = Vector3.New(0.7, -0.97, -6)

				var_210_6.localPosition = Vector3.Lerp(arg_207_1.var_.moveOldPos1084ui_story, var_210_10, var_210_9)
			...
			if arg_207_1.time_ >= var_210_7 + var_210_8 and arg_207_1.time_ < var_210_7 + var_210_8 + arg_210_0 then
				var_210_6.localPosition = Vector3.New(0.7, -0.97, -6)
			...
			if var_210_15 < arg_207_1.time_ and arg_207_1.time_ <= var_210_15 + arg_210_0 then
				...
				local var_210_17 = arg_207_1:FormatText(StoryNameCfg[451].name)
				...
				local var_210_18 = arg_207_1:GetWordFromCfg(122142048)
				...
				if manager.audio:GetVoiceLength("story_v_out_122142", "122142048", "story_v_out_122142.awb") ~= 0 then
					local var_210_23 = manager.audio:GetVoiceLength("story_v_out_122142", "122142048", "story_v_out_122142.awb") / 1000
					...
					if var_210_18.prefab_name ~= "" and arg_207_1.actors_[var_210_18.prefab_name] ~= nil then
						local var_210_24 = LuaForUtil.PlayVoiceWithCriLipsync(arg_207_1.actors_[var_210_18.prefab_name].transform, "story_v_out_122142", "122142048", "story_v_out_122142.awb")

						arg_207_1:RecordAudio("122142048", var_210_24)
						arg_207_1:RecordAudio("122142048", var_210_24)
					else
	...
	Play122142052 = function(arg_223_0, arg_223_1)
		...
		function arg_223_1.onSingleLineUpdate_(arg_226_0)
			...
			local var_226_31 = arg_223_1:GetWordFromCfg(122142004)
