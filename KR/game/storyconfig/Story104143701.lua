return {
	Play414371001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_28 = arg_1_1.actors_["1039ui_story"].transform
			local var_4_29 = 1.8

			if var_4_29 < arg_1_1.time_ and arg_1_1.time_ <= var_4_29 + arg_4_0 then
				arg_1_1.var_.moveOldPos1039ui_story = var_4_28.localPosition

				local var_4_30 = "1039ui_story"
			...
			if var_4_29 <= arg_1_1.time_ and arg_1_1.time_ < var_4_29 + var_4_31 then
				...
				local var_4_33 = Vector3.New(0, -1.01, -5.9)

				var_4_28.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1039ui_story, var_4_33, var_4_32)
			...
			if arg_1_1.time_ >= var_4_29 + var_4_31 and arg_1_1.time_ < var_4_29 + var_4_31 + arg_4_0 then
				var_4_28.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			if var_4_39 < arg_1_1.time_ and arg_1_1.time_ <= var_4_39 + arg_4_0 and arg_1_1.var_.characterEffect1039ui_story == nil then
			...
			if arg_1_1.time_ >= var_4_39 + var_4_40 and arg_1_1.time_ < var_4_39 + var_4_40 + arg_4_0 and arg_1_1.var_.characterEffect1039ui_story then
				arg_1_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				...
				local var_4_47 = arg_1_1:FormatText(StoryNameCfg[9].name)
				...
				local var_4_48 = arg_1_1:GetWordFromCfg(414371001)
	...
	Play414371002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_6 < arg_7_1.time_ and arg_7_1.time_ <= var_10_6 + arg_10_0 then
				...
				local var_10_9 = arg_7_1:GetWordFromCfg(414371002)
	...
	Play414371003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			local var_14_0 = arg_11_1.actors_["1039ui_story"].transform
			local var_14_1 = 0

			if var_14_1 < arg_11_1.time_ and arg_11_1.time_ <= var_14_1 + arg_14_0 then
				arg_11_1.var_.moveOldPos1039ui_story = var_14_0.localPosition
			end
			...
			if var_14_1 <= arg_11_1.time_ and arg_11_1.time_ < var_14_1 + var_14_2 then
				...
				local var_14_4 = Vector3.New(0, -1.01, -5.9)

				var_14_0.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1039ui_story, var_14_4, var_14_3)
			...
			if arg_11_1.time_ >= var_14_1 + var_14_2 and arg_11_1.time_ < var_14_1 + var_14_2 + arg_14_0 then
				var_14_0.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			local var_14_9 = arg_11_1.actors_["1039ui_story"]
			local var_14_10 = 0

			if var_14_10 < arg_11_1.time_ and arg_11_1.time_ <= var_14_10 + arg_14_0 and arg_11_1.var_.characterEffect1039ui_story == nil then
				arg_11_1.var_.characterEffect1039ui_story = var_14_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_11_1.time_ >= var_14_10 + var_14_11 and arg_11_1.time_ < var_14_10 + var_14_11 + arg_14_0 and arg_11_1.var_.characterEffect1039ui_story then
				arg_11_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if var_14_13 < arg_11_1.time_ and arg_11_1.time_ <= var_14_13 + arg_14_0 then
				arg_11_1:PlayTimeline("1039ui_story", "StoryTimeline/CharAction/1039/1039actionlink/1039action424")
			end
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_17 = arg_11_1:FormatText(StoryNameCfg[9].name)
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(414371003)
	...
	Play414371004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_10 < arg_15_1.time_ and arg_15_1.time_ <= var_18_10 + arg_18_0 and arg_15_1.var_.characterEffect1039ui_story == nil then
			...
			if var_18_10 <= arg_15_1.time_ and arg_15_1.time_ < var_18_10 + var_18_11 then
				...
				if arg_15_1.var_.characterEffect1039ui_story then
					...
					arg_15_1.var_.characterEffect1039ui_story.fillRatio = var_18_13
				end
			end

			if arg_15_1.time_ >= var_18_10 + var_18_11 and arg_15_1.time_ < var_18_10 + var_18_11 + arg_18_0 and arg_15_1.var_.characterEffect1039ui_story then
				local var_18_14 = 0.5

				arg_15_1.var_.characterEffect1039ui_story.fillFlat = true
				arg_15_1.var_.characterEffect1039ui_story.fillRatio = var_18_14
			end

			local var_18_15 = "104902ui_story"
			...
			local var_18_19 = arg_15_1.actors_["104902ui_story"].transform
			local var_18_20 = 0

			if var_18_20 < arg_15_1.time_ and arg_15_1.time_ <= var_18_20 + arg_18_0 then
				arg_15_1.var_.moveOldPos104902ui_story = var_18_19.localPosition
			end
			...
			if var_18_20 <= arg_15_1.time_ and arg_15_1.time_ < var_18_20 + var_18_21 then
				...
				local var_18_23 = Vector3.New(0, -1.2, -6)

				var_18_19.localPosition = Vector3.Lerp(arg_15_1.var_.moveOldPos104902ui_story, var_18_23, var_18_22)
			...
			if arg_15_1.time_ >= var_18_20 + var_18_21 and arg_15_1.time_ < var_18_20 + var_18_21 + arg_18_0 then
				var_18_19.localPosition = Vector3.New(0, -1.2, -6)
			...
			local var_18_28 = arg_15_1.actors_["104902ui_story"]
			local var_18_29 = 0

			if var_18_29 < arg_15_1.time_ and arg_15_1.time_ <= var_18_29 + arg_18_0 and arg_15_1.var_.characterEffect104902ui_story == nil then
				arg_15_1.var_.characterEffect104902ui_story = var_18_28:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_15_1.time_ >= var_18_29 + var_18_30 and arg_15_1.time_ < var_18_29 + var_18_30 + arg_18_0 and arg_15_1.var_.characterEffect104902ui_story then
				arg_15_1.var_.characterEffect104902ui_story.fillFlat = false
			end
			...
			if var_18_34 < arg_15_1.time_ and arg_15_1.time_ <= var_18_34 + arg_18_0 then
				...
				local var_18_37 = arg_15_1:GetWordFromCfg(414371004)
	...
	Play414371005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			local var_22_0 = arg_19_1.actors_["1039ui_story"].transform
			local var_22_1 = 0

			if var_22_1 < arg_19_1.time_ and arg_19_1.time_ <= var_22_1 + arg_22_0 then
				arg_19_1.var_.moveOldPos1039ui_story = var_22_0.localPosition
			end
			...
			if var_22_1 <= arg_19_1.time_ and arg_19_1.time_ < var_22_1 + var_22_2 then
				...
				local var_22_4 = Vector3.New(0, -1.01, -5.9)

				var_22_0.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos1039ui_story, var_22_4, var_22_3)
			...
			if arg_19_1.time_ >= var_22_1 + var_22_2 and arg_19_1.time_ < var_22_1 + var_22_2 + arg_22_0 then
				var_22_0.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			local var_22_9 = arg_19_1.actors_["1039ui_story"]
			local var_22_10 = 0

			if var_22_10 < arg_19_1.time_ and arg_19_1.time_ <= var_22_10 + arg_22_0 and arg_19_1.var_.characterEffect1039ui_story == nil then
				arg_19_1.var_.characterEffect1039ui_story = var_22_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_19_1.time_ >= var_22_10 + var_22_11 and arg_19_1.time_ < var_22_10 + var_22_11 + arg_22_0 and arg_19_1.var_.characterEffect1039ui_story then
				arg_19_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if var_22_13 < arg_19_1.time_ and arg_19_1.time_ <= var_22_13 + arg_22_0 then
				arg_19_1:PlayTimeline("1039ui_story", "StoryTimeline/CharAction/1039/1039action/1039action4_2")
			end
			...
			local var_22_15 = arg_19_1.actors_["104902ui_story"].transform
			local var_22_16 = 0

			if var_22_16 < arg_19_1.time_ and arg_19_1.time_ <= var_22_16 + arg_22_0 then
				arg_19_1.var_.moveOldPos104902ui_story = var_22_15.localPosition
			end
			...
			if var_22_16 <= arg_19_1.time_ and arg_19_1.time_ < var_22_16 + var_22_17 then
				...
				var_22_15.localPosition = Vector3.Lerp(arg_19_1.var_.moveOldPos104902ui_story, var_22_19, var_22_18)
			...
			local var_22_24 = arg_19_1.actors_["104902ui_story"]
			local var_22_25 = 0

			if var_22_25 < arg_19_1.time_ and arg_19_1.time_ <= var_22_25 + arg_22_0 and arg_19_1.var_.characterEffect104902ui_story == nil then
				arg_19_1.var_.characterEffect104902ui_story = var_22_24:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_22_25 <= arg_19_1.time_ and arg_19_1.time_ < var_22_25 + var_22_26 then
				...
				if arg_19_1.var_.characterEffect104902ui_story then
					...
					arg_19_1.var_.characterEffect104902ui_story.fillRatio = var_22_28
				end
			end

			if arg_19_1.time_ >= var_22_25 + var_22_26 and arg_19_1.time_ < var_22_25 + var_22_26 + arg_22_0 and arg_19_1.var_.characterEffect104902ui_story then
				local var_22_29 = 0.5

				arg_19_1.var_.characterEffect104902ui_story.fillFlat = true
				arg_19_1.var_.characterEffect104902ui_story.fillRatio = var_22_29
			end

			local var_22_30 = 0
			local var_22_31 = 0.525
			...
			if var_22_30 < arg_19_1.time_ and arg_19_1.time_ <= var_22_30 + arg_22_0 then
				...
				local var_22_32 = arg_19_1:FormatText(StoryNameCfg[9].name)
				...
				local var_22_33 = arg_19_1:GetWordFromCfg(414371005)
	...
	Play414371006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_6 < arg_23_1.time_ and arg_23_1.time_ <= var_26_6 + arg_26_0 then
				...
				local var_26_9 = arg_23_1:GetWordFromCfg(414371006)
	...
	Play414371007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_1 <= arg_27_1.time_ and arg_27_1.time_ < var_30_1 + var_30_2 then
				...
				local var_30_4 = Vector3.New(0, -1.01, -5.9)
			...
			if arg_27_1.time_ >= var_30_1 + var_30_2 and arg_27_1.time_ < var_30_1 + var_30_2 + arg_30_0 then
				var_30_0.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			if var_30_10 < arg_27_1.time_ and arg_27_1.time_ <= var_30_10 + arg_30_0 and arg_27_1.var_.characterEffect1039ui_story == nil then
			...
			if arg_27_1.time_ >= var_30_10 + var_30_11 and arg_27_1.time_ < var_30_10 + var_30_11 + arg_30_0 and arg_27_1.var_.characterEffect1039ui_story then
				arg_27_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			local var_30_15 = 0.466666666666667
			...
			if var_30_15 < arg_27_1.time_ and arg_27_1.time_ <= var_30_15 + arg_30_0 then
				...
				local var_30_18 = arg_27_1:FormatText(StoryNameCfg[9].name)
				...
				local var_30_19 = arg_27_1:GetWordFromCfg(414371007)
				...
				local var_30_23 = var_30_21 <= 0 and var_30_16 or var_30_16 * (var_30_22 / var_30_21)

				if var_30_23 > 0 and var_30_16 < var_30_23 then
			...
			if var_30_24 <= arg_27_1.time_ and arg_27_1.time_ < var_30_24 + var_30_25 then
				arg_27_1.typewritter.percent = (arg_27_1.time_ - var_30_24) / var_30_25
	...
	Play414371008 = function(arg_33_0, arg_33_1)
		...
		function arg_33_1.onSingleLineUpdate_(arg_36_0)
			...
			if var_36_1 < arg_33_1.time_ and arg_33_1.time_ <= var_36_1 + arg_36_0 and arg_33_1.var_.characterEffect1039ui_story == nil then
			...
			if arg_33_1.time_ >= var_36_1 + var_36_2 and arg_33_1.time_ < var_36_1 + var_36_2 + arg_36_0 and arg_33_1.var_.characterEffect1039ui_story then
				local var_36_5 = 0.5
			...
			if var_36_6 < arg_33_1.time_ and arg_33_1.time_ <= var_36_6 + arg_36_0 then
				...
				local var_36_8 = arg_33_1:FormatText(StoryNameCfg[90].name)
				...
				local var_36_9 = arg_33_1:GetWordFromCfg(414371008)
	...
	Play414371009 = function(arg_37_0, arg_37_1)
		...
		function arg_37_1.onSingleLineUpdate_(arg_40_0)
			local var_40_0 = arg_37_1.actors_["1039ui_story"].transform
			local var_40_1 = 0

			if var_40_1 < arg_37_1.time_ and arg_37_1.time_ <= var_40_1 + arg_40_0 then
				arg_37_1.var_.moveOldPos1039ui_story = var_40_0.localPosition
			end
			...
			if var_40_1 <= arg_37_1.time_ and arg_37_1.time_ < var_40_1 + var_40_2 then
				...
				var_40_0.localPosition = Vector3.Lerp(arg_37_1.var_.moveOldPos1039ui_story, var_40_4, var_40_3)
			...
			if var_40_9 < arg_37_1.time_ and arg_37_1.time_ <= var_40_9 + arg_40_0 then
				...
				local var_40_11 = arg_37_1:GetWordFromCfg(414371009)
	...
	Play414371010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			local var_44_0 = arg_41_1.actors_["1039ui_story"].transform
			local var_44_1 = 0

			if var_44_1 < arg_41_1.time_ and arg_41_1.time_ <= var_44_1 + arg_44_0 then
				arg_41_1.var_.moveOldPos1039ui_story = var_44_0.localPosition
			end
			...
			if var_44_1 <= arg_41_1.time_ and arg_41_1.time_ < var_44_1 + var_44_2 then
				...
				local var_44_4 = Vector3.New(0, -1.01, -5.9)

				var_44_0.localPosition = Vector3.Lerp(arg_41_1.var_.moveOldPos1039ui_story, var_44_4, var_44_3)
			...
			if arg_41_1.time_ >= var_44_1 + var_44_2 and arg_41_1.time_ < var_44_1 + var_44_2 + arg_44_0 then
				var_44_0.localPosition = Vector3.New(0, -1.01, -5.9)
			...
			local var_44_9 = arg_41_1.actors_["1039ui_story"]
			local var_44_10 = 0

			if var_44_10 < arg_41_1.time_ and arg_41_1.time_ <= var_44_10 + arg_44_0 and arg_41_1.var_.characterEffect1039ui_story == nil then
				arg_41_1.var_.characterEffect1039ui_story = var_44_9:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if arg_41_1.time_ >= var_44_10 + var_44_11 and arg_41_1.time_ < var_44_10 + var_44_11 + arg_44_0 and arg_41_1.var_.characterEffect1039ui_story then
				arg_41_1.var_.characterEffect1039ui_story.fillFlat = false
			end
			...
			if var_44_13 < arg_41_1.time_ and arg_41_1.time_ <= var_44_13 + arg_44_0 then
				arg_41_1:PlayTimeline("1039ui_story", "StoryTimeline/CharAction/1039/1039action/1039action7_2")
			end
			...
			if var_44_15 < arg_41_1.time_ and arg_41_1.time_ <= var_44_15 + arg_44_0 then
				...
				local var_44_17 = arg_41_1:FormatText(StoryNameCfg[9].name)
				...
				local var_44_18 = arg_41_1:GetWordFromCfg(414371010)
	...
	Play414371011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_0 < arg_45_1.time_ and arg_45_1.time_ <= var_48_0 + arg_48_0 then
				...
				local var_48_3 = arg_45_1:GetWordFromCfg(414371011)
