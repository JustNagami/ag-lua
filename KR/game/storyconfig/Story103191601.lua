	...
	Play319161005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_19 < arg_21_1.time_ and arg_21_1.time_ <= var_24_19 + arg_24_0 then
				...
				local var_24_21 = arg_21_1:FormatText(StoryNameCfg[6].name)
				...
				local var_24_22 = arg_21_1:GetWordFromCfg(319161005)
				...
				if manager.audio:GetVoiceLength("story_v_out_319161", "319161005", "story_v_out_319161.awb") ~= 0 then
					local var_24_27 = manager.audio:GetVoiceLength("story_v_out_319161", "319161005", "story_v_out_319161.awb") / 1000
					...
					if var_24_22.prefab_name ~= "" and arg_21_1.actors_[var_24_22.prefab_name] ~= nil then
						local var_24_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_22.prefab_name].transform, "story_v_out_319161", "319161005", "story_v_out_319161.awb")

						arg_21_1:RecordAudio("319161005", var_24_28)
						arg_21_1:RecordAudio("319161005", var_24_28)
					else
	...
	Play319161011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_22 < arg_45_1.time_ and arg_45_1.time_ <= var_48_22 + arg_48_0 then
				...
				arg_45_1.cswt_.font = Asset.Load("Fonts/SourceHanSans")
			end
			...
			if var_48_40 < arg_45_1.time_ and arg_45_1.time_ <= var_48_40 + arg_48_0 then
				...
				local var_48_42 = var_48_41:GetComponent("Text")
				local var_48_43 = var_48_41:GetComponent("RectTransform")

				var_48_42.alignment = UnityEngine.TextAnchor.LowerCenter
				var_48_43.offsetMin = Vector2.New(0, 0)
				var_48_43.offsetMax = Vector2.New(0, 0)
			end

			local var_48_44 = arg_45_1.actors_["1084ui_story"].transform
			local var_48_45 = 0

			if var_48_45 < arg_45_1.time_ and arg_45_1.time_ <= var_48_45 + arg_48_0 then
				arg_45_1.var_.moveOldPos1084ui_story = var_48_44.localPosition
			end
			...
			if var_48_45 <= arg_45_1.time_ and arg_45_1.time_ < var_48_45 + var_48_46 then
				...
				var_48_44.localPosition = Vector3.Lerp(arg_45_1.var_.moveOldPos1084ui_story, var_48_48, var_48_47)
			...
			local var_48_53 = arg_45_1.actors_["1084ui_story"]
			local var_48_54 = 0

			if var_48_54 < arg_45_1.time_ and arg_45_1.time_ <= var_48_54 + arg_48_0 and arg_45_1.var_.characterEffect1084ui_story == nil then
				arg_45_1.var_.characterEffect1084ui_story = var_48_53:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_48_55 = 0.200000002980232

			if var_48_54 <= arg_45_1.time_ and arg_45_1.time_ < var_48_54 + var_48_55 then
				local var_48_56 = (arg_45_1.time_ - var_48_54) / var_48_55

				if arg_45_1.var_.characterEffect1084ui_story then
					local var_48_57 = Mathf.Lerp(0, 0.5, var_48_56)

					arg_45_1.var_.characterEffect1084ui_story.fillFlat = true
					arg_45_1.var_.characterEffect1084ui_story.fillRatio = var_48_57
				end
			end

			if arg_45_1.time_ >= var_48_54 + var_48_55 and arg_45_1.time_ < var_48_54 + var_48_55 + arg_48_0 and arg_45_1.var_.characterEffect1084ui_story then
				local var_48_58 = 0.5
	...
	Play319161012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_6 < arg_49_1.time_ and arg_49_1.time_ <= var_52_6 + arg_52_0 then
				...
				local var_52_7 = arg_49_1:GetWordFromCfg(319161012)
				local var_52_8 = arg_49_1:FormatText(var_52_7.content)

				arg_49_1.fswt_.text = var_52_8
			...
			local var_52_9 = 0.233333333333333
			...
			local var_52_10 = 23
			local var_52_11 = 1.53333333333333
			local var_52_12 = arg_49_1:GetWordFromCfg(319161012)
			local var_52_13 = arg_49_1:FormatText(var_52_12.content)
			local var_52_14, var_52_15 = arg_49_1:GetPercentByPara(var_52_13, 1)

			if var_52_9 < arg_49_1.time_ and arg_49_1.time_ <= var_52_9 + arg_52_0 then
				arg_49_1.talkMaxDuration = 0

				local var_52_16 = var_52_10 <= 0 and var_52_11 or var_52_11 * ((var_52_15 - arg_49_1.typewritterCharCountI18N) / var_52_10)
			...
			local var_52_17 = 1.53333333333333
			local var_52_18 = math.max(var_52_17, arg_49_1.talkMaxDuration)

			if var_52_9 <= arg_49_1.time_ and arg_49_1.time_ < var_52_9 + var_52_18 then
				local var_52_19 = (arg_49_1.time_ - var_52_9) / var_52_18

				arg_49_1.fswtw_.percent = Mathf.Lerp(arg_49_1.var_.oldValueTypewriter, var_52_14, var_52_19)
				arg_49_1.fswt_:GetComponent("Text").color = Color(1, 1, 1)

				arg_49_1.fswtw_:SetDirty()
			end

			if arg_49_1.time_ >= var_52_9 + var_52_18 and arg_49_1.time_ < var_52_9 + var_52_18 + arg_52_0 then
				arg_49_1.fswtw_.percent = var_52_14

				arg_49_1.fswtw_:SetDirty()
				arg_49_1:ShowNextGo(true)

				arg_49_1.typewritterCharCountI18N = var_52_15
			end
		end
	end,
	Play319161013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if arg_53_1.actors_[var_56_20] == nil then
				local var_56_21 = Object.Instantiate(Asset.Load("Char/" .. var_56_20), arg_53_1.stage_.transform)

				var_56_21.name = var_56_20
				var_56_21.transform.localPosition = Vector3.New(0, 100, 0)
				arg_53_1.actors_[var_56_20] = var_56_21

				local var_56_22 = var_56_21:GetComponentInChildren(typeof(CharacterEffect))

				var_56_22.enabled = true

				local var_56_23 = GameObjectTools.GetOrAddComponent(var_56_21, typeof(DynamicBoneHelper))

				if var_56_23 then
					var_56_23:EnableDynamicBone(false)
				end

				arg_53_1:ShowWeapon(var_56_22.transform, false)

				arg_53_1.var_[var_56_20 .. "Animator"] = var_56_22.gameObject:GetComponent(typeof(UnityEngine.Animator))
				arg_53_1.var_[var_56_20 .. "Animator"].applyRootMotion = true
				arg_53_1.var_[var_56_20 .. "LipSync"] = var_56_22.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end

			local var_56_24 = arg_53_1.actors_["1095ui_story"].transform
			local var_56_25 = 1.86666666666667

			if var_56_25 < arg_53_1.time_ and arg_53_1.time_ <= var_56_25 + arg_56_0 then
				arg_53_1.var_.moveOldPos1095ui_story = var_56_24.localPosition
			end
			...
			if var_56_25 <= arg_53_1.time_ and arg_53_1.time_ < var_56_25 + var_56_26 then
				...
				local var_56_28 = Vector3.New(0, -0.98, -6.1)

				var_56_24.localPosition = Vector3.Lerp(arg_53_1.var_.moveOldPos1095ui_story, var_56_28, var_56_27)
			...
			if arg_53_1.time_ >= var_56_25 + var_56_26 and arg_53_1.time_ < var_56_25 + var_56_26 + arg_56_0 then
				var_56_24.localPosition = Vector3.New(0, -0.98, -6.1)
			...
			local var_56_33 = arg_53_1.actors_["1095ui_story"]
			local var_56_34 = 1.86666666666667

			if var_56_34 < arg_53_1.time_ and arg_53_1.time_ <= var_56_34 + arg_56_0 and arg_53_1.var_.characterEffect1095ui_story == nil then
				arg_53_1.var_.characterEffect1095ui_story = var_56_33:GetComponentInChildren(typeof(CharacterEffect))
			end

			local var_56_35 = 0.200000002980232

			if var_56_34 <= arg_53_1.time_ and arg_53_1.time_ < var_56_34 + var_56_35 then
				local var_56_36 = (arg_53_1.time_ - var_56_34) / var_56_35
			...
			if arg_53_1.time_ >= var_56_34 + var_56_35 and arg_53_1.time_ < var_56_34 + var_56_35 + arg_56_0 and arg_53_1.var_.characterEffect1095ui_story then
				arg_53_1.var_.characterEffect1095ui_story.fillFlat = false
			end

			local var_56_37 = 1.86666666666667
			...
			if var_56_40 < arg_53_1.time_ and arg_53_1.time_ <= var_56_40 + arg_56_0 then
				local var_56_41 = arg_53_1.fswbg_.transform:Find("textbox/adapt/content") or arg_53_1.fswbg_.transform:Find("textbox/content")
				local var_56_42 = var_56_41:GetComponent("Text")
				local var_56_43 = var_56_41:GetComponent("RectTransform")

				var_56_42.alignment = UnityEngine.TextAnchor.LowerCenter
				var_56_43.offsetMin = Vector2.New(0, 0)
				var_56_43.offsetMax = Vector2.New(0, 0)
			end
			...
			local var_56_45 = 2.0666666696469
			...
			if var_56_45 < arg_53_1.time_ and arg_53_1.time_ <= var_56_45 + arg_56_0 then
				...
				local var_56_47 = LeanTween.value(arg_53_1.dialog_, 0, 1, 0.3)

				var_56_47:setOnUpdate(LuaHelper.FloatAction(function(arg_57_0)
					arg_53_1.dialogCg_.alpha = arg_57_0
				end))
				var_56_47:setOnComplete(System.Action(function()
					LeanTween.cancel(arg_53_1.dialog_)
					var_56_47:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				local var_56_48 = arg_53_1:FormatText(StoryNameCfg[471].name)
				...
				local var_56_49 = arg_53_1:GetWordFromCfg(319161013)
				...
				local var_56_53 = var_56_51 <= 0 and var_56_46 or var_56_46 * (var_56_52 / var_56_51)

				if var_56_53 > 0 and var_56_46 < var_56_53 then
					arg_53_1.talkMaxDuration = var_56_53
					var_56_45 = var_56_45 + 0.3
				...
				if manager.audio:GetVoiceLength("story_v_out_319161", "319161013", "story_v_out_319161.awb") ~= 0 then
					local var_56_54 = manager.audio:GetVoiceLength("story_v_out_319161", "319161013", "story_v_out_319161.awb") / 1000

					if var_56_54 + var_56_45 > arg_53_1.duration_ then
						arg_53_1.duration_ = var_56_54 + var_56_45
					end

					if var_56_49.prefab_name ~= "" and arg_53_1.actors_[var_56_49.prefab_name] ~= nil then
						local var_56_55 = LuaForUtil.PlayVoiceWithCriLipsync(arg_53_1.actors_[var_56_49.prefab_name].transform, "story_v_out_319161", "319161013", "story_v_out_319161.awb")

						arg_53_1:RecordAudio("319161013", var_56_55)
						arg_53_1:RecordAudio("319161013", var_56_55)
					else
			...
			local var_56_56 = var_56_45 + 0.3
			local var_56_57 = math.max(var_56_46, arg_53_1.talkMaxDuration)

			if var_56_56 <= arg_53_1.time_ and arg_53_1.time_ < var_56_56 + var_56_57 then
				arg_53_1.typewritter.percent = (arg_53_1.time_ - var_56_56) / var_56_57

				arg_53_1.typewritter:SetDirty()
			end

			if arg_53_1.time_ >= var_56_56 + var_56_57 and arg_53_1.time_ < var_56_56 + var_56_57 + arg_56_0 then
