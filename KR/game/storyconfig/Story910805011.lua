return {
	Play910837001 = function(arg_1_0, arg_1_1)
		...
		function arg_1_1.onSingleLineUpdate_(arg_4_0)
			...
			local var_4_25 = arg_1_1.actors_["1071"].transform
			local var_4_26 = 1.8

			if var_4_26 < arg_1_1.time_ and arg_1_1.time_ <= var_4_26 + arg_4_0 then
				arg_1_1.var_.moveOldPos1071 = var_4_25.localPosition
			...
			if var_4_26 <= arg_1_1.time_ and arg_1_1.time_ < var_4_26 + var_4_29 then
				...
				local var_4_31 = Vector3.New(150.77, -446.9, 7.24)

				var_4_25.localPosition = Vector3.Lerp(arg_1_1.var_.moveOldPos1071, var_4_31, var_4_30)
			end

			if arg_1_1.time_ >= var_4_26 + var_4_29 and arg_1_1.time_ < var_4_26 + var_4_29 + arg_4_0 then
				var_4_25.localPosition = Vector3.New(150.77, -446.9, 7.24)
			end

			local var_4_32 = arg_1_1.actors_["1071"]
			local var_4_33 = 1.8

			if var_4_33 < arg_1_1.time_ and arg_1_1.time_ <= var_4_33 + arg_4_0 and arg_1_1.var_.actorSpriteComps1071 == nil then
				arg_1_1.var_.actorSpriteComps1071 = var_4_32:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_1_1.time_ >= var_4_33 + var_4_34 and arg_1_1.time_ < var_4_33 + var_4_34 + arg_4_0 and arg_1_1.var_.actorSpriteComps1071 then
			...
			if var_4_44 < arg_1_1.time_ and arg_1_1.time_ <= var_4_44 + arg_4_0 then
				...
				local var_4_47 = arg_1_1:FormatText(StoryNameCfg[384].name)
				...
				local var_4_48 = arg_1_1:GetWordFromCfg(910837001)
	...
	Play910837002 = function(arg_7_0, arg_7_1)
		...
		function arg_7_1.onSingleLineUpdate_(arg_10_0)
			...
			if var_10_15 < arg_7_1.time_ and arg_7_1.time_ <= var_10_15 + arg_10_0 then
				...
				local var_10_18 = arg_7_1:GetWordFromCfg(910837002)
	...
	Play910837003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			if var_14_15 < arg_11_1.time_ and arg_11_1.time_ <= var_14_15 + arg_14_0 then
				...
				local var_14_18 = arg_11_1:GetWordFromCfg(910837003)
	...
	Play910837004 = function(arg_15_0, arg_15_1)
		...
		function arg_15_1.onSingleLineUpdate_(arg_18_0)
			...
			if var_18_15 < arg_15_1.time_ and arg_15_1.time_ <= var_18_15 + arg_18_0 then
				...
				local var_18_18 = arg_15_1:GetWordFromCfg(910837004)
	...
	Play910837005 = function(arg_19_0, arg_19_1)
		...
		function arg_19_1.onSingleLineUpdate_(arg_22_0)
			...
			if var_22_15 < arg_19_1.time_ and arg_19_1.time_ <= var_22_15 + arg_22_0 then
				...
				local var_22_18 = arg_19_1:GetWordFromCfg(910837005)
	...
	Play910837006 = function(arg_23_0, arg_23_1)
		...
		function arg_23_1.onSingleLineUpdate_(arg_26_0)
			...
			if var_26_15 < arg_23_1.time_ and arg_23_1.time_ <= var_26_15 + arg_26_0 then
				...
				local var_26_18 = arg_23_1:GetWordFromCfg(910837006)
	...
	Play910837007 = function(arg_27_0, arg_27_1)
		...
		function arg_27_1.onSingleLineUpdate_(arg_30_0)
			...
			if var_30_15 < arg_27_1.time_ and arg_27_1.time_ <= var_30_15 + arg_30_0 then
				...
				local var_30_18 = arg_27_1:GetWordFromCfg(910837007)
	...
	Play910837008 = function(arg_31_0, arg_31_1)
		...
		function arg_31_1.onSingleLineUpdate_(arg_34_0)
			...
			if var_34_15 < arg_31_1.time_ and arg_31_1.time_ <= var_34_15 + arg_34_0 then
				...
				local var_34_17 = arg_31_1:FormatText(StoryNameCfg[623].name)
				...
				local var_34_18 = arg_31_1:GetWordFromCfg(910837008)
	...
	Play910837009 = function(arg_35_0, arg_35_1)
		...
		function arg_35_1.onSingleLineUpdate_(arg_38_0)
			...
			if var_38_15 < arg_35_1.time_ and arg_35_1.time_ <= var_38_15 + arg_38_0 then
				...
				local var_38_18 = arg_35_1:GetWordFromCfg(910837009)
	...
	Play910837010 = function(arg_39_0, arg_39_1)
		...
		function arg_39_1.onSingleLineUpdate_(arg_42_0)
			...
			if var_42_15 < arg_39_1.time_ and arg_39_1.time_ <= var_42_15 + arg_42_0 then
				...
				local var_42_18 = arg_39_1:GetWordFromCfg(910837010)
	...
	Play910837011 = function(arg_43_0, arg_43_1)
		...
		function arg_43_1.onSingleLineUpdate_(arg_46_0)
			...
			if var_46_15 < arg_43_1.time_ and arg_43_1.time_ <= var_46_15 + arg_46_0 then
				...
				local var_46_17 = arg_43_1:FormatText(StoryNameCfg[623].name)
				...
				local var_46_18 = arg_43_1:GetWordFromCfg(910837011)
	...
	Play910837012 = function(arg_47_0, arg_47_1)
		...
		function arg_47_1.onSingleLineUpdate_(arg_50_0)
			...
			if var_50_15 < arg_47_1.time_ and arg_47_1.time_ <= var_50_15 + arg_50_0 then
				...
				local var_50_18 = arg_47_1:GetWordFromCfg(910837012)
	...
	Play910837013 = function(arg_51_0, arg_51_1)
		...
		function arg_51_1.onSingleLineUpdate_(arg_54_0)
			...
			if var_54_19 < arg_51_1.time_ and arg_51_1.time_ <= var_54_19 + arg_54_0 then
				...
				local var_54_21 = arg_51_1:FormatText(StoryNameCfg[384].name)
				...
				local var_54_22 = arg_51_1:GetWordFromCfg(910837013)
