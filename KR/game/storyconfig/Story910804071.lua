return {
	...
	Play910834003 = function(arg_11_0, arg_11_1)
		...
		function arg_11_1.onSingleLineUpdate_(arg_14_0)
			...
			local var_14_3 = arg_11_1.actors_["1084"].transform
			local var_14_4 = 0

			if var_14_4 < arg_11_1.time_ and arg_11_1.time_ <= var_14_4 + arg_14_0 then
				arg_11_1.var_.moveOldPos1084 = var_14_3.localPosition
				...
				for iter_14_2 = 0, var_14_5 - 1 do
					...
					if var_14_6.name == "" or not string.find(var_14_6.name, "split") then
			...
			if var_14_4 <= arg_11_1.time_ and arg_11_1.time_ < var_14_4 + var_14_7 then
				...
				var_14_3.localPosition = Vector3.Lerp(arg_11_1.var_.moveOldPos1084, var_14_9, var_14_8)
			end
			...
			local var_14_10 = arg_11_1.actors_["1084"]
			local var_14_11 = 0

			if var_14_11 < arg_11_1.time_ and arg_11_1.time_ <= var_14_11 + arg_14_0 and arg_11_1.var_.actorSpriteComps1084 == nil then
				arg_11_1.var_.actorSpriteComps1084 = var_14_10:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if arg_11_1.time_ >= var_14_11 + var_14_12 and arg_11_1.time_ < var_14_11 + var_14_12 + arg_14_0 and arg_11_1.var_.actorSpriteComps1084 then
			...
			if var_14_18 < arg_11_1.time_ and arg_11_1.time_ <= var_14_18 + arg_14_0 then
				...
				local var_14_20 = arg_11_1:FormatText(StoryNameCfg[6].name)
				...
				local var_14_21 = arg_11_1:GetWordFromCfg(910834003)
