return {
	...
	Play117062002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			local var_12_3 = arg_9_1.actors_["1132"]
			local var_12_4 = 0
			...
			if var_12_4 <= arg_9_1.time_ and arg_9_1.time_ < var_12_4 + var_12_6 then
				...
				local var_12_8 = Mathf.Lerp(arg_9_1.var_.alphaOldValue1132, 1, var_12_7)

				if arg_9_1.var_.characterEffect1132 then
					arg_9_1.var_.characterEffect1132.alpha = var_12_8
				end
			end

			if arg_9_1.time_ >= var_12_4 + var_12_6 and arg_9_1.time_ < var_12_4 + var_12_6 + arg_12_0 and arg_9_1.var_.characterEffect1132 then
			...
			if arg_9_1.actors_[var_12_9] == nil then
				local var_12_10 = Object.Instantiate(Asset.Load("Widget/System/Story/StoryExpression/" .. var_12_9), arg_9_1.canvasGo_.transform)

				var_12_10.transform:SetSiblingIndex(1)

				var_12_10.name = var_12_9
				var_12_10.transform.localPosition = Vector3.New(0, 100000, 0)
				arg_9_1.actors_[var_12_9] = var_12_10

				local var_12_11 = var_12_10:GetComponentsInChildren(typeof(Image), true):ToTable()
			...
			local var_12_12 = arg_9_1.actors_["1033"].transform
			local var_12_13 = 0

			if var_12_13 < arg_9_1.time_ and arg_9_1.time_ <= var_12_13 + arg_12_0 then
				arg_9_1.var_.moveOldPos1033 = var_12_12.localPosition
				...
				for iter_12_4 = 0, var_12_14 - 1 do
					local var_12_15 = var_12_12:GetChild(iter_12_4)
			...
			if var_12_13 <= arg_9_1.time_ and arg_9_1.time_ < var_12_13 + var_12_16 then
				...
				local var_12_18 = Vector3.New(390, -420, 0)

				var_12_12.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1033, var_12_18, var_12_17)
			end

			if arg_9_1.time_ >= var_12_13 + var_12_16 and arg_9_1.time_ < var_12_13 + var_12_16 + arg_12_0 then
				var_12_12.localPosition = Vector3.New(390, -420, 0)
			end

			local var_12_19 = arg_9_1.actors_["1132"].transform
			local var_12_20 = 0

			if var_12_20 < arg_9_1.time_ and arg_9_1.time_ <= var_12_20 + arg_12_0 then
				arg_9_1.var_.moveOldPos1132 = var_12_19.localPosition
				...
				for iter_12_5 = 0, var_12_21 - 1 do
					local var_12_22 = var_12_19:GetChild(iter_12_5)

					if var_12_22.name == "split_6" or not string.find(var_12_22.name, "split") then
			...
			if var_12_20 <= arg_9_1.time_ and arg_9_1.time_ < var_12_20 + var_12_23 then
				...
				local var_12_25 = Vector3.New(-390, -413, -185)

				var_12_19.localPosition = Vector3.Lerp(arg_9_1.var_.moveOldPos1132, var_12_25, var_12_24)
			end

			if arg_9_1.time_ >= var_12_20 + var_12_23 and arg_9_1.time_ < var_12_20 + var_12_23 + arg_12_0 then
				var_12_19.localPosition = Vector3.New(-390, -413, -185)
			end

			local var_12_26 = arg_9_1.actors_["1132"]
			local var_12_27 = 0

			if var_12_27 < arg_9_1.time_ and arg_9_1.time_ <= var_12_27 + arg_12_0 and arg_9_1.var_.actorSpriteComps1132 == nil then
				arg_9_1.var_.actorSpriteComps1132 = var_12_26:GetComponentsInChildren(typeof(Image), true)
			end
			...
			if var_12_27 <= arg_9_1.time_ and arg_9_1.time_ < var_12_27 + var_12_28 then
				...
				if arg_9_1.var_.actorSpriteComps1132 then
					for iter_12_6, iter_12_7 in pairs(arg_9_1.var_.actorSpriteComps1132:ToTable()) do
						if iter_12_7 then
							if arg_9_1.isInRecall_ then
								local var_12_30 = Mathf.Lerp(iter_12_7.color.r, 0.82, var_12_29)
								local var_12_31 = Mathf.Lerp(iter_12_7.color.g, 0.77, var_12_29)
								local var_12_32 = Mathf.Lerp(iter_12_7.color.b, 0.62, var_12_29)

								iter_12_7.color = Color.New(var_12_30, var_12_31, var_12_32)
							else
								local var_12_33 = Mathf.Lerp(iter_12_7.color.r, 1, var_12_29)

								iter_12_7.color = Color.New(var_12_33, var_12_33, var_12_33)
							end
						end
					end
				end
			...
			if arg_9_1.time_ >= var_12_27 + var_12_28 and arg_9_1.time_ < var_12_27 + var_12_28 + arg_12_0 and arg_9_1.var_.actorSpriteComps1132 then
			...
			local var_12_45 = 0.333333333333333
			...
			if var_12_48 < arg_9_1.time_ and arg_9_1.time_ <= var_12_48 + arg_12_0 then
				...
				local var_12_50 = arg_9_1:FormatText(StoryNameCfg[61].name)
				...
				local var_12_51 = arg_9_1:GetWordFromCfg(117062002)
				...
				if manager.audio:GetVoiceLength("story_v_out_117062", "117062002", "story_v_out_117062.awb") ~= 0 then
					local var_12_56 = manager.audio:GetVoiceLength("story_v_out_117062", "117062002", "story_v_out_117062.awb") / 1000
					...
					if var_12_51.prefab_name ~= "" and arg_9_1.actors_[var_12_51.prefab_name] ~= nil then
						local var_12_57 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_51.prefab_name].transform, "story_v_out_117062", "117062002", "story_v_out_117062.awb")

						arg_9_1:RecordAudio("117062002", var_12_57)
						arg_9_1:RecordAudio("117062002", var_12_57)
					else
	...
	Play117062005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_1 < arg_21_1.time_ and arg_21_1.time_ <= var_24_1 + arg_24_0 and arg_21_1.var_.actorSpriteComps1132 == nil then
			...
			if arg_21_1.time_ >= var_24_1 + var_24_2 and arg_21_1.time_ < var_24_1 + var_24_2 + arg_24_0 and arg_21_1.var_.actorSpriteComps1132 then
	...
	Play117062011 = function(arg_45_0, arg_45_1)
		...
		function arg_45_1.onSingleLineUpdate_(arg_48_0)
			...
			if var_48_14 < arg_45_1.time_ and arg_45_1.time_ <= var_48_14 + arg_48_0 and arg_45_1.var_.actorSpriteComps1132 == nil then
			...
			if arg_45_1.time_ >= var_48_14 + var_48_15 and arg_45_1.time_ < var_48_14 + var_48_15 + arg_48_0 and arg_45_1.var_.actorSpriteComps1132 then
