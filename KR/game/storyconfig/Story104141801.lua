	...
	Play414181004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			if var_20_19 < arg_17_1.time_ and arg_17_1.time_ <= var_20_19 + arg_20_0 then
				...
				local var_20_22 = arg_17_1:GetWordFromCfg(414181004)
	...
	Play414181014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if arg_57_1.actors_[var_60_4] == nil then
				local var_60_5 = Object.Instantiate(Asset.Load("Char/" .. var_60_4), arg_57_1.stage_.transform)
			...
			if var_60_14 < arg_57_1.time_ and arg_57_1.time_ <= var_60_14 + arg_60_0 then
				...
				local var_60_16 = arg_57_1:FormatText(StoryNameCfg[562].name)
				...
				local var_60_17 = arg_57_1:GetWordFromCfg(414181014)
