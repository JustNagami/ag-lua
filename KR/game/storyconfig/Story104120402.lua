return {
	...
	Play412042002 = function(arg_9_0, arg_9_1)
		...
		function arg_9_1.onSingleLineUpdate_(arg_12_0)
			...
			if var_12_19 < arg_9_1.time_ and arg_9_1.time_ <= var_12_19 + arg_12_0 then
				...
				local var_12_22 = arg_9_1:GetWordFromCfg(412042002)
				...
				if manager.audio:GetVoiceLength("story_v_out_412042", "412042002", "story_v_out_412042.awb") ~= 0 then
					local var_12_27 = manager.audio:GetVoiceLength("story_v_out_412042", "412042002", "story_v_out_412042.awb") / 1000
					...
					if var_12_22.prefab_name ~= "" and arg_9_1.actors_[var_12_22.prefab_name] ~= nil then
						local var_12_28 = LuaForUtil.PlayVoiceWithCriLipsync(arg_9_1.actors_[var_12_22.prefab_name].transform, "story_v_out_412042", "412042002", "story_v_out_412042.awb")

						arg_9_1:RecordAudio("412042002", var_12_28)
						arg_9_1:RecordAudio("412042002", var_12_28)
					else
	...
	Play412042003 = function(arg_13_0, arg_13_1)
		...
		function arg_13_1.onSingleLineUpdate_(arg_16_0)
			...
			if var_16_34 < arg_13_1.time_ and arg_13_1.time_ <= var_16_34 + arg_16_0 then
				...
				local var_16_37 = arg_13_1:GetWordFromCfg(412042003)
				...
				if manager.audio:GetVoiceLength("story_v_out_412042", "412042003", "story_v_out_412042.awb") ~= 0 then
					local var_16_42 = manager.audio:GetVoiceLength("story_v_out_412042", "412042003", "story_v_out_412042.awb") / 1000
					...
					if var_16_37.prefab_name ~= "" and arg_13_1.actors_[var_16_37.prefab_name] ~= nil then
						local var_16_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_13_1.actors_[var_16_37.prefab_name].transform, "story_v_out_412042", "412042003", "story_v_out_412042.awb")

						arg_13_1:RecordAudio("412042003", var_16_43)
						arg_13_1:RecordAudio("412042003", var_16_43)
					else
	...
	Play412042004 = function(arg_17_0, arg_17_1)
		...
		function arg_17_1.onSingleLineUpdate_(arg_20_0)
			...
			local var_20_19 = arg_17_1.actors_["10078ui_story"].transform
			local var_20_20 = 0

			if var_20_20 < arg_17_1.time_ and arg_17_1.time_ <= var_20_20 + arg_20_0 then
				arg_17_1.var_.moveOldPos10078ui_story = var_20_19.localPosition
			end
			...
			if var_20_20 <= arg_17_1.time_ and arg_17_1.time_ < var_20_20 + var_20_21 then
				...
				var_20_19.localPosition = Vector3.Lerp(arg_17_1.var_.moveOldPos10078ui_story, var_20_23, var_20_22)
			...
			local var_20_28 = arg_17_1.actors_["10078ui_story"]
			local var_20_29 = 0

			if var_20_29 < arg_17_1.time_ and arg_17_1.time_ <= var_20_29 + arg_20_0 and arg_17_1.var_.characterEffect10078ui_story == nil then
				arg_17_1.var_.characterEffect10078ui_story = var_20_28:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_20_29 <= arg_17_1.time_ and arg_17_1.time_ < var_20_29 + var_20_30 then
				...
				if arg_17_1.var_.characterEffect10078ui_story then
					...
					arg_17_1.var_.characterEffect10078ui_story.fillRatio = var_20_32
				end
			end

			if arg_17_1.time_ >= var_20_29 + var_20_30 and arg_17_1.time_ < var_20_29 + var_20_30 + arg_20_0 and arg_17_1.var_.characterEffect10078ui_story then
				local var_20_33 = 0.5
			...
			if var_20_34 < arg_17_1.time_ and arg_17_1.time_ <= var_20_34 + arg_20_0 then
				...
				local var_20_36 = arg_17_1:FormatText(StoryNameCfg[917].name)
				...
				local var_20_37 = arg_17_1:GetWordFromCfg(412042004)
				...
				if manager.audio:GetVoiceLength("story_v_out_412042", "412042004", "story_v_out_412042.awb") ~= 0 then
					local var_20_42 = manager.audio:GetVoiceLength("story_v_out_412042", "412042004", "story_v_out_412042.awb") / 1000
					...
					if var_20_37.prefab_name ~= "" and arg_17_1.actors_[var_20_37.prefab_name] ~= nil then
						local var_20_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_17_1.actors_[var_20_37.prefab_name].transform, "story_v_out_412042", "412042004", "story_v_out_412042.awb")

						arg_17_1:RecordAudio("412042004", var_20_43)
						arg_17_1:RecordAudio("412042004", var_20_43)
					else
	...
	Play412042005 = function(arg_21_0, arg_21_1)
		...
		function arg_21_1.onSingleLineUpdate_(arg_24_0)
			...
			if var_24_5 <= arg_21_1.time_ and arg_21_1.time_ < var_24_5 + var_24_6 then
				...
				local var_24_8 = Vector3.New(0, -2.6, -2.8)
			...
			if arg_21_1.time_ >= var_24_5 + var_24_6 and arg_21_1.time_ < var_24_5 + var_24_6 + arg_24_0 then
				var_24_4.localPosition = Vector3.New(0, -2.6, -2.8)
			...
			local var_24_19 = arg_21_1.actors_["10076ui_story"].transform
			local var_24_20 = 0

			if var_24_20 < arg_21_1.time_ and arg_21_1.time_ <= var_24_20 + arg_24_0 then
				arg_21_1.var_.moveOldPos10076ui_story = var_24_19.localPosition
			end
			...
			if var_24_20 <= arg_21_1.time_ and arg_21_1.time_ < var_24_20 + var_24_21 then
				...
				var_24_19.localPosition = Vector3.Lerp(arg_21_1.var_.moveOldPos10076ui_story, var_24_23, var_24_22)
			...
			local var_24_28 = arg_21_1.actors_["10076ui_story"]
			local var_24_29 = 0

			if var_24_29 < arg_21_1.time_ and arg_21_1.time_ <= var_24_29 + arg_24_0 and arg_21_1.var_.characterEffect10076ui_story == nil then
				arg_21_1.var_.characterEffect10076ui_story = var_24_28:GetComponentInChildren(typeof(CharacterEffect))
			end
			...
			if var_24_29 <= arg_21_1.time_ and arg_21_1.time_ < var_24_29 + var_24_30 then
				...
				if arg_21_1.var_.characterEffect10076ui_story then
					...
					arg_21_1.var_.characterEffect10076ui_story.fillRatio = var_24_32
				end
			end

			if arg_21_1.time_ >= var_24_29 + var_24_30 and arg_21_1.time_ < var_24_29 + var_24_30 + arg_24_0 and arg_21_1.var_.characterEffect10076ui_story then
				local var_24_33 = 0.5
			...
			if var_24_34 < arg_21_1.time_ and arg_21_1.time_ <= var_24_34 + arg_24_0 then
				...
				local var_24_37 = arg_21_1:GetWordFromCfg(412042005)
				...
				if manager.audio:GetVoiceLength("story_v_out_412042", "412042005", "story_v_out_412042.awb") ~= 0 then
					local var_24_42 = manager.audio:GetVoiceLength("story_v_out_412042", "412042005", "story_v_out_412042.awb") / 1000
					...
					if var_24_37.prefab_name ~= "" and arg_21_1.actors_[var_24_37.prefab_name] ~= nil then
						local var_24_43 = LuaForUtil.PlayVoiceWithCriLipsync(arg_21_1.actors_[var_24_37.prefab_name].transform, "story_v_out_412042", "412042005", "story_v_out_412042.awb")

						arg_21_1:RecordAudio("412042005", var_24_43)
						arg_21_1:RecordAudio("412042005", var_24_43)
					else
	...
	Play412042006 = function(arg_25_0, arg_25_1)
		...
		function arg_25_1.onSingleLineUpdate_(arg_28_0)
			...
			if var_28_10 < arg_25_1.time_ and arg_25_1.time_ <= var_28_10 + arg_28_0 and arg_25_1.var_.characterEffect10083ui_story == nil then
			...
			if arg_25_1.time_ >= var_28_10 + var_28_11 and arg_25_1.time_ < var_28_10 + var_28_11 + arg_28_0 and arg_25_1.var_.characterEffect10083ui_story then
				local var_28_14 = 0.5
	...
	Play412042010 = function(arg_41_0, arg_41_1)
		...
		function arg_41_1.onSingleLineUpdate_(arg_44_0)
			...
			if var_44_13 < arg_41_1.time_ and arg_41_1.time_ <= var_44_13 + arg_44_0 then
				arg_41_1:PlayTimeline("1097ui_story", "StoryTimeline/CharAction/1097/1097action/1097action6_2")
			end
			...
			if var_44_16 < arg_41_1.time_ and arg_41_1.time_ <= var_44_16 + arg_44_0 and arg_41_1.var_.characterEffect10076ui_story == nil then
			...
			if arg_41_1.time_ >= var_44_16 + var_44_17 and arg_41_1.time_ < var_44_16 + var_44_17 + arg_44_0 and arg_41_1.var_.characterEffect10076ui_story then
				local var_44_20 = 0.5
	...
	Play412042012 = function(arg_49_0, arg_49_1)
		...
		function arg_49_1.onSingleLineUpdate_(arg_52_0)
			...
			if var_52_25 < arg_49_1.time_ and arg_49_1.time_ <= var_52_25 + arg_52_0 and arg_49_1.var_.characterEffect10076ui_story == nil then
			...
			if arg_49_1.time_ >= var_52_25 + var_52_26 and arg_49_1.time_ < var_52_25 + var_52_26 + arg_52_0 and arg_49_1.var_.characterEffect10076ui_story then
				local var_52_29 = 0.5
			...
			if var_52_40 < arg_49_1.time_ and arg_49_1.time_ <= var_52_40 + arg_52_0 and arg_49_1.var_.characterEffect1097ui_story == nil then
			...
			if arg_49_1.time_ >= var_52_40 + var_52_41 and arg_49_1.time_ < var_52_40 + var_52_41 + arg_52_0 and arg_49_1.var_.characterEffect1097ui_story then
				local var_52_44 = 0.5
	...
	Play412042013 = function(arg_53_0, arg_53_1)
		...
		function arg_53_1.onSingleLineUpdate_(arg_56_0)
			...
			if var_56_10 < arg_53_1.time_ and arg_53_1.time_ <= var_56_10 + arg_56_0 and arg_53_1.var_.characterEffect10078ui_story == nil then
			...
			if arg_53_1.time_ >= var_56_10 + var_56_11 and arg_53_1.time_ < var_56_10 + var_56_11 + arg_56_0 and arg_53_1.var_.characterEffect10078ui_story then
				arg_53_1.var_.characterEffect10078ui_story.fillFlat = false
			end
			...
			if var_56_13 < arg_53_1.time_ and arg_53_1.time_ <= var_56_13 + arg_56_0 then
				arg_53_1:PlayTimeline("10078ui_story", "StoryTimeline/CharAction/6046/6046action/6046action1_1")
			end
	...
	Play412042014 = function(arg_57_0, arg_57_1)
		...
		function arg_57_1.onSingleLineUpdate_(arg_60_0)
			...
			if var_60_25 < arg_57_1.time_ and arg_57_1.time_ <= var_60_25 + arg_60_0 and arg_57_1.var_.characterEffect10078ui_story == nil then
			...
			if arg_57_1.time_ >= var_60_25 + var_60_26 and arg_57_1.time_ < var_60_25 + var_60_26 + arg_60_0 and arg_57_1.var_.characterEffect10078ui_story then
				local var_60_29 = 0.5
	...
	Play412042020 = function(arg_81_0, arg_81_1)
		...
		function arg_81_1.onSingleLineUpdate_(arg_84_0)
			...
			if var_84_13 < arg_81_1.time_ and arg_81_1.time_ <= var_84_13 + arg_84_0 then
				arg_81_1:PlayTimeline("10078ui_story", "StoryTimeline/CharAction/6046/6046action/6046action1_1")
			end
			...
			if var_84_25 < arg_81_1.time_ and arg_81_1.time_ <= var_84_25 + arg_84_0 and arg_81_1.var_.characterEffect10076ui_story == nil then
			...
			if arg_81_1.time_ >= var_84_25 + var_84_26 and arg_81_1.time_ < var_84_25 + var_84_26 + arg_84_0 and arg_81_1.var_.characterEffect10076ui_story then
				local var_84_29 = 0.5
	...
	Play412042024 = function(arg_99_0, arg_99_1)
		...
		function arg_99_1.onSingleLineUpdate_(arg_102_0)
			...
			if var_102_1 < arg_99_1.time_ and arg_99_1.time_ <= var_102_1 + arg_102_0 and arg_99_1.var_.characterEffect10076ui_story == nil then
			...
			if arg_99_1.time_ >= var_102_1 + var_102_2 and arg_99_1.time_ < var_102_1 + var_102_2 + arg_102_0 and arg_99_1.var_.characterEffect10076ui_story then
				local var_102_5 = 0.5
	...
	assets = {
		...
		"Assets/UIResources/UI_AB/TextureConfig/Background/EN0110"
	},
	voices = {
