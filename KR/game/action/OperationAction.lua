...
function var_0_0.OpenTransferCode()
	var_0_0.GetCurServerTimestampAndSign(function()
		local var_40_0 = var_0_0.GetOperationUrl("ACCOUNT_TRANSFER_URL")
		local var_40_1 = PlayerData:GetPlayerInfo().userID
		local var_40_2 = _G.TMP_CHANNELID
		local var_40_3 = GetSDKLoginToken()
		local var_40_4 = string.format(var_40_0, var_40_1, var_40_2, var_40_3, _G.SERVER_TIMESTAMP, _G.SERVER_TIMESTAMP_SIGN)

		var_0_0.OpenUrl(var_40_4, OperationConst.URL_OPEN_WAY.NORMAL)
	end)
end
