...
function var_0_0.CheckGuide(arg_2_0)
	...
	local var_2_1 = ActivityData:GetActivityIsOpen(ActivityConst.ACTIVITY_3_0_DIRECTIONAL_DRAW) and not DrawData:GetNewbieChooseDrawFlag()

	var_2_0 = var_2_0 and var_2_1
